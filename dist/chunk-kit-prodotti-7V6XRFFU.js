import{a as ie,c as Rt,e as ee,f as r,g as y,h as wt,l as ne,m as Q,q as oe,t as pt,w as ae}from"./chunk-chunk-5ZDS26YL.js";function St(t){let i=Array.isArray(t)?{kits:t}:t&&typeof t=="object"?t:{},n=i.orderDrafts,e=n&&typeof n=="object"&&!Array.isArray(n)?n:{};return{kits:Array.isArray(i.kits)?i.kits.map(Wt):[],anagrafiche:Array.isArray(i.anagrafiche)?i.anagrafiche:[],distinte:Array.isArray(i.distinte)?i.distinte:[],presets:Array.isArray(i.presets)?i.presets:[],orderDrafts:e,draftDocSeq:Math.max(0,Number.parseInt(i.draftDocSeq,10)||0),ts:Number(i.ts||0)||0}}function qt(){return{kits:x.kits,anagrafiche:x.anagrafiche,distinte:x.distinte,presets:x.presets,orderDrafts:x.orderDrafts,draftDocSeq:x.draftDocSeq}}function pi(t){let i=St(t||{});return!!(i.kits&&i.kits.length||i.anagrafiche&&i.anagrafiche.length||i.distinte&&i.distinte.length||i.presets&&i.presets.length||i.orderDrafts&&Object.keys(i.orderDrafts).length||i.draftDocSeq>0)}function re(){try{let t=localStorage.getItem("_mlKitData"),i=t?JSON.parse(t):{},n=Array.isArray(i)?i:Array.isArray(i?.kits)?i.kits:[],e=JSON.parse(localStorage.getItem("_mlKitAnagrafiche")||"[]"),o=JSON.parse(localStorage.getItem("_mlKitDistinte")||"[]"),a=JSON.parse(localStorage.getItem("_mlKitPresetSections")||"[]"),s=JSON.parse(localStorage.getItem("_mlKitOrderDrafts")||"{}"),d=Number.parseInt(localStorage.getItem("_mlKitOrderDraftSeq")||"0",10)||0;return{kits:Array.isArray(n)?n:[],anagrafiche:Array.isArray(e)?e:[],distinte:Array.isArray(o)?o:[],presets:Array.isArray(a)?a:[],orderDrafts:s&&typeof s=="object"&&!Array.isArray(s)?s:{},draftDocSeq:d}}catch{return St({})}}function ce(){["_mlKitData","_mlKitDataTs","_mlKitOrderDrafts","_mlKitOrderDraftSeq","_mlKitPresetSections","_mlKitDistinte","_mlKitDistinteTs","_mlKitAnagrafiche","_mlKitAnagraficheTs"].forEach(function(i){try{localStorage.removeItem(i)}catch{}})}function ia(){jt=!1}function X(t,i){return String(t||"").trim().toLowerCase().replace(/\s+/g,"_").replace(/[^a-z0-9_-]/g,"")||i}function it(t){let i=String(t??"").trim().replace(",","."),n=Number.parseFloat(i);return Number.isFinite(n)?Math.max(0,n):0}function V(t){let i=Number(t);if(!Number.isFinite(i))return"0";let n=Math.round(i*1e3)/1e3;return Math.abs(n-Math.round(n))<1e-9?String(Math.round(n)):n.toLocaleString("it-IT",{minimumFractionDigits:0,maximumFractionDigits:3})}function xt(t,i="pz"){return String(t||i).trim().toLowerCase()||i}function de(t,i){let n="opz"+(i+1),e=X(t?.key,n);return{id:String(t?.id||_()),key:e,nome:String(t?.nome||e).trim()||e,codice:String(t?.codice||"").trim()}}function le(t,i){let n="asse"+(i+1),e=X(t?.key,n),o=Array.isArray(t?.opzioni)?t.opzioni.map((a,s)=>de(a,s)).filter(Boolean):[];return{id:String(t?.id||_()),key:e,nome:String(t?.nome||e).trim()||e,opzioni:o}}function ui(t){return t.length===1?t[0].opzioneKey:t.map(function(i){return i.asseKey+"="+i.opzioneKey}).join("|")}function pe(t){return t.length===1?t[0].opzioneNome:t.map(function(i){return i.asseNome+": "+i.opzioneNome}).join(" \xB7 ")}function fi(t){if(!Array.isArray(t)||!t.length)return[];let i=t.filter(e=>Array.isArray(e.opzioni)&&e.opzioni.length);if(!i.length)return[];let n=[{selections:[]}];for(let e of i){let o=[];for(let a of n)for(let s of e.opzioni)o.push({selections:a.selections.concat({asseId:e.id,asseKey:e.key,asseNome:e.nome,opzioneId:s.id,opzioneKey:s.key,opzioneNome:s.nome,opzioneCodice:String(s.codice||"").trim()})});n=o}return n.map(function(e,o){return{id:"combo-"+(o+1),key:ui(e.selections),nome:pe(e.selections),selections:e.selections}})}function me(t){let i=String(t?.modoComponente||"quantificato").trim()||"quantificato",n=i==="segnalazione"?!1:t?.tracciabile!==void 0?!!t.tracciabile:!0,e=i==="segnalazione"?"flag":"pz";return{id:String(t?.id||_()),nome:String(t?.nome||"Nuovo componente").trim()||"Nuovo componente",codice:String(t?.codice||"").trim(),qtaPerVariante:{...t?.qtaPerVariante||{}},caricato:Number(t?.caricato||0),modoComponente:i,tracciabile:n,noteConfig:String(t?.noteConfig||"").trim(),unitaMisura:xt(t?.unitaMisura,e),applicazioneTipo:String(t?.applicazioneTipo||"").trim(),applicazioneAsseId:String(t?.applicazioneAsseId||"").trim(),applicazioneOpzioneIds:Array.isArray(t?.applicazioneOpzioneIds)?t.applicazioneOpzioneIds.map(String):[],qtaBase:it(t?.qtaBase)}}function gi(t){return[...Array.isArray(t)?t:[]].sort((n,e)=>{let o=String(n?.nome||"").trim(),a=String(e?.nome||"").trim();return o.localeCompare(a,"it",{sensitivity:"base",numeric:!0})})}function ue(t){return{id:String(t?.id||_()),nome:String(t?.nome||"Nuova sezione").trim()||"Nuova sezione",componenti:gi(Array.isArray(t?.componenti)?t.componenti.map(me):[])}}function fe(t,i){if(t.size!==i.size)return!1;for(let n of t)if(!i.has(n))return!1;return!0}function ki(t,i){let n={tipo:"sempre",asseId:"",opzioneIds:[],qtyBase:it(t?.qtaBase)};if(t?.applicazioneTipo==="sempre"||t?.applicazioneTipo==="gruppo")return{tipo:t.applicazioneTipo,asseId:String(t.applicazioneAsseId||""),opzioneIds:Array.isArray(t.applicazioneOpzioneIds)?t.applicazioneOpzioneIds.map(String):[],qtyBase:n.qtyBase||it(Object.values(t?.qtaPerVariante||{})[0])};let e=q(i);if(!e.length)return n;let o=e.filter(c=>R(t,c.key)>0);if(!o.length)return n;let a=new Set(o.map(c=>R(t,c.key)));if(a.size!==1)return{tipo:"manuale",asseId:"",opzioneIds:[],qtyBase:Math.max(...o.map(c=>R(t,c.key)))};let s=[...a][0];if(o.length===e.length)return{tipo:"sempre",asseId:"",opzioneIds:[],qtyBase:s};let d=new Set(o.map(c=>c.key));for(let c of i.assiConfigurazione||[]){let l=[];for(let u of c.opzioni||[]){let p=new Set(e.filter(z=>(z.selections||[]).some(g=>g.asseId===c.id&&g.opzioneId===u.id)).map(z=>z.key));if(!p.size)continue;[...p].every(z=>R(t,z)===s)&&l.push(u.id)}if(!l.length)continue;let m=new Set(e.filter(u=>(u.selections||[]).some(p=>p.asseId===c.id&&l.includes(p.opzioneId))).map(u=>u.key));if(fe(m,d))return{tipo:"gruppo",asseId:c.id,opzioneIds:l,qtyBase:s}}return{tipo:"manuale",asseId:"",opzioneIds:[],qtyBase:s}}function Jt(t,i,n){if(!n||n.tipo==="manuale")return{...t?.qtaPerVariante||{}};let e={},o=it(n.qtyBase);if(!o)return e;for(let a of q(i)){let s=n.tipo==="sempre";n.tipo==="gruppo"&&(s=(a.selections||[]).some(d=>d.asseId===n.asseId&&n.opzioneIds.includes(d.opzioneId))),s&&(e[a.key]=o)}return e}function ge(t,i){let n=ue(t);return n.componenti=n.componenti.map(function(e){let o=ki(e,i);return{...e,applicazioneTipo:o.tipo,applicazioneAsseId:o.asseId,applicazioneOpzioneIds:o.opzioneIds,qtaBase:o.qtyBase,qtaPerVariante:Jt(e,i,o)}}),n}function ke(t,i){let n=q(i);if(!n.length)return null;let e=null;for(let o of n){let a=R(t,o.key);if(e===null){e=a;continue}if(e!==a)return null}return e}function ve(t,i,n){let e=q(n),o={},a=ke(t,i);if(!e.length)Object.assign(o,t?.qtaPerVariante||{});else for(let s of e){let c=Object.prototype.hasOwnProperty.call(t?.qtaPerVariante||{},s.key)?R(t,s.key):a!==null?a:0;c>0&&(o[s.key]=c)}return{id:_(),nome:String(t?.nome||"Nuovo componente").trim()||"Nuovo componente",qtaPerVariante:o,caricato:0,modoComponente:t?.modoComponente==="segnalazione"?"segnalazione":"quantificato",tracciabile:Yt(t),noteConfig:String(t?.noteConfig||"").trim(),unitaMisura:xt(t?.unitaMisura,H(t)?"flag":"pz")}}function Mt(t,i,n){return{id:_(),nome:String(t?.nome||"Nuova sezione").trim()||"Nuova sezione",componenti:Array.isArray(t?.componenti)?t.componenti.map(e=>ve(e,i,n)):[]}}function vi(t,i,n){let e=new Set((n.assiConfigurazione||[]).map(c=>c.key)),o=X(t?.key||String(t?.nome||"asse"),"asse1"),a=o,s=1;for(;e.has(a);)a=o+"_c"+s++;let d=[];for(let c=0;c<(t.opzioni||[]).length;c++){let l=t.opzioni[c],m="opz"+(c+1),u=X(l?.key,m),p=1;for(;d.some(f=>f.key===u);)u=u+"_c"+p++;d.push({id:_(),key:u,nome:String(l?.nome||"").trim()||u,codice:String(l?.codice||"").trim()})}return{id:_(),key:a,nome:String(t?.nome||"").trim()||a,opzioni:d}}function Gt(t,i){return(t?.sezioni||[]).find(n=>n.id===i)||null}function $t(t,i){let n=new Set(q(t).map(a=>a.key)),e=q(i),o=e.filter(a=>n.has(a.key)).length;return{targetCount:e.length,exactMatches:o,hasTargetVarianti:e.length>0,needsReview:e.length===0||o<e.length}}function Nt(t,i){let n=String(i||"").trim().toLowerCase();return n?String(t||"").toLowerCase().includes(n):!0}function ye(t,i){return{id:String(t?.id||_()),nome:String(t?.nome||"").trim(),varianteKey:String(t?.varianteKey||i||"").trim(),noteConfig:String(t?.noteConfig||"").trim()}}function Wt(t){let i=t&&typeof t=="object"?t:{},n=Array.isArray(i.varianti)?i.varianti.map(function(p,f){let z="v"+(f+1),g=X(p?.key,z);return{id:String(p?.id||_()),key:g,nome:String(p?.nome||g).trim()||g}}):[],e=Array.isArray(i.assiConfigurazione)?i.assiConfigurazione.map((p,f)=>le(p,f)):[],o=e.length?e:n.length?[{id:"asse-legacy-"+String(i.id||"kit"),key:"configurazione",nome:"Configurazione",opzioni:n.map(function(p){return{id:p.id,key:p.key,nome:p.nome}})}]:[],a=fi(o),s=a.length?a:n,d=new Set(s.map(p=>p.key)),c={};Object.entries(i.qtaDaProdurre||{}).forEach(function(p){d.has(p[0])&&(c[p[0]]=Math.max(0,Number.parseInt(p[1],10)||0))});for(let p of s)c[p.key]===void 0&&(c[p.key]=0);let l=Array.isArray(i.sottoAssembly)?i.sottoAssembly.map(p=>ye(p,s[0]?.key||"")).filter(p=>!p.varianteKey||d.has(p.varianteKey)):[],m={};Object.entries(i.pronti||{}).forEach(function(p){m[p[0]]=Math.max(0,Number.parseInt(p[1],10)||0)});let u=Array.isArray(i.sezioni)?i.sezioni.map(p=>ge(p,{assiConfigurazione:o,varianti:s})):[];return{id:String(i.id||_()),nome:String(i.nome||"Nuovo Kit").trim()||"Nuovo Kit",schemaVersion:Ft,assiConfigurazione:o,varianti:s,sezioni:gi(u),sottoAssembly:l,qtaDaProdurre:c,pronti:m,movimenti:Array.isArray(i.movimenti)?i.movimenti.slice():[]}}function q(t){return Array.isArray(t?.varianti)?t.varianti:[]}function H(t){return!!t&&t.modoComponente==="segnalazione"}function Yt(t){return!!t&&t.tracciabile!==!1&&!H(t)}function R(t,i){let n=it(t?.qtaPerVariante?.[i]);return H(t)?n>0?1:0:n}function Zt(t,i){return ki(t,i)}function kt(){let t=x.orderDrafts;return t&&typeof t=="object"?JSON.parse(JSON.stringify(t)):{}}function Et(t){let i=t&&typeof t=="object"?t:{};x.orderDrafts=i,yt()}function vt(){return Array.isArray(x.presets)?JSON.parse(JSON.stringify(x.presets)):[]}function Xt(t){x.presets=Array.isArray(t)?t:[],yt()}function at(){return Array.isArray(x.distinte)?JSON.parse(JSON.stringify(x.distinte)):[]}function It(t){x.distinte=Array.isArray(t)?t:[],yt()}function st(t){return String(t||"").trim().toUpperCase()}function nt(t){let i=Array.isArray(t?.ordiniCliente)?[...new Set(t.ordiniCliente.map(st).filter(Boolean))]:[];return{cliente:String(t?.cliente||"").trim(),ordiniCliente:i,documento:String(t?.documento||"").trim()}}function J(t){return nt(t?._meta||{})}function At(t,i){return t._meta=nt(i),t._meta}function ct(t,i){return Math.max(0,Number.parseInt(t?.[i],10)||0)}async function Bt(){try{let n=await pt({azione:"reserveKitDraftSeq"}),e=Math.max(0,Number.parseInt(n?.draftDocSeq,10)||0);if(e>0&&(x.draftDocSeq=e),x.ts=Number(n?.ts||x.ts||Date.now())||Date.now(),n?.documento)return String(n.documento)}catch(n){console.warn("[kit-prodotti] reserveKitDraftSeq fallita, fallback locale:",n)}let i=Math.max(0,Number.parseInt(x.draftDocSeq,10)||0)+1;return x.draftDocSeq=i,yt(),`Distinta Base-${String(i).padStart(4,"0")}`}function mi(t){let i=new Set;return(Array.isArray(t)?t:[]).filter(n=>String(n?.archiviato||"").toUpperCase()!=="TRUE").map(n=>({ordine:st(n?.ordine||""),cliente:String(n?.cliente||"").trim()})).filter(n=>!n.ordine||i.has(n.ordine)?!1:(i.add(n.ordine),!0))}function ti(){return et.length?Promise.resolve(et):Array.isArray(window._attiviProd)&&window._attiviProd.length?(et=mi(window._attiviProd),Promise.resolve(et)):_t||(Qt=!0,_t=(function(){let t=new AbortController,i=setTimeout(function(){t.abort()},5e3);return fetch(Rt,{method:"POST",body:JSON.stringify({pagina:"PROGRAMMA PRODUZIONE DEL MESE"}),signal:t.signal}).then(n=>n.json()).then(n=>(et=mi(n),et)).catch(function(n){return n&&n.name==="AbortError"?y("Ricerca ordini lenta: riprova tra poco.","warning"):console.warn("[kit-prodotti] autocomplete ordini non disponibile:",n),[]}).finally(function(){clearTimeout(i),Qt=!1,_t=null})})(),_t)}function be(t){let i=st(t);return i&&et.find(n=>n.ordine===i)||null}function Dt(t,i={}){let n=[...new Set((Array.isArray(t)?t:[]).map(function(e){let o=st(e);return o?i[o]?String(i[o]||"").trim():String(be(o)?.cliente||"").trim():""}).filter(Boolean))];return n.length===1?n[0]:""}function ot(t){let i=kt(),n=i?.[t?.id]&&typeof i[t.id]=="object"?i[t.id]:{},e={};for(let o of q(t)){let a=n[o.key];e[o.key]=Math.max(0,Number.parseInt(a,10)||0)}return e._meta=nt(n._meta||{}),e}function G(t,i){let{kits:n}=h(),e=n.find(m=>m.id===t);if(!e)return;let o=kt(),a=ot(e);i(a,e);let s={},d=!1;for(let m of q(e)){let u=Math.max(0,Number.parseInt(a[m.key],10)||0);s[m.key]=u,u>0&&(d=!0)}let c=nt(a._meta||{}),l=!!(c.cliente||c.ordiniCliente.length||c.documento);(d||l)&&(s._meta=c),d||l?o[t]=s:delete o[t],Et(o),D===t&&P()}function he(t){return Object.entries(t||{}).reduce(function(i,n){return n[0]==="_meta"?i:i+(Number.parseInt(n[1],10)||0)},0)}function yi(t){return!(t.assiConfigurazione&&t.assiConfigurazione.length)}function ft(t){let i=kt(),n=i?.[t]&&typeof i[t]=="object"?i[t]:{};return{_meta:nt(n._meta||{}),_units:Math.max(1,Number.parseInt(n._units,10)||1),_sel:n._sel&&typeof n._sel=="object"?{...n._sel}:{}}}function dt(t,i,n){let e=kt(),o=e?.[t]&&typeof e[t]=="object"?e[t]:{},a={_meta:nt(o._meta||{}),_units:Math.max(1,Number.parseInt(o._units,10)||1),_sel:o._sel&&typeof o._sel=="object"?{...o._sel}:{}};i(a);let s=Object.keys(a._sel).length>0,d=a._units>1,c=nt(a._meta||{}),l=!!(c.cliente||c.ordiniCliente.length||c.documento);s||d||l?e[t]={_meta:c,_units:a._units,_sel:a._sel}:delete e[t],Et(e),n!==!1&&D===t&&P()}function ze(t,i){let n=Math.max(1,Number.parseInt(i,10)||1);try{window._kitSuppressNextFade=!0}catch{}dt(t,function(e){e._units=n})}function we(t,i,n){try{window._kitSuppressNextFade=!0}catch{}dt(t,function(e){n?e._sel[i]=!0:delete e._sel[i]})}function _e(t,i){let n=String(i||"").trim().toLowerCase(),e=document.getElementById("kit-ns-autocomplete-"+t);if(e){if(!n){e.style.display="none",e.innerHTML="";return}Qt&&!et.length&&(e.innerHTML='<div class="autocomplete-item autocomplete-item--muted">Caricamento ordini in corso...</div>',e.style.display="block"),ti().then(function(o){let a=o.filter(function(s){return s.ordine.toLowerCase().includes(n)||s.cliente.toLowerCase().includes(n)}).slice(0,8);if(!a.length){e.style.display="none",e.innerHTML="";return}e.innerHTML=a.map(function(s){return`<div class="autocomplete-item" onmousedown='_kitNSOrderPick(${JSON.stringify(t)},${JSON.stringify(s.ordine)},${JSON.stringify(s.cliente)})'>
                <span class="ac-ordine">ORD. ${r(s.ordine)}</span>
                <span class="ac-cliente">${r(s.cliente)}</span>
            </div>`}).join(""),e.style.display="block"})}}function Ce(t){setTimeout(function(){let i=document.getElementById("kit-ns-autocomplete-"+t);i&&(i.style.display="none",i.innerHTML="")},140)}function $e(t,i,n){let e=st(i);if(!e)return;try{window._kitSuppressNextFade=!0}catch{}dt(t,function(s){s._meta.ordiniCliente.includes(e)||s._meta.ordiniCliente.push(e),s._meta.cliente=Dt(s._meta.ordiniCliente,{[e]:n})});let o=document.getElementById("kit-ns-ref-input-"+t);o&&(o.value="");let a=document.getElementById("kit-ns-autocomplete-"+t);a&&(a.style.display="none",a.innerHTML="")}function Se(t,i){let n=st(i);try{window._kitSuppressNextFade=!0}catch{}dt(t,function(e){e._meta.ordiniCliente=e._meta.ordiniCliente.filter(function(o){return o!==n}),e._meta.cliente=Dt(e._meta.ordiniCliente)})}function bi(t,i,n){try{window._kitSuppressNextFade=!0}catch{}dt(t,function(e){i.forEach(function(o){n?e._sel[o]=!0:delete e._sel[o]})})}function xe(t){try{let i=t.dataset.kitid,n=JSON.parse(t.dataset.compids);bi(i,n,t.checked)}catch(i){console.error("[kit] _kitNSToggleSectionChk error",i)}}function Ie(t){if(!confirm("Azzerare la selezione corrente?"))return;let i=kt();delete i[t],Et(i),P()}function Tt(t,i){let n=Math.max(1,Number.parseInt(i._units,10)||1),e=i._sel&&typeof i._sel=="object"?i._sel:{},o=[],a=[];for(let s of t.sezioni||[]){let d=[];for(let c of s.componenti||[]){if(!e[c.id])continue;let l=it(c.qtaBase!=null?c.qtaBase:1)*n;d.push({id:c.id,nome:c.nome,codice:String(c.codice||"").trim(),totale:l,disponibile:Number(c.caricato||0),unita:c.unitaMisura||"pz",dettaglio:"",noteConfig:c.noteConfig||""}),c.noteConfig&&a.push({id:"note-"+c.id,tipo:"nota",nome:c.nome,dettaglio:c.noteConfig,totaleCoinvolto:l,variantiLabel:""})}d.length&&o.push({id:s.id,nome:s.nome,righe:d})}return{selectedVarianti:[],sezioni:o,avvisi:a,totalePezzi:n,totaleRighe:o.reduce(function(s,d){return s+d.righe.length},0),_isNewStyle:!0}}async function Ae(t){let{kits:i}=h(),n=i.find(function(l){return l.id===t});if(!n)return;let e=ft(t),o=Tt(n,e);if(!o.totaleRighe){y("Seleziona almeno un componente per generare la distinta.","warning");return}let a=[],s=new Map;if((n.sezioni||[]).forEach(function(l){(l.componenti||[]).forEach(function(m){s.set(m.id,m)})}),(o.sezioni||[]).forEach(function(l){(l.righe||[]).forEach(function(m){let u=s.get(m.id),p=Number(u&&u.caricato||0),f=Number(m.totale||0);p<f&&a.push({nome:m.nome,disponibile:p,fabbisogno:f,delta:f-p})})}),a.length){let l=a.slice(0,3).map(function(u){return u.nome+" (-"+V(u.delta)+")"}).join(", "),m=a.length>3?" +"+(a.length-3)+" altri":"";y("Attenzione stock insufficiente: "+l+m,"warning")}if(!e._meta.documento){let l=await Bt();dt(t,function(m){m._meta.documento=l},!1),e=ft(t)}let d={_meta:e._meta},c=at();c.unshift({id:_(),kitId:n.id,kitNome:n.nome,nome:e._meta.documento||"Distinta-"+Date.now(),documento:e._meta.documento||"",createdAt:Date.now(),createdBy:Q?.nome||"Sistema",orderDraftSnapshot:d,distintaSnapshot:o}),It(c);try{typeof window._notificaFabbisognoNuovo=="function"&&window._notificaFabbisognoNuovo({kitId:n.id,kitNome:n.nome,documento:e._meta.documento||"",distinta:o})}catch{}y("Distinta salvata \u2713"),T==="distinte"&&E("distinte")}async function Me(t){let{kits:i}=h(),n=i.find(function(d){return d.id===t});if(!n)return;let e=ft(t),o=Tt(n,e);if(!o.totaleRighe){y("Seleziona almeno un componente per generare l'anteprima.","warning");return}if(!e._meta.documento){let d=await Bt();dt(t,function(c){c._meta.documento=d},!1),e=ft(t)}let a={_meta:e._meta},s=window.open("","_blank");if(!s){y("Popup bloccato: abilita l'anteprima di stampa.","warning");return}s.document.open(),s.document.write(ei(n,o,a)),s.document.close(),s.focus()}function Ne(t,i){let n=ft(t.id),e=n._units,o=n._sel,a=Tt(t,n),s=n._meta,d=t.sezioni||[],c=d.map(function(u){let p=u.componenti||[];if(!p.length)return"";let f=p.map(function(C){let K=!!o[C.id],j=K?it(C.qtaBase!=null?C.qtaBase:1)*e:0;return`<label class="kit-ns-comp-row${K?" kit-ns-comp-row--checked":""}">
...
<body>
        ...
        <div class="db-print-page">
            ...
            <div class="db-print-meta-grid">
                <div class="db-print-meta-card">
                    ...
                    <div class="db-print-meta-row"><div class="db-print-meta-label">Data emissione</div><div class="db-print-meta-value">${r(Be(e))}</div></div>
                </div>
                <div class="db-print-meta-card">
...
</html>`}async function Te(t){let{kits:i}=h(),n=i.find(s=>s.id===t);if(!n)return;let e=ot(n),o=Pt(n,e);if(!o.totalePezzi||!o.totaleRighe){y("Componi prima un ordine per generare la distinta stampabile.","warning");return}if(!J(e).documento){let s=await Bt();G(t,function(d){let c=J(d);c.documento=s,At(d,c)}),e=ot(n)}let a=window.open("","_blank");if(!a){y("Popup bloccato: abilita l'anteprima di stampa per aprire il modello completo.","warning");return}a.document.open(),a.document.write(ei(n,o,e)),a.document.close(),a.focus()}function zi(t){return[...Array.isArray(t)?t:[]].sort((n,e)=>{let o=String(n?.nome||"").trim(),a=String(e?.nome||"").trim();return o.localeCompare(a,"it",{sensitivity:"base",numeric:!0})})}function h(){let t=Array.isArray(x.kits)?x.kits.map(Wt):[];return{kits:zi(t)}}function A(t){let i=zi(Array.isArray(t)?t.map(Wt):[]);x.kits=i,yt()}function Pe(){if(!ut)return;clearTimeout(ut),ut=null;let t=qt();pt({azione:"setKitData",payload:t}).then(function(i){x.ts=Number(i?.ts||Date.now())||Date.now()}).catch(function(i){console.warn("[kit-prodotti] flush remoto fallito:",i)})}function yt(){clearTimeout(ut),ut=setTimeout(function(){ut=null;let t=qt();pt({azione:"setKitData",payload:t}).then(function(i){x.ts=Number(i?.ts||Date.now())||Date.now()}).catch(function(i){console.warn("[kit-prodotti] salvataggio remoto fallito:",i)})},1500)}function Le(t){fetch(Rt,{method:"POST",body:JSON.stringify({azione:"getKitData"})}).then(i=>i.json()).then(i=>{if(i&&i.integrityOk===!1){console.error("[kit-prodotti] payload kit non leggibile lato server:",i.parseError||"parse error"),y("Errore lettura dati Kit dal server. Contatta subito supporto: nessun salvataggio automatico verr\xE0 forzato.","error"),t&&t(!1);return}let n=St(i);if(pi(n)){x=n,t&&t(!0);return}let e=re();if(pi(e)){x=St(e),pt({azione:"setKitData",payload:qt()}).then(function(o){x.ts=Number(o?.ts||Date.now())||Date.now(),ce(),y("Migrazione Kit completata: dati spostati su Sheets.","success"),t&&t(!0)}).catch(function(){t&&t(!1)});return}x=n,t&&t(!0)}).catch(()=>{t&&t(!1)})}function _(){return Math.random().toString(36).slice(2,10)+Date.now().toString(36)}function ni(){if(!Q||!Q.nome)return!1;let t=String(Q.nome).toUpperCase().trim();return t==="ALESSIO"||t==="0000"||Q.ruolo==="MASTER"}function Ke(t){let i={};for(let n of t.sezioni||[])for(let e of n.componenti||[]){if(H(e)){i[e.id]=0;continue}let o=0;for(let[a,s]of Object.entries(t.qtaDaProdurre||{}))o+=(Number.parseInt(s,10)||0)*R(e,a);i[e.id]=o}return i}function Re(t){let i={};for(let n of t.sottoAssembly||[]){let e=Number.parseInt(t.pronti?.[n.id],10)||0;if(!e)continue;let o=n.varianteKey;for(let a of t.sezioni||[])for(let s of a.componenti||[]){if(H(s))continue;let d=R(s,o);d>0&&(i[s.id]=(i[s.id]||0)+e*d)}}return i}function wi(t,i){let n=q(t).find(e=>e.key===i);return n?r(n.nome):r(i)}function oi(){return new Date().toLocaleString("it-IT",{day:"2-digit",month:"2-digit",year:"2-digit",hour:"2-digit",minute:"2-digit"})}function bt(){if(window.paginaAttuale!=="KIT_PRODOTTI")return;if(!jt){jt=!0;let n=document.getElementById("contenitore-dati");n&&(n.innerHTML="<div class='centered-msg'><i class='fas fa-spinner fa-spin'></i> Caricamento kit dal database...</div>"),Le(function(){bt()});return}let{kits:t}=h(),i=document.getElementById("contenitore-dati");if(i){i.innerHTML=`
    <div class="kit-page">
    ...
    </div>`,E(T),ai();try{if(window&&window._kitSuppressNextFade)try{delete window._kitSuppressNextFade}catch{}else wt(i)}catch{wt(i)}}}function _i(t,i){if(!i)return;if(!t.length){i.innerHTML=`
    ...
    </div>`,wt(n),ti().catch(()=>{})}function We(){D=null,bt()}function Ye(t){Ii=t,P()}function Ze(t){G(t,function(i,n){for(let e of q(n)){let o=document.getElementById("kit-qty-"+e.key);o&&(i[e.key]=Math.max(0,Number.parseInt(o.value,10)||0))}})}function Xe(t,i,n){try{window._kitSuppressNextFade=!0}catch{}G(t,function(e){e[i]=Math.max(0,Number.parseInt(n,10)||0)})}function tn(t,i,n){try{window._kitSuppressNextFade=!0}catch{}G(t,function(e){let o=Math.max(0,Number.parseInt(e[i],10)||0);e[i]=Math.max(0,o+n)})}function en(t){G(t,function(i){for(let n of Object.keys(i))n!=="_meta"&&(i[n]=0);i._meta=nt({})})}function nn(t,i){G(t,function(n){n[i]=0})}function Ot(t,i){let n=document.getElementById("kit-order-autocomplete-"+t);if(n){if(!i.length){n.style.display="none",n.innerHTML="";return}n.innerHTML=i.map(e=>`
    ...
    `).join(""),n.style.display="block"}}function on(t,i){let n=String(i||"").trim().toLowerCase();if(!n){Ot(t,[]);return}ti().then(function(e){let o=e.filter(a=>a.ordine.toLowerCase().includes(n)||a.cliente.toLowerCase().includes(n)).slice(0,8);Ot(t,o)})}function an(t){setTimeout(function(){Ot(t,[])},140)}function sn(t,i,n){let e=st(i);if(!e)return;try{window._kitSuppressNextFade=!0}catch{}G(t,function(a){let s=J(a);s.ordiniCliente=[...new Set(s.ordiniCliente.concat(e))],s.cliente=Dt(s.ordiniCliente,{[e]:n}),At(a,s)});let o=document.getElementById("kit-order-ref-input-"+t);o&&(o.value=""),Ot(t,[])}function rn(t,i){let n=st(i);try{window._kitSuppressNextFade=!0}catch{}G(t,function(e){let o=J(e);o.ordiniCliente=o.ordiniCliente.filter(a=>a!==n),o.cliente=Dt(o.ordiniCliente),At(e,o)})}function cn(t,i,n){let{kits:e}=h(),o=e.find(s=>s.id===t);if(!o)return;let a=ii(o);if(a[i]=n,Ct[t]=a,D===t){try{window._kitSuppressNextFade=!0}catch{}P()}}function dn(t){let{kits:i}=h(),n=i.find(s=>s.id===t);if(!n)return;let e=hi(n,ii(n));if(!e){y("Completa prima le scelte elettroniche \u26A0\uFE0F");return}let o=Math.max(0,Number.parseInt(document.getElementById("kit-compose-qty-"+t)?.value,10)||0);if(!o){y("Inserisci una quantit\xE0 valida \u26A0\uFE0F");return}if(Ht[t])return;Ht[t]=Date.now(),setTimeout(function(){try{delete Ht[t]}catch{}},600);try{window._kitSuppressNextFade=!0}catch{}G(t,function(s){s[e.key]=ct(s,e.key)+o});let a=document.getElementById("kit-compose-qty-"+t);a&&(a.value=1)}function Ai(t){let i=t.dataset.cid,n=t.dataset.sid,e=Math.max(0,Number.parseInt(t.value,10)||0),{kits:o}=h(),a=o.find(v=>v.id===D);if(!a)return;let s=(a.sezioni||[]).find(v=>v.id===n),d=s&&(s.componenti||[]).find(v=>v.id===i);if(!d||!Yt(d))return;d.caricato=e,A(o);let l=Ke(a)[i]||0,m=Math.max(0,l-e),p=Re(a)[i]||0,f=t.closest("tr");if(!f)return;let z=f.querySelector(".kit-ord-zero,.kit-ord-manca,.kit-ord-ok");z&&(z.textContent=l===0?"\u2014":m,z.className=l===0?"kit-ord-zero":m>0?"kit-ord-manca":"kit-ord-ok");let g=f.querySelector(".kit-car-liberi");g&&(p>0?(g.textContent=Math.max(0,e-p)+" lib.",g.style.display=""):g.style.display="none")}function ln(t,i,n){let{kits:e}=h(),o=e.find(a=>a.id===t);o&&(o.pronti||(o.pronti={}),o.pronti[i]=Math.max(0,(Number.parseInt(o.pronti[i],10)||0)+n),A(e),D===t&&P())}function pn(t,i,n){let{kits:e}=h(),o=e.find(s=>s.id===t);if(!o)return;o.pronti||(o.pronti={}),o.pronti[i]=Math.max(0,Number.parseInt(n,10)||0),A(e);let a=document.querySelector(`.kit-pronti-input[data-said="${i}"]`);a&&(a.value=o.pronti[i],a.classList.toggle("kit-pronti-val-on",o.pronti[i]>0))}function mn(t,i){let n=t.movimenti||[];return n.length?n.map(e=>{let o=i?`<button type="button" class="kit-mov-del" onclick="_kitEliminaMovimento('${r(t.id)}',${e.id})" title="Elimina">\u2715</button>`:'<span style="width:22px;flex-shrink:0"></span>',a=i&&(e.tipo==="carico"||e.tipo==="scarico")?`<button type="button" class="kit-mov-edit" onclick="_kitModificaMovimento('${r(t.id)}',${e.id})" title="Modifica">\u270E</button>`:'<span style="width:22px;flex-shrink:0"></span>';if(e.tipo==="spedizione"){let s=(e.righe||[]).reduce((l,m)=>l+m.qty,0),d=(e.righe||[]).map(l=>`<div class="kit-assemb-sub-row"><span class="kit-assemb-sub-mat" style="color:#94a3b8">${r(l.mat)}</span><span class="kit-mov-qty scarico">\u2212${l.qty}</span></div>`).join(""),c=(e.items||[]).map(l=>`<div class="kit-assemb-sub-row kit-sped-item-row"><span class="kit-assemb-sub-mat">${r(l.nome)}</span><span class="kit-mov-qty scarico">\xD7${l.qty}</span></div>`).join("");return`<details class="kit-mov-assemb-group">
            ...
            <span class="kit-mov-ts">${e.ts}</span>
            ${a}${o}
        </div>`}).join(""):'<div class="kit-mov-empty">Nessun movimento registrato.</div>'}function un(t,i){let{kits:n}=h(),e=n.find(g=>g.id===t);if(!e)return;let o=document.getElementById("kit-mov-mat-"+t),a=document.getElementById("kit-mov-qty-"+t),s=document.getElementById("kit-mov-nota-"+t);if(!o||!a)return;let d=o.value,c=o.options[o.selectedIndex]?.dataset.sid,l=Math.max(1,Number.parseInt(a.value,10)||1),m=(s?.value||"").trim(),u=(e.sezioni||[]).find(g=>g.id===c),p=u&&(u.componenti||[]).find(g=>g.id===d);if(!p||!Yt(p))return;i==="carico"?p.caricato=(parseInt(p.caricato)||0)+l:p.caricato=Math.max(0,(parseInt(p.caricato)||0)-l),e.movimenti||(e.movimenti=[]),e.movimenti.unshift({id:Date.now(),cid:d,sid:c,tipo:i,qty:l,nota:m,mat:p.nome,ts:oi()}),A(n),a&&(a.value=1),s&&(s.value="");let f=document.getElementById("kit-mov-list-"+t);f&&(f.innerHTML=mn(e,ni()));let z=document.querySelector(`#kit-tbody-${t} input[data-cid="${d}"]`);z&&(z.value=p.caricato,Ai(z))}function fn(t,i){if(!ni())return;let{kits:n}=h(),e=n.find(a=>a.id===t);if(!e)return;let o=(e.movimenti||[]).find(a=>a.id===i);o&&gn(t,i,o)}function gn(t,i,n){let e=document.getElementById("modal-kit-del-mov");if(!e)return;let o=document.getElementById("kit-del-mov-desc"),a;if(n.tipo==="spedizione")a=`<span class="kit-mov-badge spedizione" style="font-size:.75rem">SPED.</span> <strong>Spedizione \xD7${(n.righe||[]).reduce((c,l)=>c+l.qty,0)} pz</strong>`;else if(n.tipo==="reso")a=`<span class="kit-mov-badge reso" style="font-size:.75rem">RESO</span> <strong>Rientro \xD7${n.totPz||0} pz</strong>`;else{let d=n.tipo==="carico"?"CARICO":"SCARICO";a=`<span class="kit-mov-badge ${r(n.tipo)}" style="font-size:.75rem">${d}</span> <strong>${r(n.mat)}</strong> ${n.tipo==="carico"?"+":"\u2212"}${n.qty} pz`}o&&(o.innerHTML=a);let s=document.getElementById("btn-kit-del-ok");s&&(s.onclick=()=>Ni(t,i)),e.style.display="flex",e.offsetHeight,e.classList.add("active")}function Mi(){let t=document.getElementById("modal-kit-del-mov");t&&(t.classList.remove("active"),setTimeout(()=>{t.classList.contains("active")||(t.style.display="none")},300))}function Ni(t,i){Mi();let{kits:n}=h(),e=n.find(a=>a.id===t);if(!e)return;let o=(e.movimenti||[]).find(a=>a.id===i);if(o){if(o.tipo==="spedizione"){let a=(e.sezioni||[]).find(s=>s.id===o.sid);for(let s of o.righe||[])for(let d of e.sezioni||[]){let c=(d.componenti||[]).find(l=>l.id===s.cid||l.nome===s.mat);c&&(c.caricato=(parseInt(c.caricato)||0)+s.qty)}for(let s of o.items||[])s.saId&&e.pronti&&(e.pronti[s.saId]=(parseInt(e.pronti[s.saId])||0)+s.qty)}else if(o.tipo==="reso")for(let a of o.righe||[])for(let s of e.sezioni||[]){let d=(s.componenti||[]).find(c=>c.id===a.cid||c.nome===a.mat);d&&(d.caricato=Math.max(0,(parseInt(d.caricato)||0)-a.qty))}else if(o.tipo==="carico")for(let a of e.sezioni||[]){let s=(a.componenti||[]).find(d=>d.id===o.cid);s&&(s.caricato=Math.max(0,(parseInt(s.caricato)||0)-o.qty))}else if(o.tipo==="scarico")for(let a of e.sezioni||[]){let s=(a.componenti||[]).find(d=>d.id===o.cid);s&&(s.caricato=(parseInt(s.caricato)||0)+o.qty)}e.movimenti=(e.movimenti||[]).filter(a=>a.id!==i),A(n),D===t&&P(),y("Movimento eliminato \u2713")}}function kn(t,i){if(!ni())return;let{kits:n}=h(),e=n.find(l=>l.id===t);if(!e)return;let o=(e.movimenti||[]).find(l=>l.id===i);if(!o)return;let a=document.getElementById("modal-kit-edit-mov");if(!a)return;let s=document.getElementById("kit-edit-mov-mat"),d=document.getElementById("kit-edit-mov-qty"),c=document.getElementById("kit-edit-mov-nota");s&&(s.innerHTML=`<span class="kit-mov-badge ${r(o.tipo)}" style="font-size:.75rem">${o.tipo==="carico"?"CARICO":"SCARICO"}</span> <strong>${r(o.mat)}</strong>`),d&&(d.value=o.qty),c&&(c.value=o.nota||""),a.dataset.kitId=t,a.dataset.movId=i,a.style.display="flex",a.offsetHeight,a.classList.add("active"),setTimeout(()=>c&&c.focus(),80)}function Oi(){let t=document.getElementById("modal-kit-edit-mov");t&&(t.classList.remove("active"),setTimeout(()=>{t.classList.contains("active")||(t.style.display="none")},300))}function vn(){let t=document.getElementById("modal-kit-edit-mov");if(!t)return;let i=t.dataset.kitId,n=Number(t.dataset.movId);Oi();let{kits:e}=h(),o=e.find(l=>l.id===i);if(!o)return;let a=(o.movimenti||[]).findIndex(l=>l.id===n);if(a===-1)return;let s=o.movimenti[a],d=parseInt(document.getElementById("kit-edit-mov-qty")?.value),c=(document.getElementById("kit-edit-mov-nota")?.value||"").trim();if(isNaN(d)||d<=0){y("Quantit\xE0 non valida \u26A0\uFE0F");return}if(d!==s.qty){let l=d-s.qty;for(let m of o.sezioni||[]){let u=(m.componenti||[]).find(p=>p.id===s.cid);if(u){s.tipo==="carico"?u.caricato=Math.max(0,(parseInt(u.caricato)||0)+l):u.caricato=Math.max(0,(parseInt(u.caricato)||0)-l);break}}}o.movimenti[a]={...s,qty:d,nota:c},A(e),D===i&&P(),y("Movimento aggiornato \u2713")}function yn(t){let{kits:i}=h(),n=i.find(c=>c.id===t);if(!n)return;if(!(n.sottoAssembly||[]).some(c=>(Number.parseInt(n.pronti?.[c.id],10)||0)>0)){y("Nessuna parte tracciabile pronta \u2014 imposta le quantit\xE0 prima \u26A0\uFE0F");return}let o=document.getElementById("modal-kit-sped");if(!o)return;let a=document.getElementById("kit-sped-items-list");a&&(a.innerHTML=(n.sottoAssembly||[]).filter(c=>(Number.parseInt(n.pronti?.[c.id],10)||0)>0).map(c=>{let l=Number.parseInt(n.pronti?.[c.id],10)||0,m=wi(n,c.varianteKey);return`<label class="kit-sped-item-row">
        ...
        </div>`:u='<div class="kcfg-list">'+l.map(({comp:v,sez:C})=>{let K=m(v),j=K?(K.categoria||"").trim():"",Y=j?d(j):"#e2e8f0",zt=xt(v.unitaMisura,"pz"),lt=e.map(Z=>`<option value="${Z}"${zt===Z?" selected":""}>${Z}</option>`).join("");return`<div class="kcfg-comp-row">
        ...
        </div>`)}function Sn(){if(document.getElementById("modal-kit-cfg-catalog-picker"))return;let t=document.createElement("div");t.innerHTML=`
    <div id="modal-kit-cfg-catalog-picker" class="modal-overlay" style="display:none" onclick="if(event.target===this)_kitCfgCloseCatalogPicker()">
      <div class="modal-content" style="max-width:760px;width:min(760px,92vw)">
        ...
        <div class="modal-footer" style="margin-top:12px">
          <button type="button" class="btn-modal-cancel" onclick="_kitCfgCloseCatalogPicker()">Chiudi</button>
        ...
        </div>`}).join("")}}function Nn(t,i,n,e){S(t,o=>{let a=(o.sezioni||[]).find(s=>s.id===i);a&&(a[n]=e.trim()||a[n])},!0)}function On(t,i){confirm("Eliminare questa sezione e tutti i componenti?")&&S(t,n=>{n.sezioni=(n.sezioni||[]).filter(e=>e.id!==i)},!0)}function Li(t,i){let e=W().find(a=>a.id===i);if(!e)return;let o=(e.categoria||"").trim()||"Generali";S(t,a=>{let s=(a.sezioni||[]).find(d=>d.nome.trim()===o);s||(s={id:_(),nome:o,componenti:[]},a.sezioni=a.sezioni||[],a.sezioni.push(s)),s.componenti=s.componenti||[],s.componenti.push({id:_(),nome:e.nome,codice:e.codice||"",qtaBase:1,unitaMisura:e.unitaMisura||"pz",regola:{tipo:"sempre",qtyBase:1}})},!0)}function qn(){L&&S(L,t=>{let i=(t.sezioni||[]).find(n=>n.nome==="Liberi");i||(i={id:_(),nome:"Liberi",componenti:[]},t.sezioni=t.sezioni||[],t.sezioni.push(i)),i.componenti=i.componenti||[],i.componenti.push({id:_(),nome:"Nuovo componente",codice:"",qtaBase:1,unitaMisura:"pz",regola:{tipo:"sempre",qtyBase:1}})},!0)}function En(t,i,n,e,o){S(t,a=>{let s=(a.sezioni||[]).find(c=>c.id===i),d=s&&(s.componenti||[]).find(c=>c.id===n);d&&(e==="qtaBase"?(d.qtaBase=parseFloat(o)||1,d.regola&&(d.regola.qtyBase=d.qtaBase)):d[e]=o)},!0)}function Bn(t,i,n,e,o){S(t,a=>{let s=(a.sezioni||[]).find(c=>c.id===i),d=s&&(s.componenti||[]).find(c=>c.id===n);d&&(d.regola=d.regola||{},e==="tipo"?(d.regola.tipo=o,o==="gruppo"&&!d.regola.asseId&&a.assiConfigurazione?.length&&(d.regola.asseId=a.assiConfigurazione[0].id),o==="gruppo"&&(d.regola.opzioneIds=d.regola.opzioneIds||[])):e==="asseId"?(d.regola.asseId=o,d.regola.opzioneIds=[]):d.regola[e]=o)},!0)}function Dn(t,i,n){S(t,e=>{let o=(e.sezioni||[]).find(a=>a.id===i);o&&(o.componenti=(o.componenti||[]).filter(a=>a.id!==n))},!0)}function Tn(t){S(t,i=>{i.assiConfigurazione=i.assiConfigurazione||[],i.assiConfigurazione.push({id:_(),nome:"Nuovo gruppo",key:X("","ax"+i.assiConfigurazione.length),opzioni:[]})},!0)}function Pn(t,i){confirm("Eliminare questo gruppo elettronico?")&&S(t,n=>{n.assiConfigurazione=(n.assiConfigurazione||[]).filter(e=>e.id!==i)},!0)}function Ln(t,i,n,e){S(t,o=>{let a=(o.assiConfigurazione||[]).find(s=>s.id===i);a&&(a[n]=e)},!1)}function Kn(t,i){S(t,n=>{let e=(n.assiConfigurazione||[]).find(a=>a.id===i);if(!e)return;e.opzioni=e.opzioni||[];let o=e.opzioni.length+1;e.opzioni.push({id:_(),key:X("","opz"+o),nome:"Nuova opzione",codice:""})},!0)}function Rn(t,i,n){S(t,e=>{let o=(e.assiConfigurazione||[]).find(a=>a.id===i);o&&(o.opzioni=(o.opzioni||[]).filter(a=>a.id!==n))},!0)}function Hn(t,i,n,e,o){S(t,a=>{let s=(a.assiConfigurazione||[]).find(c=>c.id===i),d=s&&(s.opzioni||[]).find(c=>c.id===n);d&&(d[e]=o)},!1)}function Ki(){let t=document.getElementById("modal-kit-crea");if(!t)return;let i=document.getElementById("kit-crea-nome");i&&(i.value=""),t.style.display="flex",t.offsetHeight,t.classList.add("active"),setTimeout(()=>i&&i.focus(),80)}function Ri(){let t=document.getElementById("modal-kit-crea");t&&(t.classList.remove("active"),setTimeout(()=>{t.classList.contains("active")||(t.style.display="none")},300))}function jn(){let t=(document.getElementById("kit-crea-nome")?.value||"").trim();if(!t){y("Inserisci un nome per il kit","warning");return}let{kits:i}=h(),n={id:_(),nome:t,schemaVersion:Ft,assiConfigurazione:[],varianti:[],sezioni:[],sottoAssembly:[],qtaDaProdurre:{},pronti:{},movimenti:[]};i.push(n),A(i),Ri(),setTimeout(()=>E("kits"),320)}function Qn(t){gt.kitId=t;let i=document.getElementById("modal-kit-qadd-sez");if(!i)return;let n=document.getElementById("kit-qadd-sez-nome");n&&(n.value=""),i.style.display="flex",i.offsetHeight,i.classList.add("active"),setTimeout(()=>n&&n.focus(),80)}function Hi(){let t=document.getElementById("modal-kit-qadd-sez");t&&(t.classList.remove("active"),setTimeout(()=>{t.classList.contains("active")||(t.style.display="none")},300))}function Vn(){let t=(document.getElementById("kit-qadd-sez-nome")?.value||"").trim()||"Nuova sezione",{kits:i}=h(),n=i.find(e=>e.id===gt.kitId);n&&(n.sezioni=n.sezioni||[],n.sezioni.push({id:_(),nome:t,componenti:[]}),A(i),Hi(),setTimeout(L?()=>F():()=>E("kits"),320))}function Un(t,i){gt.kitId=t,gt.sezId=i;let n=document.getElementById("modal-kit-qadd-comp");if(!n)return;let e=W(),o=document.getElementById("kit-qadd-comp-source-cat"),a=document.getElementById("kit-qadd-comp-source-free");e.length?(o&&(o.checked=!0),Vt("cat")):(a&&(a.checked=!0),Vt("free"));let s=[...new Set(e.map(p=>p.categoria||"Senza categoria"))].sort(),d=document.getElementById("kit-qadd-comp-cat");d&&(d.innerHTML=s.map(p=>`<option value="${r(p)}">${r(p)}</option>`).join(""),ji());let c=document.getElementById("kit-qadd-comp-qty");c&&(c.value="1");let l=document.getElementById("kit-qadd-comp-unit");l&&(l.value="pz");let m=document.getElementById("kit-qadd-comp-nome");m&&(m.value="");let u=document.getElementById("kit-qadd-comp-codice");u&&(u.value=""),n.style.display="flex",n.offsetHeight,n.classList.add("active")}function Vt(t){let i=document.getElementById("kit-qadd-comp-cat-section"),n=document.getElementById("kit-qadd-comp-free-section");i&&(i.style.display=t==="cat"?"":"none"),n&&(n.style.display=t==="free"?"":"none")}function ji(){let t=document.getElementById("kit-qadd-comp-cat"),i=document.getElementById("kit-qadd-comp-comp");if(!t||!i)return;let n=t.value,o=W().filter(a=>(a.categoria||"Senza categoria")===n);i.innerHTML=o.length?o.map(a=>`<option value="${r(a.id)}">${r(a.nome)}${a.codice?" \xB7 "+r(a.codice):""}</option>`).join(""):'<option value="">Nessun componente in questa categoria</option>'}function Qi(){let t=document.getElementById("modal-kit-qadd-comp");t&&(t.classList.remove("active"),setTimeout(()=>{t.classList.contains("active")||(t.style.display="none")},300))}function Fn(){let t=document.getElementById("kit-qadd-comp-source-cat")?.checked,i="",n="";if(t){let l=document.getElementById("kit-qadd-comp-comp")?.value;if(!l){y("Seleziona un componente dal catalogo","warning");return}let m=W().find(u=>u.id===l);if(!m){y("Componente non trovato nel catalogo","warning");return}i=m.nome,n=m.codice||""}else{if(i=(document.getElementById("kit-qadd-comp-nome")?.value||"").trim(),!i){y("Inserisci il nome del componente","warning");return}n=(document.getElementById("kit-qadd-comp-codice")?.value||"").trim()}let e=parseFloat(document.getElementById("kit-qadd-comp-qty")?.value)||1,o=document.getElementById("kit-qadd-comp-unit")?.value||"pz",{kits:a}=h(),s=a.find(c=>c.id===gt.kitId);if(!s)return;let d=(s.sezioni||[]).find(c=>c.id===gt.sezId);d&&(d.componenti=d.componenti||[],d.componenti.push({id:_(),nome:i,codice:n,qtaBase:e,qtaPerVariante:{},caricato:0,modoComponente:"quantificato",tracciabile:!0,noteConfig:"",unitaMisura:o,applicazioneTipo:"sempre"}),A(a),Qi(),setTimeout(L?()=>F():()=>E("kits"),320))}function Jn(t,i,n,e,o){let{kits:a}=h(),s=a.find(l=>l.id===t);if(!s)return;let d=(s.sezioni||[]).find(l=>l.id===i);if(!d)return;let c=(d.componenti||[]).find(l=>l.id===n);c&&(e==="qtaBase"?c.qtaBase=parseFloat(o)||0:c[e]=o,A(a))}function Gn(t,i,n){if(!n.trim())return;let{kits:e}=h(),o=e.find(s=>s.id===t);if(!o)return;let a=(o.sezioni||[]).find(s=>s.id===i);a&&(a.nome=n.trim(),A(e))}function Wn(t,i,n){let{kits:e}=h(),o=e.find(s=>s.id===t);if(!o)return;let a=(o.sezioni||[]).find(s=>s.id===i);a&&(a.componenti=(a.componenti||[]).filter(s=>s.id!==n),A(e),E("kits"))}function Yn(t,i){if(!confirm("Rimuovere questa sezione e tutti i suoi componenti?"))return;let{kits:n}=h(),e=n.find(o=>o.id===t);e&&(e.sezioni=(e.sezioni||[]).filter(o=>o.id!==i),A(n),E("kits"))}function Zn(t){if(!confirm("Eliminare questo kit? L'operazione non \xE8 reversibile."))return;let{kits:i}=h(),n=i.filter(e=>e.id!==t);A(n),E("kits")}function Xn(t){Di={sourceKitId:t};let i=document.getElementById("modal-kit-duplicate");if(!i)return;let n=document.getElementById("kit-duplicate-nome");n&&(n.value=""),i.style.display="flex",i.offsetHeight,i.classList.add("active"),setTimeout(()=>n&&n.focus(),80)}function Vi(){let t=document.getElementById("modal-kit-duplicate");t&&(t.classList.remove("active"),setTimeout(()=>{t.classList.contains("active")||(t.style.display="none")},300))}function to(){let{sourceKitId:t}=Di||{};if(!t){y("Errore: kit sorgente non trovato","error");return}let{kits:i}=h(),n=i.find(a=>a.id===t);if(!n){y("Kit sorgente non trovato","warning");return}let e=(document.getElementById("kit-duplicate-nome")?.value||"").trim();if(!e){y("Inserisci un nome per il kit duplicato","warning");return}let o=io(n);o.nome=e,i.push(o),A(i),Vi(),y(`Kit "${e}" creato da duplicazione \u2713`),setTimeout(()=>E("kits"),320)}function io(t){let i={},n=o=>(i[o]||(i[o]=_()),i[o]),e=JSON.parse(JSON.stringify(t));return e.id=_(),Array.isArray(e.sezioni)&&(e.sezioni=e.sezioni.map(o=>{let a=JSON.parse(JSON.stringify(o));return a.id=_(),Array.isArray(a.componenti)&&(a.componenti=a.componenti.map(s=>{let d=JSON.parse(JSON.stringify(s));return d.id=_(),d})),a})),Array.isArray(e.assiConfigurazione)&&(e.assiConfigurazione=e.assiConfigurazione.map(o=>{let a=JSON.parse(JSON.stringify(o));return a.id=_(),Array.isArray(a.opzioni)&&(a.opzioni=a.opzioni.map(s=>{let d=JSON.parse(JSON.stringify(s));return d.id=_(),d})),a})),Array.isArray(e.varianti)&&(e.varianti=e.varianti.map(o=>{let a=JSON.parse(JSON.stringify(o));return a.id=_(),a})),Array.isArray(e.sottoAssembly)&&(e.sottoAssembly=e.sottoAssembly.map(o=>{let a=JSON.parse(JSON.stringify(o));return a.id=_(),a})),e.qtaDaProdurre={},e.pronti={},e.movimenti=[],e}function eo(){Ki()}function Ui(t){L=t,Ti(t)}function Kt(t,i,n=""){let{kits:e}=h(),o=e.find(c=>c.id===t),a=e.find(c=>c.id!==t&&(c.sezioni||[]).length),s=o?.sezioni?.[0]?.id||"",d=e.find(c=>c.id!==t&&(c.assiConfigurazione||[]).length)?.assiConfigurazione?.[0]?.id||"";return{currentKitId:t,mode:i,search:"",sourceKitId:i==="copy"?t:a?.id||"",sectionId:n||(i==="copy"?s:a?.sezioni?.[0]?.id||""),asseId:n||(i==="import-asse"?d:""),targetKitIds:[]}}function Fi(t){$=Kt(t,"import"),tt(!0)}function no(t){$=Kt(t,"import-asse"),tt(!0)}function oo(t,i){$=Kt(t,"copy",i),tt(!0)}function mt(){let t=document.getElementById("modal-kit-import");$=null,t&&(t.classList.remove("active"),setTimeout(()=>{t.classList.contains("active")||(t.style.display="none")},300))}function ao(t){if(!$||t!=="import"&&t!=="copy"||$.mode===t)return;let i=$.currentKitId,n=t==="copy"?$.sectionId:"";$=Kt(i,t,n),tt()}function so(t){$&&($.search=String(t||""),tt())}function ro(t){if(!$)return;let{kits:i}=h(),n=i.find(e=>e.id===t);$.sourceKitId=t,$.mode==="import-asse"?$.asseId=n?.assiConfigurazione?.[0]?.id||"":$.sectionId=n?.sezioni?.[0]?.id||"",tt()}function co(t){$&&($.mode==="import-asse"?$.asseId=t:$.sectionId=t,tt())}function lo(t,i){if(!$||$.mode!=="copy")return;let n=new Set($.targetKitIds||[]);i?n.add(t):n.delete(t),$.targetKitIds=[...n],tt()}function po(){if(!$||$.mode!=="copy")return;let{kits:t}=h(),i=t.filter(e=>e.id!==$.currentKitId&&Nt(e.nome,$.search)),n=new Set($.targetKitIds||[]);for(let e of i)n.add(e.id);$.targetKitIds=[...n],tt()}function mo(){!$||$.mode!=="copy"||($.targetKitIds=[],tt())}function tt(t=!1){let i=document.getElementById("modal-kit-import");if(!i||!$)return;let{kits:n}=h(),e=$,o=n.find(k=>k.id===e.currentKitId);if(!o){mt();return}let a=[];e.mode==="import"?a=n.filter(k=>k.id!==o.id&&(k.sezioni||[]).length):e.mode==="import-asse"?a=n.filter(k=>k.id!==o.id&&(k.assiConfigurazione||[]).length):a=n.filter(k=>k.id!==o.id&&(k.sezioni||[]).length),(e.mode==="import"||e.mode==="import-asse")&&!a.some(k=>k.id===e.sourceKitId)&&(e.sourceKitId=a[0]?.id||""),e.mode==="copy"&&(e.sourceKitId=o.id,e.targetKitIds=(e.targetKitIds||[]).filter(k=>k!==o.id&&n.some(w=>w.id===k)));let s=n.find(k=>k.id===e.sourceKitId)||null,d=e.mode==="import-asse"?s?.assiConfigurazione||[]:s?.sezioni||[];e.mode==="import-asse"?d.some(k=>k.id===e.asseId)||(e.asseId=d[0]?.id||""):d.some(k=>k.id===e.sectionId)||(e.sectionId=d[0]?.id||"");let c=e.mode==="import-asse"?(s?.assiConfigurazione||[]).find(k=>k.id===e.asseId)||null:Gt(s,e.sectionId),l=a.filter(k=>Nt(k.nome,e.search)),m=n.filter(k=>k.id!==o.id&&Nt(k.nome,e.search)),u=document.getElementById("kit-import-subtitle"),p=document.getElementById("kit-import-search"),f=document.getElementById("kit-import-left-title"),z=document.getElementById("kit-import-right-title"),g=document.getElementById("kit-import-kit-list"),v=document.getElementById("kit-import-section-list"),C=document.getElementById("kit-import-target-wrap"),K=document.getElementById("kit-import-target-list"),j=document.getElementById("kit-import-preview"),Y=document.getElementById("kit-import-confirm-btn"),zt=document.getElementById("kit-import-mode-import"),lt=document.getElementById("kit-import-mode-copy");if(!u||!p||!f||!z||!g||!v||!C||!K||!j||!Y||!zt||!lt)return;zt.classList.toggle("kit-import-mode-btn--active",e.mode==="import"||e.mode==="import-asse"),lt.classList.toggle("kit-import-mode-btn--active",e.mode==="copy"),p.value=e.search,e.mode==="import"?(u.textContent=`Importa una sezione esistente dentro "${o.nome}".`,p.placeholder="Cerca kit sorgente\u2026",f.textContent="Kit sorgente",z.textContent=s?`Sezioni di ${s.nome}`:"Sezione",C.style.display="none",g.innerHTML=l.length?l.map(k=>{let w=k.id===e.sourceKitId;return`<label class="kit-import-option ${w?"kit-import-option--active":""}">
            ...
            </label>`}).join(""):`<div class="kit-import-empty">Nessun ${e.mode==="import-asse"?"gruppo elettronico":"sezione"} disponibile.</div>`;let Z=!1,b="kit-cfg-help kit-import-preview",I="";if(e.mode==="import"){if(!s)I="Seleziona un kit sorgente per vedere le sezioni disponibili.";else if(!c)I="Seleziona una sezione da importare nel kit corrente.";else{let k=$t(s,o);Z=!0,I=`La sezione <strong>${r(c.nome)}</strong> verr\xE0 importata in <strong>${r(o.nome)}</strong>. `,k.hasTargetVarianti?k.needsReview?(b="kit-cfg-warn kit-import-preview",I+=`${k.exactMatches} combinazioni su ${k.targetCount} risultano allineate: controlla i coefficienti importati.`):I+=`Tutte le ${k.targetCount} combinazioni del kit destinazione risultano allineate.`:(b="kit-cfg-warn kit-import-preview",I+="Il kit destinazione non ha ancora combinazioni: importa pure la struttura e rifinisci i coefficienti dopo aver definito gli assi.")}Y.innerHTML='<i class="fas fa-copy"></i> Importa sezione'}else if(e.mode==="import-asse")s?c?(Z=!0,I=`L'asse <strong>${r(c.nome)}</strong> verr\xE0 importato in <strong>${r(o.nome)}</strong>. Opzioni duplicate verranno ignorate (merge per codice).`):I="Seleziona un asse da importare nel kit corrente.":I="Seleziona un kit sorgente per vedere gli assi disponibili.",Y.innerHTML='<i class="fas fa-copy"></i> Importa asse';else{let k=n.filter(w=>(e.targetKitIds||[]).includes(w.id));if(!c)I="Seleziona la sezione del kit corrente che vuoi copiare.";else if(!k.length)I="Seleziona almeno un kit destinazione per eseguire la copia massiva.";else{Z=!0;let w=k.filter(M=>$t(o,M).needsReview).length;I=`La sezione <strong>${r(c.nome)}</strong> verr\xE0 copiata in <strong>${k.length}</strong> kit.`,w>0?(b="kit-cfg-warn kit-import-preview",I+=` <strong>${w}</strong> kit richiederanno un controllo manuale delle quantit\xE0 o delle combinazioni.`):I+=" Le combinazioni risultano allineate su tutti i kit selezionati."}Y.innerHTML=`<i class="fas fa-copy"></i> Copia in ${(e.targetKitIds||[]).length||0} kit`}j.className=b,j.innerHTML=I,Y.disabled=!Z,t&&(i.style.display="flex",i.offsetHeight,i.classList.add("active"),setTimeout(()=>{let k=document.getElementById("kit-import-search");k&&k.focus()},40))}function uo(){if(!$)return;let{kits:t}=h(),i=$,n=t.find(l=>l.id===i.currentKitId),e=t.find(l=>l.id===i.sourceKitId),o=Gt(e,i.sectionId),a=e?.assiConfigurazione?.find(l=>l.id===i.asseId)||null;if(!n||!e||i.mode==="import"&&!o||i.mode==="import-asse"&&!a){y("Configurazione import non valida \u26A0\uFE0F");return}if(i.mode==="import-asse"){n.assiConfigurazione=n.assiConfigurazione||[];let l=n.assiConfigurazione.find(u=>String(u.nome||"").trim().toLowerCase()===String(a.nome||"").trim().toLowerCase()),m=0;if(l){l.opzioni=l.opzioni||[];for(let u of a.opzioni||[]){let p=String(u.codice||"").trim().toLowerCase(),f=!1;if(p&&(f=l.opzioni.some(z=>String(z.codice||"").trim().toLowerCase()===p&&p!=="")),f||(f=l.opzioni.some(z=>String(z.nome||"").trim().toLowerCase()===String(u.nome||"").trim().toLowerCase())),!f){let z=(l.opzioni||[]).length+1;l.opzioni.push({id:_(),key:X(u?.key,"opz"+z),nome:String(u?.nome||"").trim()||"opz"+z,codice:String(u?.codice||"").trim()}),m+=1}}A(t),mt(),F(),m?y(`${m} opzione${m>1?"i":""} aggiunta${m>1?"e":""} all'asse "${a.nome}" \u2713`):y(`Nessuna nuova opzione trovata per l'asse "${a.nome}"`);return}n.assiConfigurazione.push(vi(a,e,n)),A(t),mt(),F(),y(`Asse "${a.nome}" importato da "${e.nome}" \u2713`);return}if(i.mode==="import"){let l=$t(e,n);n.sezioni=n.sezioni||[],n.sezioni.push(Mt(o,e,n)),A(t),mt(),F();let m="";l.hasTargetVarianti?l.needsReview&&(m=" Controlla le quantit\xE0 sulle combinazioni non allineate."):m=" Definisci poi gli assi del kit per rifinire i coefficienti.",y(`Sezione "${o.nome}" importata da "${e.nome}" \u2713${m}`);return}let s=t.filter(l=>(i.targetKitIds||[]).includes(l.id)&&l.id!==n.id);if(!s.length){y("Seleziona almeno un kit destinazione \u26A0\uFE0F");return}let d=0;for(let l of s)$t(e,l).needsReview&&(d+=1),l.sezioni=l.sezioni||[],l.sezioni.push(Mt(o,e,l));A(t),mt(),F();let c="";d>0&&(c=` ${d} kit richiedono un controllo delle quantit\xE0.`),y(`Sezione "${o.nome}" copiata in ${s.length} kit \u2713${c}`)}function fo(t){let{kits:i}=h(),n=i.find(e=>e.id===t)||null;N={currentKitId:t,search:"",selectedPresetId:"",newPresetName:"",newPresetSectionId:n?.sezioni?.[0]?.id||""},ht(!0)}function Ji(){let t=document.getElementById("modal-kit-presets");N=null,t&&(t.classList.remove("active"),setTimeout(()=>{t.classList.contains("active")||(t.style.display="none")},300))}function go(t){N&&(N.search=String(t||""),ht())}function ko(t){N&&(N.selectedPresetId=t,ht())}function vo(){if(!N)return;let t=document.getElementById("preset-new-name"),i=document.getElementById("preset-new-section"),n=String(t?.value||"").trim();if(!n){y("Inserisci il nome del preset \u26A0\uFE0F");return}let e=i?.value||"";Gi(N.currentKitId,e,n)}function Gi(t,i,n){let{kits:e}=h(),o=e.find(d=>d.id===t);if(!o){y("Kit non trovato \u26A0\uFE0F");return}let a=Gt(o,i);if(!a){y("Seleziona una sezione valida \u26A0\uFE0F");return}let s=vt();s.push({id:_(),nome:String(n||"").trim(),sourceKitId:o.id,sezione:JSON.parse(JSON.stringify(a))}),Xt(s),y("Preset salvato \u2713"),N&&N.currentKitId===t&&ht(),F()}function yo(t){if(!N)return;let i=vt(),n=t||N.selectedPresetId,e=i.find(d=>d.id===n);if(!e){y("Seleziona un preset \u26A0\uFE0F");return}let{kits:o}=h(),a=o.find(d=>d.id===N.currentKitId),s=o.find(d=>d.id===e.sourceKitId)||null;if(!a){y("Kit non trovato \u26A0\uFE0F");return}a.sezioni=a.sezioni||[],a.sezioni.push(Mt(e.sezione,s,a)),A(o),Ji(),F(),y(`Preset "${e.nome}" applicato \u2713`)}function bo(t,i){let n=vt(),e=n.find(o=>o.id===t);if(!e){y("Preset non trovato \u26A0\uFE0F");return}e.nome=String(i||"").trim()||e.nome,Xt(n),y("Nome aggiornato \u2713"),ht()}function ho(t){let i=vt().filter(n=>n.id!==t);Xt(i),N&&(N.selectedPresetId=""),ht(),y("Preset eliminato \u2713")}function ht(t=!1){let i=document.getElementById("modal-kit-presets");if(!i||!N)return;let n=vt(),e=N,o=h().kits.find(p=>p.id===e.currentKitId),a=n.filter(p=>Nt(p.nome,e.search)),s=document.getElementById("preset-list"),d=document.getElementById("preset-preview"),c=document.getElementById("preset-new-name"),l=document.getElementById("preset-new-section"),m=document.getElementById("preset-apply-btn");if(!s||!d||!c||!l||!m)return;s.innerHTML=a.length?a.map(p=>{let f=p.id===e.selectedPresetId;return`<label class="kit-import-option ${f?"kit-import-option--active":""}">
        ...
        <div class="kit-cfg-danger">
        ...
        </div>`,p=e.map((b,I)=>{let k=(b.opzioni||[]).map((w,M)=>`
            <div class="kit-cfg-row kit-cfg-sarow">
                <input class="kit-cfg-input" value="${r(w.nome)}" maxlength="50" placeholder="Nome scelta elettronica"
                       onchange="_kitCfgUpdateOpzione('${r(i.id)}','${r(b.id)}','${r(w.id)}','nome',this.value)">
                <input class="kit-cfg-input kit-cfg-input-code" value="${r(w.codice||"")}" maxlength="40" placeholder="Codice stampa opzionale"
                       onchange="_kitCfgUpdateOpzione('${r(i.id)}','${r(b.id)}','${r(w.id)}','codice',this.value)">
                <button type="button" class="kit-cfg-del-btn" onclick="_kitCfgDelOpzione('${r(i.id)}','${r(b.id)}','${r(w.id)}')"><i class="fas fa-times"></i></button>
        ...
        <div class="kit-cfg-section">
            ...
            ${f}
        </div>`,g=(i.sezioni||[]).map((b,I)=>{let k=(b.componenti||[]).map(w=>{let M=H(w),B=Zt(w,i),di=(e||[]).find(O=>O.id===B.asseId)||null,Yi=B.tipo==="gruppo"&&di?`<div class="kit-cfg-row">${(di.opzioni||[]).map(O=>`<label class="kit-meta-pill">
                        <input type="checkbox" ${B.opzioneIds.includes(O.id)?"checked":""}
                               onchange="_kitCfgToggleCompOption('${r(i.id)}','${r(b.id)}','${r(w.id)}','${r(O.id)}',this.checked)">
                        ${r(O.nome)}
                    </label>`).join("")}</div>`:"",Zi=e.length?`<select class="kit-cfg-select" style="max-width:240px"
                           onchange="_kitCfgUpdateCompRule('${r(i.id)}','${r(b.id)}','${r(w.id)}','asseId',this.value)">
                        ${e.map(O=>`<option value="${r(O.id)}" ${B.asseId===O.id?"selected":""}>${r(O.nome)}</option>`).join("")}
                   </select>`:"",Xi=B.tipo==="manuale"?'<div class="kit-cfg-warn">Questa parte usa ancora una configurazione avanzata precedente. Appena la modifichi verr\xE0 convertita nel nuovo schema semplice.</div>':"",li=M?"flag":xt(w.unitaMisura,"pz"),te=M?[{value:"flag",label:"Solo avviso"}]:[...new Set([li,...se])].filter(Boolean).map(O=>({value:O,label:O}));return`<div class="kit-cfg-sa-group" style="padding:12px 14px">
                <div class="kit-cfg-row">
                    <input class="kit-cfg-input kit-cfg-input-comp" value="${r(w.nome)}" maxlength="60" placeholder="Nome parte"
                           onchange="_kitCfgUpdateComp('${r(i.id)}','${r(b.id)}','${r(w.id)}','nome','',this.value)">
                    <input class="kit-cfg-input kit-cfg-input-code" value="${r(w.codice||"")}" maxlength="40" placeholder="Codice stampa opzionale"
                           onchange="_kitCfgUpdateComp('${r(i.id)}','${r(b.id)}','${r(w.id)}','codice','',this.value)">
                    <select class="kit-cfg-select" style="max-width:210px"
                            onchange="_kitCfgUpdateComp('${r(i.id)}','${r(b.id)}','${r(w.id)}','modo','',this.value)">
                        <option value="quantificato" ${M?"":"selected"}>Materiale da contare</option>
                        <option value="segnalazione" ${M?"selected":""}>Solo avviso</option>
                    </select>
                    <button type="button" class="kit-cfg-del-btn" onclick="_kitCfgDelComp('${r(i.id)}','${r(b.id)}','${r(w.id)}')"><i class="fas fa-times"></i></button>
                </div>
                <div class="kit-cfg-row">
                    ...
                    <input class="kit-cfg-coeff" type="number" min="0" step="0.001" value="${B.qtyBase}"
                           onchange="_kitCfgUpdateCompRule('${r(i.id)}','${r(b.id)}','${r(w.id)}','qtyBase',this.value)">
                    <select class="kit-cfg-select" style="max-width:120px"
                            onchange="_kitCfgUpdateComp('${r(i.id)}','${r(b.id)}','${r(w.id)}','unitaMisura','',this.value)"
                            ${M?"disabled":""}>
                        ${te.map(O=>`<option value="${r(O.value)}" ${li===O.value?"selected":""}>${r(O.label)}</option>`).join("")}
                    </select>
                    <select class="kit-cfg-select" style="max-width:260px"
                            onchange="_kitCfgUpdateCompRule('${r(i.id)}','${r(b.id)}','${r(w.id)}','tipo',this.value)">
                ...
                <input class="kit-cfg-input" value="${r(w.noteConfig||"")}" maxlength="100" placeholder="Nota o avviso approvvigionamento"
                       onchange="_kitCfgUpdateComp('${r(i.id)}','${r(b.id)}','${r(w.id)}','noteConfig','',this.value)">
        ...
        </div>`,C="";o.length?C=o.map(b=>{let I=(i.sottoAssembly||[]).map((w,M)=>({sa:w,i:M})).filter(({sa:w})=>w.varianteKey===b.key),k=I.map(({sa:w,i:M})=>`
                <div class="kit-cfg-row kit-cfg-sarow">
        ...
        <div class="kit-cfg-section">
            ...
            ${C}
        </div>`,j={info:u,varianti:z,bom:v,sa:K},Y=vt(),lt=`
        <div class="kit-cfg-section">
    ...
    </div>`,wt(n)}function wo(t){if(t&&D===t){P();return}D=t,P()}function _o(t){rt=t,zo()}function S(t,i,n=!0){let{kits:e}=h(),o=e.find(a=>a.id===t);o&&(i(o),A(e),n&&F())}function Co(t,i){S(t,function(n){n.nome=i.trim()||"Kit senza nome"},!1)}function $o(t){if(!confirm("Eliminare questo kit e tutti i suoi dati?"))return;let{kits:i}=h();A(i.filter(n=>n.id!==t)),Bi=null,D=null,bt()}function So(t){let{kits:i}=h(),n=i.find(o=>o.id===t);if(!n)return;let e={id:_(),nome:`Copia di ${n.nome}`,schemaVersion:Ft,assiConfigurazione:[],varianti:[],sezioni:[],sottoAssembly:[],qtaDaProdurre:{},pronti:{},movimenti:[]};for(let o of n.assiConfigurazione||[])e.assiConfigurazione.push(vi(o,n,e));e.varianti=fi(e.assiConfigurazione);for(let o of n.sezioni||[])e.sezioni.push(Mt(o,n,e));e.sottoAssembly=(n.sottoAssembly||[]).map(o=>({id:_(),nome:o.nome||"",varianteKey:o.varianteKey||"",noteConfig:o.noteConfig||""})),i.push(e),A(i),Ui(e.id),y(`Kit "${n.nome}" duplicato \u2713`)}function Wi(t){S(t,function(i){let n=(i.assiConfigurazione||[]).length+1;i.assiConfigurazione=i.assiConfigurazione||[],i.assiConfigurazione.push({id:_(),key:"asse"+n,nome:"Asse "+n,opzioni:[{id:_(),key:"opz1",nome:"Opzione 1"}]})})}function xo(t,i,n,e){S(t,function(o){let a=(o.assiConfigurazione||[]).find(s=>s.id===i);a&&(n==="key"?a.key=X(e,a.key||"asse"):a[n]=e.trim())})}function Io(t,i){S(t,function(n){n.assiConfigurazione=(n.assiConfigurazione||[]).filter(e=>e.id!==i)})}function Ao(t,i){S(t,function(n){let e=(n.assiConfigurazione||[]).find(a=>a.id===i);if(!e)return;let o=(e.opzioni||[]).length+1;e.opzioni=e.opzioni||[],e.opzioni.push({id:_(),key:"opz"+o,nome:"Opzione "+o,codice:""})})}function Mo(t,i,n,e,o){S(t,function(a){let s=(a.assiConfigurazione||[]).find(c=>c.id===i),d=s&&(s.opzioni||[]).find(c=>c.id===n);d&&(e==="key"?d.key=X(o,d.key||"opzione"):d[e]=o.trim())})}function No(t,i,n){S(t,function(e){let o=(e.assiConfigurazione||[]).find(a=>a.id===i);o&&(o.opzioni=(o.opzioni||[]).filter(a=>a.id!==n))})}function Oo(t){Wi(t)}function qo(t){S(t,function(i){i.sezioni=i.sezioni||[],i.sezioni.push({id:_(),nome:"Nuova sezione",componenti:[]})})}function Eo(t){Fi(t)}function Bo(t,i,n,e){S(t,function(o){let a=(o.sezioni||[]).find(s=>s.id===i);a&&(a[n]=e.trim())},!1)}function Do(t,i){confirm("Eliminare questa sezione e tutti i suoi componenti?")&&S(t,function(n){n.sezioni=(n.sezioni||[]).filter(e=>e.id!==i)})}function To(t,i){S(t,function(n){let e=(n.sezioni||[]).find(o=>o.id===i);e&&(e.componenti=e.componenti||[],e.componenti.push({id:_(),nome:"Nuovo componente",codice:"",qtaPerVariante:{},caricato:0,modoComponente:"quantificato",tracciabile:!0,noteConfig:"",unitaMisura:"pz"}))})}function Po(t,i,n,e,o,a){S(t,function(s){let d=(s.sezioni||[]).find(l=>l.id===i),c=d&&(d.componenti||[]).find(l=>l.id===n);if(c){if(e==="coeff"||e==="flag"){c.qtaPerVariante=c.qtaPerVariante||{},c.qtaPerVariante[o]=it(a);return}if(e==="modo"){c.modoComponente=a==="segnalazione"?"segnalazione":"quantificato",c.modoComponente==="segnalazione"?(c.tracciabile=!1,c.unitaMisura="flag"):c.unitaMisura==="flag"&&(c.unitaMisura="pz");return}if(e==="unitaMisura"){c.unitaMisura=c.modoComponente==="segnalazione"?"flag":xt(a,"pz");return}c[e]=a.trim()}},e!=="nome"&&e!=="noteConfig")}function Lo(t,i,n,e,o){S(t,function(a){let s=(a.sezioni||[]).find(l=>l.id===i),d=s&&(s.componenti||[]).find(l=>l.id===n);if(!d)return;let c=Zt(d,a);if(e==="tipo"){if(c.tipo=o==="gruppo"?"gruppo":"sempre",c.tipo==="gruppo"&&!c.asseId){c.asseId=a.assiConfigurazione?.[0]?.id||"";let l=(a.assiConfigurazione||[]).find(m=>m.id===c.asseId);c.opzioneIds=l?.opzioni?.length?[l.opzioni[0].id]:[]}}else if(e==="qtyBase")c.qtyBase=it(o);else if(e==="asseId"){c.asseId=String(o||"");let l=(a.assiConfigurazione||[]).find(m=>m.id===c.asseId);c.opzioneIds=l?.opzioni?.length?[l.opzioni[0].id]:[],c.tipo="gruppo"}d.applicazioneTipo=c.tipo,d.applicazioneAsseId=c.asseId,d.applicazioneOpzioneIds=c.opzioneIds,d.qtaBase=c.qtyBase,d.qtaPerVariante=Jt(d,a,c)})}function Ko(t,i,n,e,o){S(t,function(a){let s=(a.sezioni||[]).find(m=>m.id===i),d=s&&(s.componenti||[]).find(m=>m.id===n);if(!d)return;let c=Zt(d,a),l=new Set(c.opzioneIds||[]);o?l.add(e):l.delete(e),c.tipo="gruppo",c.opzioneIds=[...l],d.applicazioneTipo=c.tipo,d.applicazioneAsseId=c.asseId,d.applicazioneOpzioneIds=c.opzioneIds,d.qtaBase=c.qtyBase,d.qtaPerVariante=Jt(d,a,c)})}function Ro(t,i,n,e){S(t,function(o){let a=(o.sezioni||[]).find(d=>d.id===i),s=a&&(a.componenti||[]).find(d=>d.id===n);!s||H(s)||(s.tracciabile=!!e)},!1)}function Ho(t,i,n){S(t,function(e){let o=(e.sezioni||[]).find(a=>a.id===i);o&&(o.componenti=(o.componenti||[]).filter(a=>a.id!==n))})}function jo(t){S(t,function(i){i.sottoAssembly=i.sottoAssembly||[],i.sottoAssembly.push({id:_(),nome:"",varianteKey:q(i)[0]?.key||""})})}function Qo(t,i){S(t,function(n){n.sottoAssembly=n.sottoAssembly||[],n.sottoAssembly.push({id:_(),nome:"",varianteKey:i,noteConfig:""})})}function Vo(t,i,n,e){S(t,function(o){o.sottoAssembly[i]&&(o.sottoAssembly[i][n]=e.trim())},!1)}function Uo(t,i){S(t,function(n){n.sottoAssembly.splice(i,1)})}function Fo(t){let i=document.getElementById("modal-kit-distinta-edit");if(!i){Si(t);return}let{kits:n}=h(),e=n.find(c=>c.id===t);if(!e)return;let o=ot(e),a=J(o),s=document.getElementById("distinta-edit-nome"),d=document.getElementById("distinta-edit-documento");s&&(s.value=a.documento||""),d&&(d.value=a.documento||""),i.dataset.kitId=t,i.style.display="flex",i.offsetHeight,i.classList.add("active"),setTimeout(()=>s&&s.focus(),80)}function Ut(){let t=document.getElementById("modal-kit-distinta-edit");t&&(t.classList.remove("active"),setTimeout(()=>{t.classList.contains("active")||(t.style.display="none")},300))}function Jo(){let t=document.getElementById("modal-kit-distinta-edit");if(!t)return;let i=t.dataset.kitId,n=(document.getElementById("distinta-edit-nome")?.value||"").trim(),e=(document.getElementById("distinta-edit-documento")?.value||"").trim();if(!n){y("Inserisci un nome per la distinta.","warning");return}G(i,function(m){let u=J(m);e?u.documento=e:u.documento||(u.documento=n),At(m,u)});let{kits:o}=h(),a=o.find(m=>m.id===i);if(!a){Ut(),y("Kit non trovato \u26A0\uFE0F");return}let s=ot(a),d=Pt(a,s);if(!d.totalePezzi||!d.totaleRighe){y("Componi prima un ordine per generare la distinta stampabile.","warning");return}let c=at(),l={id:_(),kitId:a.id,kitNome:a.nome,nome:n||s._meta?.documento||`Distinta-${Date.now()}`,documento:e||s._meta?.documento||"",createdAt:Date.now(),createdBy:Q?.nome||"Sistema",orderDraftSnapshot:s,distintaSnapshot:d};c.unshift(l),It(c),Ut(),y("Distinta salvata \u2713"),T==="distinte"&&E("distinte")}function ea(){window._kitOpenView=Ge,window._kitOpenConfig=Ui,window._kitNuovoKit=eo,window._kitBack=We,window._kitOpenPrintPreview=Te,window._kitSwitchTab=Ye,window._kitAggiornaQty=Ze,window._kitOrdineSet=Xe,window._kitOrdineDelta=tn,window._kitOrdineReset=en,window._kitOrdineResetVoce=nn,window._kitOrderSearch=on,window._kitOrderHideSearch=an,window._kitOrderPick=sn,window._kitOrderRemoveRef=rn,window._kitComposeSelect=cn,window._kitComposeAdd=dn,window._kitAggiornaCar=Ai,window._kitAggiornaPronti=ln,window._kitSetPronti=pn,window._kitApriModalSped=yn,window._kitChiudiModalSped=qi,window._kitConfermaSpedizione=bn,window._kitApriModalReso=hn,window._kitChiudiModalReso=Ei,window._kitResoQtyChange=zn,window._kitResoAggiornaBOM=ci,window._kitConfermaReso=wn,window._kitSalvaMovimento=un,window._kitEliminaMovimento=fn,window._kitModificaMovimento=kn,window._kitChiudiModalEditMov=Oi,window._kitConfermaModificaMov=vn,window._kitChiudiModalDelMov=Mi,window._kitConfermaEliminaMov=Ni,window._kitSalvaManuale=_n,window._kitElimina=$o,window._kitDuplicaKit=So,window._kitCfgBack=wo,window._kitCfgSwitchTab=_o,window._kitCfgSaveNome=Co,window._kitCfgAddVar=Oo,window._kitCfgOpenImportModal=Fi,window._kitCfgOpenImportAsseModal=no,window._kitCfgOpenCopySezModal=oo,window._kitCfgCloseImportModal=mt,window._kitCfgSetImportMode=ao,window._kitCfgSetImportSearch=so,window._kitCfgSelectImportSource=ro,window._kitCfgSelectImportSection=co,window._kitCfgToggleImportTarget=lo,window._kitCfgSelectAllImportTargets=po,window._kitCfgClearImportTargets=mo,window._kitCfgConfirmImport=uo,window._kitOpenPresetsModal=fo,window._kitClosePresetsModal=Ji,window._kitSetPresetsSearch=go,window._kitSelectPreset=ko,window._kitCreatePresetFromSection=vo,window._kitCreatePreset=Gi,window._kitApplyPreset=yo,window._kitRenamePreset=bo,window._kitDeletePreset=ho,window._kitCfgAddAsse=Wi,window._kitCfgUpdateAsse=xo,window._kitCfgDelAsse=Io,window._kitCfgAddOpzione=Ao,window._kitCfgUpdateOpzione=Mo,window._kitCfgDelOpzione=No,window._kitCfgAddSez=qo,window._kitCfgImportSez=Eo,window._kitCfgUpdateSez=Bo,window._kitCfgDelSez=Do,window._kitCfgAddComp=To,window._kitCfgUpdateComp=Po,window._kitCfgUpdateCompRule=Lo,window._kitCfgToggleCompOption=Ko,window._kitCfgToggleCompTracked=Ro,window._kitCfgDelComp=Ho,window._kitCfgAddSA=jo,window._kitCfgAddSAForVariant=Qo,window._kitCfgUpdateSA=Vo,window._kitCfgDelSA=Uo,window._kitSwitchMainTab=E,window._kitRenderKitsGrid=_i,window._kitRenderAnagrafichePage=Ci,window._kitRenderDistintePage=$i,window._kitLoadDistinte=at,window._kitSaveDistinte=It,window._kitCreateDistintaFromDraft=Si,window._kitLoadAnagrafiche=W,window._kitSaveAnagrafiche=ri,window._kitOpenAnagraficaModal=je,window._kitCloseAnagraficaModal=xi,window._kitConfirmSaveAnagrafica=Qe,window._kitDeleteAnagrafica=Ve,window._kitOpenCreaKit=Ki,window._kitCloseCreaKit=Ri,window._kitConfirmCreaKit=jn,window._kitOpenConfigModal=Ti,window._kitCloseConfigModal=Cn,window._kitRenderConfigModal=F,window._kitCfgModalSaveNome=$n,window._kitCfgOpenCatalogPicker=xn,window._kitCfgCloseCatalogPicker=Pi,window._kitCfgSetCatalogPickerQuery=In,window._kitCfgSetCatalogPickerCategory=An,window._kitCfgAddAnagFromPicker=Mn,window._kitCfgModalAddAnag=Li,window._kitCfgModalAddCompFree=qn,window._kitCfgModalUpdateSez=Nn,window._kitCfgModalDelSez=On,window._kitCfgModalUpdateComp=En,window._kitCfgModalUpdateCompRule=Bn,window._kitCfgModalDelComp=Dn,window._kitCfgModalAddAsse=Tn,window._kitCfgModalDelAsse=Pn,window._kitCfgModalUpdateAsse=Ln,window._kitCfgModalAddOpz=Kn,window._kitCfgModalDelOpz=Rn,window._kitCfgModalUpdateOpz=Hn,window._kitQAddSezOpen=Qn,window._kitQAddSezClose=Hi,window._kitQAddSezConfirm=Vn,window._kitQAddCompOpen=Un,window._kitQAddCompToggleSource=Vt,window._kitQAddCompChangeCategoria=ji,window._kitQAddCompClose=Qi,window._kitQAddCompConfirm=Fn,window._kitQUpdateComp=Jn,window._kitQRenomeSez=Gn,window._kitQDelComp=Wn,window._kitQDelSez=Yn,window._kitQDelKit=Zn,window._kitOpenDuplicateModal=Xn,window._kitCloseDuplicateModal=Vi,window._kitConfirmDuplicate=to,window._kitRenderHeaderActions=ai,window._kitOpenSaveDistintaModal=Fo,window._kitCloseSaveDistintaModal=Ut,window._kitConfirmSaveDistinta=Jo,window._kitDistintaOpenPrint=Ue,window._kitDistintaApplyToDraft=Fe,window._kitDistintaDelete=Je,window._kitNSToggleComp=we,window._kitNSSetUnits=ze,window._kitNSOrderSearch=_e,window._kitNSOrderHideSearch=Ce,window._kitNSOrderPick=$e,window._kitNSOrderRemoveRef=Se,window._kitNSReset=Ie,window._kitNSToggleSection=bi,window._kitNSToggleSectionChk=xe,window._kitNSCreateDistinta=Ae,window._kitNSOpenPrintPreview=Me}var Ft,se,x,jt,et,_t,Qt,Ht,T,Ct,ut,D,Ii,Bi,rt,$,N,gt,L,U,Di,na,Go=ie(()=>{ee();oe();ae();ne();Ft=2,se=["pz","mt","cm","mm","kg","g","lt","ml"];x=St({});jt=!1,et=[],_t=null,Qt=!1,Ht={},T="kits";Ct={};ut=null;typeof window<"u"&&window.addEventListener("beforeunload",function(){Pe()});D=null,Ii="ordine";Bi=null,rt="info",$=null,N=null,gt={kitId:null,sezId:null},L=null,U={kitId:null,query:"",categoria:""},Di={sourceKitId:null};na=bt});Go();export{bt as caricaKitProdotti,na as default,ea as registerGlobals,ia as resetKitFetch};
//# sourceMappingURL=chunk-kit-prodotti-7V6XRFFU.js.map
