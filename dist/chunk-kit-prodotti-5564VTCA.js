...
<body>
    ...
    </div>`,rt(n),di().catch(()=>{})}function ve(){N=null,st()}function be(t){yi=t,D()}function ye(t){P(t,function(i,n){for(let e of M(n)){let o=document.getElementById("kit-qty-"+e.key);o&&(i[e.key]=Math.max(0,Number.parseInt(o.value,10)||0))}})}function he(t,i,n){try{window._kitSuppressNextFade=!0}catch{}P(t,function(e){e[i]=Math.max(0,Number.parseInt(n,10)||0)})}function ze(t,i,n){try{window._kitSuppressNextFade=!0}catch{}P(t,function(e){let o=Math.max(0,Number.parseInt(e[i],10)||0);e[i]=Math.max(0,o+n)})}function we(t){P(t,function(i){for(let n of Object.keys(i))n!=="_meta"&&(i[n]=0);i._meta=pt({})})}function _e(t,i){P(t,function(n){n[i]=0})}function bt(t,i){let n=document.getElementById("kit-order-autocomplete-"+t);if(n){if(!i.length){n.style.display="none",n.innerHTML="";return}n.innerHTML=i.map(e=>`
    ...
    </div>`,rt(n)}function dn(t){if(t&&N===t){D();return}N=t,D()}function ln(t){F=t,j()}function I(t,i,n=!0){let{kits:e}=z(),o=e.find(s=>s.id===t);o&&(i(o),x(e),n&&j())}function pn(t,i){I(t,function(n){n.nome=i.trim()||"Kit senza nome"},!1)}function mn(t){if(!confirm("Eliminare questo kit e tutti i suoi dati?"))return;let{kits:i}=z();x(i.filter(n=>n.id!==t)),Vt=null,N=null,st()}function un(t){let{kits:i}=z(),n=i.find(o=>o.id===t);if(!n)return;let e={id:C(),nome:`Copia di ${n.nome}`,schemaVersion:Et,assiConfigurazione:[],varianti:[],sezioni:[],sottoAssembly:[],qtaDaProdurre:{},pronti:{},movimenti:[]};for(let o of n.assiConfigurazione||[])e.assiConfigurazione.push(oi(o,n,e));e.varianti=ei(e.assiConfigurazione);for(let o of n.sezioni||[])e.sezioni.push(kt(o,n,e));e.sottoAssembly=(n.sottoAssembly||[]).map(o=>({id:C(),nome:o.nome||"",varianteKey:o.varianteKey||"",noteConfig:o.noteConfig||""})),i.push(e),x(i),Ft(e.id),y(`Kit "${n.nome}" duplicato \u2713`)}function Ai(t){I(t,function(i){let n=(i.assiConfigurazione||[]).length+1;i.assiConfigurazione=i.assiConfigurazione||[],i.assiConfigurazione.push({id:C(),key:"asse"+n,nome:"Asse "+n,opzioni:[{id:C(),key:"opz1",nome:"Opzione 1"}]})})}function fn(t,i,n,e){I(t,function(o){let s=(o.assiConfigurazione||[]).find(a=>a.id===i);s&&(n==="key"?s.key=U(e,s.key||"asse"):s[n]=e.trim())})}function gn(t,i){I(t,function(n){n.assiConfigurazione=(n.assiConfigurazione||[]).filter(e=>e.id!==i)})}function kn(t,i){I(t,function(n){let e=(n.assiConfigurazione||[]).find(s=>s.id===i);if(!e)return;let o=(e.opzioni||[]).length+1;e.opzioni=e.opzioni||[],e.opzioni.push({id:C(),key:"opz"+o,nome:"Opzione "+o,codice:""})})}function vn(t,i,n,e,o){I(t,function(s){let a=(s.assiConfigurazione||[]).find(c=>c.id===i),d=a&&(a.opzioni||[]).find(c=>c.id===n);d&&(e==="key"?d.key=U(o,d.key||"opzione"):d[e]=o.trim())})}function bn(t,i,n){I(t,function(e){let o=(e.assiConfigurazione||[]).find(s=>s.id===i);o&&(o.opzioni=(o.opzioni||[]).filter(s=>s.id!==n))})}function yn(t){Ai(t)}function hn(t){I(t,function(i){i.sezioni=i.sezioni||[],i.sezioni.push({id:C(),nome:"Nuova sezione",componenti:[]})})}function zn(t){Si(t)}function wn(t,i,n,e){I(t,function(o){let s=(o.sezioni||[]).find(a=>a.id===i);s&&(s[n]=e.trim())},!1)}function _n(t,i){confirm("Eliminare questa sezione e tutti i suoi componenti?")&&I(t,function(n){n.sezioni=(n.sezioni||[]).filter(e=>e.id!==i)})}function $n(t,i){I(t,function(n){let e=(n.sezioni||[]).find(o=>o.id===i);e&&(e.componenti=e.componenti||[],e.componenti.push({id:C(),nome:"Nuovo componente",codice:"",qtaPerVariante:{},caricato:0,modoComponente:"quantificato",tracciabile:!0,noteConfig:"",unitaMisura:"pz"}))})}function Cn(t,i,n,e,o,s){I(t,function(a){let d=(a.sezioni||[]).find(l=>l.id===i),c=d&&(d.componenti||[]).find(l=>l.id===n);if(c){if(e==="coeff"||e==="flag"){c.qtaPerVariante=c.qtaPerVariante||{},c.qtaPerVariante[o]=J(s);return}if(e==="modo"){c.modoComponente=s==="segnalazione"?"segnalazione":"quantificato",c.modoComponente==="segnalazione"?(c.tracciabile=!1,c.unitaMisura="flag"):c.unitaMisura==="flag"&&(c.unitaMisura="pz");return}if(e==="unitaMisura"){c.unitaMisura=c.modoComponente==="segnalazione"?"flag":yt(s,"pz");return}c[e]=s.trim()}},e!=="nome"&&e!=="noteConfig")}function Sn(t,i,n,e,o){I(t,function(s){let a=(s.sezioni||[]).find(l=>l.id===i),d=a&&(a.componenti||[]).find(l=>l.id===n);if(!d)return;let c=Tt(d,s);if(e==="tipo"){if(c.tipo=o==="gruppo"?"gruppo":"sempre",c.tipo==="gruppo"&&!c.asseId){c.asseId=s.assiConfigurazione?.[0]?.id||"";let l=(s.assiConfigurazione||[]).find(m=>m.id===c.asseId);c.opzioneIds=l?.opzioni?.length?[l.opzioni[0].id]:[]}}else if(e==="qtyBase")c.qtyBase=J(o);else if(e==="asseId"){c.asseId=String(o||"");let l=(s.assiConfigurazione||[]).find(m=>m.id===c.asseId);c.opzioneIds=l?.opzioni?.length?[l.opzioni[0].id]:[],c.tipo="gruppo"}d.applicazioneTipo=c.tipo,d.applicazioneAsseId=c.asseId,d.applicazioneOpzioneIds=c.opzioneIds,d.qtaBase=c.qtyBase,d.qtaPerVariante=Ot(d,s,c)})}function In(t,i,n,e,o){I(t,function(s){let a=(s.sezioni||[]).find(m=>m.id===i),d=a&&(a.componenti||[]).find(m=>m.id===n);if(!d)return;let c=Tt(d,s),l=new Set(c.opzioneIds||[]);o?l.add(e):l.delete(e),c.tipo="gruppo",c.opzioneIds=[...l],d.applicazioneTipo=c.tipo,d.applicazioneAsseId=c.asseId,d.applicazioneOpzioneIds=c.opzioneIds,d.qtaBase=c.qtyBase,d.qtaPerVariante=Ot(d,s,c)})}function xn(t,i,n,e){I(t,function(o){let s=(o.sezioni||[]).find(d=>d.id===i),a=s&&(s.componenti||[]).find(d=>d.id===n);!a||B(a)||(a.tracciabile=!!e)},!1)}function An(t,i,n){I(t,function(e){let o=(e.sezioni||[]).find(s=>s.id===i);o&&(o.componenti=(o.componenti||[]).filter(s=>s.id!==n))})}function Mn(t){I(t,function(i){i.sottoAssembly=i.sottoAssembly||[],i.sottoAssembly.push({id:C(),nome:"",varianteKey:M(i)[0]?.key||""})})}function En(t,i){I(t,function(n){n.sottoAssembly=n.sottoAssembly||[],n.sottoAssembly.push({id:C(),nome:"",varianteKey:i,noteConfig:""})})}function On(t,i,n,e){I(t,function(o){o.sottoAssembly[i]&&(o.sottoAssembly[i][n]=e.trim())},!1)}function Nn(t,i){I(t,function(n){n.sottoAssembly.splice(i,1)})}function qn(t){let i=document.getElementById("modal-kit-distinta-edit");if(!i){vi(t);return}let{kits:n}=z(),e=n.find(c=>c.id===t);if(!e)return;let o=Q(e),s=R(o),a=document.getElementById("distinta-edit-nome"),d=document.getElementById("distinta-edit-documento");a&&(a.value=s.documento||""),d&&(d.value=s.documento||""),i.dataset.kitId=t,i.style.display="flex",i.offsetHeight,i.classList.add("active"),setTimeout(()=>a&&a.focus(),80)}function At(){let t=document.getElementById("modal-kit-distinta-edit");t&&(t.classList.remove("active"),setTimeout(()=>{t.classList.contains("active")||(t.style.display="none")},300))}function Tn(){let t=document.getElementById("modal-kit-distinta-edit");if(!t)return;let i=t.dataset.kitId,n=(document.getElementById("distinta-edit-nome")?.value||"").trim(),e=(document.getElementById("distinta-edit-documento")?.value||"").trim();if(!n){y("Inserisci un nome per la distinta.","warning");return}P(i,function(m){let p=R(m);e?p.documento=e:p.documento||(p.documento=n),zt(m,p)});let{kits:o}=z(),s=o.find(m=>m.id===i);if(!s){At(),y("Kit non trovato \u26A0\uFE0F");return}let a=Q(s),d=wt(s,a);if(!d.totalePezzi||!d.totaleRighe){y("Componi prima un ordine per generare la distinta stampabile.","warning");return}let c=W(),l={id:C(),kitId:s.id,kitNome:s.nome,nome:n||a._meta?.documento||`Distinta-${Date.now()}`,documento:e||a._meta?.documento||"",createdAt:Date.now(),createdBy:L?.nome||"Sistema",orderDraftSnapshot:a,distintaSnapshot:d};c.unshift(l),ht(c),At(),y("Distinta salvata \u2713"),q==="distinte"&&Z("distinte")}function jn(){window._kitOpenView=ke,window._kitOpenConfig=Ft,window._kitNuovoKit=Ve,window._kitBack=ve,window._kitOpenPrintPreview=se,window._kitSwitchTab=be,window._kitAggiornaQty=ye,window._kitOrdineSet=he,window._kitOrdineDelta=ze,window._kitOrdineReset=we,window._kitOrdineResetVoce=_e,window._kitOrderSearch=$e,window._kitOrderHideSearch=Ce,window._kitOrderPick=Se,window._kitOrderRemoveRef=Ie,window._kitComposeSelect=xe,window._kitComposeAdd=Ae,window._kitAggiornaCar=hi,window._kitAggiornaPronti=Me,window._kitSetPronti=Ee,window._kitApriModalSped=De,window._kitChiudiModalSped=$i,window._kitConfermaSpedizione=Pe,window._kitApriModalReso=Le,window._kitChiudiModalReso=Ci,window._kitResoQtyChange=Re,window._kitResoAggiornaBOM=jt,window._kitConfermaReso=He,window._kitSalvaMovimento=Ne,window._kitEliminaMovimento=qe,window._kitModificaMovimento=Be,window._kitChiudiModalEditMov=_i,window._kitConfermaModificaMov=Ke,window._kitChiudiModalDelMov=zi,window._kitConfermaEliminaMov=wi,window._kitSalvaManuale=je,window._kitElimina=mn,window._kitDuplicaKit=un,window._kitCfgBack=dn,window._kitCfgSwitchTab=ln,window._kitCfgSaveNome=pn,window._kitCfgAddVar=yn,window._kitCfgOpenImportModal=Si,window._kitCfgOpenImportAsseModal=Fe,window._kitCfgOpenCopySezModal=Ue,window._kitCfgCloseImportModal=et,window._kitCfgSetImportMode=Qe,window._kitCfgSetImportSearch=Ge,window._kitCfgSelectImportSource=Je,window._kitCfgSelectImportSection=Ye,window._kitCfgToggleImportTarget=We,window._kitCfgSelectAllImportTargets=Ze,window._kitCfgClearImportTargets=Xe,window._kitCfgConfirmImport=tn,window._kitOpenPresetsModal=en,window._kitClosePresetsModal=Ii,window._kitSetPresetsSearch=nn,window._kitSelectPreset=on,window._kitCreatePresetFromSection=sn,window._kitCreatePreset=xi,window._kitApplyPreset=an,window._kitRenamePreset=rn,window._kitDeletePreset=cn,window._kitCfgAddAsse=Ai,window._kitCfgUpdateAsse=fn,window._kitCfgDelAsse=gn,window._kitCfgAddOpzione=kn,window._kitCfgUpdateOpzione=vn,window._kitCfgDelOpzione=bn,window._kitCfgAddSez=hn,window._kitCfgImportSez=zn,window._kitCfgUpdateSez=wn,window._kitCfgDelSez=_n,window._kitCfgAddComp=$n,window._kitCfgUpdateComp=Cn,window._kitCfgUpdateCompRule=Sn,window._kitCfgToggleCompOption=In,window._kitCfgToggleCompTracked=xn,window._kitCfgDelComp=An,window._kitCfgAddSA=Mn,window._kitCfgAddSAForVariant=En,window._kitCfgUpdateSA=On,window._kitCfgDelSA=Nn,window._kitSwitchMainTab=Z,window._kitRenderKitsGrid=fi,window._kitRenderAnagrafichePage=gi,window._kitRenderDistintePage=ki,window._kitLoadDistinte=W,window._kitSaveDistinte=ht,window._kitCreateDistintaFromDraft=vi,window._kitLoadAnagrafiche=mt,window._kitSaveAnagrafiche=Ht,window._kitOpenAnagraficaModal=le,window._kitCloseAnagraficaModal=bi,window._kitConfirmSaveAnagrafica=pe,window._kitDeleteAnagrafica=me,window._kitRenderHeaderActions=Rt,window._kitOpenSaveDistintaModal=qn,window._kitCloseSaveDistintaModal=At,window._kitConfirmSaveDistinta=Tn,window._kitDistintaOpenPrint=ue,window._kitDistintaApplyToDraft=fe,window._kitDistintaDelete=ge}var Mt,gt,Wt,Gt,Zt,Et,Pi,Xt,Li,ti,Ri,xt,G,ct,It,q,dt,Yt,N,yi,Vt,F,w,A,Vn,Bn=qi(()=>{Ti();Ki();Di();Bi();Mt="_mlKitData",gt="_mlKitDataTs",Wt="_mlKitOrderDrafts",Gt="_mlKitOrderDraftSeq",Zt="_mlKitPresetSections",Et=2,Pi=["pz","mt","cm","mm","kg","g","lt","ml"],Xt="_mlKitDistinte",Li="_mlKitDistinteTs",ti="_mlKitAnagrafiche",Ri="_mlKitAnagraficheTs",xt=!1,G=[],ct=null,It={},q="kits";dt={};Yt=null;N=null,yi="ordine";Vt=null,F="info",w=null,A=null;Vn=st});Bn();export{st as caricaKitProdotti,Vn as default,jn as registerGlobals,Hn as resetKitFetch};
//# sourceMappingURL=chunk-kit-prodotti-5564VTCA.js.map
