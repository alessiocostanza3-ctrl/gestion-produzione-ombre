import{a as Fi,c as Ot,e as Gi,f as r,g as y,h as vt,l as Ji,m as j,q as Wi,r as Bt,u as Yi}from"./chunk-chunk-55SFP7PR.js";function Po(){Dt=!1}function G(t,i){return String(t||"").trim().toLowerCase().replace(/\s+/g,"_").replace(/[^a-z0-9_-]/g,"")||i}function Z(t){let i=String(t??"").trim().replace(",","."),n=Number.parseFloat(i);return Number.isFinite(n)?Math.max(0,n):0}function F(t){let i=Number(t);if(!Number.isFinite(i))return"0";let n=Math.round(i*1e3)/1e3;return Math.abs(n-Math.round(n))<1e-9?String(Math.round(n)):n.toLocaleString("it-IT",{minimumFractionDigits:0,maximumFractionDigits:3})}function zt(t,i="pz"){return String(t||i).trim().toLowerCase()||i}function ie(t,i){let n="opz"+(i+1),e=G(t?.key,n);return{id:String(t?.id||C()),key:e,nome:String(t?.nome||e).trim()||e,codice:String(t?.codice||"").trim()}}function ee(t,i){let n="asse"+(i+1),e=G(t?.key,n),o=Array.isArray(t?.opzioni)?t.opzioni.map((s,a)=>ie(s,a)).filter(Boolean):[];return{id:String(t?.id||C()),key:e,nome:String(t?.nome||e).trim()||e,opzioni:o}}function li(t){return t.length===1?t[0].opzioneKey:t.map(function(i){return i.asseKey+"="+i.opzioneKey}).join("|")}function ne(t){return t.length===1?t[0].opzioneNome:t.map(function(i){return i.asseNome+": "+i.opzioneNome}).join(" \xB7 ")}function pi(t){if(!Array.isArray(t)||!t.length)return[];let i=t.filter(e=>Array.isArray(e.opzioni)&&e.opzioni.length);if(!i.length)return[];let n=[{selections:[]}];for(let e of i){let o=[];for(let s of n)for(let a of e.opzioni)o.push({selections:s.selections.concat({asseId:e.id,asseKey:e.key,asseNome:e.nome,opzioneId:a.id,opzioneKey:a.key,opzioneNome:a.nome,opzioneCodice:String(a.codice||"").trim()})});n=o}return n.map(function(e,o){return{id:"combo-"+(o+1),key:li(e.selections),nome:ne(e.selections),selections:e.selections}})}function oe(t){let i=String(t?.modoComponente||"quantificato").trim()||"quantificato",n=i==="segnalazione"?!1:t?.tracciabile!==void 0?!!t.tracciabile:!0,e=i==="segnalazione"?"flag":"pz";return{id:String(t?.id||C()),nome:String(t?.nome||"Nuovo componente").trim()||"Nuovo componente",codice:String(t?.codice||"").trim(),qtaPerVariante:{...t?.qtaPerVariante||{}},caricato:Number(t?.caricato||0),modoComponente:i,tracciabile:n,noteConfig:String(t?.noteConfig||"").trim(),unitaMisura:zt(t?.unitaMisura,e),applicazioneTipo:String(t?.applicazioneTipo||"").trim(),applicazioneAsseId:String(t?.applicazioneAsseId||"").trim(),applicazioneOpzioneIds:Array.isArray(t?.applicazioneOpzioneIds)?t.applicazioneOpzioneIds.map(String):[],qtaBase:Z(t?.qtaBase)}}function se(t){return{id:String(t?.id||C()),nome:String(t?.nome||"Nuova sezione").trim()||"Nuova sezione",componenti:Array.isArray(t?.componenti)?t.componenti.map(oe):[]}}function ae(t,i){if(t.size!==i.size)return!1;for(let n of t)if(!i.has(n))return!1;return!0}function mi(t,i){let n={tipo:"sempre",asseId:"",opzioneIds:[],qtyBase:Z(t?.qtaBase)};if(t?.applicazioneTipo==="sempre"||t?.applicazioneTipo==="gruppo")return{tipo:t.applicazioneTipo,asseId:String(t.applicazioneAsseId||""),opzioneIds:Array.isArray(t.applicazioneOpzioneIds)?t.applicazioneOpzioneIds.map(String):[],qtyBase:n.qtyBase||Z(Object.values(t?.qtaPerVariante||{})[0])};let e=N(i);if(!e.length)return n;let o=e.filter(d=>R(t,d.key)>0);if(!o.length)return n;let s=new Set(o.map(d=>R(t,d.key)));if(s.size!==1)return{tipo:"manuale",asseId:"",opzioneIds:[],qtyBase:Math.max(...o.map(d=>R(t,d.key)))};let a=[...s][0];if(o.length===e.length)return{tipo:"sempre",asseId:"",opzioneIds:[],qtyBase:a};let c=new Set(o.map(d=>d.key));for(let d of i.assiConfigurazione||[]){let l=[];for(let p of d.opzioni||[]){let u=new Set(e.filter(h=>(h.selections||[]).some(f=>f.asseId===d.id&&f.opzioneId===p.id)).map(h=>h.key));if(!u.size)continue;[...u].every(h=>R(t,h)===a)&&l.push(p.id)}if(!l.length)continue;let m=new Set(e.filter(p=>(p.selections||[]).some(u=>u.asseId===d.id&&l.includes(u.opzioneId))).map(p=>p.key));if(ae(m,c))return{tipo:"gruppo",asseId:d.id,opzioneIds:l,qtyBase:a}}return{tipo:"manuale",asseId:"",opzioneIds:[],qtyBase:a}}function Ht(t,i,n){if(!n||n.tipo==="manuale")return{...t?.qtaPerVariante||{}};let e={},o=Z(n.qtyBase);if(!o)return e;for(let s of N(i)){let a=n.tipo==="sempre";n.tipo==="gruppo"&&(a=(s.selections||[]).some(c=>c.asseId===n.asseId&&n.opzioneIds.includes(c.opzioneId))),a&&(e[s.key]=o)}return e}function re(t,i){let n=se(t);return n.componenti=n.componenti.map(function(e){let o=mi(e,i);return{...e,applicazioneTipo:o.tipo,applicazioneAsseId:o.asseId,applicazioneOpzioneIds:o.opzioneIds,qtaBase:o.qtyBase,qtaPerVariante:Ht(e,i,o)}}),n}function ce(t,i){let n=N(i);if(!n.length)return null;let e=null;for(let o of n){let s=R(t,o.key);if(e===null){e=s;continue}if(e!==s)return null}return e}function de(t,i,n){let e=N(n),o={},s=ce(t,i);if(!e.length)Object.assign(o,t?.qtaPerVariante||{});else for(let a of e){let d=Object.prototype.hasOwnProperty.call(t?.qtaPerVariante||{},a.key)?R(t,a.key):s!==null?s:0;d>0&&(o[a.key]=d)}return{id:C(),nome:String(t?.nome||"Nuovo componente").trim()||"Nuovo componente",qtaPerVariante:o,caricato:0,modoComponente:t?.modoComponente==="segnalazione"?"segnalazione":"quantificato",tracciabile:Qt(t),noteConfig:String(t?.noteConfig||"").trim(),unitaMisura:zt(t?.unitaMisura,H(t)?"flag":"pz")}}function $t(t,i,n){return{id:C(),nome:String(t?.nome||"Nuova sezione").trim()||"Nuova sezione",componenti:Array.isArray(t?.componenti)?t.componenti.map(e=>de(e,i,n)):[]}}function ui(t,i,n){let e=new Set((n.assiConfigurazione||[]).map(d=>d.key)),o=G(t?.key||String(t?.nome||"asse"),"asse1"),s=o,a=1;for(;e.has(s);)s=o+"_c"+a++;let c=[];for(let d=0;d<(t.opzioni||[]).length;d++){let l=t.opzioni[d],m="opz"+(d+1),p=G(l?.key,m),u=1;for(;c.some(g=>g.key===p);)p=p+"_c"+u++;c.push({id:C(),key:p,nome:String(l?.nome||"").trim()||p,codice:String(l?.codice||"").trim()})}return{id:C(),key:s,nome:String(t?.nome||"").trim()||s,opzioni:c}}function jt(t,i){return(t?.sezioni||[]).find(n=>n.id===i)||null}function ht(t,i){let n=new Set(N(t).map(s=>s.key)),e=N(i),o=e.filter(s=>n.has(s.key)).length;return{targetCount:e.length,exactMatches:o,hasTargetVarianti:e.length>0,needsReview:e.length===0||o<e.length}}function St(t,i){let n=String(i||"").trim().toLowerCase();return n?String(t||"").toLowerCase().includes(n):!0}function le(t,i){return{id:String(t?.id||C()),nome:String(t?.nome||"").trim(),varianteKey:String(t?.varianteKey||i||"").trim(),noteConfig:String(t?.noteConfig||"").trim()}}function fi(t){let i=t&&typeof t=="object"?t:{},n=Array.isArray(i.varianti)?i.varianti.map(function(p,u){let g="v"+(u+1),h=G(p?.key,g);return{id:String(p?.id||C()),key:h,nome:String(p?.nome||h).trim()||h}}):[],e=Array.isArray(i.assiConfigurazione)?i.assiConfigurazione.map((p,u)=>ee(p,u)):[],o=e.length?e:n.length?[{id:"asse-legacy-"+String(i.id||"kit"),key:"configurazione",nome:"Configurazione",opzioni:n.map(function(p){return{id:p.id,key:p.key,nome:p.nome}})}]:[],s=pi(o),a=s.length?s:n,c=new Set(a.map(p=>p.key)),d={};Object.entries(i.qtaDaProdurre||{}).forEach(function(p){c.has(p[0])&&(d[p[0]]=Math.max(0,Number.parseInt(p[1],10)||0))});for(let p of a)d[p.key]===void 0&&(d[p.key]=0);let l=Array.isArray(i.sottoAssembly)?i.sottoAssembly.map(p=>le(p,a[0]?.key||"")).filter(p=>!p.varianteKey||c.has(p.varianteKey)):[],m={};return Object.entries(i.pronti||{}).forEach(function(p){m[p[0]]=Math.max(0,Number.parseInt(p[1],10)||0)}),{id:String(i.id||C()),nome:String(i.nome||"Nuovo Kit").trim()||"Nuovo Kit",schemaVersion:Rt,assiConfigurazione:o,varianti:a,sezioni:Array.isArray(i.sezioni)?i.sezioni.map(p=>re(p,{assiConfigurazione:o,varianti:a})):[],sottoAssembly:l,qtaDaProdurre:d,pronti:m,movimenti:Array.isArray(i.movimenti)?i.movimenti.slice():[]}}function N(t){return Array.isArray(t?.varianti)?t.varianti:[]}function H(t){return!!t&&t.modoComponente==="segnalazione"}function Qt(t){return!!t&&t.tracciabile!==!1&&!H(t)}function R(t,i){let n=Z(t?.qtaPerVariante?.[i]);return H(t)?n>0?1:0:n}function Vt(t,i){return mi(t,i)}function mt(){try{let t=localStorage.getItem(ai),i=t?JSON.parse(t):{};return i&&typeof i=="object"?i:{}}catch{return{}}}function xt(t){try{localStorage.setItem(ai,JSON.stringify(t||{}))}catch{}}function ut(){try{let t=localStorage.getItem(ri),i=t?JSON.parse(t):[];return Array.isArray(i)?i:[]}catch{return[]}}function Ut(t){try{localStorage.setItem(ri,JSON.stringify(t||[]))}catch{}}function et(){try{let t=localStorage.getItem(ci),i=t?JSON.parse(t):[];return Array.isArray(i)?i:[]}catch{return[]}}function wt(t){try{localStorage.setItem(ci,JSON.stringify(t||[]));try{localStorage.setItem(Xi,Date.now())}catch{}}catch{}}function nt(t){return String(t||"").trim().toUpperCase()}function tt(t){let i=Array.isArray(t?.ordiniCliente)?[...new Set(t.ordiniCliente.map(nt).filter(Boolean))]:[];return{cliente:String(t?.cliente||"").trim(),ordiniCliente:i,documento:String(t?.documento||"").trim()}}function J(t){return tt(t?._meta||{})}function At(t,i){return t._meta=tt(i),t._meta}function at(t,i){return Math.max(0,Number.parseInt(t?.[i],10)||0)}function _t(){let t=1;try{t=(Number.parseInt(localStorage.getItem(ni),10)||0)+1,localStorage.setItem(ni,String(t))}catch{}return`Distinta Base-${String(t).padStart(4,"0")}`}function gi(t){let i=J(t);return i.documento||(i.documento=_t(),At(t,i)),i.documento}function oi(t){let i=new Set;return(Array.isArray(t)?t:[]).filter(n=>String(n?.archiviato||"").toUpperCase()!=="TRUE").map(n=>({ordine:nt(n?.ordine||""),cliente:String(n?.cliente||"").trim()})).filter(n=>!n.ordine||i.has(n.ordine)?!1:(i.add(n.ordine),!0))}function Ft(){return ot.length?Promise.resolve(ot):Array.isArray(window._attiviProd)&&window._attiviProd.length?(ot=oi(window._attiviProd),Promise.resolve(ot)):yt||(yt=fetch(Ot,{method:"POST",body:JSON.stringify({pagina:"PROGRAMMA PRODUZIONE DEL MESE"})}).then(t=>t.json()).then(t=>(ot=oi(t),ot)).catch(function(t){return console.warn("[kit-prodotti] autocomplete ordini non disponibile:",t),[]}).finally(function(){yt=null}),yt)}function pe(t){let i=nt(t);return i&&ot.find(n=>n.ordine===i)||null}function Mt(t,i={}){let n=[...new Set((Array.isArray(t)?t:[]).map(function(e){let o=nt(e);return o?i[o]?String(i[o]||"").trim():String(pe(o)?.cliente||"").trim():""}).filter(Boolean))];return n.length===1?n[0]:""}function it(t){let i=mt(),n=i?.[t?.id]&&typeof i[t.id]=="object"?i[t.id]:{},e={};for(let o of N(t)){let s=n[o.key];e[o.key]=Math.max(0,Number.parseInt(s,10)||0)}return e._meta=tt(n._meta||{}),e}function U(t,i){let{kits:n}=b(),e=n.find(m=>m.id===t);if(!e)return;let o=mt(),s=it(e);i(s,e);let a={},c=!1;for(let m of N(e)){let p=Math.max(0,Number.parseInt(s[m.key],10)||0);a[m.key]=p,p>0&&(c=!0)}let d=tt(s._meta||{}),l=!!(d.cliente||d.ordiniCliente.length||d.documento);(c||l)&&(d.documento||(d.documento=_t()),a._meta=d),c||l?o[t]=a:delete o[t],xt(o),B===t&&K()}function me(t){return Object.entries(t||{}).reduce(function(i,n){return n[0]==="_meta"?i:i+(Number.parseInt(n[1],10)||0)},0)}function ki(t){return!(t.assiConfigurazione&&t.assiConfigurazione.length)}function lt(t){let i=mt(),n=i?.[t]&&typeof i[t]=="object"?i[t]:{};return{_meta:tt(n._meta||{}),_units:Math.max(1,Number.parseInt(n._units,10)||1),_sel:n._sel&&typeof n._sel=="object"?{...n._sel}:{}}}function rt(t,i,n){let e=mt(),o=e?.[t]&&typeof e[t]=="object"?e[t]:{},s={_meta:tt(o._meta||{}),_units:Math.max(1,Number.parseInt(o._units,10)||1),_sel:o._sel&&typeof o._sel=="object"?{...o._sel}:{}};i(s);let a=Object.keys(s._sel).length>0,c=s._units>1,d=tt(s._meta||{}),l=!!(d.cliente||d.ordiniCliente.length||d.documento);a||c||l?(d.documento||(d.documento=_t()),e[t]={_meta:d,_units:s._units,_sel:s._sel}):delete e[t],xt(e),n!==!1&&B===t&&K()}function ue(t,i){let n=Math.max(1,Number.parseInt(i,10)||1);try{window._kitSuppressNextFade=!0}catch{}rt(t,function(e){e._units=n})}function fe(t,i,n){try{window._kitSuppressNextFade=!0}catch{}rt(t,function(e){n?e._sel[i]=!0:delete e._sel[i]})}function ge(t,i){let n=String(i||"").trim().toLowerCase(),e=document.getElementById("kit-ns-autocomplete-"+t);if(e){if(!n){e.style.display="none",e.innerHTML="";return}Ft().then(function(o){let s=o.filter(function(a){return a.ordine.toLowerCase().includes(n)||a.cliente.toLowerCase().includes(n)}).slice(0,8);if(!s.length){e.style.display="none",e.innerHTML="";return}e.innerHTML=s.map(function(a){return`<div class="autocomplete-item" onmousedown='_kitNSOrderPick(${JSON.stringify(t)},${JSON.stringify(a.ordine)},${JSON.stringify(a.cliente)})'>
            ...
            </label>`}).join(""),h=u.every(function($){return!!o[$.id]}),f=u.some(function($){return!!o[$.id]}),z=JSON.stringify(u.map(function($){return $.id}));return`<div class="kit-ns-section">
            <div class="kit-ns-section-header">
                ...
                <label class="kit-ns-sel-all" title="${h?"Deseleziona tutto":"Seleziona tutto"}">
                    <input type="checkbox" class="kit-ns-check"${h?" checked":f?' data-indeterminate="true"':""}
                        onchange="_kitNSToggleSection('${r(t.id)}',${z},this.checked)">
...
<body>
        ...
        <div class="db-print-page">
            ...
            <div class="db-print-meta-grid">
                <div class="db-print-meta-card">
                    ...
                    <div class="db-print-meta-row"><div class="db-print-meta-label">Data emissione</div><div class="db-print-meta-value">${r(Ie(e))}</div></div>
                </div>
                <div class="db-print-meta-card">
...
</html>`}function Ae(t){let{kits:i}=b(),n=i.find(a=>a.id===t);if(!n)return;let e=it(n),o=qt(n,e);if(!o.totalePezzi||!o.totaleRighe){y("Componi prima un ordine per generare la distinta stampabile.","warning");return}J(e).documento||(U(t,function(a){gi(a)}),e=it(n));let s=window.open("","_blank");if(!s){y("Popup bloccato: abilita l'anteprima di stampa per aprire il modello completo.","warning");return}s.document.open(),s.document.write(Jt(n,o,e)),s.document.close(),s.focus()}function b(){try{let t=localStorage.getItem(Pt);if(!t)return{kits:[]};let i=JSON.parse(t);return{kits:Array.isArray(i?.kits)?i.kits.map(fi):[]}}catch{return{kits:[]}}}function x(t){let i=Array.isArray(t)?t.map(fi):[];try{localStorage.setItem(Pt,JSON.stringify({kits:i})),localStorage.setItem(Ct,Date.now())}catch{}Me(i)}function Me(t){clearTimeout(si),si=setTimeout(function(){Bt({azione:"setKitData",kits:t}).catch(function(i){console.warn("[kit-prodotti] salvataggio remoto fallito:",i)})},1500)}function Ee(t){fetch(Ot,{method:"POST",body:JSON.stringify({azione:"getKitData"})}).then(i=>i.json()).then(i=>{if(i&&Array.isArray(i.kits)){let n=parseInt(i.ts||0),e=parseInt(localStorage.getItem(Ct)||0);if(n>0&&n>e){try{localStorage.setItem(Pt,JSON.stringify({kits:i.kits}))}catch{}try{localStorage.setItem(Ct,n)}catch{}t&&t(!0);return}}t&&t(!1)}).catch(()=>{t&&t(!1)})}function C(){return Math.random().toString(36).slice(2,10)+Date.now().toString(36)}function Wt(){if(!j||!j.nome)return!1;let t=String(j.nome).toUpperCase().trim();return t==="ALESSIO"||t==="0000"||j.ruolo==="MASTER"}function qe(t){let i={};for(let n of t.sezioni||[])for(let e of n.componenti||[]){if(H(e)){i[e.id]=0;continue}let o=0;for(let[s,a]of Object.entries(t.qtaDaProdurre||{}))o+=(Number.parseInt(a,10)||0)*R(e,s);i[e.id]=o}return i}function Ne(t){let i={};for(let n of t.sottoAssembly||[]){let e=Number.parseInt(t.pronti?.[n.id],10)||0;if(!e)continue;let o=n.varianteKey;for(let s of t.sezioni||[])for(let a of s.componenti||[]){if(H(a))continue;let c=R(a,o);c>0&&(i[a.id]=(i[a.id]||0)+e*c)}}return i}function yi(t,i){let n=N(t).find(e=>e.key===i);return n?r(n.nome):r(i)}function Yt(){return new Date().toLocaleString("it-IT",{day:"2-digit",month:"2-digit",year:"2-digit",hour:"2-digit",minute:"2-digit"})}function ft(){Dt||(Dt=!0,Ee(function(n){n&&ft()}));let{kits:t}=b(),i=document.getElementById("contenitore-dati");if(i){i.innerHTML=`
    <div class="kit-page">
    ...
    </div>`,T(L),Zt();try{if(window&&window._kitSuppressNextFade)try{delete window._kitSuppressNextFade}catch{}else vt(i)}catch{vt(i)}}}function bi(t,i){if(!i)return;if(!t.length){i.innerHTML=`
        ...
        </details>`).join("");i.innerHTML=e}function wi(t){let{kits:i}=b(),n=i.find(d=>d.id===t);if(!n){y("Kit non trovato \u26A0\uFE0F");return}let e=it(n);J(e).documento||(U(t,function(d){gi(d)}),e=it(n));let o=qt(n,e);if(!o.totalePezzi||!o.totaleRighe){y("Componi prima un ordine per generare la distinta stampabile.","warning");return}let s=et(),a=J(e),c={id:C(),kitId:n.id,kitNome:n.nome,nome:a.documento||`Distinta-${Date.now()}`,documento:a.documento||"",createdAt:Date.now(),createdBy:j?.nome||"Sistema",orderDraftSnapshot:e,distintaSnapshot:o};s.unshift(c),wt(s),y("Distinta salvata \u2713"),L==="distinte"&&T("distinte")}function W(){try{let t=localStorage.getItem(di),i=t?JSON.parse(t):[];return Array.isArray(i)?i:[]}catch{return[]}}function Xt(t){try{localStorage.setItem(di,JSON.stringify(t||[]));try{localStorage.setItem(te,Date.now())}catch{}}catch{}}function Oe(){if(document.getElementById("modal-kit-anagrafica-edit"))return;let t=document.createElement("div");t.innerHTML=`
    ...
    </div>`,vt(n),Ft().catch(()=>{})}function He(){B=null,ft()}function je(t){Ci=t,K()}function Qe(t){U(t,function(i,n){for(let e of N(n)){let o=document.getElementById("kit-qty-"+e.key);o&&(i[e.key]=Math.max(0,Number.parseInt(o.value,10)||0))}})}function Ve(t,i,n){try{window._kitSuppressNextFade=!0}catch{}U(t,function(e){e[i]=Math.max(0,Number.parseInt(n,10)||0)})}function Ue(t,i,n){try{window._kitSuppressNextFade=!0}catch{}U(t,function(e){let o=Math.max(0,Number.parseInt(e[i],10)||0);e[i]=Math.max(0,o+n)})}function Fe(t){U(t,function(i){for(let n of Object.keys(i))n!=="_meta"&&(i[n]=0);i._meta=tt({})})}function Ge(t,i){U(t,function(n){n[i]=0})}function It(t,i){let n=document.getElementById("kit-order-autocomplete-"+t);if(n){if(!i.length){n.style.display="none",n.innerHTML="";return}n.innerHTML=i.map(e=>`
    ...
    `).join(""),n.style.display="block"}}function Je(t,i){let n=String(i||"").trim().toLowerCase();if(!n){It(t,[]);return}Ft().then(function(e){let o=e.filter(s=>s.ordine.toLowerCase().includes(n)||s.cliente.toLowerCase().includes(n)).slice(0,8);It(t,o)})}function We(t){setTimeout(function(){It(t,[])},140)}function Ye(t,i,n){let e=nt(i);if(!e)return;try{window._kitSuppressNextFade=!0}catch{}U(t,function(s){let a=J(s);a.ordiniCliente=[...new Set(a.ordiniCliente.concat(e))],a.cliente=Mt(a.ordiniCliente,{[e]:n}),At(s,a)});let o=document.getElementById("kit-order-ref-input-"+t);o&&(o.value=""),It(t,[])}function Ze(t,i){let n=nt(i);try{window._kitSuppressNextFade=!0}catch{}U(t,function(e){let o=J(e);o.ordiniCliente=o.ordiniCliente.filter(s=>s!==n),o.cliente=Mt(o.ordiniCliente),At(e,o)})}function Xe(t,i,n){let{kits:e}=b(),o=e.find(a=>a.id===t);if(!o)return;let s=Gt(o);if(s[i]=n,bt[t]=s,B===t){try{window._kitSuppressNextFade=!0}catch{}K()}}function tn(t){let{kits:i}=b(),n=i.find(a=>a.id===t);if(!n)return;let e=vi(n,Gt(n));if(!e){y("Completa prima le scelte elettroniche \u26A0\uFE0F");return}let o=Math.max(0,Number.parseInt(document.getElementById("kit-compose-qty-"+t)?.value,10)||0);if(!o){y("Inserisci una quantit\xE0 valida \u26A0\uFE0F");return}if(Tt[t])return;Tt[t]=Date.now(),setTimeout(function(){try{delete Tt[t]}catch{}},600);try{window._kitSuppressNextFade=!0}catch{}U(t,function(a){a[e.key]=at(a,e.key)+o});let s=document.getElementById("kit-compose-qty-"+t);s&&(s.value=1)}function $i(t){let i=t.dataset.cid,n=t.dataset.sid,e=Math.max(0,Number.parseInt(t.value,10)||0),{kits:o}=b(),s=o.find(z=>z.id===B);if(!s)return;let a=(s.sezioni||[]).find(z=>z.id===n),c=a&&(a.componenti||[]).find(z=>z.id===i);if(!c||!Qt(c))return;c.caricato=e,x(o);let l=qe(s)[i]||0,m=Math.max(0,l-e),u=Ne(s)[i]||0,g=t.closest("tr");if(!g)return;let h=g.querySelector(".kit-ord-zero,.kit-ord-manca,.kit-ord-ok");h&&(h.textContent=l===0?"\u2014":m,h.className=l===0?"kit-ord-zero":m>0?"kit-ord-manca":"kit-ord-ok");let f=g.querySelector(".kit-car-liberi");f&&(u>0?(f.textContent=Math.max(0,e-u)+" lib.",f.style.display=""):f.style.display="none")}function en(t,i,n){let{kits:e}=b(),o=e.find(s=>s.id===t);o&&(o.pronti||(o.pronti={}),o.pronti[i]=Math.max(0,(Number.parseInt(o.pronti[i],10)||0)+n),x(e),B===t&&K())}function nn(t,i,n){let{kits:e}=b(),o=e.find(a=>a.id===t);if(!o)return;o.pronti||(o.pronti={}),o.pronti[i]=Math.max(0,Number.parseInt(n,10)||0),x(e);let s=document.querySelector(`.kit-pronti-input[data-said="${i}"]`);s&&(s.value=o.pronti[i],s.classList.toggle("kit-pronti-val-on",o.pronti[i]>0))}function on(t,i){let n=t.movimenti||[];return n.length?n.map(e=>{let o=i?`<button type="button" class="kit-mov-del" onclick="_kitEliminaMovimento('${r(t.id)}',${e.id})" title="Elimina">\u2715</button>`:'<span style="width:22px;flex-shrink:0"></span>',s=i&&(e.tipo==="carico"||e.tipo==="scarico")?`<button type="button" class="kit-mov-edit" onclick="_kitModificaMovimento('${r(t.id)}',${e.id})" title="Modifica">\u270E</button>`:'<span style="width:22px;flex-shrink:0"></span>';if(e.tipo==="spedizione"){let a=(e.righe||[]).reduce((l,m)=>l+m.qty,0),c=(e.righe||[]).map(l=>`<div class="kit-assemb-sub-row"><span class="kit-assemb-sub-mat" style="color:#94a3b8">${r(l.mat)}</span><span class="kit-mov-qty scarico">\u2212${l.qty}</span></div>`).join(""),d=(e.items||[]).map(l=>`<div class="kit-assemb-sub-row kit-sped-item-row"><span class="kit-assemb-sub-mat">${r(l.nome)}</span><span class="kit-mov-qty scarico">\xD7${l.qty}</span></div>`).join("");return`<details class="kit-mov-assemb-group">
            ...
            <span class="kit-mov-ts">${e.ts}</span>
            ${s}${o}
        </div>`}).join(""):'<div class="kit-mov-empty">Nessun movimento registrato.</div>'}function sn(t,i){let{kits:n}=b(),e=n.find(f=>f.id===t);if(!e)return;let o=document.getElementById("kit-mov-mat-"+t),s=document.getElementById("kit-mov-qty-"+t),a=document.getElementById("kit-mov-nota-"+t);if(!o||!s)return;let c=o.value,d=o.options[o.selectedIndex]?.dataset.sid,l=Math.max(1,Number.parseInt(s.value,10)||1),m=(a?.value||"").trim(),p=(e.sezioni||[]).find(f=>f.id===d),u=p&&(p.componenti||[]).find(f=>f.id===c);if(!u||!Qt(u))return;i==="carico"?u.caricato=(parseInt(u.caricato)||0)+l:u.caricato=Math.max(0,(parseInt(u.caricato)||0)-l),e.movimenti||(e.movimenti=[]),e.movimenti.unshift({id:Date.now(),cid:c,sid:d,tipo:i,qty:l,nota:m,mat:u.nome,ts:Yt()}),x(n),s&&(s.value=1),a&&(a.value="");let g=document.getElementById("kit-mov-list-"+t);g&&(g.innerHTML=on(e,Wt()));let h=document.querySelector(`#kit-tbody-${t} input[data-cid="${c}"]`);h&&(h.value=u.caricato,$i(h))}function an(t,i){if(!Wt())return;let{kits:n}=b(),e=n.find(s=>s.id===t);if(!e)return;let o=(e.movimenti||[]).find(s=>s.id===i);o&&rn(t,i,o)}function rn(t,i,n){let e=document.getElementById("modal-kit-del-mov");if(!e)return;let o=document.getElementById("kit-del-mov-desc"),s;if(n.tipo==="spedizione")s=`<span class="kit-mov-badge spedizione" style="font-size:.75rem">SPED.</span> <strong>Spedizione \xD7${(n.righe||[]).reduce((d,l)=>d+l.qty,0)} pz</strong>`;else if(n.tipo==="reso")s=`<span class="kit-mov-badge reso" style="font-size:.75rem">RESO</span> <strong>Rientro \xD7${n.totPz||0} pz</strong>`;else{let c=n.tipo==="carico"?"CARICO":"SCARICO";s=`<span class="kit-mov-badge ${r(n.tipo)}" style="font-size:.75rem">${c}</span> <strong>${r(n.mat)}</strong> ${n.tipo==="carico"?"+":"\u2212"}${n.qty} pz`}o&&(o.innerHTML=s);let a=document.getElementById("btn-kit-del-ok");a&&(a.onclick=()=>Ii(t,i)),e.style.display="flex",e.offsetHeight,e.classList.add("active")}function Si(){let t=document.getElementById("modal-kit-del-mov");t&&(t.classList.remove("active"),setTimeout(()=>{t.classList.contains("active")||(t.style.display="none")},300))}function Ii(t,i){Si();let{kits:n}=b(),e=n.find(s=>s.id===t);if(!e)return;let o=(e.movimenti||[]).find(s=>s.id===i);if(o){if(o.tipo==="spedizione"){let s=(e.sezioni||[]).find(a=>a.id===o.sid);for(let a of o.righe||[])for(let c of e.sezioni||[]){let d=(c.componenti||[]).find(l=>l.id===a.cid||l.nome===a.mat);d&&(d.caricato=(parseInt(d.caricato)||0)+a.qty)}for(let a of o.items||[])a.saId&&e.pronti&&(e.pronti[a.saId]=(parseInt(e.pronti[a.saId])||0)+a.qty)}else if(o.tipo==="reso")for(let s of o.righe||[])for(let a of e.sezioni||[]){let c=(a.componenti||[]).find(d=>d.id===s.cid||d.nome===s.mat);c&&(c.caricato=Math.max(0,(parseInt(c.caricato)||0)-s.qty))}else if(o.tipo==="carico")for(let s of e.sezioni||[]){let a=(s.componenti||[]).find(c=>c.id===o.cid);a&&(a.caricato=Math.max(0,(parseInt(a.caricato)||0)-o.qty))}else if(o.tipo==="scarico")for(let s of e.sezioni||[]){let a=(s.componenti||[]).find(c=>c.id===o.cid);a&&(a.caricato=(parseInt(a.caricato)||0)+o.qty)}e.movimenti=(e.movimenti||[]).filter(s=>s.id!==i),x(n),B===t&&K(),y("Movimento eliminato \u2713")}}function cn(t,i){if(!Wt())return;let{kits:n}=b(),e=n.find(l=>l.id===t);if(!e)return;let o=(e.movimenti||[]).find(l=>l.id===i);if(!o)return;let s=document.getElementById("modal-kit-edit-mov");if(!s)return;let a=document.getElementById("kit-edit-mov-mat"),c=document.getElementById("kit-edit-mov-qty"),d=document.getElementById("kit-edit-mov-nota");a&&(a.innerHTML=`<span class="kit-mov-badge ${r(o.tipo)}" style="font-size:.75rem">${o.tipo==="carico"?"CARICO":"SCARICO"}</span> <strong>${r(o.mat)}</strong>`),c&&(c.value=o.qty),d&&(d.value=o.nota||""),s.dataset.kitId=t,s.dataset.movId=i,s.style.display="flex",s.offsetHeight,s.classList.add("active"),setTimeout(()=>d&&d.focus(),80)}function xi(){let t=document.getElementById("modal-kit-edit-mov");t&&(t.classList.remove("active"),setTimeout(()=>{t.classList.contains("active")||(t.style.display="none")},300))}function dn(){let t=document.getElementById("modal-kit-edit-mov");if(!t)return;let i=t.dataset.kitId,n=Number(t.dataset.movId);xi();let{kits:e}=b(),o=e.find(l=>l.id===i);if(!o)return;let s=(o.movimenti||[]).findIndex(l=>l.id===n);if(s===-1)return;let a=o.movimenti[s],c=parseInt(document.getElementById("kit-edit-mov-qty")?.value),d=(document.getElementById("kit-edit-mov-nota")?.value||"").trim();if(isNaN(c)||c<=0){y("Quantit\xE0 non valida \u26A0\uFE0F");return}if(c!==a.qty){let l=c-a.qty;for(let m of o.sezioni||[]){let p=(m.componenti||[]).find(u=>u.id===a.cid);if(p){a.tipo==="carico"?p.caricato=Math.max(0,(parseInt(p.caricato)||0)+l):p.caricato=Math.max(0,(parseInt(p.caricato)||0)-l);break}}}o.movimenti[s]={...a,qty:c,nota:d},x(e),B===i&&K(),y("Movimento aggiornato \u2713")}function ln(t){let{kits:i}=b(),n=i.find(d=>d.id===t);if(!n)return;if(!(n.sottoAssembly||[]).some(d=>(Number.parseInt(n.pronti?.[d.id],10)||0)>0)){y("Nessuna parte tracciabile pronta \u2014 imposta le quantit\xE0 prima \u26A0\uFE0F");return}let o=document.getElementById("modal-kit-sped");if(!o)return;let s=document.getElementById("kit-sped-items-list");s&&(s.innerHTML=(n.sottoAssembly||[]).filter(d=>(Number.parseInt(n.pronti?.[d.id],10)||0)>0).map(d=>{let l=Number.parseInt(n.pronti?.[d.id],10)||0,m=yi(n,d.varianteKey);return`<label class="kit-sped-item-row">
        ...
        <div class="kit-cfg-section">
            ...
            ${g}
        </div>`,f=(i.sezioni||[]).map((v,I)=>{let k=(v.componenti||[]).map(w=>{let A=H(w),O=Vt(w,i),ii=(e||[]).find(q=>q.id===O.asseId)||null,ji=O.tipo==="gruppo"&&ii?`<div class="kit-cfg-row">${(ii.opzioni||[]).map(q=>`<label class="kit-meta-pill">
                   ...
                   </select>`:"",Vi=O.tipo==="manuale"?'<div class="kit-cfg-warn">Questa parte usa ancora una configurazione avanzata precedente. Appena la modifichi verr\xE0 convertita nel nuovo schema semplice.</div>':"",ei=A?"flag":zt(w.unitaMisura,"pz"),Ui=A?[{value:"flag",label:"Solo avviso"}]:[...new Set([ei,...Zi])].filter(Boolean).map(q=>({value:q,label:q}));return`<div class="kit-cfg-sa-group" style="padding:12px 14px">
    ...
    </div>`,vt(n)}function ao(t){if(t&&B===t){K();return}B=t,K()}function ro(t){st=t,so()}function S(t,i,n=!0){let{kits:e}=b(),o=e.find(s=>s.id===t);o&&(i(o),x(e),n&&Q())}function co(t,i){S(t,function(n){n.nome=i.trim()||"Kit senza nome"},!1)}function lo(t){if(!confirm("Eliminare questo kit e tutti i suoi dati?"))return;let{kits:i}=b();x(i.filter(n=>n.id!==t)),Ei=null,B=null,ft()}function po(t){let{kits:i}=b(),n=i.find(o=>o.id===t);if(!n)return;let e={id:C(),nome:`Copia di ${n.nome}`,schemaVersion:Rt,assiConfigurazione:[],varianti:[],sezioni:[],sottoAssembly:[],qtaDaProdurre:{},pronti:{},movimenti:[]};for(let o of n.assiConfigurazione||[])e.assiConfigurazione.push(ui(o,n,e));e.varianti=pi(e.assiConfigurazione);for(let o of n.sezioni||[])e.sezioni.push($t(o,n,e));e.sottoAssembly=(n.sottoAssembly||[]).map(o=>({id:C(),nome:o.nome||"",varianteKey:o.varianteKey||"",noteConfig:o.noteConfig||""})),i.push(e),x(i),Li(e.id),y(`Kit "${n.nome}" duplicato \u2713`)}function Hi(t){S(t,function(i){let n=(i.assiConfigurazione||[]).length+1;i.assiConfigurazione=i.assiConfigurazione||[],i.assiConfigurazione.push({id:C(),key:"asse"+n,nome:"Asse "+n,opzioni:[{id:C(),key:"opz1",nome:"Opzione 1"}]})})}function mo(t,i,n,e){S(t,function(o){let s=(o.assiConfigurazione||[]).find(a=>a.id===i);s&&(n==="key"?s.key=G(e,s.key||"asse"):s[n]=e.trim())})}function uo(t,i){S(t,function(n){n.assiConfigurazione=(n.assiConfigurazione||[]).filter(e=>e.id!==i)})}function fo(t,i){S(t,function(n){let e=(n.assiConfigurazione||[]).find(s=>s.id===i);if(!e)return;let o=(e.opzioni||[]).length+1;e.opzioni=e.opzioni||[],e.opzioni.push({id:C(),key:"opz"+o,nome:"Opzione "+o,codice:""})})}function go(t,i,n,e,o){S(t,function(s){let a=(s.assiConfigurazione||[]).find(d=>d.id===i),c=a&&(a.opzioni||[]).find(d=>d.id===n);c&&(e==="key"?c.key=G(o,c.key||"opzione"):c[e]=o.trim())})}function ko(t,i,n){S(t,function(e){let o=(e.assiConfigurazione||[]).find(s=>s.id===i);o&&(o.opzioni=(o.opzioni||[]).filter(s=>s.id!==n))})}function vo(t){Hi(t)}function yo(t){S(t,function(i){i.sezioni=i.sezioni||[],i.sezioni.push({id:C(),nome:"Nuova sezione",componenti:[]})})}function bo(t){Ki(t)}function ho(t,i,n,e){S(t,function(o){let s=(o.sezioni||[]).find(a=>a.id===i);s&&(s[n]=e.trim())},!1)}function zo(t,i){confirm("Eliminare questa sezione e tutti i suoi componenti?")&&S(t,function(n){n.sezioni=(n.sezioni||[]).filter(e=>e.id!==i)})}function wo(t,i){S(t,function(n){let e=(n.sezioni||[]).find(o=>o.id===i);e&&(e.componenti=e.componenti||[],e.componenti.push({id:C(),nome:"Nuovo componente",codice:"",qtaPerVariante:{},caricato:0,modoComponente:"quantificato",tracciabile:!0,noteConfig:"",unitaMisura:"pz"}))})}function _o(t,i,n,e,o,s){S(t,function(a){let c=(a.sezioni||[]).find(l=>l.id===i),d=c&&(c.componenti||[]).find(l=>l.id===n);if(d){if(e==="coeff"||e==="flag"){d.qtaPerVariante=d.qtaPerVariante||{},d.qtaPerVariante[o]=Z(s);return}if(e==="modo"){d.modoComponente=s==="segnalazione"?"segnalazione":"quantificato",d.modoComponente==="segnalazione"?(d.tracciabile=!1,d.unitaMisura="flag"):d.unitaMisura==="flag"&&(d.unitaMisura="pz");return}if(e==="unitaMisura"){d.unitaMisura=d.modoComponente==="segnalazione"?"flag":zt(s,"pz");return}d[e]=s.trim()}},e!=="nome"&&e!=="noteConfig")}function Co(t,i,n,e,o){S(t,function(s){let a=(s.sezioni||[]).find(l=>l.id===i),c=a&&(a.componenti||[]).find(l=>l.id===n);if(!c)return;let d=Vt(c,s);if(e==="tipo"){if(d.tipo=o==="gruppo"?"gruppo":"sempre",d.tipo==="gruppo"&&!d.asseId){d.asseId=s.assiConfigurazione?.[0]?.id||"";let l=(s.assiConfigurazione||[]).find(m=>m.id===d.asseId);d.opzioneIds=l?.opzioni?.length?[l.opzioni[0].id]:[]}}else if(e==="qtyBase")d.qtyBase=Z(o);else if(e==="asseId"){d.asseId=String(o||"");let l=(s.assiConfigurazione||[]).find(m=>m.id===d.asseId);d.opzioneIds=l?.opzioni?.length?[l.opzioni[0].id]:[],d.tipo="gruppo"}c.applicazioneTipo=d.tipo,c.applicazioneAsseId=d.asseId,c.applicazioneOpzioneIds=d.opzioneIds,c.qtaBase=d.qtyBase,c.qtaPerVariante=Ht(c,s,d)})}function $o(t,i,n,e,o){S(t,function(s){let a=(s.sezioni||[]).find(m=>m.id===i),c=a&&(a.componenti||[]).find(m=>m.id===n);if(!c)return;let d=Vt(c,s),l=new Set(d.opzioneIds||[]);o?l.add(e):l.delete(e),d.tipo="gruppo",d.opzioneIds=[...l],c.applicazioneTipo=d.tipo,c.applicazioneAsseId=d.asseId,c.applicazioneOpzioneIds=d.opzioneIds,c.qtaBase=d.qtyBase,c.qtaPerVariante=Ht(c,s,d)})}function So(t,i,n,e){S(t,function(o){let s=(o.sezioni||[]).find(c=>c.id===i),a=s&&(s.componenti||[]).find(c=>c.id===n);!a||H(a)||(a.tracciabile=!!e)},!1)}function Io(t,i,n){S(t,function(e){let o=(e.sezioni||[]).find(s=>s.id===i);o&&(o.componenti=(o.componenti||[]).filter(s=>s.id!==n))})}function xo(t){S(t,function(i){i.sottoAssembly=i.sottoAssembly||[],i.sottoAssembly.push({id:C(),nome:"",varianteKey:N(i)[0]?.key||""})})}function Ao(t,i){S(t,function(n){n.sottoAssembly=n.sottoAssembly||[],n.sottoAssembly.push({id:C(),nome:"",varianteKey:i,noteConfig:""})})}function Mo(t,i,n,e){S(t,function(o){o.sottoAssembly[i]&&(o.sottoAssembly[i][n]=e.trim())},!1)}function Eo(t,i){S(t,function(n){n.sottoAssembly.splice(i,1)})}function qo(t){let i=document.getElementById("modal-kit-distinta-edit");if(!i){wi(t);return}let{kits:n}=b(),e=n.find(d=>d.id===t);if(!e)return;let o=it(e),s=J(o),a=document.getElementById("distinta-edit-nome"),c=document.getElementById("distinta-edit-documento");a&&(a.value=s.documento||""),c&&(c.value=s.documento||""),i.dataset.kitId=t,i.style.display="flex",i.offsetHeight,i.classList.add("active"),setTimeout(()=>a&&a.focus(),80)}function Kt(){let t=document.getElementById("modal-kit-distinta-edit");t&&(t.classList.remove("active"),setTimeout(()=>{t.classList.contains("active")||(t.style.display="none")},300))}function No(){let t=document.getElementById("modal-kit-distinta-edit");if(!t)return;let i=t.dataset.kitId,n=(document.getElementById("distinta-edit-nome")?.value||"").trim(),e=(document.getElementById("distinta-edit-documento")?.value||"").trim();if(!n){y("Inserisci un nome per la distinta.","warning");return}U(i,function(m){let p=J(m);e?p.documento=e:p.documento||(p.documento=n),At(m,p)});let{kits:o}=b(),s=o.find(m=>m.id===i);if(!s){Kt(),y("Kit non trovato \u26A0\uFE0F");return}let a=it(s),c=qt(s,a);if(!c.totalePezzi||!c.totaleRighe){y("Componi prima un ordine per generare la distinta stampabile.","warning");return}let d=et(),l={id:C(),kitId:s.id,kitNome:s.nome,nome:n||a._meta?.documento||`Distinta-${Date.now()}`,documento:e||a._meta?.documento||"",createdAt:Date.now(),createdBy:j?.nome||"Sistema",orderDraftSnapshot:a,distintaSnapshot:c};d.unshift(l),wt(d),Kt(),y("Distinta salvata \u2713"),L==="distinte"&&T("distinte")}function Ro(){window._kitOpenView=Re,window._kitOpenConfig=Li,window._kitNuovoKit=Rn,window._kitBack=He,window._kitOpenPrintPreview=Ae,window._kitSwitchTab=je,window._kitAggiornaQty=Qe,window._kitOrdineSet=Ve,window._kitOrdineDelta=Ue,window._kitOrdineReset=Fe,window._kitOrdineResetVoce=Ge,window._kitOrderSearch=Je,window._kitOrderHideSearch=We,window._kitOrderPick=Ye,window._kitOrderRemoveRef=Ze,window._kitComposeSelect=Xe,window._kitComposeAdd=tn,window._kitAggiornaCar=$i,window._kitAggiornaPronti=en,window._kitSetPronti=nn,window._kitApriModalSped=ln,window._kitChiudiModalSped=Ai,window._kitConfermaSpedizione=pn,window._kitApriModalReso=mn,window._kitChiudiModalReso=Mi,window._kitResoQtyChange=un,window._kitResoAggiornaBOM=ti,window._kitConfermaReso=fn,window._kitSalvaMovimento=sn,window._kitEliminaMovimento=an,window._kitModificaMovimento=cn,window._kitChiudiModalEditMov=xi,window._kitConfermaModificaMov=dn,window._kitChiudiModalDelMov=Si,window._kitConfermaEliminaMov=Ii,window._kitSalvaManuale=gn,window._kitElimina=lo,window._kitDuplicaKit=po,window._kitCfgBack=ao,window._kitCfgSwitchTab=ro,window._kitCfgSaveNome=co,window._kitCfgAddVar=vo,window._kitCfgOpenImportModal=Ki,window._kitCfgOpenImportAsseModal=Hn,window._kitCfgOpenCopySezModal=jn,window._kitCfgCloseImportModal=dt,window._kitCfgSetImportMode=Qn,window._kitCfgSetImportSearch=Vn,window._kitCfgSelectImportSource=Un,window._kitCfgSelectImportSection=Fn,window._kitCfgToggleImportTarget=Gn,window._kitCfgSelectAllImportTargets=Jn,window._kitCfgClearImportTargets=Wn,window._kitCfgConfirmImport=Yn,window._kitOpenPresetsModal=Zn,window._kitClosePresetsModal=Pi,window._kitSetPresetsSearch=Xn,window._kitSelectPreset=to,window._kitCreatePresetFromSection=io,window._kitCreatePreset=Ri,window._kitApplyPreset=eo,window._kitRenamePreset=no,window._kitDeletePreset=oo,window._kitCfgAddAsse=Hi,window._kitCfgUpdateAsse=mo,window._kitCfgDelAsse=uo,window._kitCfgAddOpzione=fo,window._kitCfgUpdateOpzione=go,window._kitCfgDelOpzione=ko,window._kitCfgAddSez=yo,window._kitCfgImportSez=bo,window._kitCfgUpdateSez=ho,window._kitCfgDelSez=zo,window._kitCfgAddComp=wo,window._kitCfgUpdateComp=_o,window._kitCfgUpdateCompRule=Co,window._kitCfgToggleCompOption=$o,window._kitCfgToggleCompTracked=So,window._kitCfgDelComp=Io,window._kitCfgAddSA=xo,window._kitCfgAddSAForVariant=Ao,window._kitCfgUpdateSA=Mo,window._kitCfgDelSA=Eo,window._kitSwitchMainTab=T,window._kitRenderKitsGrid=bi,window._kitRenderAnagrafichePage=hi,window._kitRenderDistintePage=zi,window._kitLoadDistinte=et,window._kitSaveDistinte=wt,window._kitCreateDistintaFromDraft=wi,window._kitLoadAnagrafiche=W,window._kitSaveAnagrafiche=Xt,window._kitOpenAnagraficaModal=Be,window._kitCloseAnagraficaModal=_i,window._kitConfirmSaveAnagrafica=Te,window._kitDeleteAnagrafica=De,window._kitOpenCreaKit=Ni,window._kitCloseCreaKit=Oi,window._kitConfirmCreaKit=En,window._kitOpenConfigModal=qi,window._kitCloseConfigModal=kn,window._kitRenderConfigModal=Q,window._kitCfgModalSaveNome=vn,window._kitCfgModalAddAnag=hn,window._kitCfgModalAddCompFree=zn,window._kitCfgModalUpdateSez=yn,window._kitCfgModalDelSez=bn,window._kitCfgModalUpdateComp=wn,window._kitCfgModalUpdateCompRule=_n,window._kitCfgModalDelComp=Cn,window._kitCfgModalAddAsse=$n,window._kitCfgModalDelAsse=Sn,window._kitCfgModalUpdateAsse=In,window._kitCfgModalAddOpz=xn,window._kitCfgModalDelOpz=An,window._kitCfgModalUpdateOpz=Mn,window._kitQAddSezOpen=qn,window._kitQAddSezClose=Bi,window._kitQAddSezConfirm=Nn,window._kitQAddCompOpen=On,window._kitQAddCompToggleSource=Lt,window._kitQAddCompChangeCategoria=Ti,window._kitQAddCompClose=Di,window._kitQAddCompConfirm=Bn,window._kitQUpdateComp=Tn,window._kitQRenomeSez=Dn,window._kitQDelComp=Ln,window._kitQDelSez=Kn,window._kitQDelKit=Pn,window._kitRenderHeaderActions=Zt,window._kitOpenSaveDistintaModal=qo,window._kitCloseSaveDistintaModal=Kt,window._kitConfirmSaveDistinta=No,window._kitDistintaOpenPrint=Le,window._kitDistintaApplyToDraft=Ke,window._kitDistintaDelete=Pe,window._kitNSToggleComp=fe,window._kitNSSetUnits=ue,window._kitNSOrderSearch=ge,window._kitNSOrderHideSearch=ke,window._kitNSOrderPick=ve,window._kitNSOrderRemoveRef=ye,window._kitNSReset=he,window._kitNSToggleSection=be,window._kitNSCreateDistinta=ze,window._kitNSOpenPrintPreview=we}var Pt,Ct,ai,ni,ri,Rt,Zi,ci,Xi,di,te,Dt,ot,yt,Tt,L,bt,si,B,Ci,Ei,st,_,E,pt,V,Ho,Oo=Fi(()=>{Gi();Wi();Yi();Ji();Pt="_mlKitData",Ct="_mlKitDataTs",ai="_mlKitOrderDrafts",ni="_mlKitOrderDraftSeq",ri="_mlKitPresetSections",Rt=2,Zi=["pz","mt","cm","mm","kg","g","lt","ml"],ci="_mlKitDistinte",Xi="_mlKitDistinteTs",di="_mlKitAnagrafiche",te="_mlKitAnagraficheTs",Dt=!1,ot=[],yt=null,Tt={},L="kits";bt={};si=null;B=null,Ci="ordine";Ei=null,st="info",_=null,E=null,pt={kitId:null,sezId:null},V=null;Ho=ft});Oo();export{ft as caricaKitProdotti,Ho as default,Ro as registerGlobals,Po as resetKitFetch};
//# sourceMappingURL=chunk-kit-prodotti-47BDP7OZ.js.map
