import{a as oi,c as ut,e as si,f as r,g as A,h as at,l as ai,m as F,q as ri,r as ft,u as ci}from"./chunk-chunk-MVGUZ3SY.js";function Ye(){gt=!1}function nt(t,i){return String(t||"").trim().toLowerCase().replace(/\s+/g,"_").replace(/[^a-z0-9_-]/g,"")||i}function H(t){let i=String(t??"").trim().replace(",","."),n=Number.parseFloat(i);return Number.isFinite(n)?Math.max(0,n):0}function G(t){let i=Number(t);if(!Number.isFinite(i))return"0";let n=Math.round(i*1e3)/1e3;return Math.abs(n-Math.round(n))<1e-9?String(Math.round(n)):n.toLocaleString("it-IT",{minimumFractionDigits:0,maximumFractionDigits:3})}function mt(t,i="pz"){return String(t||i).trim().toLowerCase()||i}function li(t,i){let n="opz"+(i+1),e=nt(t?.key,n);return{id:String(t?.id||I()),key:e,nome:String(t?.nome||e).trim()||e,codice:String(t?.codice||"").trim()}}function pi(t,i){let n="asse"+(i+1),e=nt(t?.key,n),o=Array.isArray(t?.opzioni)?t.opzioni.map((s,a)=>li(s,a)).filter(Boolean):[];return{id:String(t?.id||I()),key:e,nome:String(t?.nome||e).trim()||e,opzioni:o}}function Tt(t){return t.length===1?t[0].opzioneKey:t.map(function(i){return i.asseKey+"="+i.opzioneKey}).join("|")}function mi(t){return t.length===1?t[0].opzioneNome:t.map(function(i){return i.asseNome+": "+i.opzioneNome}).join(" \xB7 ")}function ui(t){if(!Array.isArray(t)||!t.length)return[];let i=t.filter(e=>Array.isArray(e.opzioni)&&e.opzioni.length);if(!i.length)return[];let n=[{selections:[]}];for(let e of i){let o=[];for(let s of n)for(let a of e.opzioni)o.push({selections:s.selections.concat({asseId:e.id,asseKey:e.key,asseNome:e.nome,opzioneId:a.id,opzioneKey:a.key,opzioneNome:a.nome,opzioneCodice:String(a.codice||"").trim()})});n=o}return n.map(function(e,o){return{id:"combo-"+(o+1),key:Tt(e.selections),nome:mi(e.selections),selections:e.selections}})}function fi(t){let i=String(t?.modoComponente||"quantificato").trim()||"quantificato",n=i==="segnalazione"?!1:t?.tracciabile!==void 0?!!t.tracciabile:!0,e=i==="segnalazione"?"flag":"pz";return{id:String(t?.id||I()),nome:String(t?.nome||"Nuovo componente").trim()||"Nuovo componente",codice:String(t?.codice||"").trim(),qtaPerVariante:{...t?.qtaPerVariante||{}},caricato:Number(t?.caricato||0),modoComponente:i,tracciabile:n,noteConfig:String(t?.noteConfig||"").trim(),unitaMisura:mt(t?.unitaMisura,e),applicazioneTipo:String(t?.applicazioneTipo||"").trim(),applicazioneAsseId:String(t?.applicazioneAsseId||"").trim(),applicazioneOpzioneIds:Array.isArray(t?.applicazioneOpzioneIds)?t.applicazioneOpzioneIds.map(String):[],qtaBase:H(t?.qtaBase)}}function gi(t){return{id:String(t?.id||I()),nome:String(t?.nome||"Nuova sezione").trim()||"Nuova sezione",componenti:Array.isArray(t?.componenti)?t.componenti.map(fi):[]}}function ki(t,i){if(t.size!==i.size)return!1;for(let n of t)if(!i.has(n))return!1;return!0}function Bt(t,i){let n={tipo:"sempre",asseId:"",opzioneIds:[],qtyBase:H(t?.qtaBase)};if(t?.applicazioneTipo==="sempre"||t?.applicazioneTipo==="gruppo")return{tipo:t.applicazioneTipo,asseId:String(t.applicazioneAsseId||""),opzioneIds:Array.isArray(t.applicazioneOpzioneIds)?t.applicazioneOpzioneIds.map(String):[],qtyBase:n.qtyBase||H(Object.values(t?.qtaPerVariante||{})[0])};let e=S(i);if(!e.length)return n;let o=e.filter(c=>E(t,c.key)>0);if(!o.length)return n;let s=new Set(o.map(c=>E(t,c.key)));if(s.size!==1)return{tipo:"manuale",asseId:"",opzioneIds:[],qtyBase:Math.max(...o.map(c=>E(t,c.key)))};let a=[...s][0];if(o.length===e.length)return{tipo:"sempre",asseId:"",opzioneIds:[],qtyBase:a};let d=new Set(o.map(c=>c.key));for(let c of i.assiConfigurazione||[]){let l=[];for(let m of c.opzioni||[]){let k=new Set(e.filter(b=>(b.selections||[]).some(u=>u.asseId===c.id&&u.opzioneId===m.id)).map(b=>b.key));if(!k.size)continue;[...k].every(b=>E(t,b)===a)&&l.push(m.id)}if(!l.length)continue;let p=new Set(e.filter(m=>(m.selections||[]).some(k=>k.asseId===c.id&&l.includes(k.opzioneId))).map(m=>m.key));if(ki(p,d))return{tipo:"gruppo",asseId:c.id,opzioneIds:l,qtyBase:a}}return{tipo:"manuale",asseId:"",opzioneIds:[],qtyBase:a}}function bt(t,i,n){if(!n||n.tipo==="manuale")return{...t?.qtaPerVariante||{}};let e={},o=H(n.qtyBase);if(!o)return e;for(let s of S(i)){let a=n.tipo==="sempre";n.tipo==="gruppo"&&(a=(s.selections||[]).some(d=>d.asseId===n.asseId&&n.opzioneIds.includes(d.opzioneId))),a&&(e[s.key]=o)}return e}function vi(t,i){let n=gi(t);return n.componenti=n.componenti.map(function(e){let o=Bt(e,i);return{...e,applicazioneTipo:o.tipo,applicazioneAsseId:o.asseId,applicazioneOpzioneIds:o.opzioneIds,qtaBase:o.qtyBase,qtaPerVariante:bt(e,i,o)}}),n}function bi(t,i){let n=S(i);if(!n.length)return null;let e=null;for(let o of n){let s=E(t,o.key);if(e===null){e=s;continue}if(e!==s)return null}return e}function yi(t,i,n){let e=S(n),o={},s=bi(t,i);if(!e.length)Object.assign(o,t?.qtaPerVariante||{});else for(let a of e){let c=Object.prototype.hasOwnProperty.call(t?.qtaPerVariante||{},a.key)?E(t,a.key):s!==null?s:0;c>0&&(o[a.key]=c)}return{id:I(),nome:String(t?.nome||"Nuovo componente").trim()||"Nuovo componente",qtaPerVariante:o,caricato:0,modoComponente:t?.modoComponente==="segnalazione"?"segnalazione":"quantificato",tracciabile:yt(t),noteConfig:String(t?.noteConfig||"").trim(),unitaMisura:mt(t?.unitaMisura,N(t)?"flag":"pz")}}function Mt(t,i,n){return{id:I(),nome:String(t?.nome||"Nuova sezione").trim()||"Nuova sezione",componenti:Array.isArray(t?.componenti)?t.componenti.map(e=>yi(e,i,n)):[]}}function Kt(t,i){return(t?.sezioni||[]).find(n=>n.id===i)||null}function it(t,i){let n=new Set(S(t).map(s=>s.key)),e=S(i),o=e.filter(s=>n.has(s.key)).length;return{targetCount:e.length,exactMatches:o,hasTargetVarianti:e.length>0,needsReview:e.length===0||o<e.length}}function kt(t,i){let n=String(i||"").trim().toLowerCase();return n?String(t||"").toLowerCase().includes(n):!0}function hi(t,i){return{id:String(t?.id||I()),nome:String(t?.nome||"").trim(),varianteKey:String(t?.varianteKey||i||"").trim(),noteConfig:String(t?.noteConfig||"").trim()}}function Lt(t){let i=t&&typeof t=="object"?t:{},n=Array.isArray(i.varianti)?i.varianti.map(function(m,k){let g="v"+(k+1),b=nt(m?.key,g);return{id:String(m?.id||I()),key:b,nome:String(m?.nome||b).trim()||b}}):[],e=Array.isArray(i.assiConfigurazione)?i.assiConfigurazione.map((m,k)=>pi(m,k)):[],o=e.length?e:n.length?[{id:"asse-legacy-"+String(i.id||"kit"),key:"configurazione",nome:"Configurazione",opzioni:n.map(function(m){return{id:m.id,key:m.key,nome:m.nome}})}]:[],s=ui(o),a=s.length?s:n,d=new Set(a.map(m=>m.key)),c={};Object.entries(i.qtaDaProdurre||{}).forEach(function(m){d.has(m[0])&&(c[m[0]]=Math.max(0,Number.parseInt(m[1],10)||0))});for(let m of a)c[m.key]===void 0&&(c[m.key]=0);let l=Array.isArray(i.sottoAssembly)?i.sottoAssembly.map(m=>hi(m,a[0]?.key||"")).filter(m=>!m.varianteKey||d.has(m.varianteKey)):[],p={};return Object.entries(i.pronti||{}).forEach(function(m){p[m[0]]=Math.max(0,Number.parseInt(m[1],10)||0)}),{id:String(i.id||I()),nome:String(i.nome||"Nuovo Kit").trim()||"Nuovo Kit",schemaVersion:Nt,assiConfigurazione:o,varianti:a,sezioni:Array.isArray(i.sezioni)?i.sezioni.map(m=>vi(m,{assiConfigurazione:o,varianti:a})):[],sottoAssembly:l,qtaDaProdurre:c,pronti:p,movimenti:Array.isArray(i.movimenti)?i.movimenti.slice():[]}}function S(t){return Array.isArray(t?.varianti)?t.varianti:[]}function N(t){return!!t&&t.modoComponente==="segnalazione"}function yt(t){return!!t&&t.tracciabile!==!1&&!N(t)}function E(t,i){let n=H(t?.qtaPerVariante?.[i]);return N(t)?n>0?1:0:n}function ht(t,i){return Bt(t,i)}function Rt(){try{let t=localStorage.getItem(Et),i=t?JSON.parse(t):{};return i&&typeof i=="object"?i:{}}catch{return{}}}function zi(t){try{localStorage.setItem(Et,JSON.stringify(t||{}))}catch{}}function J(t){return String(t||"").trim().toUpperCase()}function ot(t){let i=Array.isArray(t?.ordiniCliente)?[...new Set(t.ordiniCliente.map(J).filter(Boolean))]:[];return{cliente:String(t?.cliente||"").trim(),ordiniCliente:i,documento:String(t?.documento||"").trim()}}function Y(t){return ot(t?._meta||{})}function zt(t,i){return t._meta=ot(i),t._meta}function j(t,i){return Math.max(0,Number.parseInt(t?.[i],10)||0)}function Pt(){let t=1;try{t=(Number.parseInt(localStorage.getItem(At),10)||0)+1,localStorage.setItem(At,String(t))}catch{}return`Distinta Base-${String(t).padStart(4,"0")}`}function Ci(t){let i=Y(t);return i.documento||(i.documento=Pt(),zt(t,i)),i.documento}function Ot(t){let i=new Set;return(Array.isArray(t)?t:[]).filter(n=>String(n?.archiviato||"").toUpperCase()!=="TRUE").map(n=>({ordine:J(n?.ordine||""),cliente:String(n?.cliente||"").trim()})).filter(n=>!n.ordine||i.has(n.ordine)?!1:(i.add(n.ordine),!0))}function Dt(){return V.length?Promise.resolve(V):Array.isArray(window._attiviProd)&&window._attiviProd.length?(V=Ot(window._attiviProd),Promise.resolve(V)):X||(X=fetch(ut,{method:"POST",body:JSON.stringify({pagina:"PROGRAMMA PRODUZIONE DEL MESE"})}).then(t=>t.json()).then(t=>(V=Ot(t),V)).catch(function(t){return console.warn("[kit-prodotti] autocomplete ordini non disponibile:",t),[]}).finally(function(){X=null}),X)}function wi(t){let i=J(t);return i&&V.find(n=>n.ordine===i)||null}function Vt(t,i={}){let n=[...new Set((Array.isArray(t)?t:[]).map(function(e){let o=J(e);return o?i[o]?String(i[o]||"").trim():String(wi(o)?.cliente||"").trim():""}).filter(Boolean))];return n.length===1?n[0]:""}function dt(t){let i=Rt(),n=i?.[t?.id]&&typeof i[t.id]=="object"?i[t.id]:{},e={};for(let o of S(t)){let s=n[o.key];e[o.key]=Math.max(0,Number.parseInt(s,10)||0)}return e._meta=ot(n._meta||{}),e}function R(t,i){let{kits:n}=C(),e=n.find(p=>p.id===t);if(!e)return;let o=Rt(),s=dt(e);try{console.debug("[kit-prodotti] _kitMutateOrderDraft START",{kitId:t,currentDraft:JSON.parse(JSON.stringify(s||{}))})}catch{}i(s,e);let a={},d=!1;for(let p of S(e)){let m=Math.max(0,Number.parseInt(s[p.key],10)||0);a[p.key]=m,m>0&&(d=!0)}let c=ot(s._meta||{}),l=!!(c.cliente||c.ordiniCliente.length||c.documento);(d||l)&&(c.documento||(c.documento=Pt()),a._meta=c);try{console.debug("[kit-prodotti] _kitMutateOrderDraft END",{kitId:t,cleanedDraft:a})}catch{}d||l?o[t]=a:delete o[t],zi(o),M===t&&K()}function $i(t){return Object.entries(t||{}).reduce(function(i,n){return n[0]==="_meta"?i:i+(Number.parseInt(n[1],10)||0)},0)}function Ct(t){let i=tt[t.id]&&typeof tt[t.id]=="object"?tt[t.id]:{},n={};for(let e of t.assiConfigurazione||[]){let o=new Set((e.opzioni||[]).map(s=>s.id));n[e.id]=o.has(i[e.id])?i[e.id]:e.opzioni?.[0]?.id||""}return tt[t.id]=n,n}function Ht(t,i){let n=t.assiConfigurazione||[];if(!n.length)return S(t)[0]||null;let e=[];for(let s of n){let a=i?.[s.id],d=(s.opzioni||[]).find(c=>c.id===a);if(!d)return null;e.push({asseId:s.id,asseKey:s.key,asseNome:s.nome,opzioneId:d.id,opzioneKey:d.key,opzioneNome:d.nome})}let o=Tt(e);return S(t).find(s=>s.key===o)||null}function _i(t){let i=String(t?.asseNome||"").trim(),n=String(t?.opzioneNome||"").trim();return i?n?n.toLowerCase().includes(i.toLowerCase())||/\s/.test(n)?n:`${i} ${n}`.trim():i:n}function Si(t,i,n){let e=String(n?.asseId||""),o=String(n?.opzioneId||"");if(!e||!o)return!1;for(let s of t.sezioni||[])for(let a of s.componenti||[])if(!N(a)&&!(E(a,i.key)<=0)&&a.applicazioneTipo==="gruppo"&&String(a.applicazioneAsseId||"")===e&&Array.isArray(a.applicazioneOpzioneIds)&&a.applicazioneOpzioneIds.includes(o))return!0;return!1}function Ii(t,i,n){let e=[],o=new Map;for(let s of i){let a=j(n,s.key);if(a)for(let d of s.selections||[]){if(Si(t,s,d))continue;let c=`${d.asseId||""}::${d.opzioneId||""}`,l=o.get(c);if(l){l.totale+=a;continue}let p={id:"sel-"+c,nome:_i(d),codice:String(d?.opzioneCodice||"").trim(),totale:a,unita:"pz",dettaglio:"",noteConfig:""};o.set(c,p),e.push(p)}}return e}function jt(t,i){let n=S(t).filter(a=>j(i,a.key)>0),e=[],o=[],s=Ii(t,n,i);s.length&&e.push({id:"kit-distinta-elettronica",nome:"ELETTRONICA",righe:s});for(let a of t.sezioni||[]){let d=[];for(let c of a.componenti||[]){let l=0,p=[];for(let k of n){let g=j(i,k.key),b=E(c,k.key);!g||!b||(N(c)?l+=g:l+=g*b,p.push({nome:k.nome,pezziOrdine:g,coeff:b}))}if(!p.length)continue;let m=p.length===1?p[0].nome:p.length+" configurazioni";if(N(c)){o.push({id:"alert-"+c.id,tipo:"alert",nome:c.nome,dettaglio:c.noteConfig||"Requisito da verificare in fase di approvvigionamento.",totaleCoinvolto:l,variantiLabel:m});continue}d.push({id:c.id,nome:c.nome,codice:String(c.codice||"").trim(),totale:l,unita:c.unitaMisura||"pz",dettaglio:"",noteConfig:c.noteConfig||""}),c.noteConfig&&o.push({id:"note-"+c.id,tipo:"nota",nome:c.nome,dettaglio:c.noteConfig,totaleCoinvolto:l,variantiLabel:m})}d.length&&e.push({id:a.id,nome:a.nome,righe:d})}return{selectedVarianti:n,sezioni:e,avvisi:o,totalePezzi:$i(i),totaleRighe:e.reduce((a,d)=>a+d.righe.length,0)}}function xi(t,i=!0){let n=t instanceof Date?t:new Date(t);return Number.isNaN(n.getTime())?"\u2014":n.toLocaleString("it-IT",i?{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}:{day:"2-digit",month:"2-digit",year:"numeric"})}function Ai(){return String(window._distintaHeaderAzienda||"").trim()}function Mi(t,i,n){let e=new Date,o=Y(n),s=Ai(),a=String(o.documento||"").trim(),d=s?s.split(/\r?\n/).map(g=>`<div>${r(g)}</div>`).join(""):"",c=o.ordiniCliente.length>1?"Ordini cliente":"Ordine cliente",l=o.ordiniCliente.join(" \xB7 "),p=i.selectedVarianti.length?i.selectedVarianti.map(g=>{let b=j(n,g.key);return`<tr>
                <td>${r(G(b))}</td>
                <td>${r(g.nome)}</td>
                ...
                <td class="db-print-cell-ref">${r(String(u.codice||"").trim())}</td>
                <td><div class="db-print-row-name">${r(u.nome)}</div></td>
                <td class="db-print-cell-unit">${r(u.unita)}</td>
                <td class="db-print-cell-qty">${r(G(u.totale))}</td>
...
<body>
    ...
    <div class="db-print-stage">
        <div class="db-print-page">
            ...
            <div class="db-print-meta-grid">
                ...
                <div class="db-print-meta-card">
                    <div class="db-print-meta-row"><div class="db-print-meta-label">Generato da</div><div class="db-print-meta-value">${r(F?.nome||"Sistema")}</div></div>
...
</html>`}function Oi(t){let{kits:i}=C(),n=i.find(a=>a.id===t);if(!n)return;let e=dt(n),o=jt(n,e);if(!o.totalePezzi||!o.totaleRighe){A("Componi prima un ordine per generare la distinta stampabile.","warning");return}Y(e).documento||(R(t,function(a){Ci(a)}),e=dt(n));let s=window.open("","_blank");if(!s){A("Popup bloccato: abilita l'anteprima di stampa per aprire il modello completo.","warning");return}s.document.open(),s.document.write(Mi(n,o,e)),s.document.close(),s.focus()}function C(){try{let t=localStorage.getItem(vt);if(!t)return{kits:[]};let i=JSON.parse(t);return{kits:Array.isArray(i?.kits)?i.kits.map(Lt):[]}}catch{return{kits:[]}}}function O(t){let i=Array.isArray(t)?t.map(Lt):[];try{localStorage.setItem(vt,JSON.stringify({kits:i})),localStorage.setItem(ct,Date.now())}catch{}qi(i)}function qi(t){clearTimeout(qt),qt=setTimeout(function(){ft({azione:"setKitData",kits:t}).catch(function(i){console.warn("[kit-prodotti] salvataggio remoto fallito:",i)})},1500)}function Ei(t){fetch(ut,{method:"POST",body:JSON.stringify({azione:"getKitData"})}).then(i=>i.json()).then(i=>{if(i&&Array.isArray(i.kits)){let n=parseInt(i.ts||0),e=parseInt(localStorage.getItem(ct)||0);if(n>0&&n>e){try{localStorage.setItem(vt,JSON.stringify({kits:i.kits}))}catch{}try{localStorage.setItem(ct,n)}catch{}t&&t(!0);return}}t&&t(!1)}).catch(()=>{t&&t(!1)})}function I(){return Math.random().toString(36).slice(2,10)+Date.now().toString(36)}function wt(){if(!F||!F.nome)return!1;let t=String(F.nome).toUpperCase().trim();return t==="ALESSIO"||t==="0000"||F.ruolo==="MASTER"}function Ni(t){let i={};for(let n of t.sezioni||[])for(let e of n.componenti||[]){if(N(e)){i[e.id]=0;continue}let o=0;for(let[s,a]of Object.entries(t.qtaDaProdurre||{}))o+=(Number.parseInt(a,10)||0)*E(e,s);i[e.id]=o}return i}function Ti(t){let i={};for(let n of t.sottoAssembly||[]){let e=Number.parseInt(t.pronti?.[n.id],10)||0;if(!e)continue;let o=n.varianteKey;for(let s of t.sezioni||[])for(let a of s.componenti||[]){if(N(a))continue;let d=E(a,o);d>0&&(i[a.id]=(i[a.id]||0)+e*d)}}return i}function Ut(t,i){let n=S(t).find(e=>e.key===i);return n?r(n.nome):r(i)}function $t(){return new Date().toLocaleString("it-IT",{day:"2-digit",month:"2-digit",year:"2-digit",hour:"2-digit",minute:"2-digit"})}function W(){gt||(gt=!0,Ei(function(e){e&&W()}));let{kits:t}=C(),i=document.getElementById("contenitore-dati"),n=t.map(e=>{let s=S(e).length,a=(e.assiConfigurazione||[]).length,d=(e.sezioni||[]).reduce((c,l)=>c+(l.componenti||[]).length,0);return`
    ...
    <div class="kit-page">
        ...
        ${t.length===0?`<div class="kit-empty-state">
            ...
            </span>`).join(""):'<div class="kit-order-meta-empty">Nessun ordine cliente collegato.</div>',l=Ct(i),p=Ht(i,l),m=(i.assiConfigurazione||[]).length?(i.assiConfigurazione||[]).map(u=>`
            ...
            </div>`).join(""):'<div class="kit-cfg-help">Questo prodotto non ha elettronica selezionabile: puoi usarlo come prodotto fisso.</div>',k=a.selectedVarianti.length?a.selectedVarianti.map(u=>{let z=j(o,u.key);return`<div class="kit-order-line">
                <div class="kit-order-line-main">
                    <div class="kit-order-line-name">${r(u.nome)}</div>
        ...
        </div>`,b=a.avvisi.length?a.avvisi.map(u=>`
            <div class="kit-distinta-alert ${u.tipo==="alert"?"kit-distinta-alert--warning":""}">
                <div class="kit-distinta-alert-title">${r(u.nome)}</div>
                <div class="kit-distinta-alert-body">${r(u.dettaglio)}</div>
    ...
    </div>`,at(n),Dt().catch(()=>{})}function Ki(){M=null,W()}function Li(t){Qt=t,K()}function Ri(t){R(t,function(i,n){for(let e of S(n)){let o=document.getElementById("kit-qty-"+e.key);o&&(i[e.key]=Math.max(0,Number.parseInt(o.value,10)||0))}})}function Pi(t,i,n){R(t,function(e){e[i]=Math.max(0,Number.parseInt(n,10)||0)})}function Di(t,i,n){R(t,function(e){let o=Math.max(0,Number.parseInt(e[i],10)||0);e[i]=Math.max(0,o+n)})}function Vi(t){R(t,function(i){for(let n of Object.keys(i))n!=="_meta"&&(i[n]=0);i._meta=ot({})})}function Hi(t,i){R(t,function(n){n[i]=0})}function lt(t,i){let n=document.getElementById("kit-order-autocomplete-"+t);if(n){if(!i.length){n.style.display="none",n.innerHTML="";return}n.innerHTML=i.map(e=>`
    ...
    `).join(""),n.style.display="block"}}function ji(t,i){let n=String(i||"").trim().toLowerCase();if(!n){lt(t,[]);return}Dt().then(function(e){let o=e.filter(s=>s.ordine.toLowerCase().includes(n)||s.cliente.toLowerCase().includes(n)).slice(0,8);lt(t,o)})}function Ui(t){setTimeout(function(){lt(t,[])},140)}function Qi(t,i,n){let e=J(i);if(!e)return;R(t,function(s){let a=Y(s);a.ordiniCliente=[...new Set(a.ordiniCliente.concat(e))],a.cliente=Vt(a.ordiniCliente,{[e]:n}),zt(s,a)});let o=document.getElementById("kit-order-ref-input-"+t);o&&(o.value=""),lt(t,[])}function Fi(t,i){let n=J(i);R(t,function(e){let o=Y(e);o.ordiniCliente=o.ordiniCliente.filter(s=>s!==n),o.cliente=Vt(o.ordiniCliente),zt(e,o)})}function Gi(t,i,n){let{kits:e}=C(),o=e.find(a=>a.id===t);if(!o)return;let s=Ct(o);s[i]=n,tt[t]=s,M===t&&K()}function Ji(t){let{kits:i}=C(),n=i.find(a=>a.id===t);if(!n)return;try{console.debug("[kit-prodotti] _kitComposeAdd CLICK",{kitId:t,time:new Date().toISOString()})}catch{}let e=Ht(n,Ct(n));if(!e){A("Completa prima le scelte elettroniche \u26A0\uFE0F");return}let o=Math.max(0,Number.parseInt(document.getElementById("kit-compose-qty-"+t)?.value,10)||0);try{console.debug("[kit-prodotti] _kitComposeAdd variant/qty",{kitId:t,variantKey:e?.key||null,qty:o})}catch{}if(!o){A("Inserisci una quantit\xE0 valida \u26A0\uFE0F");return}if(rt[t]){try{console.debug("[kit-prodotti] _kitComposeAdd SKIPPED duplicate",{kitId:t,variantKey:e?.key||null,qty:o,since:Date.now()-rt[t]})}catch{}return}rt[t]=Date.now(),setTimeout(function(){try{delete rt[t]}catch{}},600),R(t,function(a){a[e.key]=j(a,e.key)+o});let s=document.getElementById("kit-compose-qty-"+t);s&&(s.value=1)}function Ft(t){let i=t.dataset.cid,n=t.dataset.sid,e=Math.max(0,Number.parseInt(t.value,10)||0),{kits:o}=C(),s=o.find(z=>z.id===M);if(!s)return;let a=(s.sezioni||[]).find(z=>z.id===n),d=a&&(a.componenti||[]).find(z=>z.id===i);if(!d||!yt(d))return;d.caricato=e,O(o);let l=Ni(s)[i]||0,p=Math.max(0,l-e),k=Ti(s)[i]||0,g=t.closest("tr");if(!g)return;let b=g.querySelector(".kit-ord-zero,.kit-ord-manca,.kit-ord-ok");b&&(b.textContent=l===0?"\u2014":p,b.className=l===0?"kit-ord-zero":p>0?"kit-ord-manca":"kit-ord-ok");let u=g.querySelector(".kit-car-liberi");u&&(k>0?(u.textContent=Math.max(0,e-k)+" lib.",u.style.display=""):u.style.display="none")}function Yi(t,i,n){let{kits:e}=C(),o=e.find(s=>s.id===t);o&&(o.pronti||(o.pronti={}),o.pronti[i]=Math.max(0,(Number.parseInt(o.pronti[i],10)||0)+n),O(e),M===t&&K())}function Wi(t,i,n){let{kits:e}=C(),o=e.find(a=>a.id===t);if(!o)return;o.pronti||(o.pronti={}),o.pronti[i]=Math.max(0,Number.parseInt(n,10)||0),O(e);let s=document.querySelector(`.kit-pronti-input[data-said="${i}"]`);s&&(s.value=o.pronti[i],s.classList.toggle("kit-pronti-val-on",o.pronti[i]>0))}function Zi(t,i){let n=t.movimenti||[];return n.length?n.map(e=>{let o=i?`<button type="button" class="kit-mov-del" onclick="_kitEliminaMovimento('${r(t.id)}',${e.id})" title="Elimina">\u2715</button>`:'<span style="width:22px;flex-shrink:0"></span>',s=i&&(e.tipo==="carico"||e.tipo==="scarico")?`<button type="button" class="kit-mov-edit" onclick="_kitModificaMovimento('${r(t.id)}',${e.id})" title="Modifica">\u270E</button>`:'<span style="width:22px;flex-shrink:0"></span>';if(e.tipo==="spedizione"){let a=(e.righe||[]).reduce((l,p)=>l+p.qty,0),d=(e.righe||[]).map(l=>`<div class="kit-assemb-sub-row"><span class="kit-assemb-sub-mat" style="color:#94a3b8">${r(l.mat)}</span><span class="kit-mov-qty scarico">\u2212${l.qty}</span></div>`).join(""),c=(e.items||[]).map(l=>`<div class="kit-assemb-sub-row kit-sped-item-row"><span class="kit-assemb-sub-mat">${r(l.nome)}</span><span class="kit-mov-qty scarico">\xD7${l.qty}</span></div>`).join("");return`<details class="kit-mov-assemb-group">
            ...
            <span class="kit-mov-ts">${e.ts}</span>
            ${s}${o}
        </div>`}).join(""):'<div class="kit-mov-empty">Nessun movimento registrato.</div>'}function Xi(t,i){let{kits:n}=C(),e=n.find(u=>u.id===t);if(!e)return;let o=document.getElementById("kit-mov-mat-"+t),s=document.getElementById("kit-mov-qty-"+t),a=document.getElementById("kit-mov-nota-"+t);if(!o||!s)return;let d=o.value,c=o.options[o.selectedIndex]?.dataset.sid,l=Math.max(1,Number.parseInt(s.value,10)||1),p=(a?.value||"").trim(),m=(e.sezioni||[]).find(u=>u.id===c),k=m&&(m.componenti||[]).find(u=>u.id===d);if(!k||!yt(k))return;i==="carico"?k.caricato=(parseInt(k.caricato)||0)+l:k.caricato=Math.max(0,(parseInt(k.caricato)||0)-l),e.movimenti||(e.movimenti=[]),e.movimenti.unshift({id:Date.now(),cid:d,sid:c,tipo:i,qty:l,nota:p,mat:k.nome,ts:$t()}),O(n),s&&(s.value=1),a&&(a.value="");let g=document.getElementById("kit-mov-list-"+t);g&&(g.innerHTML=Zi(e,wt()));let b=document.querySelector(`#kit-tbody-${t} input[data-cid="${d}"]`);b&&(b.value=k.caricato,Ft(b))}function te(t,i){if(!wt())return;let{kits:n}=C(),e=n.find(s=>s.id===t);if(!e)return;let o=(e.movimenti||[]).find(s=>s.id===i);o&&ie(t,i,o)}function ie(t,i,n){let e=document.getElementById("modal-kit-del-mov");if(!e)return;let o=document.getElementById("kit-del-mov-desc"),s;if(n.tipo==="spedizione")s=`<span class="kit-mov-badge spedizione" style="font-size:.75rem">SPED.</span> <strong>Spedizione \xD7${(n.righe||[]).reduce((c,l)=>c+l.qty,0)} pz</strong>`;else if(n.tipo==="reso")s=`<span class="kit-mov-badge reso" style="font-size:.75rem">RESO</span> <strong>Rientro \xD7${n.totPz||0} pz</strong>`;else{let d=n.tipo==="carico"?"CARICO":"SCARICO";s=`<span class="kit-mov-badge ${r(n.tipo)}" style="font-size:.75rem">${d}</span> <strong>${r(n.mat)}</strong> ${n.tipo==="carico"?"+":"\u2212"}${n.qty} pz`}o&&(o.innerHTML=s);let a=document.getElementById("btn-kit-del-ok");a&&(a.onclick=()=>Jt(t,i)),e.style.display="flex",e.offsetHeight,e.classList.add("active")}function Gt(){let t=document.getElementById("modal-kit-del-mov");t&&(t.classList.remove("active"),setTimeout(()=>{t.classList.contains("active")||(t.style.display="none")},300))}function Jt(t,i){Gt();let{kits:n}=C(),e=n.find(s=>s.id===t);if(!e)return;let o=(e.movimenti||[]).find(s=>s.id===i);if(o){if(o.tipo==="spedizione"){let s=(e.sezioni||[]).find(a=>a.id===o.sid);for(let a of o.righe||[])for(let d of e.sezioni||[]){let c=(d.componenti||[]).find(l=>l.id===a.cid||l.nome===a.mat);c&&(c.caricato=(parseInt(c.caricato)||0)+a.qty)}for(let a of o.items||[])a.saId&&e.pronti&&(e.pronti[a.saId]=(parseInt(e.pronti[a.saId])||0)+a.qty)}else if(o.tipo==="reso")for(let s of o.righe||[])for(let a of e.sezioni||[]){let d=(a.componenti||[]).find(c=>c.id===s.cid||c.nome===s.mat);d&&(d.caricato=Math.max(0,(parseInt(d.caricato)||0)-s.qty))}else if(o.tipo==="carico")for(let s of e.sezioni||[]){let a=(s.componenti||[]).find(d=>d.id===o.cid);a&&(a.caricato=Math.max(0,(parseInt(a.caricato)||0)-o.qty))}else if(o.tipo==="scarico")for(let s of e.sezioni||[]){let a=(s.componenti||[]).find(d=>d.id===o.cid);a&&(a.caricato=(parseInt(a.caricato)||0)+o.qty)}e.movimenti=(e.movimenti||[]).filter(s=>s.id!==i),O(n),M===t&&K(),A("Movimento eliminato \u2713")}}function ee(t,i){if(!wt())return;let{kits:n}=C(),e=n.find(l=>l.id===t);if(!e)return;let o=(e.movimenti||[]).find(l=>l.id===i);if(!o)return;let s=document.getElementById("modal-kit-edit-mov");if(!s)return;let a=document.getElementById("kit-edit-mov-mat"),d=document.getElementById("kit-edit-mov-qty"),c=document.getElementById("kit-edit-mov-nota");a&&(a.innerHTML=`<span class="kit-mov-badge ${r(o.tipo)}" style="font-size:.75rem">${o.tipo==="carico"?"CARICO":"SCARICO"}</span> <strong>${r(o.mat)}</strong>`),d&&(d.value=o.qty),c&&(c.value=o.nota||""),s.dataset.kitId=t,s.dataset.movId=i,s.style.display="flex",s.offsetHeight,s.classList.add("active"),setTimeout(()=>c&&c.focus(),80)}function Yt(){let t=document.getElementById("modal-kit-edit-mov");t&&(t.classList.remove("active"),setTimeout(()=>{t.classList.contains("active")||(t.style.display="none")},300))}function ne(){let t=document.getElementById("modal-kit-edit-mov");if(!t)return;let i=t.dataset.kitId,n=Number(t.dataset.movId);Yt();let{kits:e}=C(),o=e.find(l=>l.id===i);if(!o)return;let s=(o.movimenti||[]).findIndex(l=>l.id===n);if(s===-1)return;let a=o.movimenti[s],d=parseInt(document.getElementById("kit-edit-mov-qty")?.value),c=(document.getElementById("kit-edit-mov-nota")?.value||"").trim();if(isNaN(d)||d<=0){A("Quantit\xE0 non valida \u26A0\uFE0F");return}if(d!==a.qty){let l=d-a.qty;for(let p of o.sezioni||[]){let m=(p.componenti||[]).find(k=>k.id===a.cid);if(m){a.tipo==="carico"?m.caricato=Math.max(0,(parseInt(m.caricato)||0)+l):m.caricato=Math.max(0,(parseInt(m.caricato)||0)-l);break}}}o.movimenti[s]={...a,qty:d,nota:c},O(e),M===i&&K(),A("Movimento aggiornato \u2713")}function oe(t){let{kits:i}=C(),n=i.find(c=>c.id===t);if(!n)return;if(!(n.sottoAssembly||[]).some(c=>(Number.parseInt(n.pronti?.[c.id],10)||0)>0)){A("Nessuna parte tracciabile pronta \u2014 imposta le quantit\xE0 prima \u26A0\uFE0F");return}let o=document.getElementById("modal-kit-sped");if(!o)return;let s=document.getElementById("kit-sped-items-list");s&&(s.innerHTML=(n.sottoAssembly||[]).filter(c=>(Number.parseInt(n.pronti?.[c.id],10)||0)>0).map(c=>{let l=Number.parseInt(n.pronti?.[c.id],10)||0,p=Ut(n,c.varianteKey);return`<label class="kit-sped-item-row">
            ...
            <span class="kit-reso-bom-qty">+${c}</span>
        </label>`).join("")}function ce(){let t=document.getElementById("modal-kit-reso");if(!t)return;let i=t.dataset.kitId,{kits:n}=C(),e=n.find(l=>l.id===i);if(!e)return;let o=[];for(let l of e.sottoAssembly||[]){let p=Number.parseInt(document.getElementById("kit-reso-qty-"+l.id)?.value,10)||0;p>0&&o.push({saId:l.id,nome:l.nome,qty:p})}if(!o.length){A("Inserisci almeno un articolo rientrato \u26A0\uFE0F");return}let s=[],a=[];document.querySelectorAll(".kit-reso-bom-chk").forEach(l=>{let p=l.dataset.cid,m=Number.parseInt(l.dataset.qty,10),k=[...e.sezioni||[]].flatMap(g=>g.componenti||[]).find(g=>g.id===p)?.nome||"?";l.checked?s.push({cid:p,mat:k,qty:m}):a.push({cid:p,mat:k,qty:m})});for(let l of s)for(let p of e.sezioni||[]){let m=(p.componenti||[]).find(k=>k.id===l.cid);if(m){m.caricato=(parseInt(m.caricato)||0)+l.qty;break}}let d=(document.getElementById("kit-reso-nota")?.value||"").trim(),c=o.reduce((l,p)=>l+p.qty,0);e.movimenti||(e.movimenti=[]),e.movimenti.unshift({id:Date.now(),tipo:"reso",items:o,righe:s,scartate:a,nota:d,ts:$t(),totPz:c}),O(n),Zt(),A(`Reso registrato: ${c} pz \u2014 ${s.length} comp. recuperati \u2713`),M===i&&K()}function de(t){let i=document.getElementById("kit-save-btn"),n=document.getElementById("kit-save-label");if(!i||!n)return;i.disabled=!0,i.classList.add("kit-save-loading"),n.textContent="Salvataggio\u2026";let{kits:e}=C();ft({azione:"setKitData",kits:e}).then(()=>{try{localStorage.setItem(ct,Date.now())}catch{}i.classList.remove("kit-save-loading"),i.classList.add("kit-save-ok"),n.textContent="Salvato \u2713",setTimeout(()=>{i.classList.remove("kit-save-ok"),n.textContent="Salva",i.disabled=!1},2500)}).catch(()=>{i.classList.remove("kit-save-loading"),i.classList.add("kit-save-err"),n.textContent="Errore \u2717",setTimeout(()=>{i.classList.remove("kit-save-err"),n.textContent="Salva",i.disabled=!1},3e3)})}function le(){let{kits:t}=C(),i={id:I(),nome:"Nuovo Kit",schemaVersion:Nt,assiConfigurazione:[],varianti:[],sezioni:[],sottoAssembly:[],qtaDaProdurre:{},pronti:{},movimenti:[]};t.push(i),O(t),Xt(i.id)}function Xt(t){St=t,D="info",et()}function It(t,i,n=""){let{kits:e}=C(),o=e.find(d=>d.id===t),s=e.find(d=>d.id!==t&&(d.sezioni||[]).length),a=o?.sezioni?.[0]?.id||"";return{currentKitId:t,mode:i,search:"",sourceKitId:i==="copy"?t:s?.id||"",sectionId:n||(i==="copy"?a:s?.sezioni?.[0]?.id||""),targetKitIds:[]}}function ti(t){h=It(t,"import"),P(!0)}function pe(t,i){h=It(t,"copy",i),P(!0)}function pt(){let t=document.getElementById("modal-kit-import");h=null,t&&(t.classList.remove("active"),setTimeout(()=>{t.classList.contains("active")||(t.style.display="none")},300))}function me(t){if(!h||t!=="import"&&t!=="copy"||h.mode===t)return;let i=h.currentKitId,n=t==="copy"?h.sectionId:"";h=It(i,t,n),P()}function ue(t){h&&(h.search=String(t||""),P())}function fe(t){if(!h)return;let{kits:i}=C(),n=i.find(e=>e.id===t);h.sourceKitId=t,h.sectionId=n?.sezioni?.[0]?.id||"",P()}function ge(t){h&&(h.sectionId=t,P())}function ke(t,i){if(!h||h.mode!=="copy")return;let n=new Set(h.targetKitIds||[]);i?n.add(t):n.delete(t),h.targetKitIds=[...n],P()}function ve(){if(!h||h.mode!=="copy")return;let{kits:t}=C(),i=t.filter(e=>e.id!==h.currentKitId&&kt(e.nome,h.search)),n=new Set(h.targetKitIds||[]);for(let e of i)n.add(e.id);h.targetKitIds=[...n],P()}function be(){!h||h.mode!=="copy"||(h.targetKitIds=[],P())}function P(t=!1){let i=document.getElementById("modal-kit-import");if(!i||!h)return;let{kits:n}=C(),e=h,o=n.find(f=>f.id===e.currentKitId);if(!o){pt();return}let s=n.filter(f=>f.id!==o.id&&(f.sezioni||[]).length);e.mode==="import"&&!s.some(f=>f.id===e.sourceKitId)&&(e.sourceKitId=s[0]?.id||""),e.mode==="copy"&&(e.sourceKitId=o.id,e.targetKitIds=(e.targetKitIds||[]).filter(f=>f!==o.id&&n.some(_=>_.id===f)));let a=n.find(f=>f.id===e.sourceKitId)||null,d=a?.sezioni||[];d.some(f=>f.id===e.sectionId)||(e.sectionId=d[0]?.id||"");let c=Kt(a,e.sectionId),l=s.filter(f=>kt(f.nome,e.search)),p=n.filter(f=>f.id!==o.id&&kt(f.nome,e.search)),m=document.getElementById("kit-import-subtitle"),k=document.getElementById("kit-import-search"),g=document.getElementById("kit-import-left-title"),b=document.getElementById("kit-import-right-title"),u=document.getElementById("kit-import-kit-list"),z=document.getElementById("kit-import-section-list"),T=document.getElementById("kit-import-target-wrap"),st=document.getElementById("kit-import-target-list"),Z=document.getElementById("kit-import-preview"),U=document.getElementById("kit-import-confirm-btn"),v=document.getElementById("kit-import-mode-import"),q=document.getElementById("kit-import-mode-copy");if(!m||!k||!g||!b||!u||!z||!T||!st||!Z||!U||!v||!q)return;v.classList.toggle("kit-import-mode-btn--active",e.mode==="import"),q.classList.toggle("kit-import-mode-btn--active",e.mode==="copy"),k.value=e.search,e.mode==="import"?(m.textContent=`Importa una sezione esistente dentro "${o.nome}".`,k.placeholder="Cerca kit sorgente\u2026",g.textContent="Kit sorgente",b.textContent=a?`Sezioni di ${a.nome}`:"Sezione",T.style.display="none",u.innerHTML=l.length?l.map(f=>{let _=f.id===e.sourceKitId;return`<label class="kit-import-option ${_?"kit-import-option--active":""}">
                ...
                </label>`}).join(""):'<div class="kit-import-empty">Nessun kit sorgente trovato.</div>'):(m.textContent=`Seleziona una sezione di "${o.nome}" e copiala in pi\xF9 kit.`,k.placeholder="Cerca kit destinazione\u2026",g.textContent="Kit sorgente",b.textContent="Sezione da copiare",T.style.display="flex",u.innerHTML=`<div class="kit-import-source-card">
            <div class="kit-import-option-title">${r(o.nome)}</div>
            <div class="kit-import-option-meta">${(o.sezioni||[]).length} sezioni configurate</div>
        </div>`,st.innerHTML=p.length?p.map(f=>{let _=(e.targetKitIds||[]).includes(f.id),B=c?it(o,f):null,Q=`${(f.sezioni||[]).length} sezioni`;return B&&(B.hasTargetVarianti?B.needsReview?Q=`${B.exactMatches}/${B.targetCount} combinazioni allineate`:Q=`${B.targetCount}/${B.targetCount} combinazioni allineate`:Q="nessuna combinazione: rifinisci dopo"),`<label class="kit-import-option ${_?"kit-import-option--active":""}">
                    <input type="checkbox" ${_?"checked":""}
                           onchange="_kitCfgToggleImportTarget('${r(f.id)}',this.checked)">
                    <span class="kit-import-option-body">
                        <span class="kit-import-option-title">${r(f.nome)}</span>
                        <span class="kit-import-option-meta">${r(Q)}</span>
                    </span>
            ...
            </label>`}).join(""):'<div class="kit-import-empty">Nessuna sezione disponibile.</div>';let L=!1,y="kit-cfg-help kit-import-preview",w="";if(e.mode==="import"){if(!a)w="Seleziona un kit sorgente per vedere le sezioni disponibili.";else if(!c)w="Seleziona una sezione da importare nel kit corrente.";else{let f=it(a,o);L=!0,w=`La sezione <strong>${r(c.nome)}</strong> verr\xE0 importata in <strong>${r(o.nome)}</strong>. `,f.hasTargetVarianti?f.needsReview?(y="kit-cfg-warn kit-import-preview",w+=`${f.exactMatches} combinazioni su ${f.targetCount} risultano allineate: controlla i coefficienti importati.`):w+=`Tutte le ${f.targetCount} combinazioni del kit destinazione risultano allineate.`:(y="kit-cfg-warn kit-import-preview",w+="Il kit destinazione non ha ancora combinazioni: importa pure la struttura e rifinisci i coefficienti dopo aver definito gli assi.")}U.innerHTML='<i class="fas fa-copy"></i> Importa sezione'}else{let f=n.filter(_=>(e.targetKitIds||[]).includes(_.id));if(!c)w="Seleziona la sezione del kit corrente che vuoi copiare.";else if(!f.length)w="Seleziona almeno un kit destinazione per eseguire la copia massiva.";else{L=!0;let _=f.filter(B=>it(o,B).needsReview).length;w=`La sezione <strong>${r(c.nome)}</strong> verr\xE0 copiata in <strong>${f.length}</strong> kit.`,_>0?(y="kit-cfg-warn kit-import-preview",w+=` <strong>${_}</strong> kit richiederanno un controllo manuale delle quantit\xE0 o delle combinazioni.`):w+=" Le combinazioni risultano allineate su tutti i kit selezionati."}U.innerHTML=`<i class="fas fa-copy"></i> Copia in ${(e.targetKitIds||[]).length||0} kit`}Z.className=y,Z.innerHTML=w,U.disabled=!L,t&&(i.style.display="flex",i.offsetHeight,i.classList.add("active"),setTimeout(()=>{let f=document.getElementById("kit-import-search");f&&f.focus()},40))}function ye(){if(!h)return;let{kits:t}=C(),i=h,n=t.find(c=>c.id===i.currentKitId),e=t.find(c=>c.id===i.sourceKitId),o=Kt(e,i.sectionId);if(!n||!e||!o){A("Configurazione import non valida \u26A0\uFE0F");return}if(i.mode==="import"){let c=it(e,n);n.sezioni=n.sezioni||[],n.sezioni.push(Mt(o,e,n)),O(t),pt(),et();let l="";c.hasTargetVarianti?c.needsReview&&(l=" Controlla le quantit\xE0 sulle combinazioni non allineate."):l=" Definisci poi gli assi del kit per rifinire i coefficienti.",A(`Sezione "${o.nome}" importata da "${e.nome}" \u2713${l}`);return}let s=t.filter(c=>(i.targetKitIds||[]).includes(c.id)&&c.id!==n.id);if(!s.length){A("Seleziona almeno un kit destinazione \u26A0\uFE0F");return}let a=0;for(let c of s)it(e,c).needsReview&&(a+=1),c.sezioni=c.sezioni||[],c.sezioni.push(Mt(o,e,c));O(t),pt(),et();let d="";a>0&&(d=` ${a} kit richiedono un controllo delle quantit\xE0.`),A(`Sezione "${o.nome}" copiata in ${s.length} kit \u2713${d}`)}function et(){let{kits:t}=C(),i=t.find(v=>v.id===St);if(!i){W();return}let n=document.getElementById("contenitore-dati"),e=i.assiConfigurazione||[],o=S(i);D==="sezioni"&&(D="bom"),D==="sa"&&(D="bom");let s=["info","varianti","bom"],a={info:"Prodotto",varianti:"Elettronica selezionabile",bom:"Parti del prodotto"},d=e.length,c=o.length,l=(i.sezioni||[]).reduce((v,q)=>v+(q.componenti||[]).length,0),p=c?`
        ...
        <div class="kit-cfg-section">
            ...
            ${g}
                   ...
                   </select>`:"",ei=f.tipo==="manuale"?'<div class="kit-cfg-warn">Questa parte usa ancora una configurazione avanzata precedente. Appena la modifichi verr\xE0 convertita nel nuovo schema semplice.</div>':"",xt=w?"flag":mt(y.unitaMisura,"pz"),ni=w?[{value:"flag",label:"Solo avviso"}]:[...new Set([xt,...di])].filter(Boolean).map(x=>({value:x,label:x}));return`<div class="kit-cfg-sa-group" style="padding:12px 14px">
        ...
        <div class="kit-cfg-section">
            ...
            </div>`}).join(""):T='<div class="kit-cfg-warn">\u26A0\uFE0F Aggiungi prima almeno un asse con opzioni nella tab <strong>Assi di configurazione</strong>.</div>';let st=`
        <div class="kit-cfg-section">
            <div class="kit-cfg-help">
            ...
            ${T}
        </div>`,Z={info:m,varianti:b,bom:z,sa:st},U=s.map(v=>`<button class="kit-tab ${D===v?"kit-tab--active":""}" onclick="_kitCfgSwitchTab('${v}')">${a[v]}</button>`).join("");n.innerHTML=`
    <div class="kit-page">
        <div class="kit-view-header">
