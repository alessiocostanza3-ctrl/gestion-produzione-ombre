import{a as Se,b as N,c as zt}from"./chunk-chunk-VLVTJAKH.js";import{a as W,b as Ps,c as x,d as De,e as ft,f as y,g,h as z,i as Yi,j as rt,k as Xi,l as gt,m as h,n as Lt,o as tn,p as en,q as vt,r as Pt,s as zs,t as xt,u as ct,v as on,w as _e}from"./chunk-chunk-NM2LGQZU.js";function ht(t,e){try{let o=localStorage.getItem(t);if(!o)return null;let i=JSON.parse(o);return Date.now()-i.ts<e?i.data:null}catch{return null}}function Z(t,e){try{let o=typeof e=="string"?e:JSON.stringify(e);if(o.length>25e5)return;localStorage.setItem(t,JSON.stringify({ts:Date.now(),data:o}))}catch{}}function U(t){try{localStorage.removeItem(t)}catch{}}function nn(){try{let t=[];for(let e=0;e<localStorage.length;e++){let o=localStorage.key(e);o&&o.startsWith("_html_")&&t.push(o)}t.forEach(e=>localStorage.removeItem(e))}catch{}}var It=W(()=>{});var F,X,A,Qt=W(()=>{"use strict";F={},X={},A={dashBundle:null,dashPromise:null,rqBundle:null,rqPromise:null,matBundle:null,matPromise:null,ordiniBundle:null,ordiniPromise:null}});var Ms,Ns,qs,Ds,Bs,Us,Fs,Hs,js,an,sn,rn=W(()=>{"use strict";Ms="_pushStato",Ns="notifPrefs",qs="mlPipQty",Ds="mlPipCaricato",Bs="mlPipPronti",Us="mlPipMovimenti",Fs="avatarColor_",Hs="avatarColorRecenti_",js="avatarColorHidden_",an=[Ns,Ms,qs,Ds,Us,Bs],sn=[Fs,Hs,js]});function cn(t){qo=t.onRemoteChange,Do=t.onUsersOnline,Ee=t.getUtenteAttuale,qt=t.getPaginaCorrente}var qo,Do,Ee,qt,ln,M,Kt=W(()=>{_e();ft();zs();qo=null,Do=null,Ee=null,qt=null;ln={INTERVAL_MS:2e4,INTERVAL_FOCUS_MS:3e4,INTERVAL_BG_MS:3e4,PING_INTERVAL_MS:6e4,MAX_BACKOFF_MS:6e4,_timer:null,_pingTimer:null,_lastRevision:null,_lastCheck:0,_paused:!1,_errorStreak:0,_offPageTick:0,lastRevisionValue:null,lastOnlineList:[],lastCheckTs:0,start:function(){this.stop(),this._lastRevision=null,this._paused=!1,this._errorStreak=0,this._offPageTick=0,this._schedule(document.hidden?this.INTERVAL_BG_MS:this.INTERVAL_FOCUS_MS),this._schedulePing(5e3)},stop:function(){this._timer&&(clearTimeout(this._timer),this._timer=null),this._pingTimer&&(clearTimeout(this._pingTimer),this._pingTimer=null),this._lastRevision=null,this._paused=!1;var t=document.getElementById("online-indicator");t&&t.remove();var e=document.getElementById("online-indicator-mob");e&&e.remove()},pauseFor:function(t){t||(t=5e3),this._paused=!0;var e=this;setTimeout(function(){e._paused=!1},t)},_schedule:function(t){this._timer&&clearTimeout(this._timer);var e=this;this._timer=setTimeout(function(){e._tick()},t)},_tick:function(){var t=this;this._check().finally(function(){var e=qt?String(qt()||"").toUpperCase().trim():"",o=e==="PROGRAMMA PRODUZIONE DEL MESE",i=document.hidden?t.INTERVAL_BG_MS:document.hasFocus&&document.hasFocus()?t.INTERVAL_FOCUS_MS:t.INTERVAL_MS;o||(i=Math.max(i,t.INTERVAL_BG_MS));var n=i;if(t._errorStreak>0){var a=Math.min(4,1+t._errorStreak*.5);n=Math.min(t.MAX_BACKOFF_MS,Math.round(i*a))}t._schedule(n)})},_check:async function(){if(!this._paused){var t=Date.now(),e=qt?String(qt()||"").toUpperCase().trim():"",o=e==="PROGRAMMA PRODUZIONE DEL MESE";if(!(!o&&(this._offPageTick=(this._offPageTick+1)%3,this._offPageTick!==0)))try{var i=await on();if(!i||i.status!=="ok"){this._errorStreak=Math.min(this._errorStreak+1,10),Pt("poller_check",{action:e||"UNKNOWN_PAGE",status:"invalid_payload",durationMs:Date.now()-t},{sampleRate:.5});return}var n=Number(i.revision);if(this._errorStreak=0,this._lastCheck=Date.now(),this.lastRevisionValue=n,this.lastCheckTs=Date.now(),this._lastRevision===null){this._lastRevision=n,Pt("poller_check",{action:e||"UNKNOWN_PAGE",status:"baseline",durationMs:Date.now()-t},{sampleRate:.3});return}if(n===this._lastRevision){Pt("poller_check",{action:e||"UNKNOWN_PAGE",status:"unchanged",durationMs:Date.now()-t},{sampleRate:.2});return}var a=Ee?Ee():null,s=a&&a.nome?a.nome.toUpperCase():"",r=i.utente?String(i.utente).toUpperCase():"";if(this._lastRevision=n,r===s)return;var c=i.utente||"Qualcuno";Pt("poller_check",{action:e||"UNKNOWN_PAGE",status:"remote_change",durationMs:Date.now()-t,detail:String(c||"")},{sampleRate:1}),qo&&qo(c)}catch(l){this._errorStreak=Math.min(this._errorStreak+1,10),Pt("poller_check",{action:e||"UNKNOWN_PAGE",status:"error",durationMs:Date.now()-t,error:l&&l.message?l.message:String(l||"")},{sampleRate:.7}),l&&l.name!=="AbortError"&&console.warn("[RevisionPoller]",l)}}},_schedulePing:function(t){this._pingTimer&&clearTimeout(this._pingTimer);var e=this;this._pingTimer=setTimeout(function(){e._pingServer().finally(function(){e._schedulePing(e.PING_INTERVAL_MS)})},t)},_pingServer:async function(){var t=Ee?Ee():null;if(!(!t||!t.nome))try{var e=await xt({azione:"ping",pagina:(qt?qt():"")||""});e&&e.status==="ok"&&Array.isArray(e.online)&&(Do&&Do(e.online),ln.lastOnlineList=e.online,Pt("poller_ping",{action:"ping",status:"ok",detail:String(e.online.length)},{sampleRate:.3}))}catch(o){Pt("poller_ping",{action:"ping",status:"error",error:o&&o.message?o.message:String(o||"")},{sampleRate:.7})}}},M=ln});function pn(){return"ORDINI_ACQUISTI_"+(h?.nome?.toUpperCase()||"_")}function Uo(){let t=document.getElementById("contenitore-dati");t&&(pt._acq_ordini=t.innerHTML,Ct._acq_ordini=Date.now(),N.set(pn(),t.innerHTML).catch(()=>{}))}function Zs(){A.ordiniBundle=null,A.ordiniPromise=null}function dn(t,e,o){t.classList.toggle("is-ordinato",o),e.classList.toggle("checked",o),e.title=o?"Segna In Attesa":"Segna Ordinato";let i=e.querySelector("i");i&&(i.className="fas "+(o?"fa-check-circle":"fa-circle"));let n=t.querySelector(".oi-stato-badge");n&&(n.className="oi-stato-badge "+(o?"badge-ordinato-sm":"badge-attesa-sm"),n.innerHTML=o?'<i class="fas fa-circle-check"></i> ORDINATO':"IN ATTESA");let a=t.querySelector(".oi-stato-dot");a&&(a.className="oi-stato-dot "+(o?"dot-ordinato":"dot-attesa"));let s=t.closest(".ordine-group");if(s){let l=s.querySelectorAll(".ordine-item").length,d=s.querySelectorAll(".ordine-item.is-ordinato").length,u=s.querySelector(".og-progress");if(u&&(u.textContent=d+"/"+l),d===l){s.classList.add("all-done");let f=s.querySelector(".og-left");f&&!f.querySelector(".og-done-badge")&&f.insertAdjacentHTML("beforeend",'<span class="og-done-badge"><i class="fas fa-check-circle"></i> Completato</span>')}else{s.classList.remove("all-done");let f=s.querySelector(".og-done-badge");f&&f.remove()}}let r=document.querySelector(".acquisti-subtitle");if(r){let c=document.querySelectorAll(".ordine-item:not(.is-ordinato)").length;r.textContent=c>0?`${c} articoli in attesa`:"Tutto ordinato \u2705"}}function un(t,e){return fetch(x,{method:"POST",body:JSON.stringify({pagina:t}),...e?{signal:e}:{}}).then(o=>{if(!o.ok)throw new Error(`HTTP ${o.status}`);return o.json()})}function Ho(){let t=document.getElementById("acq-tab-catalogo"),e=document.getElementById("acq-tab-ordini"),o=document.getElementById("acq-tab-fornitori");t&&t.classList.toggle("active",dt==="catalogo"),e&&e.classList.toggle("active",dt==="ordini"),o&&o.classList.toggle("active",dt==="fornitori")}function Qs(t){if(t===dt)return;dt=t,window._acquistTabAttivo=t,Ho();let e=document.getElementById("contenitore-dati");if(e){if(t==="fornitori"){typeof window.caricaOrdiniFornitori=="function"&&window.caricaOrdiniFornitori(null,null,!1);return}if(t==="ordini"){let o=pt._acq_ordini,i=Ct._acq_ordini||0;if(o&&Date.now()-i<3e5){e.innerHTML=o,z(e),window.aggiornaListaFiltrabili?.();return}mn(null,null)}else{let o=pt["MATERIALE DA ORDINARE"],i=Ct["MATERIALE DA ORDINARE"]||0;if(o&&Date.now()-i<3e5){e.innerHTML=o,z(e),window.aggiornaListaFiltrabili?.();return}let n=ht("_html_MATERIALE DA ORDINARE",3e5);if(n){pt["MATERIALE DA ORDINARE"]=n,Ct["MATERIALE DA ORDINARE"]=Date.now(),e.innerHTML=n,z(e),window.aggiornaListaFiltrabili?.();return}bt(!1,null,null)}}}async function mn(t=null,e=null){if(xe)return;xe=!0;let o=document.getElementById("contenitore-dati");if(!o){xe=!1;return}let i=h?.nome?.toUpperCase().trim()==="ALESSIO",n=i?"":h?.nome||"",a=pn(),s=!1;try{let r=await N.get(a);if(dt!=="ordini"){xe=!1;return}r&&r.dati&&(o.innerHTML=r.dati,pt._acq_ordini=r.dati,Ct._acq_ordini=Date.now(),z(o),window.aggiornaListaFiltrabili?.(),s=!0)}catch{}if(s||(o.innerHTML="<div class='centered-msg'><i class='fas fa-spinner fa-spin'></i> Caricamento ordini...</div>"),!(s&&t!==null))try{let r;if(A.ordiniBundle?(r=A.ordiniBundle,A.ordiniBundle=null,A.ordiniPromise=null):A.ordiniPromise?(r=await A.ordiniPromise,A.ordiniBundle=null,A.ordiniPromise=null):r=await(await fetch(x,{method:"POST",body:JSON.stringify({azione:"getOrdiniAcquisti",operatore:n}),...e?{signal:e}:{}})).json(),e?.aborted)return;if(!Array.isArray(r)||r.length===0){o.innerHTML=`<div class='empty-msg'>${i?"Nessun ordine ricevuto.":"Non hai ancora inviato ordini."}</div>`,z(o);return}let c={};r.forEach(f=>{let p=f.id_gruppo||f.data+"_"+f.operatore;c[p]||(c[p]={data:f.data,operatore:f.operatore,items:[]}),c[p].items.push(f)});let l=Object.keys(c).reverse(),d=r.filter(f=>f.stato!=="ORDINATO").length,u=`<div class="ordini-acq-page">
    ...
    <div class="ordine-item ${o?"is-ordinato":""}" id="oi-${t.id_riga}" data-search="${String(t.articolo).toLowerCase()} ${String(t.fornitore).toLowerCase()}">
        ...
        <span class="oi-stato-badge ${o?"badge-ordinato-sm":"badge-attesa-sm"}">${o?'<i class="fas fa-circle-check"></i> ORDINATO':"IN ATTESA"}</span>
            ...
            <div id="lista-materiali-grid">`,d=window.innerWidth<=768;if(V.forEach((u,f)=>{let p=c[u]||[],m=r(u);l+=`
        ...
        </div>`;let e={};t.forEach(p=>{let m=p.n_ordine||"N.D.";e[m]||(e[m]=[]),e[m].push(p)});let o=[],i=[];Object.keys(e).forEach(p=>{e[p].some(b=>b.review_missing)?o.push(p):i.push(p)});let n=p=>p.sort((m,b)=>{let w=(e[m][0].fornitore||"").toUpperCase(),v=(e[b][0].fornitore||"").toUpperCase();return w<v?-1:w>v?1:m<b?-1:m>b?1:0});n(o),n(i);let a=[...o,...i],s=t.length,r=a.length,c=t.reduce((p,m)=>p+m.qta_evasa,0),l=t.reduce((p,m)=>p+m.quantita,0),d=l>0?Math.round(c/l*100):0,u=o.length,f=`<div class="acquisti-header header-flex">
        <div>
        ...
        </div>`}),f}function Cr(t){let e=y(t.codice||"-"),o=y(kr(t.prodotto,60)),i=y(t.prodotto||"-"),n=y(t.fornitore||"-"),a=y(t.n_ordine||"-"),s=y(t.data_consegna||"-"),r=t.quantita||0,c=t.qta_evasa||0,l=t.qta_da_consegnare||0,d=Lr(t.importo),u=h?.nome?.toUpperCase().trim()==="ALESSIO",f=r>0?Math.round(c/r*100):0,p=f===100?"#22c55e":f>0?"#f59e0b":"#94a3b8",m=`data-codice="${e}" data-prodotto="${i}" data-fornitore="${n}" data-ordine="${a}" data-data="${s}" data-qty="${r}" data-evasa="${c}" data-daconsegnare="${l}"${u?` data-importo="${d}"`:""}`;return`<div class="item-card of-item-card${u?"":" of-item-card-no-importo"}" onclick="_apriDettaglioOF(this)" ${m}>
...
Non comparir\xE0 pi\xF9 nella lista principale.`))return;let e=document.querySelector(`.of-ordine-wrapper[data-nordine="${t}"]`);e&&(e.style.opacity="0.4",e.style.pointerEvents="none");try{let o=await ct({azione:"archiviaOrdineFornitori",n_ordine:t},8e3,{retries:1});if(!o||o.status!=="ok"){g("Errore archiviazione","error"),e&&(e.style.opacity="",e.style.pointerEvents="");return}e&&e.remove();let i=document.querySelector(".acquisti-subtitle");if(i){let n=document.querySelectorAll(".of-ordine-wrapper"),a=document.querySelectorAll(".of-ordine-missing").length,s=a>0?` \xB7 <span style="color:#d97706;font-weight:600">\u26A0 ${a} da revisionare</span>`:"";i.innerHTML=`${n.length} ordini${s}`}if(!document.querySelector(".of-ordine-missing")){let n=document.querySelector(".of-review-banner");n&&n.remove()}Go()}catch{g("Errore connessione","error"),e&&(e.style.opacity="",e.style.pointerEvents="")}}function kr(t,e){return t?t.length>e?t.substring(0,e)+"\u2026":t:"-"}function Lr(t){return!t&&t!==0?"-":Number(t).toLocaleString("it-IT",{minimumFractionDigits:2,maximumFractionDigits:2})+" \u20AC"}async function Pr(t,e,o=!1){let i=document.getElementById("contenitore-dati");if(i){if(!o){let n=Xt[it],a=te[it]||0;if(n&&Date.now()-a<3e5){i.innerHTML=n,z(i),window.aggiornaListaFiltrabili?.();return}try{let r=await N.get(it);if(r&&r.dati){i.innerHTML=r.dati,Xt[it]=r.dati,te[it]=r.timestamp,z(i),window.aggiornaListaFiltrabili?.(),r.isStale&&zr(e);return}}catch{}let s=ht(Ue,3e5);if(s){i.innerHTML=s,Xt[it]=s,te[it]=Date.now(),z(i),window.aggiornaListaFiltrabili?.();return}i.innerHTML=`<div class="centered-msg" id="_of-loader">
    ...
    `).join(""),n.dataset.idRiga=t||"",n.dataset.nOrdine=o,n.dataset.cliente=i||"";let s=document.getElementById("modal-ordine-row");s&&(s.style.display="none"),document.getElementById("messaggio-aiuto").value="",Wo("DOMANDA")}function Pn(t={}){let e=document.getElementById("modalAiuto");if(e.style.display==="flex")return;e._openedAt=Date.now(),e.style.display="flex",e.offsetHeight,e.classList.add("active"),document.getElementById("modal-titolo").innerText="Nuova Richiesta";let o=window.listaOperatori||[];document.getElementById("wrapper-operatori").innerHTML=o.map(n=>`
        <label class="op-label">
...
' + document.documentElement.outerHTML;
    ...
    <\/script>
        ...
        <div class="fabprod-sel-modal-box">
            ...
            <button onclick="cambiaPagina('STORICO_RICHIESTE', null)"
                ...
                &#x21bb; Riprova
            </button>`)},12e3);try{let n=await ne(e);if(clearTimeout(i),Ge(n.attive),t!==null&&t!==window._latestNavRequest)return;window.aggiornaBadgeNotifiche?.(n.attive),Ae(n)}catch(n){if(clearTimeout(i),n.name==="AbortError")return;console.error("Errore caricamento richieste:",n),o.innerHTML=`<div class='centered-error-bold'>Errore nel caricamento. <button onclick="cambiaPagina('STORICO_RICHIESTE',null)" style="margin-left:8px;padding:4px 12px;background:#242424;color:#fff;border:none;border-radius:6px;cursor:pointer">Riprova</button></div>`,z(o)}}function Ae(t){if(window.paginaAttuale!=="STORICO_RICHIESTE")return;let e=document.getElementById("contenitore-dati");if(!e)return;let o=t.attive||[],i=t.archivio||[],n=t.fabbisogno||[];je=t.fabbisognoRaw||[],Q=new Set;{let P=new Set;Ut=[];for(let I of je){if(!I||!I.ordine||String(I.archiviato||"").toUpperCase()==="TRUE"||Qo(I.stato))continue;let T=String(I.ordine).trim();!T||P.has(T)||(P.add(T),Ut.push({ordine:T,cliente:String(I.cliente||"").trim()}))}Ut.sort((I,T)=>I.ordine.localeCompare(T.ordine,"it"))}let a=(h?.nome||"").toUpperCase().trim(),s=P=>{let I={};return P.forEach(T=>{I[T.ORDINE]||(I[T.ORDINE]=[]),I[T.ORDINE].push(T)}),I},r=s(o),c=s(i),l=(()=>{if(Nr())return()=>!0;let P=yt(h?.nome||"").toUpperCase();return I=>I.some(T=>{if(yt(T.DA||"").toUpperCase()===P)return!0;var B=String(T.A||"");return B.split(",").some(function(Y){return yt(Y.trim()).toUpperCase()===P})})})(),d=P=>{let I={};return Object.keys(P).forEach(T=>{l(P[T])&&(I[T]=P[T])}),I},u=d(r),f=d(c),p={},m={},b={};Object.keys(u).forEach(P=>{let T=u[P].filter(B=>(B.TIPO||"").toUpperCase()!=="SCADENZA");T.length>0&&((T[0].TIPO||"MSG").toUpperCase()==="ASSEGNAZIONE"?p[P]=T:m[P]=T)}),Object.keys(r).forEach(P=>{let I=r[P].filter(T=>(T.TIPO||"").toUpperCase()==="SCADENZA");I.length>0&&(b[P+"_scad"]=I)});let w=localStorage.getItem("_rg_assegnazioni")!=="0",v=localStorage.getItem("_rg_richieste")!=="0",E=localStorage.getItem("_rg_scadenze")!=="0",C=localStorage.getItem("_rg_fabbisogno_produzione")!=="0",_=Object.keys(p).length,$=Object.keys(m).length,k=Object.values(b).reduce((P,I)=>P+I.length,0),R=n.length,O=(P,I)=>{let T="";return Object.keys(P).reverse().forEach(B=>{T+=Vo(P[B],I,!1)}),T||'<div class="empty-msg" style="margin:16px 0 8px">Nessun elemento.</div>'},q=()=>{let P=Object.values(b).flat();return P.sort((I,T)=>{let B=Jo(I),Y=Jo(T);return!B&&!Y?0:B?Y?B-Y:-1:1}),P.map(I=>Hn(I,a)).join("")||'<div class="empty-msg" style="margin:16px 0 8px">Nessuna scadenza.</div>'},j=P=>!P||!P.length?Q.size===0?`<div class="fabprod-empty-sel">
                    ...
                    </div>`:'<div class="empty-msg" style="margin:16px 0 8px">Nessun articolo attivo per gli ordini selezionati.</div>':(window._fabprodCurrentRows=P,P.map((I,T)=>{let B=I.ordini.map(st=>{let L=st.ordine.replace(/\\/g,"\\\\").replace(/'/g,"\\'"),J=(st.cliente||"").replace(/\\/g,"\\\\").replace(/'/g,"\\'");return`<span class="fabprod-order-pill fabprod-order-pill--click" onclick="event.stopPropagation();_fabprodApriModalOrdine('${L}','${J}')">ORD. ${st.ordine}${st.cliente?`<span class="fabprod-pill-cliente"> \xB7 ${st.cliente}</span>`:""}</span>`}).join(""),Y=I.ordini.length>1?`<div class="fabprod-qty-breakdown">${I.ordini.map(st=>`${_t(st.qty)}\xA0(${st.ordine})`).join(" + ")}</div>`:"";return`
        ...
        <div class="req-card${o?" archiviata":""}${r?" sollecitata":""}" data-id-riga="${String(i.id_riga||"")}" data-ordine="${String(a||"")}" data-cliente="${(s||"").toLowerCase().replace(/"/g,"")}" data-riferimento="${(i.RIFERIMENTO||"").toLowerCase().replace(/"/g,"")}">
            ...
            <div id="rc-body-${i.id_riga}" class="rc-body">
                ${t.map(b=>{let w=String(b.DA).toUpperCase().trim()===e,v=String(b.MESSAGGIO||"").includes("|")?b.MESSAGGIO.split("|")[1]:b.MESSAGGIO,E=b["DATA ORA"]?Je(b["DATA ORA"]):"";return`
                        <div class="chat-bubble-wrapper ${w?"sent":"received"}">
                            <div class="chat-bubble">
                                <div class="chat-bubble-name">${yt(b.DA)}</div>
    ...
    </div>`}function jn(){window.chiudiModal=Zo,window.confermaInvioSupporto=Hr,window.setTipoAzione=Wo,window.chiudiModalSollecito=Ln,window.confermaInvioSollecito=Dr,window.apriNuovaRichiesta=Pn,window.apriModalAiuto=Br,window.apriModalSollecito=qr,window.toggleAreaRisposta=zn,window.toggleBoxArchivia=jr,window.inviaRisposta=Gr,window._selezionaOrdine=Fr,window.aggiornaBadgeRichieste=Ge,window.aggiornaBadgeSidebar=Ge,window.caricaRichieste=Ot,window._fetchDatiRichieste=ne,window._renderDatiRichieste=Ae,window._saveReqGroup=Mn,window._fabprodCardClick=Wr,window._fabprodApriModalOrdine=Jr,window._fabprodApriModalArticolo=Nn,window._fabprodVaiOrdine=Vr,window._aggiornaPannelloFabbisogno=Ft,window._apriModalFabbisognoSel=ic,window._applicaSelFabbisogno=nc,window._chiudiModalFabbisognoSel=Yo,window._fabprodDaScadenzeTutte=ac,window._fabprodDaScadenzeFlaggate=sc,window._fabprodStampaFabbisognoSel=Yr,window._fabprodSalvaSnapshotCondiviso=Xr,window._fabprodApriArchivioSnapshot=tc,window._fabprodChiudiArchivioSnapshot=Ko,window._fabprodApriSnapshotById=ec,window._fabprodArchiviaSnapshotById=oc,window._notificaFabbisognoNuovo=Qr,window.aggiornaRichiesta=Un,window._sollecitaConferma=pc,window._archiviaConferma=uc,window.sollecitaRichiesta=Fn,window.cambiaVistaUtente=cc,window._toggleRcBody=mc,window.formattaData=Je,window.generaCardRichiesta=Vo,window.generaCardScadenza=Hn,window._getScadDate=Jo}function Gn(){let t=document.getElementById("btn-nuova-richiesta");t&&t.addEventListener("click",function(o){o.stopPropagation(),Pn()});let e=document.getElementById("modalAiuto");e&&e.addEventListener("click",function(o){o.target===this&&(Date.now()-(this._openedAt||0)<800||Zo())}),document.addEventListener("click",function(o){o.target.closest(".req-card")||document.querySelectorAll(".box-risposta, .box-conferma").forEach(function(i){i.style.display!=="none"&&i.style.display!==""&&(i.style.opacity="0",i.style.transform="translateY(-10px)",setTimeout(function(){i.style.display="none"},300))})})}var He,Q,je,Ut,ie,ee,oe,Rn,yt,Vn=W(()=>{ft();zt();vt();_e();gt();Kt();Qt();It();He=[],Q=new Set,je=[],Ut=[],ie=null,ee="",oe=[],Rn=null,yt=t=>window._normNome?window._normNome(t):t&&String(t).trim()});async function Jn(){return ct({azione:"getManuali"},1e4,{retries:2})}async function Wn(t){return ct({azione:"salvaManualeNuovo",...t},18e4,{noDedupe:!0})}async function Zn(t){return ct({azione:"aggiornaManuale",...t},18e4,{noDedupe:!0})}async function Qn(t){return ct({azione:"getStoricoManuale",id:t},1e4,{retries:2})}var Kn=W(()=>{"use strict";_e()});function Xe(t){if(!t)return"-";let e=new Date(t);return Number.isNaN(e.getTime())?String(t):e.toLocaleString("it-IT",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"})}function et(t){let e=String(t||"").trim();return e&&(/^data:image\/(png|jpe?g|webp|gif);base64,[a-z0-9+/=\s]+$/i.test(e)||/^https?:\/\/[^\s]+$/i.test(e))?e:""}function to(t){return t&&t.sections&&t.sections._v===2?t.sections:null}function Ye(t,e,o){if(t){let i=o?`<button type="button" onclick="${o}" title="Rimuovi foto" style="position:absolute;top:-7px;right:-7px;background:#ef4444;border:none;color:#fff;width:22px;height:22px;border-radius:50%;font-size:1.1rem;line-height:1;cursor:pointer;display:flex;align-items:center;justify-content:center;box-shadow:0 1px 4px rgba(0,0,0,.3)">&times;</button>`:"";return`<div class="foto-wrapper" style="position:relative;display:inline-block;max-width:100%;margin-bottom:6px"><img src="${t}" alt="${e}" style="max-width:100%;max-height:180px;border-radius:10px;border:1px solid #e2e8f0;display:block">${i}</div>`}return'<div class="text-xs text-slate-400" style="margin-bottom:6px">Nessuna foto</div>'}function Ce(t){return`
    ...
    </article>`}function Xn(){let t=document.getElementById("contenitore-dati");if(!t)return;let e=se.map(hc).join(""),o=h?.nome?.toUpperCase().trim()==="ALESSIO";t.innerHTML=`
    ...
    </div>`}function re(t){return`<button type="button" class="manuali-modal-close" onclick="${t}" aria-label="Chiudi" title="Chiudi"><i class="fas fa-times"></i></button>`}function ni(t,e){let o=document.getElementById("manuali-modal-host");if(!o)return;let i=to(e),n=i?i.schedaTecnica||[]:[],a=i?i.occorrente||[]:[],s=i?i.procedimenti||[]:Array.isArray(e?.steps)?e.steps.map(function(v){return{descrizione:v.descrizione||v.titolo||"",foto:v.foto||""}}):[],r=i&&i.disegnoTecnico?.foto||"",c={},l=[];n.forEach(function(v){Yn.includes(v.voce)?c[v.voce]=v.valore:l.push(v)});let d=0,u=Yn.map(function(v){return bc(v,c[v]||"",d++)}).join("")+l.map(function(v){return ta(v.voce,v.valore,d++)}).join(""),f=a.length>0?a.map(function(v,E){return oi(v,E)}).join(""):oi(null,0),p=s.length>0?s.map(function(v,E){return ii(v,E)}).join(""):ii(null,0),m=et(e?.copertina||""),b=m?`<img id="manuali-copertina-preview" src="${m}" alt="copertina" style="max-width:100%;max-height:200px;border-radius:10px;border:1px solid #e2e8f0;display:block;margin-bottom:6px">`:'<div id="manuali-copertina-preview" class="text-xs text-slate-400" style="margin-bottom:6px">Nessuna copertina</div>',w=(v,E)=>`<h3 style="font-weight:700;font-size:.8rem;text-transform:uppercase;letter-spacing:.05em;color:#64748b;margin-bottom:10px;padding-bottom:6px;border-bottom:2px solid #e2e8f0"><i class="${v}"></i> &nbsp;${E}</h3>`;o.innerHTML=`
...
<body>
    ...
    <div class="man-print-stage">
        ...
        <section class="man-print-page man-break">
            ...
            </div>`}).join("");l&&(r+=a("fas fa-boxes-stacked","Materiale Occorrente")+`<div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(180px,1fr));gap:10px">${l}</div>`);let d=(s.procedimenti||[]).map(function(f,p){let m=et(f.foto||""),b=et(f.foto2||""),w=[m,b].filter(Boolean),v=w.length?`<div style="display:grid;grid-template-columns:repeat(${w.length},1fr);gap:6px;margin-bottom:6px">${w.map(E=>`<img src="${E}" style="width:100%;border-radius:10px;border:1px solid #e2e8f0">`).join("")}</div>`:"";return`<details class="border border-slate-200 rounded-xl p-3 bg-white" ${p===0?"open":""}>
...
</html>`,i=new Blob([o],{type:"text/html; charset=utf-8"}),n=URL.createObjectURL(i);window.open(n,"_blank","width=900,height=700")?setTimeout(()=>URL.revokeObjectURL(n),3e4):(URL.revokeObjectURL(n),g("\u26A0\uFE0F Abilita i popup per la stampa.","error"))}var K,ui,Mt,Te,ao,ut,ke,pi,Ta=W(()=>{ft();zt();gt();It();K=[],ui={};Mt=null,Te=null,ao=null,ut=null,ke=null;pi=!1});function Ra(t){return window.hashSHA256(t)}function ka(){return h?.nome?"avatarColorRecenti_"+h.nome.toUpperCase().trim():null}function La(){return h?.nome?"avatarColorHidden_"+h.nome.toUpperCase().trim():null}function $t(){let t=ka();if(!t)return[];try{return JSON.parse(localStorage.getItem(t)||"[]")}catch{return[]}}function le(t){let e=ka();if(e)try{localStorage.setItem(e,JSON.stringify(t.slice(0,7)))}catch{}}function Pa(){let t=La();if(!t)return[];try{return JSON.parse(localStorage.getItem(t)||"[]")}catch{return[]}}function za(t){let e=La();if(e)try{localStorage.setItem(e,JSON.stringify(t))}catch{}}function bi(){let t=document.getElementById("avatar-predefined-swatches");if(!t)return;let e=Pa();t.innerHTML="",(window._PREDEFINED_AVATAR_COLORS||[]).forEach(o=>{if(e.includes(o))return;let i=document.createElement("button");i.className="avatar-color-swatch",i.style.background=o,i.dataset.color=o,i.title="Clicca per applicare o eliminare",i.onclick=n=>{n.stopPropagation(),gl(o,n)},t.appendChild(i)})}function Vt(){let t=["avatar-custom-swatches","avatar-custom-swatches-mob"],e=$t();t.forEach(o=>{let i=document.getElementById(o);if(!i)return;let n=o.endsWith("-mob");i.innerHTML="",e.forEach((a,s)=>{let r=document.createElement("button");r.className="avatar-color-swatch avatar-color-custom-swatch",r.style.background=a,r.dataset.color=a,r.title="Clicca per modificare o eliminare",r.onclick=n?c=>{c.stopPropagation(),Sl(s,c)}:c=>{c.stopPropagation(),fl(s,c)},i.appendChild(r)})})}function yi(t,e){let o=document.getElementById("avatar-color-editor"),i=document.getElementById("avatar-color-edit-input"),n=document.getElementById("avatar-editor-delete");!o||!i||(i.value=t||"#ff0000",n&&(n.style.display=e?"":"none"),o.style.display="flex")}function wi(){let t=document.getElementById("avatar-color-editor");t&&(t.style.display="none"),H=null}function ml(t){t&&t.stopPropagation(),H=null,yi("#ff0000",!1)}function fl(t,e){e&&e.stopPropagation();let o=$t();H={type:"custom",idx:t},yi(o[t]||"#ff0000",!0)}function gl(t,e){e&&e.stopPropagation(),H={type:"predefined",color:t},yi(t,!0)}function vl(t){t&&t.stopPropagation();let e=document.getElementById("avatar-color-edit-input");if(!e)return;let o=e.value;if(H===null){let i=$t();i.unshift(o),le(i),Vt()}else if(H.type==="custom"){let i=$t();i[H.idx]=o,le(i),Vt()}wi(),_i(o)}function hl(t){t&&t.stopPropagation(),wi()}function bl(t){if(t&&t.stopPropagation(),!!H){if(H.type==="custom"){let e=$t();e.splice(H.idx,1),le(e),Vt()}else if(H.type==="predefined"){let e=Pa();e.includes(H.color)||e.push(H.color),za(e),bi()}wi()}}function yl(t){t&&t.stopPropagation(),za([]),bi()}function Ma(t,e){let o=document.getElementById("avatar-color-editor-mob"),i=document.getElementById("avatar-color-edit-input-mob"),n=document.getElementById("avatar-editor-delete-mob");!o||!i||(i.value=t||"#ff0000",n&&(n.style.display=e?"":"none"),o.style.display="flex")}function Si(){let t=document.getElementById("avatar-color-editor-mob");t&&(t.style.display="none"),H=null}function wl(t){t&&t.stopPropagation(),H=null,Ma("#ff0000",!1)}function Sl(t,e){e&&e.stopPropagation();let o=$t();H={type:"custom",idx:t},Ma(o[t]||"#ff0000",!0)}function _l(t){t&&t.stopPropagation();let e=document.getElementById("avatar-color-edit-input-mob");if(!e)return;let o=e.value;if(H===null){let i=$t();i.unshift(o),le(i),Vt()}else if(H.type==="custom"){let i=$t();i[H.idx]=o,le(i),Vt()}Si(),_i(o)}function El(t){t&&t.stopPropagation(),Si()}function xl(t){if(t&&t.stopPropagation(),!!H){if(H.type==="custom"){let e=$t();e.splice(H.idx,1),le(e),Vt()}Si()}}function Na(t){document.documentElement.style.setProperty("--avatar-user-color",t);let e=document.getElementById("user-avatar-btn"),o=document.getElementById("account-ddrop-avatar"),i=document.getElementById("user-avatar-btn-mobile"),n=document.getElementById("account-ddrop-avatar-mob");e&&(e.style.setProperty("background",t,"important"),e.style.setProperty("box-shadow",`0 2px 8px ${t}66`,"important")),i&&(i.style.setProperty("background",t,"important"),i.style.setProperty("box-shadow",`0 2px 8px ${t}66`,"important")),o&&o.style.setProperty("background",t,"important"),n&&n.style.setProperty("background",t,"important"),document.querySelectorAll(".avatar-color-swatch").forEach(a=>{a.classList.toggle("active",a.dataset.color===t)})}function _i(t){if(!h||!h.nome)return;let e=h.nome.toUpperCase().trim();try{localStorage.setItem("avatarColor_"+e,t)}catch{}window._avatarColorsCache&&(window._avatarColorsCache[e]=t),h.nome&&fetch(x,{method:"POST",body:JSON.stringify({azione:"setAvatarColor",username:h.nome,color:t})}).catch(()=>{}),Na(t)}function Il(t){t&&t.stopPropagation();let e=document.getElementById("account-dropdown");e&&e.classList.toggle("open")}function Al(){let t=document.getElementById("account-dropdown");t&&t.classList.remove("open")}function Cl(){U("_impostazioni_cache"),window.paginaAttuale&&(window.cacheContenuti&&delete window.cacheContenuti[window.paginaAttuale],U("_html_"+window.paginaAttuale)),window.location.reload()}function Ol(t){t&&t.stopPropagation();let e=document.getElementById("account-dropdown-mobile");e&&e.classList.toggle("open")}function $l(){let t=document.getElementById("account-dropdown-mobile");t&&t.classList.remove("open")}async function Tl(){try{let o=(await(await fetch(x,{method:"POST",body:JSON.stringify({azione:"pushInfo"})})).json().catch(()=>({}))).subscriptions||[];if(!o.length){g("Nessun dispositivo registrato in PUSH_SUBSCRIPTIONS","error");return}let i={};o.forEach(s=>{i[s.user]||(i[s.user]=0),i[s.user]++});let n=Object.entries(i).sort((s,r)=>s[0].localeCompare(r[0])).map(([s,r])=>`<tr><td style="padding:6px 10px;font-weight:600">${s}</td><td style="padding:6px 10px;text-align:center">${r} dispositivo${r>1?"i":""}</td></tr>`).join(""),a=`<div style="position:fixed;inset:0;background:rgba(0,0,0,.45);z-index:9999;display:flex;align-items:center;justify-content:center" onclick="this.remove()">
...
`)[0]||"",s=a.split(";").length>=a.split(",").length?";":",";i&&(i.style.display="block",i.innerHTML='<div style="display:flex;align-items:center;gap:8px;color:#64748b;font-size:0.88rem"><i class="fas fa-spinner fa-spin"></i> Import Lista di Carico in corso\u2026</div>');try{let c=await(await fetch(x,{method:"POST",body:JSON.stringify({azione:"importaListaDiCarico",csvText:n,separatore:s})})).json().catch(()=>({}));if(i)if(c.status==="ok"){let l=`<strong>\u2705 Import completato</strong><br>Nuovi: <strong>${c.nuove||0}</strong> \xB7 Aggiornati: <strong>${c.aggiornate||0}</strong> \xB7 Invariati: <strong>${c.invariate||0}</strong>`;c.corrette>0&&(l+=`<br><span style="color:#b45309"><i class="fas fa-exclamation-triangle"></i> ${c.corrette} righe corrette automaticamente (campi con separatore nel testo)</span>`),c.missingCount>0&&(l+=`<br><span style="color:#d97706">\u26A0 <strong>${c.missingCount}</strong> ordini non presenti nel CSV \u2014 vai nel tab Fornitori per archiviarli.</span>`),i.innerHTML=`<div style="background:#dcfce7;border:1px solid #86efac;border-radius:10px;padding:12px 16px;font-size:0.88rem;color:#166534">${l}</div>`,typeof window.invalidateOFCache=="function"&&window.invalidateOFCache()}else i.innerHTML=po(c.msg||c.message||"Errore sconosciuto")}catch(r){i&&(i.innerHTML=po(r.message))}t.value=""}async function Le(){let t="_impostazioni_cache",e="_impostazioni_stati_forn_cache",i=ht(t,1/0);if(i){try{let n=typeof i=="string"?JSON.parse(i):i;if(n.stati&&n.stati.length){window.listaStati=n.stati,window.listaOperatori=n.operatori||[],window._distintaHeaderAzienda=String(n.distintaHeaderAzienda||""),qa(n.overviewStati);let a=ht(e,1/0);if(a)try{let s=typeof a=="string"?JSON.parse(a):a;Array.isArray(s)&&s.length&&(window.listaStatiFornitori=s)}catch{}ht(t,3e5)||uo().catch(s=>console.warn("[impostazioni] bg refresh:",s));return}}catch(n){console.warn("[impostazioni] cache JSON corrotta, ricarico dal server:",n)}U(t)}await uo()}async function uo(){let t="_impostazioni_cache",e="_impostazioni_stati_forn_cache";try{let i=await(await fetch(x,{method:"POST",body:JSON.stringify({azione:"getImpostazioni",noCache:!0})})).json();window.listaStati=i.stati&&i.stati.length?i.stati:window._defaultListaStati_(),window.listaOperatori=i.operatori||[],window._distintaHeaderAzienda=String(i.distintaHeaderAzienda||""),qa(i.overviewStati),Z(t,JSON.stringify({stati:window.listaStati,operatori:window.listaOperatori,overviewStati:i.overviewStati,distintaHeaderAzienda:window._distintaHeaderAzienda}))}catch(o){console.warn("[Boot] _fetchImpostazioniDaServer:",o),g("Impostazioni non aggiornate \u2014 uso dati locali.","warning")}try{let i=await(await fetch(x,{method:"POST",body:JSON.stringify({azione:"getStatiFornitoriConfig"})})).json();i.stati&&i.stati.length&&(window.listaStatiFornitori=i.stati,Z(e,JSON.stringify(i.stati)))}catch{}}function qa(t){t&&(Array.isArray(t.art)&&t.art.length&&(window._ovStatiArt=t.art.map(e=>e.toUpperCase().trim())),Array.isArray(t.ord)&&t.ord.length&&(window._ovStatiOrd=t.ord.map(e=>e.toUpperCase().trim())))}function Dl(t,e){let o=document.getElementById(t);if(!o)return;let i=e.querySelector(".settings-row-arrow"),n=o.style.display==="block";o.style.display=n?"none":"block",i&&(i.style.transform=n?"":"rotate(180deg)"),e.classList.toggle("settings-row-active",!n),!n&&(t==="section-utenti"||t==="section-team-utenti")&&Pe(),!n&&t==="section-qr-postazioni"&&requestAnimationFrame(()=>vi())}async function Pe(){let t=document.getElementById("lista-utenti-config");if(t){t.innerHTML='<div class="centered-msg small">Caricamento...</div>';try{let o=await(await fetch(x,{method:"POST",body:JSON.stringify({azione:"getUtenti"})})).json();if(!o.length){t.innerHTML='<p class="centered-msg small">Nessun utente creato. Clicca "+ Aggiungi Utente".</p>';return}t.innerHTML=o.map(i=>{let n=i.id_riga,a=(i.username||"").trim(),s=(i.email||"").trim(),r=(i.ruolo||"OPERATORE").trim().toUpperCase(),c=Number(i.max_utenti)||1;return`
    ...
    <div class="item-card ${i.card}${l}" data-id-riga="${t.id_riga}" data-codice="${s.toLowerCase().replace(/"/g,"")}">
        ...
        ${(()=>{let p=fo(t.data_ordine),m=fo(t.data_consegna);if(!p&&!m)return"";let b=p?Ai(p):"\u2014",w=m?`<span style="${Fa(m)}">${Ai(m)}</span>`:"\u2014";return`<div class="card-date-row"><span class="label-sm ${i.label}" style="margin-bottom:1px">Date</span><span class="card-date-vals"><span class="card-date-item"><i class="fas fa-file-signature" style="color:#94a3b8;font-size:.7rem;margin-right:3px"></i><span class="card-date-lbl">Ord.</span> ${b}</span><span class="card-date-sep">\xB7</span><span class="card-date-item"><i class="fas fa-truck" style="color:#94a3b8;font-size:.7rem;margin-right:3px"></i><span class="card-date-lbl">Cons.</span> ${w}</span></span></div>`})()}
        <div class="qty-cell">
    ...
    </div>`}var Ci=W(()=>{mo();gt();vt()});function Nt(){let t=pe(),e=(S.attiviProd||[]).filter(n=>t.includes((n.stato||"").toUpperCase().trim())).length,o=document.querySelector("#ov-accordion .ov-summary-meta");o&&(o.textContent=`${e} art. in lavorazione`);let i=document.getElementById("ov-content");if(i){if(i.querySelector(".ov-lazy-placeholder")){let n=document.getElementById("ov-accordion");if(!n||!n.open)return;i.innerHTML=ue(S.attiviProd),requestAnimationFrame(Tt);return}i.innerHTML=ue(S.attiviProd),requestAnimationFrame(Tt)}}function Ha(t){if(!t.parentElement.open){let o=document.getElementById("ov-content");o&&o.querySelector(".ov-lazy-placeholder")&&(o.innerHTML=ue(S.attiviProd),requestAnimationFrame(Tt))}}function ja(t){let e=document.getElementById(t);if(!e)return;let o=e.querySelector(".sezione-archiviata"),i=S.datiArchLazy||S.ultimiDatiProduzione&&S.ultimiDatiProduzione.archivio;if(o&&i&&(S.datiArchLazy||!o.children.length)){let a=Wt(i,!0)||"<div class='empty-msg'>L'archivio \xE8 vuoto.</div>";o.innerHTML=a,window.aggiornaListaFiltrabili?.(),F.ARCHIVIO_ORDINI||(F.ARCHIVIO_ORDINI=a,X.ARCHIVIO_ORDINI=Date.now(),Z("_html_ARCHIVIO_ORDINI",a)),S.datiArchLazy=null}e.open=!0,requestAnimationFrame(()=>{e.querySelector("summary")?.scrollIntoView({behavior:"smooth",block:"start"})})}function Oi(t){let e=(t||[]).filter(p=>!wt(p.stato)),o=["Riccardo","Fabio T.","Niccol\xF2","Alessio"],i=new Map;o.forEach(p=>i.set(p,[]));let n=new Map;o.forEach(p=>n.set(p,new Set));function a(p){let m=window._normNome(p);return o.find(b=>b===m||b.toUpperCase()===String(p).trim().toUpperCase())}e.forEach(p=>{if(!p.assegna||p.assegna===""||p.assegna==="undefined")return;let m=String(p.ordine||"").trim();m&&p.assegna.split(",").forEach(b=>{let w=b.trim();if(!w)return;let v=a(w);v&&!n.get(v).has(m)&&(n.get(v).add(m),i.get(v).push(p))})});let s={};(window.listaStati||[]).forEach(p=>{s[p.nome.toUpperCase()]=p.colore});function r(p){let m=String(p.cliente||"").trim().toUpperCase();if(!m||m==="DA DEFINIRE"){let w=String(p.riferimento||"").trim();return w||""}let b=p.cliente.trim().split(/\s+/).slice(0,2).join(" ");return b.length>14?b.substring(0,13)+"\u2026":b}let c=o.map(p=>{let m=i.get(p)||[],b=window._getOpColor(p),w=m.length===0?'<div class="ov-op-item ov-op-item-free"><span class="ov-op-item-cod" style="color:#475569">Libero</span></div>':m.map(v=>{let E=(v.stato||"IN ATTESA").toUpperCase().trim(),C=s[E]||"#94a3b8",_=String(v.ordine||"").trim(),$=r(v),k=_.length>10?_.substring(0,9)+"\u2026":_;return`<div class="ov-op-item">
