import{a as Vi,c as Pt,e as Ui,f as r,g as y,h as zt,l as Fi,m as Q,q as Ji,r as lt,u as Gi}from"./chunk-chunk-55SFP7PR.js";function $t(t){let i=Array.isArray(t)?{kits:t}:t&&typeof t=="object"?t:{},n=i.orderDrafts,e=n&&typeof n=="object"&&!Array.isArray(n)?n:{};return{kits:Array.isArray(i.kits)?i.kits.map(Ft):[],anagrafiche:Array.isArray(i.anagrafiche)?i.anagrafiche:[],distinte:Array.isArray(i.distinte)?i.distinte:[],presets:Array.isArray(i.presets)?i.presets:[],orderDrafts:e,draftDocSeq:Math.max(0,Number.parseInt(i.draftDocSeq,10)||0),ts:Number(i.ts||0)||0}}function Nt(){return{kits:x.kits,anagrafiche:x.anagrafiche,distinte:x.distinte,presets:x.presets,orderDrafts:x.orderDrafts,draftDocSeq:x.draftDocSeq}}function ri(t){let i=$t(t||{});return!!(i.kits&&i.kits.length||i.anagrafiche&&i.anagrafiche.length||i.distinte&&i.distinte.length||i.presets&&i.presets.length||i.orderDrafts&&Object.keys(i.orderDrafts).length||i.draftDocSeq>0)}function Yi(){try{let t=localStorage.getItem("_mlKitData"),i=t?JSON.parse(t):{},n=Array.isArray(i)?i:Array.isArray(i?.kits)?i.kits:[],e=JSON.parse(localStorage.getItem("_mlKitAnagrafiche")||"[]"),o=JSON.parse(localStorage.getItem("_mlKitDistinte")||"[]"),s=JSON.parse(localStorage.getItem("_mlKitPresetSections")||"[]"),a=JSON.parse(localStorage.getItem("_mlKitOrderDrafts")||"{}"),c=Number.parseInt(localStorage.getItem("_mlKitOrderDraftSeq")||"0",10)||0;return{kits:Array.isArray(n)?n:[],anagrafiche:Array.isArray(e)?e:[],distinte:Array.isArray(o)?o:[],presets:Array.isArray(s)?s:[],orderDrafts:a&&typeof a=="object"&&!Array.isArray(a)?a:{},draftDocSeq:c}}catch{return $t({})}}function Zi(){["_mlKitData","_mlKitDataTs","_mlKitOrderDrafts","_mlKitOrderDraftSeq","_mlKitPresetSections","_mlKitDistinte","_mlKitDistinteTs","_mlKitAnagrafiche","_mlKitAnagraficheTs"].forEach(function(i){try{localStorage.removeItem(i)}catch{}})}function Lo(){Rt=!1}function W(t,i){return String(t||"").trim().toLowerCase().replace(/\s+/g,"_").replace(/[^a-z0-9_-]/g,"")||i}function X(t){let i=String(t??"").trim().replace(",","."),n=Number.parseFloat(i);return Number.isFinite(n)?Math.max(0,n):0}function G(t){let i=Number(t);if(!Number.isFinite(i))return"0";let n=Math.round(i*1e3)/1e3;return Math.abs(n-Math.round(n))<1e-9?String(Math.round(n)):n.toLocaleString("it-IT",{minimumFractionDigits:0,maximumFractionDigits:3})}function St(t,i="pz"){return String(t||i).trim().toLowerCase()||i}function Xi(t,i){let n="opz"+(i+1),e=W(t?.key,n);return{id:String(t?.id||C()),key:e,nome:String(t?.nome||e).trim()||e,codice:String(t?.codice||"").trim()}}function te(t,i){let n="asse"+(i+1),e=W(t?.key,n),o=Array.isArray(t?.opzioni)?t.opzioni.map((s,a)=>Xi(s,a)).filter(Boolean):[];return{id:String(t?.id||C()),key:e,nome:String(t?.nome||e).trim()||e,opzioni:o}}function di(t){return t.length===1?t[0].opzioneKey:t.map(function(i){return i.asseKey+"="+i.opzioneKey}).join("|")}function ie(t){return t.length===1?t[0].opzioneNome:t.map(function(i){return i.asseNome+": "+i.opzioneNome}).join(" \xB7 ")}function li(t){if(!Array.isArray(t)||!t.length)return[];let i=t.filter(e=>Array.isArray(e.opzioni)&&e.opzioni.length);if(!i.length)return[];let n=[{selections:[]}];for(let e of i){let o=[];for(let s of n)for(let a of e.opzioni)o.push({selections:s.selections.concat({asseId:e.id,asseKey:e.key,asseNome:e.nome,opzioneId:a.id,opzioneKey:a.key,opzioneNome:a.nome,opzioneCodice:String(a.codice||"").trim()})});n=o}return n.map(function(e,o){return{id:"combo-"+(o+1),key:di(e.selections),nome:ie(e.selections),selections:e.selections}})}function ee(t){let i=String(t?.modoComponente||"quantificato").trim()||"quantificato",n=i==="segnalazione"?!1:t?.tracciabile!==void 0?!!t.tracciabile:!0,e=i==="segnalazione"?"flag":"pz";return{id:String(t?.id||C()),nome:String(t?.nome||"Nuovo componente").trim()||"Nuovo componente",codice:String(t?.codice||"").trim(),qtaPerVariante:{...t?.qtaPerVariante||{}},caricato:Number(t?.caricato||0),modoComponente:i,tracciabile:n,noteConfig:String(t?.noteConfig||"").trim(),unitaMisura:St(t?.unitaMisura,e),applicazioneTipo:String(t?.applicazioneTipo||"").trim(),applicazioneAsseId:String(t?.applicazioneAsseId||"").trim(),applicazioneOpzioneIds:Array.isArray(t?.applicazioneOpzioneIds)?t.applicazioneOpzioneIds.map(String):[],qtaBase:X(t?.qtaBase)}}function ne(t){return{id:String(t?.id||C()),nome:String(t?.nome||"Nuova sezione").trim()||"Nuova sezione",componenti:Array.isArray(t?.componenti)?t.componenti.map(ee):[]}}function oe(t,i){if(t.size!==i.size)return!1;for(let n of t)if(!i.has(n))return!1;return!0}function pi(t,i){let n={tipo:"sempre",asseId:"",opzioneIds:[],qtyBase:X(t?.qtaBase)};if(t?.applicazioneTipo==="sempre"||t?.applicazioneTipo==="gruppo")return{tipo:t.applicazioneTipo,asseId:String(t.applicazioneAsseId||""),opzioneIds:Array.isArray(t.applicazioneOpzioneIds)?t.applicazioneOpzioneIds.map(String):[],qtyBase:n.qtyBase||X(Object.values(t?.qtaPerVariante||{})[0])};let e=E(i);if(!e.length)return n;let o=e.filter(d=>H(t,d.key)>0);if(!o.length)return n;let s=new Set(o.map(d=>H(t,d.key)));if(s.size!==1)return{tipo:"manuale",asseId:"",opzioneIds:[],qtyBase:Math.max(...o.map(d=>H(t,d.key)))};let a=[...s][0];if(o.length===e.length)return{tipo:"sempre",asseId:"",opzioneIds:[],qtyBase:a};let c=new Set(o.map(d=>d.key));for(let d of i.assiConfigurazione||[]){let l=[];for(let p of d.opzioni||[]){let u=new Set(e.filter(b=>(b.selections||[]).some(f=>f.asseId===d.id&&f.opzioneId===p.id)).map(b=>b.key));if(!u.size)continue;[...u].every(b=>H(t,b)===a)&&l.push(p.id)}if(!l.length)continue;let m=new Set(e.filter(p=>(p.selections||[]).some(u=>u.asseId===d.id&&l.includes(u.opzioneId))).map(p=>p.key));if(oe(m,c))return{tipo:"gruppo",asseId:d.id,opzioneIds:l,qtyBase:a}}return{tipo:"manuale",asseId:"",opzioneIds:[],qtyBase:a}}function Vt(t,i,n){if(!n||n.tipo==="manuale")return{...t?.qtaPerVariante||{}};let e={},o=X(n.qtyBase);if(!o)return e;for(let s of E(i)){let a=n.tipo==="sempre";n.tipo==="gruppo"&&(a=(s.selections||[]).some(c=>c.asseId===n.asseId&&n.opzioneIds.includes(c.opzioneId))),a&&(e[s.key]=o)}return e}function se(t,i){let n=ne(t);return n.componenti=n.componenti.map(function(e){let o=pi(e,i);return{...e,applicazioneTipo:o.tipo,applicazioneAsseId:o.asseId,applicazioneOpzioneIds:o.opzioneIds,qtaBase:o.qtyBase,qtaPerVariante:Vt(e,i,o)}}),n}function ae(t,i){let n=E(i);if(!n.length)return null;let e=null;for(let o of n){let s=H(t,o.key);if(e===null){e=s;continue}if(e!==s)return null}return e}function re(t,i,n){let e=E(n),o={},s=ae(t,i);if(!e.length)Object.assign(o,t?.qtaPerVariante||{});else for(let a of e){let d=Object.prototype.hasOwnProperty.call(t?.qtaPerVariante||{},a.key)?H(t,a.key):s!==null?s:0;d>0&&(o[a.key]=d)}return{id:C(),nome:String(t?.nome||"Nuovo componente").trim()||"Nuovo componente",qtaPerVariante:o,caricato:0,modoComponente:t?.modoComponente==="segnalazione"?"segnalazione":"quantificato",tracciabile:Jt(t),noteConfig:String(t?.noteConfig||"").trim(),unitaMisura:St(t?.unitaMisura,j(t)?"flag":"pz")}}function At(t,i,n){return{id:C(),nome:String(t?.nome||"Nuova sezione").trim()||"Nuova sezione",componenti:Array.isArray(t?.componenti)?t.componenti.map(e=>re(e,i,n)):[]}}function mi(t,i,n){let e=new Set((n.assiConfigurazione||[]).map(d=>d.key)),o=W(t?.key||String(t?.nome||"asse"),"asse1"),s=o,a=1;for(;e.has(s);)s=o+"_c"+a++;let c=[];for(let d=0;d<(t.opzioni||[]).length;d++){let l=t.opzioni[d],m="opz"+(d+1),p=W(l?.key,m),u=1;for(;c.some(g=>g.key===p);)p=p+"_c"+u++;c.push({id:C(),key:p,nome:String(l?.nome||"").trim()||p,codice:String(l?.codice||"").trim()})}return{id:C(),key:s,nome:String(t?.nome||"").trim()||s,opzioni:c}}function Ut(t,i){return(t?.sezioni||[]).find(n=>n.id===i)||null}function Ct(t,i){let n=new Set(E(t).map(s=>s.key)),e=E(i),o=e.filter(s=>n.has(s.key)).length;return{targetCount:e.length,exactMatches:o,hasTargetVarianti:e.length>0,needsReview:e.length===0||o<e.length}}function Mt(t,i){let n=String(i||"").trim().toLowerCase();return n?String(t||"").toLowerCase().includes(n):!0}function ce(t,i){return{id:String(t?.id||C()),nome:String(t?.nome||"").trim(),varianteKey:String(t?.varianteKey||i||"").trim(),noteConfig:String(t?.noteConfig||"").trim()}}function Ft(t){let i=t&&typeof t=="object"?t:{},n=Array.isArray(i.varianti)?i.varianti.map(function(p,u){let g="v"+(u+1),b=W(p?.key,g);return{id:String(p?.id||C()),key:b,nome:String(p?.nome||b).trim()||b}}):[],e=Array.isArray(i.assiConfigurazione)?i.assiConfigurazione.map((p,u)=>te(p,u)):[],o=e.length?e:n.length?[{id:"asse-legacy-"+String(i.id||"kit"),key:"configurazione",nome:"Configurazione",opzioni:n.map(function(p){return{id:p.id,key:p.key,nome:p.nome}})}]:[],s=li(o),a=s.length?s:n,c=new Set(a.map(p=>p.key)),d={};Object.entries(i.qtaDaProdurre||{}).forEach(function(p){c.has(p[0])&&(d[p[0]]=Math.max(0,Number.parseInt(p[1],10)||0))});for(let p of a)d[p.key]===void 0&&(d[p.key]=0);let l=Array.isArray(i.sottoAssembly)?i.sottoAssembly.map(p=>ce(p,a[0]?.key||"")).filter(p=>!p.varianteKey||c.has(p.varianteKey)):[],m={};return Object.entries(i.pronti||{}).forEach(function(p){m[p[0]]=Math.max(0,Number.parseInt(p[1],10)||0)}),{id:String(i.id||C()),nome:String(i.nome||"Nuovo Kit").trim()||"Nuovo Kit",schemaVersion:Qt,assiConfigurazione:o,varianti:a,sezioni:Array.isArray(i.sezioni)?i.sezioni.map(p=>se(p,{assiConfigurazione:o,varianti:a})):[],sottoAssembly:l,qtaDaProdurre:d,pronti:m,movimenti:Array.isArray(i.movimenti)?i.movimenti.slice():[]}}function E(t){return Array.isArray(t?.varianti)?t.varianti:[]}function j(t){return!!t&&t.modoComponente==="segnalazione"}function Jt(t){return!!t&&t.tracciabile!==!1&&!j(t)}function H(t,i){let n=X(t?.qtaPerVariante?.[i]);return j(t)?n>0?1:0:n}function Gt(t,i){return pi(t,i)}function gt(){let t=x.orderDrafts;return t&&typeof t=="object"?JSON.parse(JSON.stringify(t)):{}}function Ot(t){let i=t&&typeof t=="object"?t:{};x.orderDrafts=i,vt()}function kt(){return Array.isArray(x.presets)?JSON.parse(JSON.stringify(x.presets)):[]}function Wt(t){x.presets=Array.isArray(t)?t:[],vt()}function nt(){return Array.isArray(x.distinte)?JSON.parse(JSON.stringify(x.distinte)):[]}function xt(t){x.distinte=Array.isArray(t)?t:[],vt()}function ot(t){return String(t||"").trim().toUpperCase()}function it(t){let i=Array.isArray(t?.ordiniCliente)?[...new Set(t.ordiniCliente.map(ot).filter(Boolean))]:[];return{cliente:String(t?.cliente||"").trim(),ordiniCliente:i,documento:String(t?.documento||"").trim()}}function U(t){return it(t?._meta||{})}function It(t,i){return t._meta=it(i),t._meta}function rt(t,i){return Math.max(0,Number.parseInt(t?.[i],10)||0)}async function Et(){try{let n=await lt({azione:"reserveKitDraftSeq"}),e=Math.max(0,Number.parseInt(n?.draftDocSeq,10)||0);if(e>0&&(x.draftDocSeq=e),x.ts=Number(n?.ts||x.ts||Date.now())||Date.now(),n?.documento)return String(n.documento)}catch(n){console.warn("[kit-prodotti] reserveKitDraftSeq fallita, fallback locale:",n)}let i=Math.max(0,Number.parseInt(x.draftDocSeq,10)||0)+1;return x.draftDocSeq=i,vt(),`Distinta Base-${String(i).padStart(4,"0")}`}function ci(t){let i=new Set;return(Array.isArray(t)?t:[]).filter(n=>String(n?.archiviato||"").toUpperCase()!=="TRUE").map(n=>({ordine:ot(n?.ordine||""),cliente:String(n?.cliente||"").trim()})).filter(n=>!n.ordine||i.has(n.ordine)?!1:(i.add(n.ordine),!0))}function Yt(){return st.length?Promise.resolve(st):Array.isArray(window._attiviProd)&&window._attiviProd.length?(st=ci(window._attiviProd),Promise.resolve(st)):wt||(wt=fetch(Pt,{method:"POST",body:JSON.stringify({pagina:"PROGRAMMA PRODUZIONE DEL MESE"})}).then(t=>t.json()).then(t=>(st=ci(t),st)).catch(function(t){return console.warn("[kit-prodotti] autocomplete ordini non disponibile:",t),[]}).finally(function(){wt=null}),wt)}function de(t){let i=ot(t);return i&&st.find(n=>n.ordine===i)||null}function Bt(t,i={}){let n=[...new Set((Array.isArray(t)?t:[]).map(function(e){let o=ot(e);return o?i[o]?String(i[o]||"").trim():String(de(o)?.cliente||"").trim():""}).filter(Boolean))];return n.length===1?n[0]:""}function et(t){let i=gt(),n=i?.[t?.id]&&typeof i[t.id]=="object"?i[t.id]:{},e={};for(let o of E(t)){let s=n[o.key];e[o.key]=Math.max(0,Number.parseInt(s,10)||0)}return e._meta=it(n._meta||{}),e}function J(t,i){let{kits:n}=h(),e=n.find(m=>m.id===t);if(!e)return;let o=gt(),s=et(e);i(s,e);let a={},c=!1;for(let m of E(e)){let p=Math.max(0,Number.parseInt(s[m.key],10)||0);a[m.key]=p,p>0&&(c=!0)}let d=it(s._meta||{}),l=!!(d.cliente||d.ordiniCliente.length||d.documento);(c||l)&&(a._meta=d),c||l?o[t]=a:delete o[t],Ot(o),D===t&&K()}function le(t){return Object.entries(t||{}).reduce(function(i,n){return n[0]==="_meta"?i:i+(Number.parseInt(n[1],10)||0)},0)}function ui(t){return!(t.assiConfigurazione&&t.assiConfigurazione.length)}function ut(t){let i=gt(),n=i?.[t]&&typeof i[t]=="object"?i[t]:{};return{_meta:it(n._meta||{}),_units:Math.max(1,Number.parseInt(n._units,10)||1),_sel:n._sel&&typeof n._sel=="object"?{...n._sel}:{}}}function ct(t,i,n){let e=gt(),o=e?.[t]&&typeof e[t]=="object"?e[t]:{},s={_meta:it(o._meta||{}),_units:Math.max(1,Number.parseInt(o._units,10)||1),_sel:o._sel&&typeof o._sel=="object"?{...o._sel}:{}};i(s);let a=Object.keys(s._sel).length>0,c=s._units>1,d=it(s._meta||{}),l=!!(d.cliente||d.ordiniCliente.length||d.documento);a||c||l?e[t]={_meta:d,_units:s._units,_sel:s._sel}:delete e[t],Ot(e),n!==!1&&D===t&&K()}function pe(t,i){let n=Math.max(1,Number.parseInt(i,10)||1);try{window._kitSuppressNextFade=!0}catch{}ct(t,function(e){e._units=n})}function me(t,i,n){try{window._kitSuppressNextFade=!0}catch{}ct(t,function(e){n?e._sel[i]=!0:delete e._sel[i]})}function ue(t,i){let n=String(i||"").trim().toLowerCase(),e=document.getElementById("kit-ns-autocomplete-"+t);if(e){if(!n){e.style.display="none",e.innerHTML="";return}Yt().then(function(o){let s=o.filter(function(a){return a.ordine.toLowerCase().includes(n)||a.cliente.toLowerCase().includes(n)}).slice(0,8);if(!s.length){e.style.display="none",e.innerHTML="";return}e.innerHTML=s.map(function(a){return`<div class="autocomplete-item" onmousedown='_kitNSOrderPick(${JSON.stringify(t)},${JSON.stringify(a.ordine)},${JSON.stringify(a.cliente)})'>
                <span class="ac-ordine">ORD. ${r(a.ordine)}</span>
                <span class="ac-cliente">${r(a.cliente)}</span>
            </div>`}).join(""),e.style.display="block"})}}function fe(t){setTimeout(function(){let i=document.getElementById("kit-ns-autocomplete-"+t);i&&(i.style.display="none",i.innerHTML="")},140)}function ge(t,i,n){let e=ot(i);if(!e)return;try{window._kitSuppressNextFade=!0}catch{}ct(t,function(a){a._meta.ordiniCliente.includes(e)||a._meta.ordiniCliente.push(e),a._meta.cliente=Bt(a._meta.ordiniCliente,{[e]:n})});let o=document.getElementById("kit-ns-ref-input-"+t);o&&(o.value="");let s=document.getElementById("kit-ns-autocomplete-"+t);s&&(s.style.display="none",s.innerHTML="")}function ke(t,i){let n=ot(i);try{window._kitSuppressNextFade=!0}catch{}ct(t,function(e){e._meta.ordiniCliente=e._meta.ordiniCliente.filter(function(o){return o!==n}),e._meta.cliente=Bt(e._meta.ordiniCliente)})}function fi(t,i,n){try{window._kitSuppressNextFade=!0}catch{}ct(t,function(e){i.forEach(function(o){n?e._sel[o]=!0:delete e._sel[o]})})}function ve(t){try{let i=t.dataset.kitid,n=JSON.parse(t.dataset.compids);fi(i,n,t.checked)}catch(i){console.error("[kit] _kitNSToggleSectionChk error",i)}}function ye(t){if(!confirm("Azzerare la selezione corrente?"))return;let i=gt();delete i[t],Ot(i),K()}function Dt(t,i){let n=Math.max(1,Number.parseInt(i._units,10)||1),e=i._sel&&typeof i._sel=="object"?i._sel:{},o=[],s=[];for(let a of t.sezioni||[]){let c=[];for(let d of a.componenti||[]){if(!e[d.id])continue;let l=X(d.qtaBase!=null?d.qtaBase:1)*n;c.push({id:d.id,nome:d.nome,codice:String(d.codice||"").trim(),totale:l,unita:d.unitaMisura||"pz",dettaglio:"",noteConfig:d.noteConfig||""}),d.noteConfig&&s.push({id:"note-"+d.id,tipo:"nota",nome:d.nome,dettaglio:d.noteConfig,totaleCoinvolto:l,variantiLabel:""})}c.length&&o.push({id:a.id,nome:a.nome,righe:c})}return{selectedVarianti:[],sezioni:o,avvisi:s,totalePezzi:n,totaleRighe:o.reduce(function(a,c){return a+c.righe.length},0),_isNewStyle:!0}}async function be(t){let{kits:i}=h(),n=i.find(function(c){return c.id===t});if(!n)return;let e=ut(t),o=Dt(n,e);if(!o.totaleRighe){y("Seleziona almeno un componente per generare la distinta.","warning");return}if(!e._meta.documento){let c=await Et();ct(t,function(d){d._meta.documento=c},!1),e=ut(t)}let s={_meta:e._meta},a=nt();a.unshift({id:C(),kitId:n.id,kitNome:n.nome,nome:e._meta.documento||"Distinta-"+Date.now(),documento:e._meta.documento||"",createdAt:Date.now(),createdBy:Q?.nome||"Sistema",orderDraftSnapshot:s,distintaSnapshot:o}),xt(a),y("Distinta salvata \u2713"),P==="distinte"&&T("distinte")}async function he(t){let{kits:i}=h(),n=i.find(function(c){return c.id===t});if(!n)return;let e=ut(t),o=Dt(n,e);if(!o.totaleRighe){y("Seleziona almeno un componente per generare l'anteprima.","warning");return}if(!e._meta.documento){let c=await Et();ct(t,function(d){d._meta.documento=c},!1),e=ut(t)}let s={_meta:e._meta},a=window.open("","_blank");if(!a){y("Popup bloccato: abilita l'anteprima di stampa.","warning");return}a.document.open(),a.document.write(Xt(n,o,s)),a.document.close(),a.focus()}function ze(t,i){let n=ut(t.id),e=n._units,o=n._sel,s=Dt(t,n),a=n._meta,c=t.sezioni||[],d=c.map(function(p){let u=p.componenti||[];if(!u.length)return"";let g=u.map(function($){let L=!!o[$.id],R=L?X($.qtaBase!=null?$.qtaBase:1)*e:0;return`<label class="kit-ns-comp-row${L?" kit-ns-comp-row--checked":""}">
...
<body>
        ...
        <div class="db-print-page">
            ...
            <div class="db-print-meta-grid">
                <div class="db-print-meta-card">
                    ...
                    <div class="db-print-meta-row"><div class="db-print-meta-label">Data emissione</div><div class="db-print-meta-value">${r($e(e))}</div></div>
                </div>
                <div class="db-print-meta-card">
    ...
    <div class="kit-page">
    ...
    </div>`,T(P),ei();try{if(window&&window._kitSuppressNextFade)try{delete window._kitSuppressNextFade}catch{}else zt(i)}catch{zt(i)}}}function vi(t,i){if(!i)return;if(!t.length){i.innerHTML=`
        ...
        </details>`}).join("");i.innerHTML=e}function ei(){let t=document.getElementById("kit-page-actions");t&&(P==="kits"?t.innerHTML='<button type="button" class="btn-modal-send" style="font-size:0.8rem;padding:8px 14px" onclick="_kitOpenCreaKit()"><i class="fas fa-plus"></i> Nuovo Kit</button>':P==="anagrafiche"?t.innerHTML='<button type="button" class="btn-modal-send" style="font-size:0.8rem;padding:8px 14px" onclick="_kitOpenAnagraficaModal()"><i class="fas fa-plus"></i> Aggiungi</button>':t.innerHTML="")}function T(t){P=t,document.querySelectorAll("#kit-tab-bar .acq-tab").forEach(e=>{e.classList.toggle("active",e.dataset.tab===t)});let{kits:i}=h(),n=document.getElementById("kit-main-content");n&&(t==="kits"?vi(i,n):t==="anagrafiche"?yi(i,n):t==="distinte"&&bi(i,n),ei())}function yi(t,i){if(!i)return;let n=Y();if(!n.length){i.innerHTML=`
        ...
        </details>`).join("");i.innerHTML=e}async function hi(t){let{kits:i}=h(),n=i.find(d=>d.id===t);if(!n){y("Kit non trovato \u26A0\uFE0F");return}let e=et(n);if(!U(e).documento){let d=await Et();J(t,function(l){let m=U(l);m.documento=d,It(l,m)}),e=et(n)}let o=Tt(n,e);if(!o.totalePezzi||!o.totaleRighe){y("Componi prima un ordine per generare la distinta stampabile.","warning");return}let s=nt(),a=U(e),c={id:C(),kitId:n.id,kitNome:n.nome,nome:a.documento||`Distinta-${Date.now()}`,documento:a.documento||"",createdAt:Date.now(),createdBy:Q?.nome||"Sistema",orderDraftSnapshot:e,distintaSnapshot:o};s.unshift(c),xt(s),y("Distinta salvata \u2713"),P==="distinte"&&T("distinte")}function Y(){return Array.isArray(x.anagrafiche)?JSON.parse(JSON.stringify(x.anagrafiche)):[]}function ni(t){x.anagrafiche=Array.isArray(t)?t:[],vt()}function Ne(){if(document.getElementById("modal-kit-anagrafica-edit"))return;let t=document.createElement("div");t.innerHTML=`
    ...
    </div>`,zt(n),Yt().catch(()=>{})}function Ke(){D=null,yt()}function Re(t){wi=t,K()}function He(t){J(t,function(i,n){for(let e of E(n)){let o=document.getElementById("kit-qty-"+e.key);o&&(i[e.key]=Math.max(0,Number.parseInt(o.value,10)||0))}})}function je(t,i,n){try{window._kitSuppressNextFade=!0}catch{}J(t,function(e){e[i]=Math.max(0,Number.parseInt(n,10)||0)})}function Qe(t,i,n){try{window._kitSuppressNextFade=!0}catch{}J(t,function(e){let o=Math.max(0,Number.parseInt(e[i],10)||0);e[i]=Math.max(0,o+n)})}function Ve(t){J(t,function(i){for(let n of Object.keys(i))n!=="_meta"&&(i[n]=0);i._meta=it({})})}function Ue(t,i){J(t,function(n){n[i]=0})}function qt(t,i){let n=document.getElementById("kit-order-autocomplete-"+t);if(n){if(!i.length){n.style.display="none",n.innerHTML="";return}n.innerHTML=i.map(e=>`
    ...
    `).join(""),n.style.display="block"}}function Fe(t,i){let n=String(i||"").trim().toLowerCase();if(!n){qt(t,[]);return}Yt().then(function(e){let o=e.filter(s=>s.ordine.toLowerCase().includes(n)||s.cliente.toLowerCase().includes(n)).slice(0,8);qt(t,o)})}function Je(t){setTimeout(function(){qt(t,[])},140)}function Ge(t,i,n){let e=ot(i);if(!e)return;try{window._kitSuppressNextFade=!0}catch{}J(t,function(s){let a=U(s);a.ordiniCliente=[...new Set(a.ordiniCliente.concat(e))],a.cliente=Bt(a.ordiniCliente,{[e]:n}),It(s,a)});let o=document.getElementById("kit-order-ref-input-"+t);o&&(o.value=""),qt(t,[])}function We(t,i){let n=ot(i);try{window._kitSuppressNextFade=!0}catch{}J(t,function(e){let o=U(e);o.ordiniCliente=o.ordiniCliente.filter(s=>s!==n),o.cliente=Bt(o.ordiniCliente),It(e,o)})}function Ye(t,i,n){let{kits:e}=h(),o=e.find(a=>a.id===t);if(!o)return;let s=Zt(o);if(s[i]=n,_t[t]=s,D===t){try{window._kitSuppressNextFade=!0}catch{}K()}}function Ze(t){let{kits:i}=h(),n=i.find(a=>a.id===t);if(!n)return;let e=gi(n,Zt(n));if(!e){y("Completa prima le scelte elettroniche \u26A0\uFE0F");return}let o=Math.max(0,Number.parseInt(document.getElementById("kit-compose-qty-"+t)?.value,10)||0);if(!o){y("Inserisci una quantit\xE0 valida \u26A0\uFE0F");return}if(Kt[t])return;Kt[t]=Date.now(),setTimeout(function(){try{delete Kt[t]}catch{}},600);try{window._kitSuppressNextFade=!0}catch{}J(t,function(a){a[e.key]=rt(a,e.key)+o});let s=document.getElementById("kit-compose-qty-"+t);s&&(s.value=1)}function _i(t){let i=t.dataset.cid,n=t.dataset.sid,e=Math.max(0,Number.parseInt(t.value,10)||0),{kits:o}=h(),s=o.find(z=>z.id===D);if(!s)return;let a=(s.sezioni||[]).find(z=>z.id===n),c=a&&(a.componenti||[]).find(z=>z.id===i);if(!c||!Jt(c))return;c.caricato=e,A(o);let l=Me(s)[i]||0,m=Math.max(0,l-e),u=qe(s)[i]||0,g=t.closest("tr");if(!g)return;let b=g.querySelector(".kit-ord-zero,.kit-ord-manca,.kit-ord-ok");b&&(b.textContent=l===0?"\u2014":m,b.className=l===0?"kit-ord-zero":m>0?"kit-ord-manca":"kit-ord-ok");let f=g.querySelector(".kit-car-liberi");f&&(u>0?(f.textContent=Math.max(0,e-u)+" lib.",f.style.display=""):f.style.display="none")}function Xe(t,i,n){let{kits:e}=h(),o=e.find(s=>s.id===t);o&&(o.pronti||(o.pronti={}),o.pronti[i]=Math.max(0,(Number.parseInt(o.pronti[i],10)||0)+n),A(e),D===t&&K())}function tn(t,i,n){let{kits:e}=h(),o=e.find(a=>a.id===t);if(!o)return;o.pronti||(o.pronti={}),o.pronti[i]=Math.max(0,Number.parseInt(n,10)||0),A(e);let s=document.querySelector(`.kit-pronti-input[data-said="${i}"]`);s&&(s.value=o.pronti[i],s.classList.toggle("kit-pronti-val-on",o.pronti[i]>0))}function en(t,i){let n=t.movimenti||[];return n.length?n.map(e=>{let o=i?`<button type="button" class="kit-mov-del" onclick="_kitEliminaMovimento('${r(t.id)}',${e.id})" title="Elimina">\u2715</button>`:'<span style="width:22px;flex-shrink:0"></span>',s=i&&(e.tipo==="carico"||e.tipo==="scarico")?`<button type="button" class="kit-mov-edit" onclick="_kitModificaMovimento('${r(t.id)}',${e.id})" title="Modifica">\u270E</button>`:'<span style="width:22px;flex-shrink:0"></span>';if(e.tipo==="spedizione"){let a=(e.righe||[]).reduce((l,m)=>l+m.qty,0),c=(e.righe||[]).map(l=>`<div class="kit-assemb-sub-row"><span class="kit-assemb-sub-mat" style="color:#94a3b8">${r(l.mat)}</span><span class="kit-mov-qty scarico">\u2212${l.qty}</span></div>`).join(""),d=(e.items||[]).map(l=>`<div class="kit-assemb-sub-row kit-sped-item-row"><span class="kit-assemb-sub-mat">${r(l.nome)}</span><span class="kit-mov-qty scarico">\xD7${l.qty}</span></div>`).join("");return`<details class="kit-mov-assemb-group">
        ...
        </div>`:p='<div class="kcfg-list">'+l.map(({comp:f,sez:z})=>{let $=m(f),L=$?($.categoria||"").trim():"",R=L?c(L):"#e2e8f0",q=St(f.unitaMisura,"pz"),ht=e.map(tt=>`<option value="${tt}"${q===tt?" selected":""}>${tt}</option>`).join("");return`<div class="kcfg-comp-row">
        ...
        <div style="margin-top:14px;padding-top:10px;border-top:1px solid #f1f5f9">
            ...
            </label>`}).join(""):`<div class="kit-import-empty">Nessun ${e.mode==="import-asse"?"gruppo elettronico":"sezione"} disponibile.</div>`;let dt=!1,v="kit-cfg-help kit-import-preview",I="";if(e.mode==="import"){if(!a)I="Seleziona un kit sorgente per vedere le sezioni disponibili.";else if(!d)I="Seleziona una sezione da importare nel kit corrente.";else{let k=Ct(a,o);dt=!0,I=`La sezione <strong>${r(d.nome)}</strong> verr\xE0 importata in <strong>${r(o.nome)}</strong>. `,k.hasTargetVarianti?k.needsReview?(v="kit-cfg-warn kit-import-preview",I+=`${k.exactMatches} combinazioni su ${k.targetCount} risultano allineate: controlla i coefficienti importati.`):I+=`Tutte le ${k.targetCount} combinazioni del kit destinazione risultano allineate.`:(v="kit-cfg-warn kit-import-preview",I+="Il kit destinazione non ha ancora combinazioni: importa pure la struttura e rifinisci i coefficienti dopo aver definito gli assi.")}q.innerHTML='<i class="fas fa-copy"></i> Importa sezione'}else if(e.mode==="import-asse")a?d?(dt=!0,I=`L'asse <strong>${r(d.nome)}</strong> verr\xE0 importato in <strong>${r(o.nome)}</strong>. Opzioni duplicate verranno ignorate (merge per codice).`):I="Seleziona un asse da importare nel kit corrente.":I="Seleziona un kit sorgente per vedere gli assi disponibili.",q.innerHTML='<i class="fas fa-copy"></i> Importa asse';else{let k=n.filter(w=>(e.targetKitIds||[]).includes(w.id));if(!d)I="Seleziona la sezione del kit corrente che vuoi copiare.";else if(!k.length)I="Seleziona almeno un kit destinazione per eseguire la copia massiva.";else{dt=!0;let w=k.filter(M=>Ct(o,M).needsReview).length;I=`La sezione <strong>${r(d.nome)}</strong> verr\xE0 copiata in <strong>${k.length}</strong> kit.`,w>0?(v="kit-cfg-warn kit-import-preview",I+=` <strong>${w}</strong> kit richiederanno un controllo manuale delle quantit\xE0 o delle combinazioni.`):I+=" Le combinazioni risultano allineate su tutti i kit selezionati."}q.innerHTML=`<i class="fas fa-copy"></i> Copia in ${(e.targetKitIds||[]).length||0} kit`}R.className=v,R.innerHTML=I,q.disabled=!dt,t&&(i.style.display="flex",i.offsetHeight,i.classList.add("active"),setTimeout(()=>{let k=document.getElementById("kit-import-search");k&&k.focus()},40))}function Gn(){if(!_)return;let{kits:t}=h(),i=_,n=t.find(l=>l.id===i.currentKitId),e=t.find(l=>l.id===i.sourceKitId),o=Ut(e,i.sectionId),s=e?.assiConfigurazione?.find(l=>l.id===i.asseId)||null;if(!n||!e||i.mode==="import"&&!o||i.mode==="import-asse"&&!s){y("Configurazione import non valida \u26A0\uFE0F");return}if(i.mode==="import-asse"){n.assiConfigurazione=n.assiConfigurazione||[];let l=n.assiConfigurazione.find(p=>String(p.nome||"").trim().toLowerCase()===String(s.nome||"").trim().toLowerCase()),m=0;if(l){l.opzioni=l.opzioni||[];for(let p of s.opzioni||[]){let u=String(p.codice||"").trim().toLowerCase(),g=!1;if(u&&(g=l.opzioni.some(b=>String(b.codice||"").trim().toLowerCase()===u&&u!=="")),g||(g=l.opzioni.some(b=>String(b.nome||"").trim().toLowerCase()===String(p.nome||"").trim().toLowerCase())),!g){let b=(l.opzioni||[]).length+1;l.opzioni.push({id:C(),key:W(p?.key,"opz"+b),nome:String(p?.nome||"").trim()||"opz"+b,codice:String(p?.codice||"").trim()}),m+=1}}A(t),pt(),V(),m?y(`${m} opzione${m>1?"i":""} aggiunta${m>1?"e":""} all'asse "${s.nome}" \u2713`):y(`Nessuna nuova opzione trovata per l'asse "${s.nome}"`);return}n.assiConfigurazione.push(mi(s,e,n)),A(t),pt(),V(),y(`Asse "${s.nome}" importato da "${e.nome}" \u2713`);return}if(i.mode==="import"){let l=Ct(e,n);n.sezioni=n.sezioni||[],n.sezioni.push(At(o,e,n)),A(t),pt(),V();let m="";l.hasTargetVarianti?l.needsReview&&(m=" Controlla le quantit\xE0 sulle combinazioni non allineate."):m=" Definisci poi gli assi del kit per rifinire i coefficienti.",y(`Sezione "${o.nome}" importata da "${e.nome}" \u2713${m}`);return}let a=t.filter(l=>(i.targetKitIds||[]).includes(l.id)&&l.id!==n.id);if(!a.length){y("Seleziona almeno un kit destinazione \u26A0\uFE0F");return}let c=0;for(let l of a)Ct(e,l).needsReview&&(c+=1),l.sezioni=l.sezioni||[],l.sezioni.push(At(o,e,l));A(t),pt(),V();let d="";c>0&&(d=` ${c} kit richiedono un controllo delle quantit\xE0.`),y(`Sezione "${o.nome}" copiata in ${a.length} kit \u2713${d}`)}function Wn(t){let{kits:i}=h(),n=i.find(e=>e.id===t)||null;N={currentKitId:t,search:"",selectedPresetId:"",newPresetName:"",newPresetSectionId:n?.sezioni?.[0]?.id||""},bt(!0)}function Li(){let t=document.getElementById("modal-kit-presets");N=null,t&&(t.classList.remove("active"),setTimeout(()=>{t.classList.contains("active")||(t.style.display="none")},300))}function Yn(t){N&&(N.search=String(t||""),bt())}function Zn(t){N&&(N.selectedPresetId=t,bt())}function Xn(){if(!N)return;let t=document.getElementById("preset-new-name"),i=document.getElementById("preset-new-section"),n=String(t?.value||"").trim();if(!n){y("Inserisci il nome del preset \u26A0\uFE0F");return}let e=i?.value||"";Pi(N.currentKitId,e,n)}function Pi(t,i,n){let{kits:e}=h(),o=e.find(c=>c.id===t);if(!o){y("Kit non trovato \u26A0\uFE0F");return}let s=Ut(o,i);if(!s){y("Seleziona una sezione valida \u26A0\uFE0F");return}let a=kt();a.push({id:C(),nome:String(n||"").trim(),sourceKitId:o.id,sezione:JSON.parse(JSON.stringify(s))}),Wt(a),y("Preset salvato \u2713"),N&&N.currentKitId===t&&bt(),V()}function to(t){if(!N)return;let i=kt(),n=t||N.selectedPresetId,e=i.find(c=>c.id===n);if(!e){y("Seleziona un preset \u26A0\uFE0F");return}let{kits:o}=h(),s=o.find(c=>c.id===N.currentKitId),a=o.find(c=>c.id===e.sourceKitId)||null;if(!s){y("Kit non trovato \u26A0\uFE0F");return}s.sezioni=s.sezioni||[],s.sezioni.push(At(e.sezione,a,s)),A(o),Li(),V(),y(`Preset "${e.nome}" applicato \u2713`)}function io(t,i){let n=kt(),e=n.find(o=>o.id===t);if(!e){y("Preset non trovato \u26A0\uFE0F");return}e.nome=String(i||"").trim()||e.nome,Wt(n),y("Nome aggiornato \u2713"),bt()}function eo(t){let i=kt().filter(n=>n.id!==t);Wt(i),N&&(N.selectedPresetId=""),bt(),y("Preset eliminato \u2713")}function bt(t=!1){let i=document.getElementById("modal-kit-presets");if(!i||!N)return;let n=kt(),e=N,o=h().kits.find(u=>u.id===e.currentKitId),s=n.filter(u=>Mt(u.nome,e.search)),a=document.getElementById("preset-list"),c=document.getElementById("preset-preview"),d=document.getElementById("preset-new-name"),l=document.getElementById("preset-new-section"),m=document.getElementById("preset-apply-btn");if(!a||!c||!d||!l||!m)return;a.innerHTML=s.length?s.map(u=>{let g=u.id===e.selectedPresetId;return`<label class="kit-import-option ${g?"kit-import-option--active":""}">
        ...
        <div class="kit-cfg-section">
            ...
            ${g}
        </div>`,f=(i.sezioni||[]).map((v,I)=>{let k=(v.componenti||[]).map(w=>{let M=j(w),B=Gt(w,i),si=(e||[]).find(O=>O.id===B.asseId)||null,Ri=B.tipo==="gruppo"&&si?`<div class="kit-cfg-row">${(si.opzioni||[]).map(O=>`<label class="kit-meta-pill">
                   ...
                   </select>`:"",ji=B.tipo==="manuale"?'<div class="kit-cfg-warn">Questa parte usa ancora una configurazione avanzata precedente. Appena la modifichi verr\xE0 convertita nel nuovo schema semplice.</div>':"",ai=M?"flag":St(w.unitaMisura,"pz"),Qi=M?[{value:"flag",label:"Solo avviso"}]:[...new Set([ai,...Wi])].filter(Boolean).map(O=>({value:O,label:O}));return`<div class="kit-cfg-sa-group" style="padding:12px 14px">
                ...
                <div class="kit-cfg-row">
                    ...
                    <select class="kit-cfg-select" style="max-width:120px"
                            ...
                            ${M?"disabled":""}>
                        ${Qi.map(O=>`<option value="${r(O.value)}" ${ai===O.value?"selected":""}>${r(O.label)}</option>`).join("")}
                    </select>
        ...
        <div class="kit-cfg-section">
            ...
            ${$}
        </div>`,R={info:p,varianti:b,bom:z,sa:L},q=kt(),tt=`
        <div class="kit-cfg-section">
            ...
            <div style="margin-top:8px">${q.length?q.map(v=>`<div class="kit-preset-row" style="display:flex;justify-content:space-between;align-items:center;padding:6px 0">
                <div style="flex:1">
                    ...
                    <div style="color:#94a3b8;font-size:0.85rem">${r(v.sourceKitId&&h().kits.find(I=>I.id===v.sourceKitId)?.nome||"")}</div>
                </div>
    ...
    </div>`,zt(n)}function oo(t){if(t&&D===t){K();return}D=t,K()}function so(t){at=t,no()}function S(t,i,n=!0){let{kits:e}=h(),o=e.find(s=>s.id===t);o&&(i(o),A(e),n&&V())}function ao(t,i){S(t,function(n){n.nome=i.trim()||"Kit senza nome"},!1)}function ro(t){if(!confirm("Eliminare questo kit e tutti i suoi dati?"))return;let{kits:i}=h();A(i.filter(n=>n.id!==t)),Ai=null,D=null,yt()}function co(t){let{kits:i}=h(),n=i.find(o=>o.id===t);if(!n)return;let e={id:C(),nome:`Copia di ${n.nome}`,schemaVersion:Qt,assiConfigurazione:[],varianti:[],sezioni:[],sottoAssembly:[],qtaDaProdurre:{},pronti:{},movimenti:[]};for(let o of n.assiConfigurazione||[])e.assiConfigurazione.push(mi(o,n,e));e.varianti=li(e.assiConfigurazione);for(let o of n.sezioni||[])e.sezioni.push(At(o,n,e));e.sottoAssembly=(n.sottoAssembly||[]).map(o=>({id:C(),nome:o.nome||"",varianteKey:o.varianteKey||"",noteConfig:o.noteConfig||""})),i.push(e),A(i),Di(e.id),y(`Kit "${n.nome}" duplicato \u2713`)}function Ki(t){S(t,function(i){let n=(i.assiConfigurazione||[]).length+1;i.assiConfigurazione=i.assiConfigurazione||[],i.assiConfigurazione.push({id:C(),key:"asse"+n,nome:"Asse "+n,opzioni:[{id:C(),key:"opz1",nome:"Opzione 1"}]})})}function lo(t,i,n,e){S(t,function(o){let s=(o.assiConfigurazione||[]).find(a=>a.id===i);s&&(n==="key"?s.key=W(e,s.key||"asse"):s[n]=e.trim())})}function po(t,i){S(t,function(n){n.assiConfigurazione=(n.assiConfigurazione||[]).filter(e=>e.id!==i)})}function mo(t,i){S(t,function(n){let e=(n.assiConfigurazione||[]).find(s=>s.id===i);if(!e)return;let o=(e.opzioni||[]).length+1;e.opzioni=e.opzioni||[],e.opzioni.push({id:C(),key:"opz"+o,nome:"Opzione "+o,codice:""})})}function uo(t,i,n,e,o){S(t,function(s){let a=(s.assiConfigurazione||[]).find(d=>d.id===i),c=a&&(a.opzioni||[]).find(d=>d.id===n);c&&(e==="key"?c.key=W(o,c.key||"opzione"):c[e]=o.trim())})}function fo(t,i,n){S(t,function(e){let o=(e.assiConfigurazione||[]).find(s=>s.id===i);o&&(o.opzioni=(o.opzioni||[]).filter(s=>s.id!==n))})}function go(t){Ki(t)}function ko(t){S(t,function(i){i.sezioni=i.sezioni||[],i.sezioni.push({id:C(),nome:"Nuova sezione",componenti:[]})})}function vo(t){Ti(t)}function yo(t,i,n,e){S(t,function(o){let s=(o.sezioni||[]).find(a=>a.id===i);s&&(s[n]=e.trim())},!1)}function bo(t,i){confirm("Eliminare questa sezione e tutti i suoi componenti?")&&S(t,function(n){n.sezioni=(n.sezioni||[]).filter(e=>e.id!==i)})}function ho(t,i){S(t,function(n){let e=(n.sezioni||[]).find(o=>o.id===i);e&&(e.componenti=e.componenti||[],e.componenti.push({id:C(),nome:"Nuovo componente",codice:"",qtaPerVariante:{},caricato:0,modoComponente:"quantificato",tracciabile:!0,noteConfig:"",unitaMisura:"pz"}))})}function zo(t,i,n,e,o,s){S(t,function(a){let c=(a.sezioni||[]).find(l=>l.id===i),d=c&&(c.componenti||[]).find(l=>l.id===n);if(d){if(e==="coeff"||e==="flag"){d.qtaPerVariante=d.qtaPerVariante||{},d.qtaPerVariante[o]=X(s);return}if(e==="modo"){d.modoComponente=s==="segnalazione"?"segnalazione":"quantificato",d.modoComponente==="segnalazione"?(d.tracciabile=!1,d.unitaMisura="flag"):d.unitaMisura==="flag"&&(d.unitaMisura="pz");return}if(e==="unitaMisura"){d.unitaMisura=d.modoComponente==="segnalazione"?"flag":St(s,"pz");return}d[e]=s.trim()}},e!=="nome"&&e!=="noteConfig")}function wo(t,i,n,e,o){S(t,function(s){let a=(s.sezioni||[]).find(l=>l.id===i),c=a&&(a.componenti||[]).find(l=>l.id===n);if(!c)return;let d=Gt(c,s);if(e==="tipo"){if(d.tipo=o==="gruppo"?"gruppo":"sempre",d.tipo==="gruppo"&&!d.asseId){d.asseId=s.assiConfigurazione?.[0]?.id||"";let l=(s.assiConfigurazione||[]).find(m=>m.id===d.asseId);d.opzioneIds=l?.opzioni?.length?[l.opzioni[0].id]:[]}}else if(e==="qtyBase")d.qtyBase=X(o);else if(e==="asseId"){d.asseId=String(o||"");let l=(s.assiConfigurazione||[]).find(m=>m.id===d.asseId);d.opzioneIds=l?.opzioni?.length?[l.opzioni[0].id]:[],d.tipo="gruppo"}c.applicazioneTipo=d.tipo,c.applicazioneAsseId=d.asseId,c.applicazioneOpzioneIds=d.opzioneIds,c.qtaBase=d.qtyBase,c.qtaPerVariante=Vt(c,s,d)})}function _o(t,i,n,e,o){S(t,function(s){let a=(s.sezioni||[]).find(m=>m.id===i),c=a&&(a.componenti||[]).find(m=>m.id===n);if(!c)return;let d=Gt(c,s),l=new Set(d.opzioneIds||[]);o?l.add(e):l.delete(e),d.tipo="gruppo",d.opzioneIds=[...l],c.applicazioneTipo=d.tipo,c.applicazioneAsseId=d.asseId,c.applicazioneOpzioneIds=d.opzioneIds,c.qtaBase=d.qtyBase,c.qtaPerVariante=Vt(c,s,d)})}function Co(t,i,n,e){S(t,function(o){let s=(o.sezioni||[]).find(c=>c.id===i),a=s&&(s.componenti||[]).find(c=>c.id===n);!a||j(a)||(a.tracciabile=!!e)},!1)}function $o(t,i,n){S(t,function(e){let o=(e.sezioni||[]).find(s=>s.id===i);o&&(o.componenti=(o.componenti||[]).filter(s=>s.id!==n))})}function So(t){S(t,function(i){i.sottoAssembly=i.sottoAssembly||[],i.sottoAssembly.push({id:C(),nome:"",varianteKey:E(i)[0]?.key||""})})}function xo(t,i){S(t,function(n){n.sottoAssembly=n.sottoAssembly||[],n.sottoAssembly.push({id:C(),nome:"",varianteKey:i,noteConfig:""})})}function Io(t,i,n,e){S(t,function(o){o.sottoAssembly[i]&&(o.sottoAssembly[i][n]=e.trim())},!1)}function Ao(t,i){S(t,function(n){n.sottoAssembly.splice(i,1)})}function Mo(t){let i=document.getElementById("modal-kit-distinta-edit");if(!i){hi(t);return}let{kits:n}=h(),e=n.find(d=>d.id===t);if(!e)return;let o=et(e),s=U(o),a=document.getElementById("distinta-edit-nome"),c=document.getElementById("distinta-edit-documento");a&&(a.value=s.documento||""),c&&(c.value=s.documento||""),i.dataset.kitId=t,i.style.display="flex",i.offsetHeight,i.classList.add("active"),setTimeout(()=>a&&a.focus(),80)}function jt(){let t=document.getElementById("modal-kit-distinta-edit");t&&(t.classList.remove("active"),setTimeout(()=>{t.classList.contains("active")||(t.style.display="none")},300))}function qo(){let t=document.getElementById("modal-kit-distinta-edit");if(!t)return;let i=t.dataset.kitId,n=(document.getElementById("distinta-edit-nome")?.value||"").trim(),e=(document.getElementById("distinta-edit-documento")?.value||"").trim();if(!n){y("Inserisci un nome per la distinta.","warning");return}J(i,function(m){let p=U(m);e?p.documento=e:p.documento||(p.documento=n),It(m,p)});let{kits:o}=h(),s=o.find(m=>m.id===i);if(!s){jt(),y("Kit non trovato \u26A0\uFE0F");return}let a=et(s),c=Tt(s,a);if(!c.totalePezzi||!c.totaleRighe){y("Componi prima un ordine per generare la distinta stampabile.","warning");return}let d=nt(),l={id:C(),kitId:s.id,kitNome:s.nome,nome:n||a._meta?.documento||`Distinta-${Date.now()}`,documento:e||a._meta?.documento||"",createdAt:Date.now(),createdBy:Q?.nome||"Sistema",orderDraftSnapshot:a,distintaSnapshot:c};d.unshift(l),xt(d),jt(),y("Distinta salvata \u2713"),P==="distinte"&&T("distinte")}function Po(){window._kitOpenView=Pe,window._kitOpenConfig=Di,window._kitNuovoKit=Pn,window._kitBack=Ke,window._kitOpenPrintPreview=xe,window._kitSwitchTab=Re,window._kitAggiornaQty=He,window._kitOrdineSet=je,window._kitOrdineDelta=Qe,window._kitOrdineReset=Ve,window._kitOrdineResetVoce=Ue,window._kitOrderSearch=Fe,window._kitOrderHideSearch=Je,window._kitOrderPick=Ge,window._kitOrderRemoveRef=We,window._kitComposeSelect=Ye,window._kitComposeAdd=Ze,window._kitAggiornaCar=_i,window._kitAggiornaPronti=Xe,window._kitSetPronti=tn,window._kitApriModalSped=cn,window._kitChiudiModalSped=xi,window._kitConfermaSpedizione=dn,window._kitApriModalReso=ln,window._kitChiudiModalReso=Ii,window._kitResoQtyChange=pn,window._kitResoAggiornaBOM=oi,window._kitConfermaReso=mn,window._kitSalvaMovimento=nn,window._kitEliminaMovimento=on,window._kitModificaMovimento=an,window._kitChiudiModalEditMov=Si,window._kitConfermaModificaMov=rn,window._kitChiudiModalDelMov=Ci,window._kitConfermaEliminaMov=$i,window._kitSalvaManuale=un,window._kitElimina=ro,window._kitDuplicaKit=co,window._kitCfgBack=oo,window._kitCfgSwitchTab=so,window._kitCfgSaveNome=ao,window._kitCfgAddVar=go,window._kitCfgOpenImportModal=Ti,window._kitCfgOpenImportAsseModal=Kn,window._kitCfgOpenCopySezModal=Rn,window._kitCfgCloseImportModal=pt,window._kitCfgSetImportMode=Hn,window._kitCfgSetImportSearch=jn,window._kitCfgSelectImportSource=Qn,window._kitCfgSelectImportSection=Vn,window._kitCfgToggleImportTarget=Un,window._kitCfgSelectAllImportTargets=Fn,window._kitCfgClearImportTargets=Jn,window._kitCfgConfirmImport=Gn,window._kitOpenPresetsModal=Wn,window._kitClosePresetsModal=Li,window._kitSetPresetsSearch=Yn,window._kitSelectPreset=Zn,window._kitCreatePresetFromSection=Xn,window._kitCreatePreset=Pi,window._kitApplyPreset=to,window._kitRenamePreset=io,window._kitDeletePreset=eo,window._kitCfgAddAsse=Ki,window._kitCfgUpdateAsse=lo,window._kitCfgDelAsse=po,window._kitCfgAddOpzione=mo,window._kitCfgUpdateOpzione=uo,window._kitCfgDelOpzione=fo,window._kitCfgAddSez=ko,window._kitCfgImportSez=vo,window._kitCfgUpdateSez=yo,window._kitCfgDelSez=bo,window._kitCfgAddComp=ho,window._kitCfgUpdateComp=zo,window._kitCfgUpdateCompRule=wo,window._kitCfgToggleCompOption=_o,window._kitCfgToggleCompTracked=Co,window._kitCfgDelComp=$o,window._kitCfgAddSA=So,window._kitCfgAddSAForVariant=xo,window._kitCfgUpdateSA=Io,window._kitCfgDelSA=Ao,window._kitSwitchMainTab=T,window._kitRenderKitsGrid=vi,window._kitRenderAnagrafichePage=yi,window._kitRenderDistintePage=bi,window._kitLoadDistinte=nt,window._kitSaveDistinte=xt,window._kitCreateDistintaFromDraft=hi,window._kitLoadAnagrafiche=Y,window._kitSaveAnagrafiche=ni,window._kitOpenAnagraficaModal=Oe,window._kitCloseAnagraficaModal=zi,window._kitConfirmSaveAnagrafica=Ee,window._kitDeleteAnagrafica=Be,window._kitOpenCreaKit=qi,window._kitCloseCreaKit=Ni,window._kitConfirmCreaKit=An,window._kitOpenConfigModal=Mi,window._kitCloseConfigModal=fn,window._kitRenderConfigModal=V,window._kitCfgModalSaveNome=gn,window._kitCfgModalAddAnag=yn,window._kitCfgModalAddCompFree=bn,window._kitCfgModalUpdateSez=kn,window._kitCfgModalDelSez=vn,window._kitCfgModalUpdateComp=hn,window._kitCfgModalUpdateCompRule=zn,window._kitCfgModalDelComp=wn,window._kitCfgModalAddAsse=_n,window._kitCfgModalDelAsse=Cn,window._kitCfgModalUpdateAsse=$n,window._kitCfgModalAddOpz=Sn,window._kitCfgModalDelOpz=xn,window._kitCfgModalUpdateOpz=In,window._kitQAddSezOpen=Mn,window._kitQAddSezClose=Oi,window._kitQAddSezConfirm=qn,window._kitQAddCompOpen=Nn,window._kitQAddCompToggleSource=Ht,window._kitQAddCompChangeCategoria=Ei,window._kitQAddCompClose=Bi,window._kitQAddCompConfirm=On,window._kitQUpdateComp=En,window._kitQRenomeSez=Bn,window._kitQDelComp=Dn,window._kitQDelSez=Tn,window._kitQDelKit=Ln,window._kitRenderHeaderActions=ei,window._kitOpenSaveDistintaModal=Mo,window._kitCloseSaveDistintaModal=jt,window._kitConfirmSaveDistinta=qo,window._kitDistintaOpenPrint=De,window._kitDistintaApplyToDraft=Te,window._kitDistintaDelete=Le,window._kitNSToggleComp=me,window._kitNSSetUnits=pe,window._kitNSOrderSearch=ue,window._kitNSOrderHideSearch=fe,window._kitNSOrderPick=ge,window._kitNSOrderRemoveRef=ke,window._kitNSReset=ye,window._kitNSToggleSection=fi,window._kitNSToggleSectionChk=ve,window._kitNSCreateDistinta=be,window._kitNSOpenPrintPreview=he}var Qt,Wi,x,Rt,st,wt,Kt,P,_t,mt,D,wi,Ai,at,_,N,ft,F,Ko,No=Vi(()=>{Ui();Ji();Gi();Fi();Qt=2,Wi=["pz","mt","cm","mm","kg","g","lt","ml"];x=$t({});Rt=!1,st=[],wt=null,Kt={},P="kits";_t={};mt=null;typeof window<"u"&&window.addEventListener("beforeunload",function(){Ie()});D=null,wi="ordine";Ai=null,at="info",_=null,N=null,ft={kitId:null,sezId:null},F=null;Ko=yt});No();export{yt as caricaKitProdotti,Ko as default,Po as registerGlobals,Lo as resetKitFetch};
//# sourceMappingURL=chunk-kit-prodotti-EZOM73BA.js.map
