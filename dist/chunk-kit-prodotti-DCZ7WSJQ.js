...
<body>
...
</html>`}async function Me(t){let{kits:i}=b(),n=i.find(a=>a.id===t);if(!n)return;let e=et(n),o=Tt(n,e);if(!o.totalePezzi||!o.totaleRighe){y("Componi prima un ordine per generare la distinta stampabile.","warning");return}if(!U(e).documento){let a=await Et();J(t,function(c){let d=U(c);d.documento=a,It(c,d)}),e=et(n)}let s=window.open("","_blank");if(!s){y("Popup bloccato: abilita l'anteprima di stampa per aprire il modello completo.","warning");return}s.document.open(),s.document.write(Xt(n,o,e)),s.document.close(),s.focus()}function ki(t){return[...Array.isArray(t)?t:[]].sort((n,e)=>{let o=String(n?.nome||"").trim(),s=String(e?.nome||"").trim();return o.localeCompare(s,"it",{sensitivity:"base",numeric:!0})})}function b(){let t=Array.isArray(x.kits)?x.kits.map(Ft):[];return{kits:ki(t)}}function A(t){let i=ki(Array.isArray(t)?t.map(Ft):[]);x.kits=i,vt()}function Ne(){if(!mt)return;clearTimeout(mt),mt=null;let t=Ot();lt({azione:"setKitData",payload:t}).then(function(i){x.ts=Number(i?.ts||Date.now())||Date.now()}).catch(function(i){console.warn("[kit-prodotti] flush remoto fallito:",i)})}function vt(){clearTimeout(mt),mt=setTimeout(function(){mt=null;let t=Ot();lt({azione:"setKitData",payload:t}).then(function(i){x.ts=Number(i?.ts||Date.now())||Date.now()}).catch(function(i){console.warn("[kit-prodotti] salvataggio remoto fallito:",i)})},1500)}function Oe(t){fetch(Pt,{method:"POST",body:JSON.stringify({azione:"getKitData"})}).then(i=>i.json()).then(i=>{if(i&&i.integrityOk===!1){console.error("[kit-prodotti] payload kit non leggibile lato server:",i.parseError||"parse error"),y("Errore lettura dati Kit dal server. Contatta subito supporto: nessun salvataggio automatico verr\xE0 forzato.","error"),t&&t(!1);return}let n=$t(i);if(ri(n)){x=n,t&&t(!0);return}let e=te();if(ri(e)){x=$t(e),lt({azione:"setKitData",payload:Ot()}).then(function(o){x.ts=Number(o?.ts||Date.now())||Date.now(),ie(),y("Migrazione Kit completata: dati spostati su Sheets.","success"),t&&t(!0)}).catch(function(){t&&t(!1)});return}x=n,t&&t(!0)}).catch(()=>{t&&t(!1)})}function _(){return Math.random().toString(36).slice(2,10)+Date.now().toString(36)}function ti(){if(!V||!V.nome)return!1;let t=String(V.nome).toUpperCase().trim();return t==="ALESSIO"||t==="0000"||V.ruolo==="MASTER"}function qe(t){let i={};for(let n of t.sezioni||[])for(let e of n.componenti||[]){if(j(e)){i[e.id]=0;continue}let o=0;for(let[s,a]of Object.entries(t.qtaDaProdurre||{}))o+=(Number.parseInt(a,10)||0)*H(e,s);i[e.id]=o}return i}function Ee(t){let i={};for(let n of t.sottoAssembly||[]){let e=Number.parseInt(t.pronti?.[n.id],10)||0;if(!e)continue;let o=n.varianteKey;for(let s of t.sezioni||[])for(let a of s.componenti||[]){if(j(a))continue;let c=H(a,o);c>0&&(i[a.id]=(i[a.id]||0)+e*c)}}return i}function vi(t,i){let n=E(t).find(e=>e.key===i);return n?r(n.nome):r(i)}function ii(){return new Date().toLocaleString("it-IT",{day:"2-digit",month:"2-digit",year:"2-digit",hour:"2-digit",minute:"2-digit"})}function yt(){if(window.paginaAttuale!=="KIT_PRODOTTI")return;if(!Rt){Rt=!0;let n=document.getElementById("contenitore-dati");n&&(n.innerHTML="<div class='centered-msg'><i class='fas fa-spinner fa-spin'></i> Caricamento kit dal database...</div>"),Oe(function(){yt()});return}let{kits:t}=b(),i=document.getElementById("contenitore-dati");if(i){i.innerHTML=`
    <div class="kit-page">
    ...
    </div>`,D(P),ei();try{if(window&&window._kitSuppressNextFade)try{delete window._kitSuppressNextFade}catch{}else zt(i)}catch{zt(i)}}}function yi(t,i){if(!i)return;if(!t.length){i.innerHTML=`
    ...
    </div>`,zt(n),Yt().catch(()=>{})}function je(){T=null,yt()}function Ve(t){_i=t,K()}function Qe(t){J(t,function(i,n){for(let e of E(n)){let o=document.getElementById("kit-qty-"+e.key);o&&(i[e.key]=Math.max(0,Number.parseInt(o.value,10)||0))}})}function Ue(t,i,n){try{window._kitSuppressNextFade=!0}catch{}J(t,function(e){e[i]=Math.max(0,Number.parseInt(n,10)||0)})}function Fe(t,i,n){try{window._kitSuppressNextFade=!0}catch{}J(t,function(e){let o=Math.max(0,Number.parseInt(e[i],10)||0);e[i]=Math.max(0,o+n)})}function Je(t){J(t,function(i){for(let n of Object.keys(i))n!=="_meta"&&(i[n]=0);i._meta=it({})})}function Ge(t,i){J(t,function(n){n[i]=0})}function Nt(t,i){let n=document.getElementById("kit-order-autocomplete-"+t);if(n){if(!i.length){n.style.display="none",n.innerHTML="";return}n.innerHTML=i.map(e=>`
    ...
    `).join(""),n.style.display="block"}}function We(t,i){let n=String(i||"").trim().toLowerCase();if(!n){Nt(t,[]);return}Yt().then(function(e){let o=e.filter(s=>s.ordine.toLowerCase().includes(n)||s.cliente.toLowerCase().includes(n)).slice(0,8);Nt(t,o)})}function Ye(t){setTimeout(function(){Nt(t,[])},140)}function Ze(t,i,n){let e=ot(i);if(!e)return;try{window._kitSuppressNextFade=!0}catch{}J(t,function(s){let a=U(s);a.ordiniCliente=[...new Set(a.ordiniCliente.concat(e))],a.cliente=Dt(a.ordiniCliente,{[e]:n}),It(s,a)});let o=document.getElementById("kit-order-ref-input-"+t);o&&(o.value=""),Nt(t,[])}function Xe(t,i){let n=ot(i);try{window._kitSuppressNextFade=!0}catch{}J(t,function(e){let o=U(e);o.ordiniCliente=o.ordiniCliente.filter(s=>s!==n),o.cliente=Dt(o.ordiniCliente),It(e,o)})}function tn(t,i,n){let{kits:e}=b(),o=e.find(a=>a.id===t);if(!o)return;let s=Zt(o);if(s[i]=n,_t[t]=s,T===t){try{window._kitSuppressNextFade=!0}catch{}K()}}function en(t){let{kits:i}=b(),n=i.find(a=>a.id===t);if(!n)return;let e=gi(n,Zt(n));if(!e){y("Completa prima le scelte elettroniche \u26A0\uFE0F");return}let o=Math.max(0,Number.parseInt(document.getElementById("kit-compose-qty-"+t)?.value,10)||0);if(!o){y("Inserisci una quantit\xE0 valida \u26A0\uFE0F");return}if(Kt[t])return;Kt[t]=Date.now(),setTimeout(function(){try{delete Kt[t]}catch{}},600);try{window._kitSuppressNextFade=!0}catch{}J(t,function(a){a[e.key]=rt(a,e.key)+o});let s=document.getElementById("kit-compose-qty-"+t);s&&(s.value=1)}function Ci(t){let i=t.dataset.cid,n=t.dataset.sid,e=Math.max(0,Number.parseInt(t.value,10)||0),{kits:o}=b(),s=o.find(z=>z.id===T);if(!s)return;let a=(s.sezioni||[]).find(z=>z.id===n),c=a&&(a.componenti||[]).find(z=>z.id===i);if(!c||!Jt(c))return;c.caricato=e,A(o);let l=qe(s)[i]||0,m=Math.max(0,l-e),u=Ee(s)[i]||0,g=t.closest("tr");if(!g)return;let h=g.querySelector(".kit-ord-zero,.kit-ord-manca,.kit-ord-ok");h&&(h.textContent=l===0?"\u2014":m,h.className=l===0?"kit-ord-zero":m>0?"kit-ord-manca":"kit-ord-ok");let f=g.querySelector(".kit-car-liberi");f&&(u>0?(f.textContent=Math.max(0,e-u)+" lib.",f.style.display=""):f.style.display="none")}function nn(t,i,n){let{kits:e}=b(),o=e.find(s=>s.id===t);o&&(o.pronti||(o.pronti={}),o.pronti[i]=Math.max(0,(Number.parseInt(o.pronti[i],10)||0)+n),A(e),T===t&&K())}function on(t,i,n){let{kits:e}=b(),o=e.find(a=>a.id===t);if(!o)return;o.pronti||(o.pronti={}),o.pronti[i]=Math.max(0,Number.parseInt(n,10)||0),A(e);let s=document.querySelector(`.kit-pronti-input[data-said="${i}"]`);s&&(s.value=o.pronti[i],s.classList.toggle("kit-pronti-val-on",o.pronti[i]>0))}function sn(t,i){let n=t.movimenti||[];return n.length?n.map(e=>{let o=i?`<button type="button" class="kit-mov-del" onclick="_kitEliminaMovimento('${r(t.id)}',${e.id})" title="Elimina">\u2715</button>`:'<span style="width:22px;flex-shrink:0"></span>',s=i&&(e.tipo==="carico"||e.tipo==="scarico")?`<button type="button" class="kit-mov-edit" onclick="_kitModificaMovimento('${r(t.id)}',${e.id})" title="Modifica">\u270E</button>`:'<span style="width:22px;flex-shrink:0"></span>';if(e.tipo==="spedizione"){let a=(e.righe||[]).reduce((l,m)=>l+m.qty,0),c=(e.righe||[]).map(l=>`<div class="kit-assemb-sub-row"><span class="kit-assemb-sub-mat" style="color:#94a3b8">${r(l.mat)}</span><span class="kit-mov-qty scarico">\u2212${l.qty}</span></div>`).join(""),d=(e.items||[]).map(l=>`<div class="kit-assemb-sub-row kit-sped-item-row"><span class="kit-assemb-sub-mat">${r(l.nome)}</span><span class="kit-mov-qty scarico">\xD7${l.qty}</span></div>`).join("");return`<details class="kit-mov-assemb-group">
        ...
        <div class="kit-cfg-section">
            ...
            ${g}
        </div>`,f=(i.sezioni||[]).map((v,I)=>{let k=(v.componenti||[]).map(w=>{let M=j(w),B=Gt(w,i),si=(e||[]).find(q=>q.id===B.asseId)||null,Vi=B.tipo==="gruppo"&&si?`<div class="kit-cfg-row">${(si.opzioni||[]).map(q=>`<label class="kit-meta-pill">
                   ...
                   </select>`:"",Ui=B.tipo==="manuale"?'<div class="kit-cfg-warn">Questa parte usa ancora una configurazione avanzata precedente. Appena la modifichi verr\xE0 convertita nel nuovo schema semplice.</div>':"",ai=M?"flag":St(w.unitaMisura,"pz"),Fi=M?[{value:"flag",label:"Solo avviso"}]:[...new Set([ai,...Xi])].filter(Boolean).map(q=>({value:q,label:q}));return`<div class="kit-cfg-sa-group" style="padding:12px 14px">
                ...
                <div class="kit-cfg-row">
                    ...
                    <select class="kit-cfg-select" style="max-width:120px"
                            ...
                            ${M?"disabled":""}>
                        ${Fi.map(q=>`<option value="${r(q.value)}" ${ai===q.value?"selected":""}>${r(q.label)}</option>`).join("")}
                    </select>
    ...
    </div>`,zt(n)}function po(t){if(t&&T===t){K();return}T=t,K()}function mo(t){at=t,lo()}function S(t,i,n=!0){let{kits:e}=b(),o=e.find(s=>s.id===t);o&&(i(o),A(e),n&&Q())}function uo(t,i){S(t,function(n){n.nome=i.trim()||"Kit senza nome"},!1)}function fo(t){if(!confirm("Eliminare questo kit e tutti i suoi dati?"))return;let{kits:i}=b();A(i.filter(n=>n.id!==t)),Mi=null,T=null,yt()}function go(t){let{kits:i}=b(),n=i.find(o=>o.id===t);if(!n)return;let e={id:_(),nome:`Copia di ${n.nome}`,schemaVersion:Vt,assiConfigurazione:[],varianti:[],sezioni:[],sottoAssembly:[],qtaDaProdurre:{},pronti:{},movimenti:[]};for(let o of n.assiConfigurazione||[])e.assiConfigurazione.push(mi(o,n,e));e.varianti=li(e.assiConfigurazione);for(let o of n.sezioni||[])e.sezioni.push(At(o,n,e));e.sottoAssembly=(n.sottoAssembly||[]).map(o=>({id:_(),nome:o.nome||"",varianteKey:o.varianteKey||"",noteConfig:o.noteConfig||""})),i.push(e),A(i),Pi(e.id),y(`Kit "${n.nome}" duplicato \u2713`)}function ji(t){S(t,function(i){let n=(i.assiConfigurazione||[]).length+1;i.assiConfigurazione=i.assiConfigurazione||[],i.assiConfigurazione.push({id:_(),key:"asse"+n,nome:"Asse "+n,opzioni:[{id:_(),key:"opz1",nome:"Opzione 1"}]})})}function ko(t,i,n,e){S(t,function(o){let s=(o.assiConfigurazione||[]).find(a=>a.id===i);s&&(n==="key"?s.key=W(e,s.key||"asse"):s[n]=e.trim())})}function vo(t,i){S(t,function(n){n.assiConfigurazione=(n.assiConfigurazione||[]).filter(e=>e.id!==i)})}function yo(t,i){S(t,function(n){let e=(n.assiConfigurazione||[]).find(s=>s.id===i);if(!e)return;let o=(e.opzioni||[]).length+1;e.opzioni=e.opzioni||[],e.opzioni.push({id:_(),key:"opz"+o,nome:"Opzione "+o,codice:""})})}function bo(t,i,n,e,o){S(t,function(s){let a=(s.assiConfigurazione||[]).find(d=>d.id===i),c=a&&(a.opzioni||[]).find(d=>d.id===n);c&&(e==="key"?c.key=W(o,c.key||"opzione"):c[e]=o.trim())})}function ho(t,i,n){S(t,function(e){let o=(e.assiConfigurazione||[]).find(s=>s.id===i);o&&(o.opzioni=(o.opzioni||[]).filter(s=>s.id!==n))})}function zo(t){ji(t)}function wo(t){S(t,function(i){i.sezioni=i.sezioni||[],i.sezioni.push({id:_(),nome:"Nuova sezione",componenti:[]})})}function _o(t){Ki(t)}function Co(t,i,n,e){S(t,function(o){let s=(o.sezioni||[]).find(a=>a.id===i);s&&(s[n]=e.trim())},!1)}function $o(t,i){confirm("Eliminare questa sezione e tutti i suoi componenti?")&&S(t,function(n){n.sezioni=(n.sezioni||[]).filter(e=>e.id!==i)})}function So(t,i){S(t,function(n){let e=(n.sezioni||[]).find(o=>o.id===i);e&&(e.componenti=e.componenti||[],e.componenti.push({id:_(),nome:"Nuovo componente",codice:"",qtaPerVariante:{},caricato:0,modoComponente:"quantificato",tracciabile:!0,noteConfig:"",unitaMisura:"pz"}))})}function xo(t,i,n,e,o,s){S(t,function(a){let c=(a.sezioni||[]).find(l=>l.id===i),d=c&&(c.componenti||[]).find(l=>l.id===n);if(d){if(e==="coeff"||e==="flag"){d.qtaPerVariante=d.qtaPerVariante||{},d.qtaPerVariante[o]=X(s);return}if(e==="modo"){d.modoComponente=s==="segnalazione"?"segnalazione":"quantificato",d.modoComponente==="segnalazione"?(d.tracciabile=!1,d.unitaMisura="flag"):d.unitaMisura==="flag"&&(d.unitaMisura="pz");return}if(e==="unitaMisura"){d.unitaMisura=d.modoComponente==="segnalazione"?"flag":St(s,"pz");return}d[e]=s.trim()}},e!=="nome"&&e!=="noteConfig")}function Io(t,i,n,e,o){S(t,function(s){let a=(s.sezioni||[]).find(l=>l.id===i),c=a&&(a.componenti||[]).find(l=>l.id===n);if(!c)return;let d=Gt(c,s);if(e==="tipo"){if(d.tipo=o==="gruppo"?"gruppo":"sempre",d.tipo==="gruppo"&&!d.asseId){d.asseId=s.assiConfigurazione?.[0]?.id||"";let l=(s.assiConfigurazione||[]).find(m=>m.id===d.asseId);d.opzioneIds=l?.opzioni?.length?[l.opzioni[0].id]:[]}}else if(e==="qtyBase")d.qtyBase=X(o);else if(e==="asseId"){d.asseId=String(o||"");let l=(s.assiConfigurazione||[]).find(m=>m.id===d.asseId);d.opzioneIds=l?.opzioni?.length?[l.opzioni[0].id]:[],d.tipo="gruppo"}c.applicazioneTipo=d.tipo,c.applicazioneAsseId=d.asseId,c.applicazioneOpzioneIds=d.opzioneIds,c.qtaBase=d.qtyBase,c.qtaPerVariante=Qt(c,s,d)})}function Ao(t,i,n,e,o){S(t,function(s){let a=(s.sezioni||[]).find(m=>m.id===i),c=a&&(a.componenti||[]).find(m=>m.id===n);if(!c)return;let d=Gt(c,s),l=new Set(d.opzioneIds||[]);o?l.add(e):l.delete(e),d.tipo="gruppo",d.opzioneIds=[...l],c.applicazioneTipo=d.tipo,c.applicazioneAsseId=d.asseId,c.applicazioneOpzioneIds=d.opzioneIds,c.qtaBase=d.qtyBase,c.qtaPerVariante=Qt(c,s,d)})}function Mo(t,i,n,e){S(t,function(o){let s=(o.sezioni||[]).find(c=>c.id===i),a=s&&(s.componenti||[]).find(c=>c.id===n);!a||j(a)||(a.tracciabile=!!e)},!1)}function No(t,i,n){S(t,function(e){let o=(e.sezioni||[]).find(s=>s.id===i);o&&(o.componenti=(o.componenti||[]).filter(s=>s.id!==n))})}function Oo(t){S(t,function(i){i.sottoAssembly=i.sottoAssembly||[],i.sottoAssembly.push({id:_(),nome:"",varianteKey:E(i)[0]?.key||""})})}function qo(t,i){S(t,function(n){n.sottoAssembly=n.sottoAssembly||[],n.sottoAssembly.push({id:_(),nome:"",varianteKey:i,noteConfig:""})})}function Eo(t,i,n,e){S(t,function(o){o.sottoAssembly[i]&&(o.sottoAssembly[i][n]=e.trim())},!1)}function Do(t,i){S(t,function(n){n.sottoAssembly.splice(i,1)})}function Bo(t){let i=document.getElementById("modal-kit-distinta-edit");if(!i){zi(t);return}let{kits:n}=b(),e=n.find(d=>d.id===t);if(!e)return;let o=et(e),s=U(o),a=document.getElementById("distinta-edit-nome"),c=document.getElementById("distinta-edit-documento");a&&(a.value=s.documento||""),c&&(c.value=s.documento||""),i.dataset.kitId=t,i.style.display="flex",i.offsetHeight,i.classList.add("active"),setTimeout(()=>a&&a.focus(),80)}function jt(){let t=document.getElementById("modal-kit-distinta-edit");t&&(t.classList.remove("active"),setTimeout(()=>{t.classList.contains("active")||(t.style.display="none")},300))}function To(){let t=document.getElementById("modal-kit-distinta-edit");if(!t)return;let i=t.dataset.kitId,n=(document.getElementById("distinta-edit-nome")?.value||"").trim(),e=(document.getElementById("distinta-edit-documento")?.value||"").trim();if(!n){y("Inserisci un nome per la distinta.","warning");return}J(i,function(m){let p=U(m);e?p.documento=e:p.documento||(p.documento=n),It(m,p)});let{kits:o}=b(),s=o.find(m=>m.id===i);if(!s){jt(),y("Kit non trovato \u26A0\uFE0F");return}let a=et(s),c=Tt(s,a);if(!c.totalePezzi||!c.totaleRighe){y("Componi prima un ordine per generare la distinta stampabile.","warning");return}let d=nt(),l={id:_(),kitId:s.id,kitNome:s.nome,nome:n||a._meta?.documento||`Distinta-${Date.now()}`,documento:e||a._meta?.documento||"",createdAt:Date.now(),createdBy:V?.nome||"Sistema",orderDraftSnapshot:a,distintaSnapshot:c};d.unshift(l),xt(d),jt(),y("Distinta salvata \u2713"),P==="distinte"&&D("distinte")}function Qo(){window._kitOpenView=He,window._kitOpenConfig=Pi,window._kitNuovoKit=Qn,window._kitBack=je,window._kitOpenPrintPreview=Me,window._kitSwitchTab=Ve,window._kitAggiornaQty=Qe,window._kitOrdineSet=Ue,window._kitOrdineDelta=Fe,window._kitOrdineReset=Je,window._kitOrdineResetVoce=Ge,window._kitOrderSearch=We,window._kitOrderHideSearch=Ye,window._kitOrderPick=Ze,window._kitOrderRemoveRef=Xe,window._kitComposeSelect=tn,window._kitComposeAdd=en,window._kitAggiornaCar=Ci,window._kitAggiornaPronti=nn,window._kitSetPronti=on,window._kitApriModalSped=pn,window._kitChiudiModalSped=Ii,window._kitConfermaSpedizione=mn,window._kitApriModalReso=un,window._kitChiudiModalReso=Ai,window._kitResoQtyChange=fn,window._kitResoAggiornaBOM=oi,window._kitConfermaReso=gn,window._kitSalvaMovimento=an,window._kitEliminaMovimento=rn,window._kitModificaMovimento=dn,window._kitChiudiModalEditMov=xi,window._kitConfermaModificaMov=ln,window._kitChiudiModalDelMov=$i,window._kitConfermaEliminaMov=Si,window._kitSalvaManuale=kn,window._kitElimina=fo,window._kitDuplicaKit=go,window._kitCfgBack=po,window._kitCfgSwitchTab=mo,window._kitCfgSaveNome=uo,window._kitCfgAddVar=zo,window._kitCfgOpenImportModal=Ki,window._kitCfgOpenImportAsseModal=Un,window._kitCfgOpenCopySezModal=Fn,window._kitCfgCloseImportModal=pt,window._kitCfgSetImportMode=Jn,window._kitCfgSetImportSearch=Gn,window._kitCfgSelectImportSource=Wn,window._kitCfgSelectImportSection=Yn,window._kitCfgToggleImportTarget=Zn,window._kitCfgSelectAllImportTargets=Xn,window._kitCfgClearImportTargets=to,window._kitCfgConfirmImport=io,window._kitOpenPresetsModal=eo,window._kitClosePresetsModal=Ri,window._kitSetPresetsSearch=no,window._kitSelectPreset=oo,window._kitCreatePresetFromSection=so,window._kitCreatePreset=Hi,window._kitApplyPreset=ao,window._kitRenamePreset=ro,window._kitDeletePreset=co,window._kitCfgAddAsse=ji,window._kitCfgUpdateAsse=ko,window._kitCfgDelAsse=vo,window._kitCfgAddOpzione=yo,window._kitCfgUpdateOpzione=bo,window._kitCfgDelOpzione=ho,window._kitCfgAddSez=wo,window._kitCfgImportSez=_o,window._kitCfgUpdateSez=Co,window._kitCfgDelSez=$o,window._kitCfgAddComp=So,window._kitCfgUpdateComp=xo,window._kitCfgUpdateCompRule=Io,window._kitCfgToggleCompOption=Ao,window._kitCfgToggleCompTracked=Mo,window._kitCfgDelComp=No,window._kitCfgAddSA=Oo,window._kitCfgAddSAForVariant=qo,window._kitCfgUpdateSA=Eo,window._kitCfgDelSA=Do,window._kitSwitchMainTab=D,window._kitRenderKitsGrid=yi,window._kitRenderAnagrafichePage=bi,window._kitRenderDistintePage=hi,window._kitLoadDistinte=nt,window._kitSaveDistinte=xt,window._kitCreateDistintaFromDraft=zi,window._kitLoadAnagrafiche=Y,window._kitSaveAnagrafiche=ni,window._kitOpenAnagraficaModal=Be,window._kitCloseAnagraficaModal=wi,window._kitConfirmSaveAnagrafica=Te,window._kitDeleteAnagrafica=Le,window._kitOpenCreaKit=qi,window._kitCloseCreaKit=Ei,window._kitConfirmCreaKit=On,window._kitOpenConfigModal=Oi,window._kitCloseConfigModal=vn,window._kitRenderConfigModal=Q,window._kitCfgModalSaveNome=yn,window._kitCfgModalAddAnag=zn,window._kitCfgModalAddCompFree=wn,window._kitCfgModalUpdateSez=bn,window._kitCfgModalDelSez=hn,window._kitCfgModalUpdateComp=_n,window._kitCfgModalUpdateCompRule=Cn,window._kitCfgModalDelComp=$n,window._kitCfgModalAddAsse=Sn,window._kitCfgModalDelAsse=xn,window._kitCfgModalUpdateAsse=In,window._kitCfgModalAddOpz=An,window._kitCfgModalDelOpz=Mn,window._kitCfgModalUpdateOpz=Nn,window._kitQAddSezOpen=qn,window._kitQAddSezClose=Di,window._kitQAddSezConfirm=En,window._kitQAddCompOpen=Dn,window._kitQAddCompToggleSource=Ht,window._kitQAddCompChangeCategoria=Bi,window._kitQAddCompClose=Ti,window._kitQAddCompConfirm=Bn,window._kitQUpdateComp=Tn,window._kitQRenomeSez=Ln,window._kitQDelComp=Pn,window._kitQDelSez=Kn,window._kitQDelKit=Rn,window._kitOpenDuplicateModal=Hn,window._kitCloseDuplicateModal=Li,window._kitConfirmDuplicate=jn,window._kitRenderHeaderActions=ei,window._kitOpenSaveDistintaModal=Bo,window._kitCloseSaveDistintaModal=jt,window._kitConfirmSaveDistinta=To,window._kitDistintaOpenPrint=Pe,window._kitDistintaApplyToDraft=Ke,window._kitDistintaDelete=Re,window._kitNSToggleComp=ge,window._kitNSSetUnits=fe,window._kitNSOrderSearch=ke,window._kitNSOrderHideSearch=ve,window._kitNSOrderPick=ye,window._kitNSOrderRemoveRef=be,window._kitNSReset=ze,window._kitNSToggleSection=fi,window._kitNSToggleSectionChk=he,window._kitNSCreateDistinta=we,window._kitNSOpenPrintPreview=_e}var Vt,Xi,x,Rt,st,wt,Kt,P,_t,mt,T,_i,Mi,at,C,O,ft,F,Ni,Uo,Lo=Ji(()=>{Gi();Yi();Zi();Wi();Vt=2,Xi=["pz","mt","cm","mm","kg","g","lt","ml"];x=$t({});Rt=!1,st=[],wt=null,Kt={},P="kits";_t={};mt=null;typeof window<"u"&&window.addEventListener("beforeunload",function(){Ne()});T=null,_i="ordine";Mi=null,at="info",C=null,O=null,ft={kitId:null,sezId:null},F=null,Ni={sourceKitId:null};Uo=yt});Lo();export{yt as caricaKitProdotti,Uo as default,Qo as registerGlobals,Vo as resetKitFetch};
//# sourceMappingURL=chunk-kit-prodotti-DCZ7WSJQ.js.map
