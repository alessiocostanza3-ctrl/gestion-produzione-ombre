import{a as Gi,c as Pt,e as Wi,f as r,g as y,h as zt,l as Yi,m as V,q as Zi,r as lt,u as Xi}from"./chunk-chunk-55SFP7PR.js";function $t(t){let i=Array.isArray(t)?{kits:t}:t&&typeof t=="object"?t:{},n=i.orderDrafts,e=n&&typeof n=="object"&&!Array.isArray(n)?n:{};return{kits:Array.isArray(i.kits)?i.kits.map(Ft):[],anagrafiche:Array.isArray(i.anagrafiche)?i.anagrafiche:[],distinte:Array.isArray(i.distinte)?i.distinte:[],presets:Array.isArray(i.presets)?i.presets:[],orderDrafts:e,draftDocSeq:Math.max(0,Number.parseInt(i.draftDocSeq,10)||0),ts:Number(i.ts||0)||0}}function Ot(){return{kits:x.kits,anagrafiche:x.anagrafiche,distinte:x.distinte,presets:x.presets,orderDrafts:x.orderDrafts,draftDocSeq:x.draftDocSeq}}function ci(t){let i=$t(t||{});return!!(i.kits&&i.kits.length||i.anagrafiche&&i.anagrafiche.length||i.distinte&&i.distinte.length||i.presets&&i.presets.length||i.orderDrafts&&Object.keys(i.orderDrafts).length||i.draftDocSeq>0)}function ie(){try{let t=localStorage.getItem("_mlKitData"),i=t?JSON.parse(t):{},n=Array.isArray(i)?i:Array.isArray(i?.kits)?i.kits:[],e=JSON.parse(localStorage.getItem("_mlKitAnagrafiche")||"[]"),o=JSON.parse(localStorage.getItem("_mlKitDistinte")||"[]"),s=JSON.parse(localStorage.getItem("_mlKitPresetSections")||"[]"),a=JSON.parse(localStorage.getItem("_mlKitOrderDrafts")||"{}"),d=Number.parseInt(localStorage.getItem("_mlKitOrderDraftSeq")||"0",10)||0;return{kits:Array.isArray(n)?n:[],anagrafiche:Array.isArray(e)?e:[],distinte:Array.isArray(o)?o:[],presets:Array.isArray(s)?s:[],orderDrafts:a&&typeof a=="object"&&!Array.isArray(a)?a:{},draftDocSeq:d}}catch{return $t({})}}function ee(){["_mlKitData","_mlKitDataTs","_mlKitOrderDrafts","_mlKitOrderDraftSeq","_mlKitPresetSections","_mlKitDistinte","_mlKitDistinteTs","_mlKitAnagrafiche","_mlKitAnagraficheTs"].forEach(function(i){try{localStorage.removeItem(i)}catch{}})}function Qo(){Rt=!1}function W(t,i){return String(t||"").trim().toLowerCase().replace(/\s+/g,"_").replace(/[^a-z0-9_-]/g,"")||i}function X(t){let i=String(t??"").trim().replace(",","."),n=Number.parseFloat(i);return Number.isFinite(n)?Math.max(0,n):0}function G(t){let i=Number(t);if(!Number.isFinite(i))return"0";let n=Math.round(i*1e3)/1e3;return Math.abs(n-Math.round(n))<1e-9?String(Math.round(n)):n.toLocaleString("it-IT",{minimumFractionDigits:0,maximumFractionDigits:3})}function St(t,i="pz"){return String(t||i).trim().toLowerCase()||i}function ne(t,i){let n="opz"+(i+1),e=W(t?.key,n);return{id:String(t?.id||_()),key:e,nome:String(t?.nome||e).trim()||e,codice:String(t?.codice||"").trim()}}function oe(t,i){let n="asse"+(i+1),e=W(t?.key,n),o=Array.isArray(t?.opzioni)?t.opzioni.map((s,a)=>ne(s,a)).filter(Boolean):[];return{id:String(t?.id||_()),key:e,nome:String(t?.nome||e).trim()||e,opzioni:o}}function li(t){return t.length===1?t[0].opzioneKey:t.map(function(i){return i.asseKey+"="+i.opzioneKey}).join("|")}function se(t){return t.length===1?t[0].opzioneNome:t.map(function(i){return i.asseNome+": "+i.opzioneNome}).join(" \xB7 ")}function pi(t){if(!Array.isArray(t)||!t.length)return[];let i=t.filter(e=>Array.isArray(e.opzioni)&&e.opzioni.length);if(!i.length)return[];let n=[{selections:[]}];for(let e of i){let o=[];for(let s of n)for(let a of e.opzioni)o.push({selections:s.selections.concat({asseId:e.id,asseKey:e.key,asseNome:e.nome,opzioneId:a.id,opzioneKey:a.key,opzioneNome:a.nome,opzioneCodice:String(a.codice||"").trim()})});n=o}return n.map(function(e,o){return{id:"combo-"+(o+1),key:li(e.selections),nome:se(e.selections),selections:e.selections}})}function ae(t){let i=String(t?.modoComponente||"quantificato").trim()||"quantificato",n=i==="segnalazione"?!1:t?.tracciabile!==void 0?!!t.tracciabile:!0,e=i==="segnalazione"?"flag":"pz";return{id:String(t?.id||_()),nome:String(t?.nome||"Nuovo componente").trim()||"Nuovo componente",codice:String(t?.codice||"").trim(),qtaPerVariante:{...t?.qtaPerVariante||{}},caricato:Number(t?.caricato||0),modoComponente:i,tracciabile:n,noteConfig:String(t?.noteConfig||"").trim(),unitaMisura:St(t?.unitaMisura,e),applicazioneTipo:String(t?.applicazioneTipo||"").trim(),applicazioneAsseId:String(t?.applicazioneAsseId||"").trim(),applicazioneOpzioneIds:Array.isArray(t?.applicazioneOpzioneIds)?t.applicazioneOpzioneIds.map(String):[],qtaBase:X(t?.qtaBase)}}function re(t){return{id:String(t?.id||_()),nome:String(t?.nome||"Nuova sezione").trim()||"Nuova sezione",componenti:Array.isArray(t?.componenti)?t.componenti.map(ae):[]}}function ce(t,i){if(t.size!==i.size)return!1;for(let n of t)if(!i.has(n))return!1;return!0}function mi(t,i){let n={tipo:"sempre",asseId:"",opzioneIds:[],qtyBase:X(t?.qtaBase)};if(t?.applicazioneTipo==="sempre"||t?.applicazioneTipo==="gruppo")return{tipo:t.applicazioneTipo,asseId:String(t.applicazioneAsseId||""),opzioneIds:Array.isArray(t.applicazioneOpzioneIds)?t.applicazioneOpzioneIds.map(String):[],qtyBase:n.qtyBase||X(Object.values(t?.qtaPerVariante||{})[0])};let e=E(i);if(!e.length)return n;let o=e.filter(c=>H(t,c.key)>0);if(!o.length)return n;let s=new Set(o.map(c=>H(t,c.key)));if(s.size!==1)return{tipo:"manuale",asseId:"",opzioneIds:[],qtyBase:Math.max(...o.map(c=>H(t,c.key)))};let a=[...s][0];if(o.length===e.length)return{tipo:"sempre",asseId:"",opzioneIds:[],qtyBase:a};let d=new Set(o.map(c=>c.key));for(let c of i.assiConfigurazione||[]){let l=[];for(let p of c.opzioni||[]){let u=new Set(e.filter(h=>(h.selections||[]).some(f=>f.asseId===c.id&&f.opzioneId===p.id)).map(h=>h.key));if(!u.size)continue;[...u].every(h=>H(t,h)===a)&&l.push(p.id)}if(!l.length)continue;let m=new Set(e.filter(p=>(p.selections||[]).some(u=>u.asseId===c.id&&l.includes(u.opzioneId))).map(p=>p.key));if(ce(m,d))return{tipo:"gruppo",asseId:c.id,opzioneIds:l,qtyBase:a}}return{tipo:"manuale",asseId:"",opzioneIds:[],qtyBase:a}}function Qt(t,i,n){if(!n||n.tipo==="manuale")return{...t?.qtaPerVariante||{}};let e={},o=X(n.qtyBase);if(!o)return e;for(let s of E(i)){let a=n.tipo==="sempre";n.tipo==="gruppo"&&(a=(s.selections||[]).some(d=>d.asseId===n.asseId&&n.opzioneIds.includes(d.opzioneId))),a&&(e[s.key]=o)}return e}function de(t,i){let n=re(t);return n.componenti=n.componenti.map(function(e){let o=mi(e,i);return{...e,applicazioneTipo:o.tipo,applicazioneAsseId:o.asseId,applicazioneOpzioneIds:o.opzioneIds,qtaBase:o.qtyBase,qtaPerVariante:Qt(e,i,o)}}),n}function le(t,i){let n=E(i);if(!n.length)return null;let e=null;for(let o of n){let s=H(t,o.key);if(e===null){e=s;continue}if(e!==s)return null}return e}function pe(t,i,n){let e=E(n),o={},s=le(t,i);if(!e.length)Object.assign(o,t?.qtaPerVariante||{});else for(let a of e){let c=Object.prototype.hasOwnProperty.call(t?.qtaPerVariante||{},a.key)?H(t,a.key):s!==null?s:0;c>0&&(o[a.key]=c)}return{id:_(),nome:String(t?.nome||"Nuovo componente").trim()||"Nuovo componente",qtaPerVariante:o,caricato:0,modoComponente:t?.modoComponente==="segnalazione"?"segnalazione":"quantificato",tracciabile:Jt(t),noteConfig:String(t?.noteConfig||"").trim(),unitaMisura:St(t?.unitaMisura,j(t)?"flag":"pz")}}function At(t,i,n){return{id:_(),nome:String(t?.nome||"Nuova sezione").trim()||"Nuova sezione",componenti:Array.isArray(t?.componenti)?t.componenti.map(e=>pe(e,i,n)):[]}}function ui(t,i,n){let e=new Set((n.assiConfigurazione||[]).map(c=>c.key)),o=W(t?.key||String(t?.nome||"asse"),"asse1"),s=o,a=1;for(;e.has(s);)s=o+"_c"+a++;let d=[];for(let c=0;c<(t.opzioni||[]).length;c++){let l=t.opzioni[c],m="opz"+(c+1),p=W(l?.key,m),u=1;for(;d.some(g=>g.key===p);)p=p+"_c"+u++;d.push({id:_(),key:p,nome:String(l?.nome||"").trim()||p,codice:String(l?.codice||"").trim()})}return{id:_(),key:s,nome:String(t?.nome||"").trim()||s,opzioni:d}}function Ut(t,i){return(t?.sezioni||[]).find(n=>n.id===i)||null}function Ct(t,i){let n=new Set(E(t).map(s=>s.key)),e=E(i),o=e.filter(s=>n.has(s.key)).length;return{targetCount:e.length,exactMatches:o,hasTargetVarianti:e.length>0,needsReview:e.length===0||o<e.length}}function Mt(t,i){let n=String(i||"").trim().toLowerCase();return n?String(t||"").toLowerCase().includes(n):!0}function me(t,i){return{id:String(t?.id||_()),nome:String(t?.nome||"").trim(),varianteKey:String(t?.varianteKey||i||"").trim(),noteConfig:String(t?.noteConfig||"").trim()}}function Ft(t){let i=t&&typeof t=="object"?t:{},n=Array.isArray(i.varianti)?i.varianti.map(function(p,u){let g="v"+(u+1),h=W(p?.key,g);return{id:String(p?.id||_()),key:h,nome:String(p?.nome||h).trim()||h}}):[],e=Array.isArray(i.assiConfigurazione)?i.assiConfigurazione.map((p,u)=>oe(p,u)):[],o=e.length?e:n.length?[{id:"asse-legacy-"+String(i.id||"kit"),key:"configurazione",nome:"Configurazione",opzioni:n.map(function(p){return{id:p.id,key:p.key,nome:p.nome}})}]:[],s=pi(o),a=s.length?s:n,d=new Set(a.map(p=>p.key)),c={};Object.entries(i.qtaDaProdurre||{}).forEach(function(p){d.has(p[0])&&(c[p[0]]=Math.max(0,Number.parseInt(p[1],10)||0))});for(let p of a)c[p.key]===void 0&&(c[p.key]=0);let l=Array.isArray(i.sottoAssembly)?i.sottoAssembly.map(p=>me(p,a[0]?.key||"")).filter(p=>!p.varianteKey||d.has(p.varianteKey)):[],m={};return Object.entries(i.pronti||{}).forEach(function(p){m[p[0]]=Math.max(0,Number.parseInt(p[1],10)||0)}),{id:String(i.id||_()),nome:String(i.nome||"Nuovo Kit").trim()||"Nuovo Kit",schemaVersion:Vt,assiConfigurazione:o,varianti:a,sezioni:Array.isArray(i.sezioni)?i.sezioni.map(p=>de(p,{assiConfigurazione:o,varianti:a})):[],sottoAssembly:l,qtaDaProdurre:c,pronti:m,movimenti:Array.isArray(i.movimenti)?i.movimenti.slice():[]}}function E(t){return Array.isArray(t?.varianti)?t.varianti:[]}function j(t){return!!t&&t.modoComponente==="segnalazione"}function Jt(t){return!!t&&t.tracciabile!==!1&&!j(t)}function H(t,i){let n=X(t?.qtaPerVariante?.[i]);return j(t)?n>0?1:0:n}function Gt(t,i){return mi(t,i)}function gt(){let t=x.orderDrafts;return t&&typeof t=="object"?JSON.parse(JSON.stringify(t)):{}}function qt(t){let i=t&&typeof t=="object"?t:{};x.orderDrafts=i,vt()}function kt(){return Array.isArray(x.presets)?JSON.parse(JSON.stringify(x.presets)):[]}function Wt(t){x.presets=Array.isArray(t)?t:[],vt()}function nt(){return Array.isArray(x.distinte)?JSON.parse(JSON.stringify(x.distinte)):[]}function xt(t){x.distinte=Array.isArray(t)?t:[],vt()}function ot(t){return String(t||"").trim().toUpperCase()}function it(t){let i=Array.isArray(t?.ordiniCliente)?[...new Set(t.ordiniCliente.map(ot).filter(Boolean))]:[];return{cliente:String(t?.cliente||"").trim(),ordiniCliente:i,documento:String(t?.documento||"").trim()}}function U(t){return it(t?._meta||{})}function It(t,i){return t._meta=it(i),t._meta}function rt(t,i){return Math.max(0,Number.parseInt(t?.[i],10)||0)}async function Et(){try{let n=await lt({azione:"reserveKitDraftSeq"}),e=Math.max(0,Number.parseInt(n?.draftDocSeq,10)||0);if(e>0&&(x.draftDocSeq=e),x.ts=Number(n?.ts||x.ts||Date.now())||Date.now(),n?.documento)return String(n.documento)}catch(n){console.warn("[kit-prodotti] reserveKitDraftSeq fallita, fallback locale:",n)}let i=Math.max(0,Number.parseInt(x.draftDocSeq,10)||0)+1;return x.draftDocSeq=i,vt(),`Distinta Base-${String(i).padStart(4,"0")}`}function di(t){let i=new Set;return(Array.isArray(t)?t:[]).filter(n=>String(n?.archiviato||"").toUpperCase()!=="TRUE").map(n=>({ordine:ot(n?.ordine||""),cliente:String(n?.cliente||"").trim()})).filter(n=>!n.ordine||i.has(n.ordine)?!1:(i.add(n.ordine),!0))}function Yt(){return st.length?Promise.resolve(st):Array.isArray(window._attiviProd)&&window._attiviProd.length?(st=di(window._attiviProd),Promise.resolve(st)):wt||(wt=fetch(Pt,{method:"POST",body:JSON.stringify({pagina:"PROGRAMMA PRODUZIONE DEL MESE"})}).then(t=>t.json()).then(t=>(st=di(t),st)).catch(function(t){return console.warn("[kit-prodotti] autocomplete ordini non disponibile:",t),[]}).finally(function(){wt=null}),wt)}function ue(t){let i=ot(t);return i&&st.find(n=>n.ordine===i)||null}function Bt(t,i={}){let n=[...new Set((Array.isArray(t)?t:[]).map(function(e){let o=ot(e);return o?i[o]?String(i[o]||"").trim():String(ue(o)?.cliente||"").trim():""}).filter(Boolean))];return n.length===1?n[0]:""}function et(t){let i=gt(),n=i?.[t?.id]&&typeof i[t.id]=="object"?i[t.id]:{},e={};for(let o of E(t)){let s=n[o.key];e[o.key]=Math.max(0,Number.parseInt(s,10)||0)}return e._meta=it(n._meta||{}),e}function J(t,i){let{kits:n}=b(),e=n.find(m=>m.id===t);if(!e)return;let o=gt(),s=et(e);i(s,e);let a={},d=!1;for(let m of E(e)){let p=Math.max(0,Number.parseInt(s[m.key],10)||0);a[m.key]=p,p>0&&(d=!0)}let c=it(s._meta||{}),l=!!(c.cliente||c.ordiniCliente.length||c.documento);(d||l)&&(a._meta=c),d||l?o[t]=a:delete o[t],qt(o),T===t&&K()}function fe(t){return Object.entries(t||{}).reduce(function(i,n){return n[0]==="_meta"?i:i+(Number.parseInt(n[1],10)||0)},0)}function fi(t){return!(t.assiConfigurazione&&t.assiConfigurazione.length)}function ut(t){let i=gt(),n=i?.[t]&&typeof i[t]=="object"?i[t]:{};return{_meta:it(n._meta||{}),_units:Math.max(1,Number.parseInt(n._units,10)||1),_sel:n._sel&&typeof n._sel=="object"?{...n._sel}:{}}}function ct(t,i,n){let e=gt(),o=e?.[t]&&typeof e[t]=="object"?e[t]:{},s={_meta:it(o._meta||{}),_units:Math.max(1,Number.parseInt(o._units,10)||1),_sel:o._sel&&typeof o._sel=="object"?{...o._sel}:{}};i(s);let a=Object.keys(s._sel).length>0,d=s._units>1,c=it(s._meta||{}),l=!!(c.cliente||c.ordiniCliente.length||c.documento);a||d||l?e[t]={_meta:c,_units:s._units,_sel:s._sel}:delete e[t],qt(e),n!==!1&&T===t&&K()}function ge(t,i){let n=Math.max(1,Number.parseInt(i,10)||1);try{window._kitSuppressNextFade=!0}catch{}ct(t,function(e){e._units=n})}function ke(t,i,n){try{window._kitSuppressNextFade=!0}catch{}ct(t,function(e){n?e._sel[i]=!0:delete e._sel[i]})}function ve(t,i){let n=String(i||"").trim().toLowerCase(),e=document.getElementById("kit-ns-autocomplete-"+t);if(e){if(!n){e.style.display="none",e.innerHTML="";return}Yt().then(function(o){let s=o.filter(function(a){return a.ordine.toLowerCase().includes(n)||a.cliente.toLowerCase().includes(n)}).slice(0,8);if(!s.length){e.style.display="none",e.innerHTML="";return}e.innerHTML=s.map(function(a){return`<div class="autocomplete-item" onmousedown='_kitNSOrderPick(${JSON.stringify(t)},${JSON.stringify(a.ordine)},${JSON.stringify(a.cliente)})'>
                <span class="ac-ordine">ORD. ${r(a.ordine)}</span>
                <span class="ac-cliente">${r(a.cliente)}</span>
            </div>`}).join(""),e.style.display="block"})}}function ye(t){setTimeout(function(){let i=document.getElementById("kit-ns-autocomplete-"+t);i&&(i.style.display="none",i.innerHTML="")},140)}function be(t,i,n){let e=ot(i);if(!e)return;try{window._kitSuppressNextFade=!0}catch{}ct(t,function(a){a._meta.ordiniCliente.includes(e)||a._meta.ordiniCliente.push(e),a._meta.cliente=Bt(a._meta.ordiniCliente,{[e]:n})});let o=document.getElementById("kit-ns-ref-input-"+t);o&&(o.value="");let s=document.getElementById("kit-ns-autocomplete-"+t);s&&(s.style.display="none",s.innerHTML="")}function he(t,i){let n=ot(i);try{window._kitSuppressNextFade=!0}catch{}ct(t,function(e){e._meta.ordiniCliente=e._meta.ordiniCliente.filter(function(o){return o!==n}),e._meta.cliente=Bt(e._meta.ordiniCliente)})}function gi(t,i,n){try{window._kitSuppressNextFade=!0}catch{}ct(t,function(e){i.forEach(function(o){n?e._sel[o]=!0:delete e._sel[o]})})}function ze(t){try{let i=t.dataset.kitid,n=JSON.parse(t.dataset.compids);gi(i,n,t.checked)}catch(i){console.error("[kit] _kitNSToggleSectionChk error",i)}}function we(t){if(!confirm("Azzerare la selezione corrente?"))return;let i=gt();delete i[t],qt(i),K()}function Dt(t,i){let n=Math.max(1,Number.parseInt(i._units,10)||1),e=i._sel&&typeof i._sel=="object"?i._sel:{},o=[],s=[];for(let a of t.sezioni||[]){let d=[];for(let c of a.componenti||[]){if(!e[c.id])continue;let l=X(c.qtaBase!=null?c.qtaBase:1)*n;d.push({id:c.id,nome:c.nome,codice:String(c.codice||"").trim(),totale:l,unita:c.unitaMisura||"pz",dettaglio:"",noteConfig:c.noteConfig||""}),c.noteConfig&&s.push({id:"note-"+c.id,tipo:"nota",nome:c.nome,dettaglio:c.noteConfig,totaleCoinvolto:l,variantiLabel:""})}d.length&&o.push({id:a.id,nome:a.nome,righe:d})}return{selectedVarianti:[],sezioni:o,avvisi:s,totalePezzi:n,totaleRighe:o.reduce(function(a,d){return a+d.righe.length},0),_isNewStyle:!0}}async function _e(t){let{kits:i}=b(),n=i.find(function(d){return d.id===t});if(!n)return;let e=ut(t),o=Dt(n,e);if(!o.totaleRighe){y("Seleziona almeno un componente per generare la distinta.","warning");return}if(!e._meta.documento){let d=await Et();ct(t,function(c){c._meta.documento=d},!1),e=ut(t)}let s={_meta:e._meta},a=nt();a.unshift({id:_(),kitId:n.id,kitNome:n.nome,nome:e._meta.documento||"Distinta-"+Date.now(),documento:e._meta.documento||"",createdAt:Date.now(),createdBy:V?.nome||"Sistema",orderDraftSnapshot:s,distintaSnapshot:o}),xt(a),y("Distinta salvata \u2713"),P==="distinte"&&B("distinte")}async function Ce(t){let{kits:i}=b(),n=i.find(function(d){return d.id===t});if(!n)return;let e=ut(t),o=Dt(n,e);if(!o.totaleRighe){y("Seleziona almeno un componente per generare l'anteprima.","warning");return}if(!e._meta.documento){let d=await Et();ct(t,function(c){c._meta.documento=d},!1),e=ut(t)}let s={_meta:e._meta},a=window.open("","_blank");if(!a){y("Popup bloccato: abilita l'anteprima di stampa.","warning");return}a.document.open(),a.document.write(Xt(n,o,s)),a.document.close(),a.focus()}function $e(t,i){let n=ut(t.id),e=n._units,o=n._sel,s=Dt(t,n),a=n._meta,d=t.sezioni||[],c=d.map(function(p){let u=p.componenti||[];if(!u.length)return"";let g=u.map(function($){let L=!!o[$.id],R=L?X($.qtaBase!=null?$.qtaBase:1)*e:0;return`<label class="kit-ns-comp-row${L?" kit-ns-comp-row--checked":""}">
    ...
    </div>`,i.querySelectorAll('[data-indeterminate="true"]').forEach(function(p){p.indeterminate=!0})}function Zt(t){let i=_t[t.id]&&typeof _t[t.id]=="object"?_t[t.id]:{},n={};for(let e of t.assiConfigurazione||[]){let o=new Set((e.opzioni||[]).map(s=>s.id));n[e.id]=o.has(i[e.id])?i[e.id]:e.opzioni?.[0]?.id||""}return _t[t.id]=n,n}function ki(t,i){let n=t.assiConfigurazione||[];if(!n.length)return E(t)[0]||null;let e=[];for(let s of n){let a=i?.[s.id],d=(s.opzioni||[]).find(c=>c.id===a);if(!d)return null;e.push({asseId:s.id,asseKey:s.key,asseNome:s.nome,opzioneId:d.id,opzioneKey:d.key,opzioneNome:d.nome})}let o=li(e);return E(t).find(s=>s.key===o)||null}function Se(t){let i=String(t?.asseNome||"").trim(),n=String(t?.opzioneNome||"").trim();return i?n?n.toLowerCase().includes(i.toLowerCase())||/\s/.test(n)?n:`${i} ${n}`.trim():i:n}function xe(t,i,n){let e=String(n?.asseId||""),o=String(n?.opzioneId||"");if(!e||!o)return!1;for(let s of t.sezioni||[])for(let a of s.componenti||[])if(!j(a)&&!(H(a,i.key)<=0)&&a.applicazioneTipo==="gruppo"&&String(a.applicazioneAsseId||"")===e&&Array.isArray(a.applicazioneOpzioneIds)&&a.applicazioneOpzioneIds.includes(o))return!0;return!1}function Ie(t,i,n){let e=[],o=new Map;for(let s of i){let a=rt(n,s.key);if(a)for(let d of s.selections||[]){if(xe(t,s,d))continue;let c=`${d.asseId||""}::${d.opzioneId||""}`,l=o.get(c);if(l){l.totale+=a;continue}let m={id:"sel-"+c,nome:Se(d),codice:String(d?.opzioneCodice||"").trim(),totale:a,unita:"pz",dettaglio:"",noteConfig:""};o.set(c,m),e.push(m)}}return e}function Tt(t,i){if(fi(t))return Dt(t,ut(t.id));let n=E(t).filter(a=>rt(i,a.key)>0),e=[],o=[],s=Ie(t,n,i);s.length&&e.push({id:"kit-distinta-elettronica",nome:"ELETTRONICA",righe:s});for(let a of t.sezioni||[]){let d=[];for(let c of a.componenti||[]){let l=0,m=[];for(let u of n){let g=rt(i,u.key),h=H(c,u.key);!g||!h||(j(c)?l+=g:l+=g*h,m.push({nome:u.nome,pezziOrdine:g,coeff:h}))}if(!m.length)continue;let p=m.length===1?m[0].nome:m.length+" configurazioni";if(j(c)){o.push({id:"alert-"+c.id,tipo:"alert",nome:c.nome,dettaglio:c.noteConfig||"Requisito da verificare in fase di approvvigionamento.",totaleCoinvolto:l,variantiLabel:p});continue}d.push({id:c.id,nome:c.nome,codice:String(c.codice||"").trim(),totale:l,unita:c.unitaMisura||"pz",dettaglio:"",noteConfig:c.noteConfig||""}),c.noteConfig&&o.push({id:"note-"+c.id,tipo:"nota",nome:c.nome,dettaglio:c.noteConfig,totaleCoinvolto:l,variantiLabel:p})}d.length&&e.push({id:a.id,nome:a.nome,righe:d})}return{selectedVarianti:n,sezioni:e,avvisi:o,totalePezzi:fe(i),totaleRighe:e.reduce((a,d)=>a+d.righe.length,0)}}function Ae(t,i=!0){let n=t instanceof Date?t:new Date(t);return Number.isNaN(n.getTime())?"\u2014":n.toLocaleString("it-IT",i?{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}:{day:"2-digit",month:"2-digit",year:"numeric"})}function Me(){return String(window._distintaHeaderAzienda||"").trim()}function Xt(t,i,n){let e=new Date,o=U(n),s=Me(),a=String(o.documento||"").trim(),d=s?s.split(/\r?\n/).map(g=>String(g||"").trim()).filter(Boolean).join(" - "):"",c=o.ordiniCliente.length>1?"Ordini cliente":"Ordine cliente",l=o.ordiniCliente.join(" \xB7 "),m=i.selectedVarianti.length?i.selectedVarianti.map(g=>{let h=rt(n,g.key);return`<tr>
                <td>${r(G(h))}</td>
                <td>${r(g.nome)}</td>
...
<body>
        ...
        <div class="db-print-page">
            ...
            <div class="db-print-meta-grid">
                <div class="db-print-meta-card">
                    ...
                    <div class="db-print-meta-row"><div class="db-print-meta-label">Data emissione</div><div class="db-print-meta-value">${r(Ae(e))}</div></div>
                </div>
                <div class="db-print-meta-card">
...
</html>`}async function Ne(t){let{kits:i}=b(),n=i.find(a=>a.id===t);if(!n)return;let e=et(n),o=Tt(n,e);if(!o.totalePezzi||!o.totaleRighe){y("Componi prima un ordine per generare la distinta stampabile.","warning");return}if(!U(e).documento){let a=await Et();J(t,function(d){let c=U(d);c.documento=a,It(d,c)}),e=et(n)}let s=window.open("","_blank");if(!s){y("Popup bloccato: abilita l'anteprima di stampa per aprire il modello completo.","warning");return}s.document.open(),s.document.write(Xt(n,o,e)),s.document.close(),s.focus()}function vi(t){return[...Array.isArray(t)?t:[]].sort((n,e)=>{let o=String(n?.nome||"").trim(),s=String(e?.nome||"").trim();return o.localeCompare(s,"it",{sensitivity:"base",numeric:!0})})}function b(){let t=Array.isArray(x.kits)?x.kits.map(Ft):[];return{kits:vi(t)}}function A(t){let i=vi(Array.isArray(t)?t.map(Ft):[]);x.kits=i,vt()}function Oe(){if(!mt)return;clearTimeout(mt),mt=null;let t=Ot();lt({azione:"setKitData",payload:t}).then(function(i){x.ts=Number(i?.ts||Date.now())||Date.now()}).catch(function(i){console.warn("[kit-prodotti] flush remoto fallito:",i)})}function vt(){clearTimeout(mt),mt=setTimeout(function(){mt=null;let t=Ot();lt({azione:"setKitData",payload:t}).then(function(i){x.ts=Number(i?.ts||Date.now())||Date.now()}).catch(function(i){console.warn("[kit-prodotti] salvataggio remoto fallito:",i)})},1500)}function qe(t){fetch(Pt,{method:"POST",body:JSON.stringify({azione:"getKitData"})}).then(i=>i.json()).then(i=>{if(i&&i.integrityOk===!1){console.error("[kit-prodotti] payload kit non leggibile lato server:",i.parseError||"parse error"),y("Errore lettura dati Kit dal server. Contatta subito supporto: nessun salvataggio automatico verr\xE0 forzato.","error"),t&&t(!1);return}let n=$t(i);if(ci(n)){x=n,t&&t(!0);return}let e=ie();if(ci(e)){x=$t(e),lt({azione:"setKitData",payload:Ot()}).then(function(o){x.ts=Number(o?.ts||Date.now())||Date.now(),ee(),y("Migrazione Kit completata: dati spostati su Sheets.","success"),t&&t(!0)}).catch(function(){t&&t(!1)});return}x=n,t&&t(!0)}).catch(()=>{t&&t(!1)})}function _(){return Math.random().toString(36).slice(2,10)+Date.now().toString(36)}function ti(){if(!V||!V.nome)return!1;let t=String(V.nome).toUpperCase().trim();return t==="ALESSIO"||t==="0000"||V.ruolo==="MASTER"}function Ee(t){let i={};for(let n of t.sezioni||[])for(let e of n.componenti||[]){if(j(e)){i[e.id]=0;continue}let o=0;for(let[s,a]of Object.entries(t.qtaDaProdurre||{}))o+=(Number.parseInt(a,10)||0)*H(e,s);i[e.id]=o}return i}function Be(t){let i={};for(let n of t.sottoAssembly||[]){let e=Number.parseInt(t.pronti?.[n.id],10)||0;if(!e)continue;let o=n.varianteKey;for(let s of t.sezioni||[])for(let a of s.componenti||[]){if(j(a))continue;let d=H(a,o);d>0&&(i[a.id]=(i[a.id]||0)+e*d)}}return i}function yi(t,i){let n=E(t).find(e=>e.key===i);return n?r(n.nome):r(i)}function ii(){return new Date().toLocaleString("it-IT",{day:"2-digit",month:"2-digit",year:"2-digit",hour:"2-digit",minute:"2-digit"})}function yt(){if(window.paginaAttuale!=="KIT_PRODOTTI")return;if(!Rt){Rt=!0;let n=document.getElementById("contenitore-dati");n&&(n.innerHTML="<div class='centered-msg'><i class='fas fa-spinner fa-spin'></i> Caricamento kit dal database...</div>"),qe(function(){yt()});return}let{kits:t}=b(),i=document.getElementById("contenitore-dati");if(i){i.innerHTML=`
    <div class="kit-page">
    ...
    </div>`,B(P),ei();try{if(window&&window._kitSuppressNextFade)try{delete window._kitSuppressNextFade}catch{}else zt(i)}catch{zt(i)}}}function bi(t,i){if(!i)return;if(!t.length){i.innerHTML=`
        ...
        </div>`;return}let n=["pz","mt","cm","mm","kg","g","lt","ml"],e=t.map(o=>{let s=o.sezioni||[],a=s.reduce((l,m)=>l+(m.componenti||[]).length,0),d=s.length,c=s.map(l=>{let m=l.componenti||[],p=m.map(u=>`
        ...
        <details class="ordine-group" style="margin-bottom:8px">
            ...
            <div class="ordine-items">`,s+=d.map(c=>`
                ...
                </div>`).join(""),s+="</div></details>"}i.innerHTML=s}function zi(t,i){if(!i)return;let n=nt();if(!n.length){i.innerHTML='<div style="padding:24px 0;text-align:center"><p class="acquisti-subtitle">Nessuna distinta salvata.</p></div>';return}let e=n.map(o=>`
        ...
        </details>`).join("");i.innerHTML=e}async function wi(t){let{kits:i}=b(),n=i.find(c=>c.id===t);if(!n){y("Kit non trovato \u26A0\uFE0F");return}let e=et(n);if(!U(e).documento){let c=await Et();J(t,function(l){let m=U(l);m.documento=c,It(l,m)}),e=et(n)}let o=Tt(n,e);if(!o.totalePezzi||!o.totaleRighe){y("Componi prima un ordine per generare la distinta stampabile.","warning");return}let s=nt(),a=U(e),d={id:_(),kitId:n.id,kitNome:n.nome,nome:a.documento||`Distinta-${Date.now()}`,documento:a.documento||"",createdAt:Date.now(),createdBy:V?.nome||"Sistema",orderDraftSnapshot:e,distintaSnapshot:o};s.unshift(d),xt(s),y("Distinta salvata \u2713"),P==="distinte"&&B("distinte")}function ni(t){return[...Array.isArray(t)?t:[]].sort((n,e)=>{let o=String(n?.categoria||"Senza categoria").trim()||"Senza categoria",s=String(e?.categoria||"Senza categoria").trim()||"Senza categoria",a=o.localeCompare(s,"it",{sensitivity:"base",numeric:!0});if(a!==0)return a;let d=String(n?.nome||"").trim(),c=String(e?.nome||"").trim(),l=d.localeCompare(c,"it",{sensitivity:"base",numeric:!0});if(l!==0)return l;let m=String(n?.codice||"").trim(),p=String(e?.codice||"").trim();return m.localeCompare(p,"it",{sensitivity:"base",numeric:!0})})}function Y(){let t=Array.isArray(x.anagrafiche)?JSON.parse(JSON.stringify(x.anagrafiche)):[];return ni(t)}function oi(t){x.anagrafiche=ni(Array.isArray(t)?t:[]),vt()}function De(){if(document.getElementById("modal-kit-anagrafica-edit"))return;let t=document.createElement("div");t.innerHTML=`
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn-modal-send" onclick="_kitConfirmSaveAnagrafica()"><i class="fas fa-save"></i> Salva</button>
            ...
            </span>`).join(""):'<div class="kit-order-meta-empty">Nessun ordine cliente collegato.</div>',l=Zt(i),m=ki(i,l),p=(i.assiConfigurazione||[]).length?(i.assiConfigurazione||[]).map(f=>`
    ...
    </div>`,zt(n),Yt().catch(()=>{})}function Ve(){T=null,yt()}function Qe(t){Ci=t,K()}function Ue(t){J(t,function(i,n){for(let e of E(n)){let o=document.getElementById("kit-qty-"+e.key);o&&(i[e.key]=Math.max(0,Number.parseInt(o.value,10)||0))}})}function Fe(t,i,n){try{window._kitSuppressNextFade=!0}catch{}J(t,function(e){e[i]=Math.max(0,Number.parseInt(n,10)||0)})}function Je(t,i,n){try{window._kitSuppressNextFade=!0}catch{}J(t,function(e){let o=Math.max(0,Number.parseInt(e[i],10)||0);e[i]=Math.max(0,o+n)})}function Ge(t){J(t,function(i){for(let n of Object.keys(i))n!=="_meta"&&(i[n]=0);i._meta=it({})})}function We(t,i){J(t,function(n){n[i]=0})}function Nt(t,i){let n=document.getElementById("kit-order-autocomplete-"+t);if(n){if(!i.length){n.style.display="none",n.innerHTML="";return}n.innerHTML=i.map(e=>`
    ...
    `).join(""),n.style.display="block"}}function Ye(t,i){let n=String(i||"").trim().toLowerCase();if(!n){Nt(t,[]);return}Yt().then(function(e){let o=e.filter(s=>s.ordine.toLowerCase().includes(n)||s.cliente.toLowerCase().includes(n)).slice(0,8);Nt(t,o)})}function Ze(t){setTimeout(function(){Nt(t,[])},140)}function Xe(t,i,n){let e=ot(i);if(!e)return;try{window._kitSuppressNextFade=!0}catch{}J(t,function(s){let a=U(s);a.ordiniCliente=[...new Set(a.ordiniCliente.concat(e))],a.cliente=Bt(a.ordiniCliente,{[e]:n}),It(s,a)});let o=document.getElementById("kit-order-ref-input-"+t);o&&(o.value=""),Nt(t,[])}function tn(t,i){let n=ot(i);try{window._kitSuppressNextFade=!0}catch{}J(t,function(e){let o=U(e);o.ordiniCliente=o.ordiniCliente.filter(s=>s!==n),o.cliente=Bt(o.ordiniCliente),It(e,o)})}function en(t,i,n){let{kits:e}=b(),o=e.find(a=>a.id===t);if(!o)return;let s=Zt(o);if(s[i]=n,_t[t]=s,T===t){try{window._kitSuppressNextFade=!0}catch{}K()}}function nn(t){let{kits:i}=b(),n=i.find(a=>a.id===t);if(!n)return;let e=ki(n,Zt(n));if(!e){y("Completa prima le scelte elettroniche \u26A0\uFE0F");return}let o=Math.max(0,Number.parseInt(document.getElementById("kit-compose-qty-"+t)?.value,10)||0);if(!o){y("Inserisci una quantit\xE0 valida \u26A0\uFE0F");return}if(Kt[t])return;Kt[t]=Date.now(),setTimeout(function(){try{delete Kt[t]}catch{}},600);try{window._kitSuppressNextFade=!0}catch{}J(t,function(a){a[e.key]=rt(a,e.key)+o});let s=document.getElementById("kit-compose-qty-"+t);s&&(s.value=1)}function $i(t){let i=t.dataset.cid,n=t.dataset.sid,e=Math.max(0,Number.parseInt(t.value,10)||0),{kits:o}=b(),s=o.find(z=>z.id===T);if(!s)return;let a=(s.sezioni||[]).find(z=>z.id===n),d=a&&(a.componenti||[]).find(z=>z.id===i);if(!d||!Jt(d))return;d.caricato=e,A(o);let l=Ee(s)[i]||0,m=Math.max(0,l-e),u=Be(s)[i]||0,g=t.closest("tr");if(!g)return;let h=g.querySelector(".kit-ord-zero,.kit-ord-manca,.kit-ord-ok");h&&(h.textContent=l===0?"\u2014":m,h.className=l===0?"kit-ord-zero":m>0?"kit-ord-manca":"kit-ord-ok");let f=g.querySelector(".kit-car-liberi");f&&(u>0?(f.textContent=Math.max(0,e-u)+" lib.",f.style.display=""):f.style.display="none")}function on(t,i,n){let{kits:e}=b(),o=e.find(s=>s.id===t);o&&(o.pronti||(o.pronti={}),o.pronti[i]=Math.max(0,(Number.parseInt(o.pronti[i],10)||0)+n),A(e),T===t&&K())}function sn(t,i,n){let{kits:e}=b(),o=e.find(a=>a.id===t);if(!o)return;o.pronti||(o.pronti={}),o.pronti[i]=Math.max(0,Number.parseInt(n,10)||0),A(e);let s=document.querySelector(`.kit-pronti-input[data-said="${i}"]`);s&&(s.value=o.pronti[i],s.classList.toggle("kit-pronti-val-on",o.pronti[i]>0))}function an(t,i){let n=t.movimenti||[];return n.length?n.map(e=>{let o=i?`<button type="button" class="kit-mov-del" onclick="_kitEliminaMovimento('${r(t.id)}',${e.id})" title="Elimina">\u2715</button>`:'<span style="width:22px;flex-shrink:0"></span>',s=i&&(e.tipo==="carico"||e.tipo==="scarico")?`<button type="button" class="kit-mov-edit" onclick="_kitModificaMovimento('${r(t.id)}',${e.id})" title="Modifica">\u270E</button>`:'<span style="width:22px;flex-shrink:0"></span>';if(e.tipo==="spedizione"){let a=(e.righe||[]).reduce((l,m)=>l+m.qty,0),d=(e.righe||[]).map(l=>`<div class="kit-assemb-sub-row"><span class="kit-assemb-sub-mat" style="color:#94a3b8">${r(l.mat)}</span><span class="kit-mov-qty scarico">\u2212${l.qty}</span></div>`).join(""),c=(e.items||[]).map(l=>`<div class="kit-assemb-sub-row kit-sped-item-row"><span class="kit-assemb-sub-mat">${r(l.nome)}</span><span class="kit-mov-qty scarico">\xD7${l.qty}</span></div>`).join("");return`<details class="kit-mov-assemb-group">
            ...
            <span class="kit-mov-ts">${e.ts}</span>
            ${s}${o}
        </div>`}).join(""):'<div class="kit-mov-empty">Nessun movimento registrato.</div>'}function rn(t,i){let{kits:n}=b(),e=n.find(f=>f.id===t);if(!e)return;let o=document.getElementById("kit-mov-mat-"+t),s=document.getElementById("kit-mov-qty-"+t),a=document.getElementById("kit-mov-nota-"+t);if(!o||!s)return;let d=o.value,c=o.options[o.selectedIndex]?.dataset.sid,l=Math.max(1,Number.parseInt(s.value,10)||1),m=(a?.value||"").trim(),p=(e.sezioni||[]).find(f=>f.id===c),u=p&&(p.componenti||[]).find(f=>f.id===d);if(!u||!Jt(u))return;i==="carico"?u.caricato=(parseInt(u.caricato)||0)+l:u.caricato=Math.max(0,(parseInt(u.caricato)||0)-l),e.movimenti||(e.movimenti=[]),e.movimenti.unshift({id:Date.now(),cid:d,sid:c,tipo:i,qty:l,nota:m,mat:u.nome,ts:ii()}),A(n),s&&(s.value=1),a&&(a.value="");let g=document.getElementById("kit-mov-list-"+t);g&&(g.innerHTML=an(e,ti()));let h=document.querySelector(`#kit-tbody-${t} input[data-cid="${d}"]`);h&&(h.value=u.caricato,$i(h))}function cn(t,i){if(!ti())return;let{kits:n}=b(),e=n.find(s=>s.id===t);if(!e)return;let o=(e.movimenti||[]).find(s=>s.id===i);o&&dn(t,i,o)}function dn(t,i,n){let e=document.getElementById("modal-kit-del-mov");if(!e)return;let o=document.getElementById("kit-del-mov-desc"),s;if(n.tipo==="spedizione")s=`<span class="kit-mov-badge spedizione" style="font-size:.75rem">SPED.</span> <strong>Spedizione \xD7${(n.righe||[]).reduce((c,l)=>c+l.qty,0)} pz</strong>`;else if(n.tipo==="reso")s=`<span class="kit-mov-badge reso" style="font-size:.75rem">RESO</span> <strong>Rientro \xD7${n.totPz||0} pz</strong>`;else{let d=n.tipo==="carico"?"CARICO":"SCARICO";s=`<span class="kit-mov-badge ${r(n.tipo)}" style="font-size:.75rem">${d}</span> <strong>${r(n.mat)}</strong> ${n.tipo==="carico"?"+":"\u2212"}${n.qty} pz`}o&&(o.innerHTML=s);let a=document.getElementById("btn-kit-del-ok");a&&(a.onclick=()=>xi(t,i)),e.style.display="flex",e.offsetHeight,e.classList.add("active")}function Si(){let t=document.getElementById("modal-kit-del-mov");t&&(t.classList.remove("active"),setTimeout(()=>{t.classList.contains("active")||(t.style.display="none")},300))}function xi(t,i){Si();let{kits:n}=b(),e=n.find(s=>s.id===t);if(!e)return;let o=(e.movimenti||[]).find(s=>s.id===i);if(o){if(o.tipo==="spedizione"){let s=(e.sezioni||[]).find(a=>a.id===o.sid);for(let a of o.righe||[])for(let d of e.sezioni||[]){let c=(d.componenti||[]).find(l=>l.id===a.cid||l.nome===a.mat);c&&(c.caricato=(parseInt(c.caricato)||0)+a.qty)}for(let a of o.items||[])a.saId&&e.pronti&&(e.pronti[a.saId]=(parseInt(e.pronti[a.saId])||0)+a.qty)}else if(o.tipo==="reso")for(let s of o.righe||[])for(let a of e.sezioni||[]){let d=(a.componenti||[]).find(c=>c.id===s.cid||c.nome===s.mat);d&&(d.caricato=Math.max(0,(parseInt(d.caricato)||0)-s.qty))}else if(o.tipo==="carico")for(let s of e.sezioni||[]){let a=(s.componenti||[]).find(d=>d.id===o.cid);a&&(a.caricato=Math.max(0,(parseInt(a.caricato)||0)-o.qty))}else if(o.tipo==="scarico")for(let s of e.sezioni||[]){let a=(s.componenti||[]).find(d=>d.id===o.cid);a&&(a.caricato=(parseInt(a.caricato)||0)+o.qty)}e.movimenti=(e.movimenti||[]).filter(s=>s.id!==i),A(n),T===t&&K(),y("Movimento eliminato \u2713")}}function ln(t,i){if(!ti())return;let{kits:n}=b(),e=n.find(l=>l.id===t);if(!e)return;let o=(e.movimenti||[]).find(l=>l.id===i);if(!o)return;let s=document.getElementById("modal-kit-edit-mov");if(!s)return;let a=document.getElementById("kit-edit-mov-mat"),d=document.getElementById("kit-edit-mov-qty"),c=document.getElementById("kit-edit-mov-nota");a&&(a.innerHTML=`<span class="kit-mov-badge ${r(o.tipo)}" style="font-size:.75rem">${o.tipo==="carico"?"CARICO":"SCARICO"}</span> <strong>${r(o.mat)}</strong>`),d&&(d.value=o.qty),c&&(c.value=o.nota||""),s.dataset.kitId=t,s.dataset.movId=i,s.style.display="flex",s.offsetHeight,s.classList.add("active"),setTimeout(()=>c&&c.focus(),80)}function Ii(){let t=document.getElementById("modal-kit-edit-mov");t&&(t.classList.remove("active"),setTimeout(()=>{t.classList.contains("active")||(t.style.display="none")},300))}function pn(){let t=document.getElementById("modal-kit-edit-mov");if(!t)return;let i=t.dataset.kitId,n=Number(t.dataset.movId);Ii();let{kits:e}=b(),o=e.find(l=>l.id===i);if(!o)return;let s=(o.movimenti||[]).findIndex(l=>l.id===n);if(s===-1)return;let a=o.movimenti[s],d=parseInt(document.getElementById("kit-edit-mov-qty")?.value),c=(document.getElementById("kit-edit-mov-nota")?.value||"").trim();if(isNaN(d)||d<=0){y("Quantit\xE0 non valida \u26A0\uFE0F");return}if(d!==a.qty){let l=d-a.qty;for(let m of o.sezioni||[]){let p=(m.componenti||[]).find(u=>u.id===a.cid);if(p){a.tipo==="carico"?p.caricato=Math.max(0,(parseInt(p.caricato)||0)+l):p.caricato=Math.max(0,(parseInt(p.caricato)||0)-l);break}}}o.movimenti[s]={...a,qty:d,nota:c},A(e),T===i&&K(),y("Movimento aggiornato \u2713")}function mn(t){let{kits:i}=b(),n=i.find(c=>c.id===t);if(!n)return;if(!(n.sottoAssembly||[]).some(c=>(Number.parseInt(n.pronti?.[c.id],10)||0)>0)){y("Nessuna parte tracciabile pronta \u2014 imposta le quantit\xE0 prima \u26A0\uFE0F");return}let o=document.getElementById("modal-kit-sped");if(!o)return;let s=document.getElementById("kit-sped-items-list");s&&(s.innerHTML=(n.sottoAssembly||[]).filter(c=>(Number.parseInt(n.pronti?.[c.id],10)||0)>0).map(c=>{let l=Number.parseInt(n.pronti?.[c.id],10)||0,m=yi(n,c.varianteKey);return`<label class="kit-sped-item-row">
                ...
                </label>`}).join(""));let a=document.getElementById("kit-sped-nota-"+t),d=document.getElementById("kit-sped-modal-nota");d&&a&&(d.value=a.value||""),d&&!a&&(d.value=""),o.dataset.kitId=t,o.style.display="flex",o.offsetHeight,o.classList.add("active")}function Ai(){let t=document.getElementById("modal-kit-sped");t&&(t.classList.remove("active"),setTimeout(()=>{t.classList.contains("active")||(t.style.display="none")},300))}function un(){let t=document.getElementById("modal-kit-sped");if(!t)return;let i=t.dataset.kitId;Ai();let n=[...document.querySelectorAll(".kit-sped-chk:checked")].map(l=>l.dataset.said);if(!n.length)return;let{kits:e}=b(),o=e.find(l=>l.id===i);if(!o)return;let s=(document.getElementById("kit-sped-modal-nota")?.value||"").trim(),a=[],d=[];for(let l of n){let m=(o.sottoAssembly||[]).find(u=>u.id===l);if(!m)continue;let p=Number.parseInt(o.pronti?.[l],10)||0;if(p){a.push({saId:l,nome:m.nome,qty:p});for(let u of o.sezioni||[])for(let g of u.componenti||[]){if(j(g))continue;let h=H(g,m.varianteKey);if(!h)continue;let f=p*h;g.caricato=Math.max(0,(parseInt(g.caricato)||0)-f);let z=d.find($=>$.cid===g.id);z?z.qty+=f:d.push({cid:g.id,mat:g.nome,qty:f})}o.pronti||(o.pronti={}),delete o.pronti[l]}}o.movimenti||(o.movimenti=[]),o.movimenti.unshift({id:Date.now(),tipo:"spedizione",items:a,righe:d,nota:s,ts:ii()}),A(e);let c=a.reduce((l,m)=>l+m.qty,0);y(`Spedizione registrata: ${c} pz \u2713`),T===i&&K()}function fn(t){let{kits:i}=b(),n=i.find(a=>a.id===t);if(!n)return;let e=document.getElementById("modal-kit-reso");if(!e)return;let o=document.getElementById("kit-reso-items-list");if(o){let a=n.sottoAssembly||[];o.innerHTML=a.length===0?'<p style="color:#94a3b8;text-align:center">Configura prima i sub-assembly per registrare un reso.</p>':a.map(d=>{let c=yi(n,d.varianteKey);return`<div class="kit-reso-item-row">
        ...
        </div>`:p='<div class="kcfg-list">'+l.map(({comp:f,sez:z})=>{let $=m(f),L=$?($.categoria||"").trim():"",R=L?d(L):"#e2e8f0",N=St(f.unitaMisura,"pz"),ht=e.map(tt=>`<option value="${tt}"${N===tt?" selected":""}>${tt}</option>`).join("");return`<div class="kcfg-comp-row">
        ...
        </div>`:g=s.map(z=>{let $=n.filter(N=>(N.categoria||"").trim()===z&&!u.has(N.nome));if($.length===0)return"";let L=d(z),R=$.map(N=>`<button type="button" class="kcfg-pill"
        ...
        <div style="margin-top:14px;padding-top:10px;border-top:1px solid #f1f5f9">
        ...
        </div>`)}function hn(t,i,n,e){S(t,o=>{let s=(o.sezioni||[]).find(a=>a.id===i);s&&(s[n]=e.trim()||s[n])},!0)}function zn(t,i){confirm("Eliminare questa sezione e tutti i componenti?")&&S(t,n=>{n.sezioni=(n.sezioni||[]).filter(e=>e.id!==i)},!0)}function wn(t,i){let e=Y().find(s=>s.id===i);if(!e)return;let o=(e.categoria||"").trim()||"Generali";S(t,s=>{let a=(s.sezioni||[]).find(d=>d.nome.trim()===o);a||(a={id:_(),nome:o,componenti:[]},s.sezioni=s.sezioni||[],s.sezioni.push(a)),a.componenti=a.componenti||[],a.componenti.push({id:_(),nome:e.nome,codice:e.codice||"",qtaBase:1,unitaMisura:e.unitaMisura||"pz",regola:{tipo:"sempre",qtyBase:1}})},!0)}function _n(){F&&S(F,t=>{let i=(t.sezioni||[]).find(n=>n.nome==="Liberi");i||(i={id:_(),nome:"Liberi",componenti:[]},t.sezioni=t.sezioni||[],t.sezioni.push(i)),i.componenti=i.componenti||[],i.componenti.push({id:_(),nome:"Nuovo componente",codice:"",qtaBase:1,unitaMisura:"pz",regola:{tipo:"sempre",qtyBase:1}})},!0)}function Cn(t,i,n,e,o){S(t,s=>{let a=(s.sezioni||[]).find(c=>c.id===i),d=a&&(a.componenti||[]).find(c=>c.id===n);d&&(e==="qtaBase"?(d.qtaBase=parseFloat(o)||1,d.regola&&(d.regola.qtyBase=d.qtaBase)):d[e]=o)},!0)}function $n(t,i,n,e,o){S(t,s=>{let a=(s.sezioni||[]).find(c=>c.id===i),d=a&&(a.componenti||[]).find(c=>c.id===n);d&&(d.regola=d.regola||{},e==="tipo"?(d.regola.tipo=o,o==="gruppo"&&!d.regola.asseId&&s.assiConfigurazione?.length&&(d.regola.asseId=s.assiConfigurazione[0].id),o==="gruppo"&&(d.regola.opzioneIds=d.regola.opzioneIds||[])):e==="asseId"?(d.regola.asseId=o,d.regola.opzioneIds=[]):d.regola[e]=o)},!0)}function Sn(t,i,n){S(t,e=>{let o=(e.sezioni||[]).find(s=>s.id===i);o&&(o.componenti=(o.componenti||[]).filter(s=>s.id!==n))},!0)}function xn(t){S(t,i=>{i.assiConfigurazione=i.assiConfigurazione||[],i.assiConfigurazione.push({id:_(),nome:"Nuovo gruppo",key:W("","ax"+i.assiConfigurazione.length),opzioni:[]})},!0)}function In(t,i){confirm("Eliminare questo gruppo elettronico?")&&S(t,n=>{n.assiConfigurazione=(n.assiConfigurazione||[]).filter(e=>e.id!==i)},!0)}function An(t,i,n,e){S(t,o=>{let s=(o.assiConfigurazione||[]).find(a=>a.id===i);s&&(s[n]=e)},!1)}function Mn(t,i){S(t,n=>{let e=(n.assiConfigurazione||[]).find(s=>s.id===i);if(!e)return;e.opzioni=e.opzioni||[];let o=e.opzioni.length+1;e.opzioni.push({id:_(),key:W("","opz"+o),nome:"Nuova opzione",codice:""})},!0)}function Nn(t,i,n){S(t,e=>{let o=(e.assiConfigurazione||[]).find(s=>s.id===i);o&&(o.opzioni=(o.opzioni||[]).filter(s=>s.id!==n))},!0)}function On(t,i,n,e,o){S(t,s=>{let a=(s.assiConfigurazione||[]).find(c=>c.id===i),d=a&&(a.opzioni||[]).find(c=>c.id===n);d&&(d[e]=o)},!1)}function Ei(){let t=document.getElementById("modal-kit-crea");if(!t)return;let i=document.getElementById("kit-crea-nome");i&&(i.value=""),t.style.display="flex",t.offsetHeight,t.classList.add("active"),setTimeout(()=>i&&i.focus(),80)}function Bi(){let t=document.getElementById("modal-kit-crea");t&&(t.classList.remove("active"),setTimeout(()=>{t.classList.contains("active")||(t.style.display="none")},300))}function qn(){let t=(document.getElementById("kit-crea-nome")?.value||"").trim();if(!t){y("Inserisci un nome per il kit","warning");return}let{kits:i}=b(),n={id:_(),nome:t,schemaVersion:Vt,assiConfigurazione:[],varianti:[],sezioni:[],sottoAssembly:[],qtaDaProdurre:{},pronti:{},movimenti:[]};i.push(n),A(i),Bi(),setTimeout(()=>B("kits"),320)}function En(t){ft.kitId=t;let i=document.getElementById("modal-kit-qadd-sez");if(!i)return;let n=document.getElementById("kit-qadd-sez-nome");n&&(n.value=""),i.style.display="flex",i.offsetHeight,i.classList.add("active"),setTimeout(()=>n&&n.focus(),80)}function Di(){let t=document.getElementById("modal-kit-qadd-sez");t&&(t.classList.remove("active"),setTimeout(()=>{t.classList.contains("active")||(t.style.display="none")},300))}function Bn(){let t=(document.getElementById("kit-qadd-sez-nome")?.value||"").trim()||"Nuova sezione",{kits:i}=b(),n=i.find(e=>e.id===ft.kitId);n&&(n.sezioni=n.sezioni||[],n.sezioni.push({id:_(),nome:t,componenti:[]}),A(i),Di(),setTimeout(F?()=>Q():()=>B("kits"),320))}function Dn(t,i){ft.kitId=t,ft.sezId=i;let n=document.getElementById("modal-kit-qadd-comp");if(!n)return;let e=Y(),o=document.getElementById("kit-qadd-comp-source-cat"),s=document.getElementById("kit-qadd-comp-source-free");e.length?(o&&(o.checked=!0),Ht("cat")):(s&&(s.checked=!0),Ht("free"));let a=[...new Set(e.map(u=>u.categoria||"Senza categoria"))].sort(),d=document.getElementById("kit-qadd-comp-cat");d&&(d.innerHTML=a.map(u=>`<option value="${r(u)}">${r(u)}</option>`).join(""),Ti());let c=document.getElementById("kit-qadd-comp-qty");c&&(c.value="1");let l=document.getElementById("kit-qadd-comp-unit");l&&(l.value="pz");let m=document.getElementById("kit-qadd-comp-nome");m&&(m.value="");let p=document.getElementById("kit-qadd-comp-codice");p&&(p.value=""),n.style.display="flex",n.offsetHeight,n.classList.add("active")}function Ht(t){let i=document.getElementById("kit-qadd-comp-cat-section"),n=document.getElementById("kit-qadd-comp-free-section");i&&(i.style.display=t==="cat"?"":"none"),n&&(n.style.display=t==="free"?"":"none")}function Ti(){let t=document.getElementById("kit-qadd-comp-cat"),i=document.getElementById("kit-qadd-comp-comp");if(!t||!i)return;let n=t.value,o=Y().filter(s=>(s.categoria||"Senza categoria")===n);i.innerHTML=o.length?o.map(s=>`<option value="${r(s.id)}">${r(s.nome)}${s.codice?" \xB7 "+r(s.codice):""}</option>`).join(""):'<option value="">Nessun componente in questa categoria</option>'}function Li(){let t=document.getElementById("modal-kit-qadd-comp");t&&(t.classList.remove("active"),setTimeout(()=>{t.classList.contains("active")||(t.style.display="none")},300))}function Tn(){let t=document.getElementById("kit-qadd-comp-source-cat")?.checked,i="",n="";if(t){let l=document.getElementById("kit-qadd-comp-comp")?.value;if(!l){y("Seleziona un componente dal catalogo","warning");return}let m=Y().find(p=>p.id===l);if(!m){y("Componente non trovato nel catalogo","warning");return}i=m.nome,n=m.codice||""}else{if(i=(document.getElementById("kit-qadd-comp-nome")?.value||"").trim(),!i){y("Inserisci il nome del componente","warning");return}n=(document.getElementById("kit-qadd-comp-codice")?.value||"").trim()}let e=parseFloat(document.getElementById("kit-qadd-comp-qty")?.value)||1,o=document.getElementById("kit-qadd-comp-unit")?.value||"pz",{kits:s}=b(),a=s.find(c=>c.id===ft.kitId);if(!a)return;let d=(a.sezioni||[]).find(c=>c.id===ft.sezId);d&&(d.componenti=d.componenti||[],d.componenti.push({id:_(),nome:i,codice:n,qtaBase:e,qtaPerVariante:{},caricato:0,modoComponente:"quantificato",tracciabile:!0,noteConfig:"",unitaMisura:o,applicazioneTipo:"sempre"}),A(s),Li(),setTimeout(F?()=>Q():()=>B("kits"),320))}function Ln(t,i,n,e,o){let{kits:s}=b(),a=s.find(l=>l.id===t);if(!a)return;let d=(a.sezioni||[]).find(l=>l.id===i);if(!d)return;let c=(d.componenti||[]).find(l=>l.id===n);c&&(e==="qtaBase"?c.qtaBase=parseFloat(o)||0:c[e]=o,A(s))}function Pn(t,i,n){if(!n.trim())return;let{kits:e}=b(),o=e.find(a=>a.id===t);if(!o)return;let s=(o.sezioni||[]).find(a=>a.id===i);s&&(s.nome=n.trim(),A(e))}function Kn(t,i,n){let{kits:e}=b(),o=e.find(a=>a.id===t);if(!o)return;let s=(o.sezioni||[]).find(a=>a.id===i);s&&(s.componenti=(s.componenti||[]).filter(a=>a.id!==n),A(e),B("kits"))}function Rn(t,i){if(!confirm("Rimuovere questa sezione e tutti i suoi componenti?"))return;let{kits:n}=b(),e=n.find(o=>o.id===t);e&&(e.sezioni=(e.sezioni||[]).filter(o=>o.id!==i),A(n),B("kits"))}function Hn(t){if(!confirm("Eliminare questo kit? L'operazione non \xE8 reversibile."))return;let{kits:i}=b(),n=i.filter(e=>e.id!==t);A(n),B("kits")}function jn(t){Oi={sourceKitId:t};let i=document.getElementById("modal-kit-duplicate");if(!i)return;let n=document.getElementById("kit-duplicate-nome");n&&(n.value=""),i.style.display="flex",i.offsetHeight,i.classList.add("active"),setTimeout(()=>n&&n.focus(),80)}function Pi(){let t=document.getElementById("modal-kit-duplicate");t&&(t.classList.remove("active"),setTimeout(()=>{t.classList.contains("active")||(t.style.display="none")},300))}function Vn(){let{sourceKitId:t}=Oi||{};if(!t){y("Errore: kit sorgente non trovato","error");return}let{kits:i}=b(),n=i.find(s=>s.id===t);if(!n){y("Kit sorgente non trovato","warning");return}let e=(document.getElementById("kit-duplicate-nome")?.value||"").trim();if(!e){y("Inserisci un nome per il kit duplicato","warning");return}let o=Qn(n);o.nome=e,i.push(o),A(i),Pi(),y(`Kit "${e}" creato da duplicazione \u2713`),setTimeout(()=>B("kits"),320)}function Qn(t){let i={},n=o=>(i[o]||(i[o]=_()),i[o]),e=JSON.parse(JSON.stringify(t));return e.id=_(),Array.isArray(e.sezioni)&&(e.sezioni=e.sezioni.map(o=>{let s=JSON.parse(JSON.stringify(o));return s.id=_(),Array.isArray(s.componenti)&&(s.componenti=s.componenti.map(a=>{let d=JSON.parse(JSON.stringify(a));return d.id=_(),d})),s})),Array.isArray(e.assiConfigurazione)&&(e.assiConfigurazione=e.assiConfigurazione.map(o=>{let s=JSON.parse(JSON.stringify(o));return s.id=_(),Array.isArray(s.opzioni)&&(s.opzioni=s.opzioni.map(a=>{let d=JSON.parse(JSON.stringify(a));return d.id=_(),d})),s})),Array.isArray(e.varianti)&&(e.varianti=e.varianti.map(o=>{let s=JSON.parse(JSON.stringify(o));return s.id=_(),s})),Array.isArray(e.sottoAssembly)&&(e.sottoAssembly=e.sottoAssembly.map(o=>{let s=JSON.parse(JSON.stringify(o));return s.id=_(),s})),e.qtaDaProdurre={},e.pronti={},e.movimenti=[],e}function Un(){Ei()}function Ki(t){F=t,qi(t)}function Lt(t,i,n=""){let{kits:e}=b(),o=e.find(c=>c.id===t),s=e.find(c=>c.id!==t&&(c.sezioni||[]).length),a=o?.sezioni?.[0]?.id||"",d=e.find(c=>c.id!==t&&(c.assiConfigurazione||[]).length)?.assiConfigurazione?.[0]?.id||"";return{currentKitId:t,mode:i,search:"",sourceKitId:i==="copy"?t:s?.id||"",sectionId:n||(i==="copy"?a:s?.sezioni?.[0]?.id||""),asseId:n||(i==="import-asse"?d:""),targetKitIds:[]}}function Ri(t){C=Lt(t,"import"),Z(!0)}function Fn(t){C=Lt(t,"import-asse"),Z(!0)}function Jn(t,i){C=Lt(t,"copy",i),Z(!0)}function pt(){let t=document.getElementById("modal-kit-import");C=null,t&&(t.classList.remove("active"),setTimeout(()=>{t.classList.contains("active")||(t.style.display="none")},300))}function Gn(t){if(!C||t!=="import"&&t!=="copy"||C.mode===t)return;let i=C.currentKitId,n=t==="copy"?C.sectionId:"";C=Lt(i,t,n),Z()}function Wn(t){C&&(C.search=String(t||""),Z())}function Yn(t){if(!C)return;let{kits:i}=b(),n=i.find(e=>e.id===t);C.sourceKitId=t,C.mode==="import-asse"?C.asseId=n?.assiConfigurazione?.[0]?.id||"":C.sectionId=n?.sezioni?.[0]?.id||"",Z()}function Zn(t){C&&(C.mode==="import-asse"?C.asseId=t:C.sectionId=t,Z())}function Xn(t,i){if(!C||C.mode!=="copy")return;let n=new Set(C.targetKitIds||[]);i?n.add(t):n.delete(t),C.targetKitIds=[...n],Z()}function to(){if(!C||C.mode!=="copy")return;let{kits:t}=b(),i=t.filter(e=>e.id!==C.currentKitId&&Mt(e.nome,C.search)),n=new Set(C.targetKitIds||[]);for(let e of i)n.add(e.id);C.targetKitIds=[...n],Z()}function io(){!C||C.mode!=="copy"||(C.targetKitIds=[],Z())}function Z(t=!1){let i=document.getElementById("modal-kit-import");if(!i||!C)return;let{kits:n}=b(),e=C,o=n.find(k=>k.id===e.currentKitId);if(!o){pt();return}let s=[];e.mode==="import"?s=n.filter(k=>k.id!==o.id&&(k.sezioni||[]).length):e.mode==="import-asse"?s=n.filter(k=>k.id!==o.id&&(k.assiConfigurazione||[]).length):s=n.filter(k=>k.id!==o.id&&(k.sezioni||[]).length),(e.mode==="import"||e.mode==="import-asse")&&!s.some(k=>k.id===e.sourceKitId)&&(e.sourceKitId=s[0]?.id||""),e.mode==="copy"&&(e.sourceKitId=o.id,e.targetKitIds=(e.targetKitIds||[]).filter(k=>k!==o.id&&n.some(w=>w.id===k)));let a=n.find(k=>k.id===e.sourceKitId)||null,d=e.mode==="import-asse"?a?.assiConfigurazione||[]:a?.sezioni||[];e.mode==="import-asse"?d.some(k=>k.id===e.asseId)||(e.asseId=d[0]?.id||""):d.some(k=>k.id===e.sectionId)||(e.sectionId=d[0]?.id||"");let c=e.mode==="import-asse"?(a?.assiConfigurazione||[]).find(k=>k.id===e.asseId)||null:Ut(a,e.sectionId),l=s.filter(k=>Mt(k.nome,e.search)),m=n.filter(k=>k.id!==o.id&&Mt(k.nome,e.search)),p=document.getElementById("kit-import-subtitle"),u=document.getElementById("kit-import-search"),g=document.getElementById("kit-import-left-title"),h=document.getElementById("kit-import-right-title"),f=document.getElementById("kit-import-kit-list"),z=document.getElementById("kit-import-section-list"),$=document.getElementById("kit-import-target-wrap"),L=document.getElementById("kit-import-target-list"),R=document.getElementById("kit-import-preview"),N=document.getElementById("kit-import-confirm-btn"),ht=document.getElementById("kit-import-mode-import"),tt=document.getElementById("kit-import-mode-copy");if(!p||!u||!g||!h||!f||!z||!$||!L||!R||!N||!ht||!tt)return;ht.classList.toggle("kit-import-mode-btn--active",e.mode==="import"||e.mode==="import-asse"),tt.classList.toggle("kit-import-mode-btn--active",e.mode==="copy"),u.value=e.search,e.mode==="import"?(p.textContent=`Importa una sezione esistente dentro "${o.nome}".`,u.placeholder="Cerca kit sorgente\u2026",g.textContent="Kit sorgente",h.textContent=a?`Sezioni di ${a.nome}`:"Sezione",$.style.display="none",f.innerHTML=l.length?l.map(k=>{let w=k.id===e.sourceKitId;return`<label class="kit-import-option ${w?"kit-import-option--active":""}">
            ...
            </label>`}).join(""):'<div class="kit-import-empty">Nessun preset presente.</div>';let p=n.find(u=>u.id===e.selectedPresetId)||null;if(p){let u=p.sourceKitId&&b().kits.find(g=>g.id===p.sourceKitId)?.nome||"";d.innerHTML=`<div style="padding:6px"><strong>${r(p.nome)}</strong><div style="color:#94a3b8">${r(u)}</div></div>`+(p.sezione?.componenti?.length?`<div>${p.sezione.componenti.map(g=>`<div class="kit-meta-pill">${r(g.nome)}${g.codice?" \xB7 "+r(g.codice):""}</div>`).join("")}</div>`:'<div class="kit-import-empty">Sezione vuota</div>')}else d.innerHTML=`<div class="kit-import-empty">Seleziona un preset per vedere l'anteprima.</div>`;m.disabled=!p,c.value="",l.innerHTML=(o?.sezioni||[]).map(u=>`<option value="${r(u.id)}">${r(u.nome)}</option>`).join(""),t&&(i.style.display="flex",i.offsetHeight,i.classList.add("active"),setTimeout(()=>{let u=document.getElementById("preset-search");u&&u.focus()},40))}function po(){let{kits:t}=b(),i=t.find(v=>v.id===Ni);if(!i){yt();return}let n=document.getElementById("contenitore-dati"),e=i.assiConfigurazione||[],o=E(i);at==="sezioni"&&(at="bom"),at==="sa"&&(at="bom");let s=["info","varianti","anagrafiche","bom"],a={info:"Prodotto",varianti:"Elettronica selezionabile",anagrafiche:"Anagrafiche",bom:"Parti del prodotto"},d=e.length,c=o.length,l=(i.sezioni||[]).reduce((v,I)=>v+(I.componenti||[]).length,0),m=c?`
        ...
        <div class="kit-cfg-section">
            ...
            ${g}
        </div>`,f=(i.sezioni||[]).map((v,I)=>{let k=(v.componenti||[]).map(w=>{let M=j(w),D=Gt(w,i),ai=(e||[]).find(q=>q.id===D.asseId)||null,Qi=D.tipo==="gruppo"&&ai?`<div class="kit-cfg-row">${(ai.opzioni||[]).map(q=>`<label class="kit-meta-pill">
                   ...
                   </select>`:"",Fi=D.tipo==="manuale"?'<div class="kit-cfg-warn">Questa parte usa ancora una configurazione avanzata precedente. Appena la modifichi verr\xE0 convertita nel nuovo schema semplice.</div>':"",ri=M?"flag":St(w.unitaMisura,"pz"),Ji=M?[{value:"flag",label:"Solo avviso"}]:[...new Set([ri,...te])].filter(Boolean).map(q=>({value:q,label:q}));return`<div class="kit-cfg-sa-group" style="padding:12px 14px">
                ...
                <div class="kit-cfg-row">
                    ...
                    <select class="kit-cfg-select" style="max-width:120px"
                            ...
                            ${M?"disabled":""}>
                        ${Ji.map(q=>`<option value="${r(q.value)}" ${ri===q.value?"selected":""}>${r(q.label)}</option>`).join("")}
                    </select>
    ...
    </div>`,zt(n)}function mo(t){if(t&&T===t){K();return}T=t,K()}function uo(t){at=t,po()}function S(t,i,n=!0){let{kits:e}=b(),o=e.find(s=>s.id===t);o&&(i(o),A(e),n&&Q())}function fo(t,i){S(t,function(n){n.nome=i.trim()||"Kit senza nome"},!1)}function go(t){if(!confirm("Eliminare questo kit e tutti i suoi dati?"))return;let{kits:i}=b();A(i.filter(n=>n.id!==t)),Ni=null,T=null,yt()}function ko(t){let{kits:i}=b(),n=i.find(o=>o.id===t);if(!n)return;let e={id:_(),nome:`Copia di ${n.nome}`,schemaVersion:Vt,assiConfigurazione:[],varianti:[],sezioni:[],sottoAssembly:[],qtaDaProdurre:{},pronti:{},movimenti:[]};for(let o of n.assiConfigurazione||[])e.assiConfigurazione.push(ui(o,n,e));e.varianti=pi(e.assiConfigurazione);for(let o of n.sezioni||[])e.sezioni.push(At(o,n,e));e.sottoAssembly=(n.sottoAssembly||[]).map(o=>({id:_(),nome:o.nome||"",varianteKey:o.varianteKey||"",noteConfig:o.noteConfig||""})),i.push(e),A(i),Ki(e.id),y(`Kit "${n.nome}" duplicato \u2713`)}function Vi(t){S(t,function(i){let n=(i.assiConfigurazione||[]).length+1;i.assiConfigurazione=i.assiConfigurazione||[],i.assiConfigurazione.push({id:_(),key:"asse"+n,nome:"Asse "+n,opzioni:[{id:_(),key:"opz1",nome:"Opzione 1"}]})})}function vo(t,i,n,e){S(t,function(o){let s=(o.assiConfigurazione||[]).find(a=>a.id===i);s&&(n==="key"?s.key=W(e,s.key||"asse"):s[n]=e.trim())})}function yo(t,i){S(t,function(n){n.assiConfigurazione=(n.assiConfigurazione||[]).filter(e=>e.id!==i)})}function bo(t,i){S(t,function(n){let e=(n.assiConfigurazione||[]).find(s=>s.id===i);if(!e)return;let o=(e.opzioni||[]).length+1;e.opzioni=e.opzioni||[],e.opzioni.push({id:_(),key:"opz"+o,nome:"Opzione "+o,codice:""})})}function ho(t,i,n,e,o){S(t,function(s){let a=(s.assiConfigurazione||[]).find(c=>c.id===i),d=a&&(a.opzioni||[]).find(c=>c.id===n);d&&(e==="key"?d.key=W(o,d.key||"opzione"):d[e]=o.trim())})}function zo(t,i,n){S(t,function(e){let o=(e.assiConfigurazione||[]).find(s=>s.id===i);o&&(o.opzioni=(o.opzioni||[]).filter(s=>s.id!==n))})}function wo(t){Vi(t)}function _o(t){S(t,function(i){i.sezioni=i.sezioni||[],i.sezioni.push({id:_(),nome:"Nuova sezione",componenti:[]})})}function Co(t){Ri(t)}function $o(t,i,n,e){S(t,function(o){let s=(o.sezioni||[]).find(a=>a.id===i);s&&(s[n]=e.trim())},!1)}function So(t,i){confirm("Eliminare questa sezione e tutti i suoi componenti?")&&S(t,function(n){n.sezioni=(n.sezioni||[]).filter(e=>e.id!==i)})}function xo(t,i){S(t,function(n){let e=(n.sezioni||[]).find(o=>o.id===i);e&&(e.componenti=e.componenti||[],e.componenti.push({id:_(),nome:"Nuovo componente",codice:"",qtaPerVariante:{},caricato:0,modoComponente:"quantificato",tracciabile:!0,noteConfig:"",unitaMisura:"pz"}))})}function Io(t,i,n,e,o,s){S(t,function(a){let d=(a.sezioni||[]).find(l=>l.id===i),c=d&&(d.componenti||[]).find(l=>l.id===n);if(c){if(e==="coeff"||e==="flag"){c.qtaPerVariante=c.qtaPerVariante||{},c.qtaPerVariante[o]=X(s);return}if(e==="modo"){c.modoComponente=s==="segnalazione"?"segnalazione":"quantificato",c.modoComponente==="segnalazione"?(c.tracciabile=!1,c.unitaMisura="flag"):c.unitaMisura==="flag"&&(c.unitaMisura="pz");return}if(e==="unitaMisura"){c.unitaMisura=c.modoComponente==="segnalazione"?"flag":St(s,"pz");return}c[e]=s.trim()}},e!=="nome"&&e!=="noteConfig")}function Ao(t,i,n,e,o){S(t,function(s){let a=(s.sezioni||[]).find(l=>l.id===i),d=a&&(a.componenti||[]).find(l=>l.id===n);if(!d)return;let c=Gt(d,s);if(e==="tipo"){if(c.tipo=o==="gruppo"?"gruppo":"sempre",c.tipo==="gruppo"&&!c.asseId){c.asseId=s.assiConfigurazione?.[0]?.id||"";let l=(s.assiConfigurazione||[]).find(m=>m.id===c.asseId);c.opzioneIds=l?.opzioni?.length?[l.opzioni[0].id]:[]}}else if(e==="qtyBase")c.qtyBase=X(o);else if(e==="asseId"){c.asseId=String(o||"");let l=(s.assiConfigurazione||[]).find(m=>m.id===c.asseId);c.opzioneIds=l?.opzioni?.length?[l.opzioni[0].id]:[],c.tipo="gruppo"}d.applicazioneTipo=c.tipo,d.applicazioneAsseId=c.asseId,d.applicazioneOpzioneIds=c.opzioneIds,d.qtaBase=c.qtyBase,d.qtaPerVariante=Qt(d,s,c)})}function Mo(t,i,n,e,o){S(t,function(s){let a=(s.sezioni||[]).find(m=>m.id===i),d=a&&(a.componenti||[]).find(m=>m.id===n);if(!d)return;let c=Gt(d,s),l=new Set(c.opzioneIds||[]);o?l.add(e):l.delete(e),c.tipo="gruppo",c.opzioneIds=[...l],d.applicazioneTipo=c.tipo,d.applicazioneAsseId=c.asseId,d.applicazioneOpzioneIds=c.opzioneIds,d.qtaBase=c.qtyBase,d.qtaPerVariante=Qt(d,s,c)})}function No(t,i,n,e){S(t,function(o){let s=(o.sezioni||[]).find(d=>d.id===i),a=s&&(s.componenti||[]).find(d=>d.id===n);!a||j(a)||(a.tracciabile=!!e)},!1)}function Oo(t,i,n){S(t,function(e){let o=(e.sezioni||[]).find(s=>s.id===i);o&&(o.componenti=(o.componenti||[]).filter(s=>s.id!==n))})}function qo(t){S(t,function(i){i.sottoAssembly=i.sottoAssembly||[],i.sottoAssembly.push({id:_(),nome:"",varianteKey:E(i)[0]?.key||""})})}function Eo(t,i){S(t,function(n){n.sottoAssembly=n.sottoAssembly||[],n.sottoAssembly.push({id:_(),nome:"",varianteKey:i,noteConfig:""})})}function Bo(t,i,n,e){S(t,function(o){o.sottoAssembly[i]&&(o.sottoAssembly[i][n]=e.trim())},!1)}function Do(t,i){S(t,function(n){n.sottoAssembly.splice(i,1)})}function To(t){let i=document.getElementById("modal-kit-distinta-edit");if(!i){wi(t);return}let{kits:n}=b(),e=n.find(c=>c.id===t);if(!e)return;let o=et(e),s=U(o),a=document.getElementById("distinta-edit-nome"),d=document.getElementById("distinta-edit-documento");a&&(a.value=s.documento||""),d&&(d.value=s.documento||""),i.dataset.kitId=t,i.style.display="flex",i.offsetHeight,i.classList.add("active"),setTimeout(()=>a&&a.focus(),80)}function jt(){let t=document.getElementById("modal-kit-distinta-edit");t&&(t.classList.remove("active"),setTimeout(()=>{t.classList.contains("active")||(t.style.display="none")},300))}function Lo(){let t=document.getElementById("modal-kit-distinta-edit");if(!t)return;let i=t.dataset.kitId,n=(document.getElementById("distinta-edit-nome")?.value||"").trim(),e=(document.getElementById("distinta-edit-documento")?.value||"").trim();if(!n){y("Inserisci un nome per la distinta.","warning");return}J(i,function(m){let p=U(m);e?p.documento=e:p.documento||(p.documento=n),It(m,p)});let{kits:o}=b(),s=o.find(m=>m.id===i);if(!s){jt(),y("Kit non trovato \u26A0\uFE0F");return}let a=et(s),d=Tt(s,a);if(!d.totalePezzi||!d.totaleRighe){y("Componi prima un ordine per generare la distinta stampabile.","warning");return}let c=nt(),l={id:_(),kitId:s.id,kitNome:s.nome,nome:n||a._meta?.documento||`Distinta-${Date.now()}`,documento:e||a._meta?.documento||"",createdAt:Date.now(),createdBy:V?.nome||"Sistema",orderDraftSnapshot:a,distintaSnapshot:d};c.unshift(l),xt(c),jt(),y("Distinta salvata \u2713"),P==="distinte"&&B("distinte")}function Uo(){window._kitOpenView=je,window._kitOpenConfig=Ki,window._kitNuovoKit=Un,window._kitBack=Ve,window._kitOpenPrintPreview=Ne,window._kitSwitchTab=Qe,window._kitAggiornaQty=Ue,window._kitOrdineSet=Fe,window._kitOrdineDelta=Je,window._kitOrdineReset=Ge,window._kitOrdineResetVoce=We,window._kitOrderSearch=Ye,window._kitOrderHideSearch=Ze,window._kitOrderPick=Xe,window._kitOrderRemoveRef=tn,window._kitComposeSelect=en,window._kitComposeAdd=nn,window._kitAggiornaCar=$i,window._kitAggiornaPronti=on,window._kitSetPronti=sn,window._kitApriModalSped=mn,window._kitChiudiModalSped=Ai,window._kitConfermaSpedizione=un,window._kitApriModalReso=fn,window._kitChiudiModalReso=Mi,window._kitResoQtyChange=gn,window._kitResoAggiornaBOM=si,window._kitConfermaReso=kn,window._kitSalvaMovimento=rn,window._kitEliminaMovimento=cn,window._kitModificaMovimento=ln,window._kitChiudiModalEditMov=Ii,window._kitConfermaModificaMov=pn,window._kitChiudiModalDelMov=Si,window._kitConfermaEliminaMov=xi,window._kitSalvaManuale=vn,window._kitElimina=go,window._kitDuplicaKit=ko,window._kitCfgBack=mo,window._kitCfgSwitchTab=uo,window._kitCfgSaveNome=fo,window._kitCfgAddVar=wo,window._kitCfgOpenImportModal=Ri,window._kitCfgOpenImportAsseModal=Fn,window._kitCfgOpenCopySezModal=Jn,window._kitCfgCloseImportModal=pt,window._kitCfgSetImportMode=Gn,window._kitCfgSetImportSearch=Wn,window._kitCfgSelectImportSource=Yn,window._kitCfgSelectImportSection=Zn,window._kitCfgToggleImportTarget=Xn,window._kitCfgSelectAllImportTargets=to,window._kitCfgClearImportTargets=io,window._kitCfgConfirmImport=eo,window._kitOpenPresetsModal=no,window._kitClosePresetsModal=Hi,window._kitSetPresetsSearch=oo,window._kitSelectPreset=so,window._kitCreatePresetFromSection=ao,window._kitCreatePreset=ji,window._kitApplyPreset=ro,window._kitRenamePreset=co,window._kitDeletePreset=lo,window._kitCfgAddAsse=Vi,window._kitCfgUpdateAsse=vo,window._kitCfgDelAsse=yo,window._kitCfgAddOpzione=bo,window._kitCfgUpdateOpzione=ho,window._kitCfgDelOpzione=zo,window._kitCfgAddSez=_o,window._kitCfgImportSez=Co,window._kitCfgUpdateSez=$o,window._kitCfgDelSez=So,window._kitCfgAddComp=xo,window._kitCfgUpdateComp=Io,window._kitCfgUpdateCompRule=Ao,window._kitCfgToggleCompOption=Mo,window._kitCfgToggleCompTracked=No,window._kitCfgDelComp=Oo,window._kitCfgAddSA=qo,window._kitCfgAddSAForVariant=Eo,window._kitCfgUpdateSA=Bo,window._kitCfgDelSA=Do,window._kitSwitchMainTab=B,window._kitRenderKitsGrid=bi,window._kitRenderAnagrafichePage=hi,window._kitRenderDistintePage=zi,window._kitLoadDistinte=nt,window._kitSaveDistinte=xt,window._kitCreateDistintaFromDraft=wi,window._kitLoadAnagrafiche=Y,window._kitSaveAnagrafiche=oi,window._kitOpenAnagraficaModal=Te,window._kitCloseAnagraficaModal=_i,window._kitConfirmSaveAnagrafica=Le,window._kitDeleteAnagrafica=Pe,window._kitOpenCreaKit=Ei,window._kitCloseCreaKit=Bi,window._kitConfirmCreaKit=qn,window._kitOpenConfigModal=qi,window._kitCloseConfigModal=yn,window._kitRenderConfigModal=Q,window._kitCfgModalSaveNome=bn,window._kitCfgModalAddAnag=wn,window._kitCfgModalAddCompFree=_n,window._kitCfgModalUpdateSez=hn,window._kitCfgModalDelSez=zn,window._kitCfgModalUpdateComp=Cn,window._kitCfgModalUpdateCompRule=$n,window._kitCfgModalDelComp=Sn,window._kitCfgModalAddAsse=xn,window._kitCfgModalDelAsse=In,window._kitCfgModalUpdateAsse=An,window._kitCfgModalAddOpz=Mn,window._kitCfgModalDelOpz=Nn,window._kitCfgModalUpdateOpz=On,window._kitQAddSezOpen=En,window._kitQAddSezClose=Di,window._kitQAddSezConfirm=Bn,window._kitQAddCompOpen=Dn,window._kitQAddCompToggleSource=Ht,window._kitQAddCompChangeCategoria=Ti,window._kitQAddCompClose=Li,window._kitQAddCompConfirm=Tn,window._kitQUpdateComp=Ln,window._kitQRenomeSez=Pn,window._kitQDelComp=Kn,window._kitQDelSez=Rn,window._kitQDelKit=Hn,window._kitOpenDuplicateModal=jn,window._kitCloseDuplicateModal=Pi,window._kitConfirmDuplicate=Vn,window._kitRenderHeaderActions=ei,window._kitOpenSaveDistintaModal=To,window._kitCloseSaveDistintaModal=jt,window._kitConfirmSaveDistinta=Lo,window._kitDistintaOpenPrint=Ke,window._kitDistintaApplyToDraft=Re,window._kitDistintaDelete=He,window._kitNSToggleComp=ke,window._kitNSSetUnits=ge,window._kitNSOrderSearch=ve,window._kitNSOrderHideSearch=ye,window._kitNSOrderPick=be,window._kitNSOrderRemoveRef=he,window._kitNSReset=we,window._kitNSToggleSection=gi,window._kitNSToggleSectionChk=ze,window._kitNSCreateDistinta=_e,window._kitNSOpenPrintPreview=Ce}var Vt,te,x,Rt,st,wt,Kt,P,_t,mt,T,Ci,Ni,at,C,O,ft,F,Oi,Fo,Po=Gi(()=>{Wi();Zi();Xi();Yi();Vt=2,te=["pz","mt","cm","mm","kg","g","lt","ml"];x=$t({});Rt=!1,st=[],wt=null,Kt={},P="kits";_t={};mt=null;typeof window<"u"&&window.addEventListener("beforeunload",function(){Oe()});T=null,Ci="ordine";Ni=null,at="info",C=null,O=null,ft={kitId:null,sezId:null},F=null,Oi={sourceKitId:null};Fo=yt});Po();export{yt as caricaKitProdotti,Fo as default,Uo as registerGlobals,Qo as resetKitFetch};
//# sourceMappingURL=chunk-kit-prodotti-OXEZSCUZ.js.map
