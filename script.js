...
function _buildCaricoOperatoriHtml(attivi) {
    ...
    const card1 = `<details class="ov-stato-card" open style="grid-column:1;grid-row:3">
    ...
    const card2 = `<details class="ov-stato-card" open style="grid-column:2;grid-row:3">
