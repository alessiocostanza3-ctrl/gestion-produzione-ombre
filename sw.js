/* ============================================================
   ...
   v9: bump cache v91 - fix card operatori solo IN PRODUZIONE + dedup ordine
   ============================================================ */
'use strict';
...
var SHELL_CACHE = 'prod-shell-v9';
var SHELL_ASSETS = [
    APP_URL,
    APP_URL + 'index.html',
    APP_URL + 'style.css?v=20260305d',
    APP_URL + 'script.js?v=20260305d',
