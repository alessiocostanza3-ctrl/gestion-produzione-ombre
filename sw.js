/* ============================================================
   ...
   v10: bump cache v91 - FORZA RELOAD - card operatori solo IN PRODUZIONE
   ============================================================ */
'use strict';
...
var SHELL_CACHE = 'prod-shell-v10';
var SHELL_ASSETS = [
    APP_URL,
    APP_URL + 'index.html',
    APP_URL + 'style.css?v=20260305e',
    APP_URL + 'script.js?v=20260305e',
