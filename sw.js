/* ============================================================
   ...
   v13: bump cache v94 - dropdown assegnazione per MASTER, Assegnami per operatori
   ============================================================ */
'use strict';
...
var SHELL_CACHE = 'prod-shell-v33';
var SHELL_ASSETS = [
    APP_URL,
    APP_URL + 'index.html',
    APP_URL + 'style.css?v=20260311d',
    APP_URL + 'script.js?v=20260311j',
