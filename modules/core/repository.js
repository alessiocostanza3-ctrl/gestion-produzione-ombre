...
export async function createManuale(payload) {
    return gasRequestWithTimeout({ azione: 'salvaManualeNuovo', ...payload }, 180000, { noDedupe: true });
}
...
export async function updateManuale(payload) {
    return gasRequestWithTimeout({ azione: 'aggiornaManuale', ...payload }, 180000, { noDedupe: true });
}
